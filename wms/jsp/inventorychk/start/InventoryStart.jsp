<%-- $Id: InventoryStart.jsp 7102 2010-02-18 01:42:02Z fukuwa $ --%>
 ...
 * 
 * @version $Revision: 7102 $, $Date: 2010-02-18 10:42:02 +0900 (木, 18 2 2010) $
      ...
      border=0>
        ...
        <TR height=28>
          <TD width=7><IMG 
            ...
            width=7></TD>
          <TD width=7></TD>
          <TD noWrap><h:tab id="tab" templateKey="W_InventoryStart"/></TD>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_1" templateKey="W_Area"/></TD>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_3" templateKey="W_Location"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_LocationFrom" templateKey="W_Location"/><h:label id="lbl_6" templateKey="W_Range"/><h:freetextbox id="txt_LocationTo" templateKey="W_Location"/><h:label id="lbl_InputStyle" templateKey="W_InputStyle"/><h:label id="lbl_InLocationStyle" templateKey="W_In_JavaSet"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7 colSpan=3><h:checkbox id="chk_InventoryIssue" templateKey="W_IssueReport"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7 colSpan=3><h:checkbox id="chk_InventoryStockReport" templateKey="W_InventoryStockQtyReport"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
