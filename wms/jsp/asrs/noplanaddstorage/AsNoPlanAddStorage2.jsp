<%-- $Id: AsNoPlanAddStorage2.jsp 2122 2008-12-15 06:31:06Z rnakai $ --%>
 ...
 * 
 * @version $Revision: 2122 $, $Date: 2008-12-15 15:31:06 +0900 (月, 15 12 2008) $
  ...
  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
      ...
      border=0>
        ...
        <TR height=28>
          ...
          <TD width=7></TD>
          <TD noWrap><h:tab id="NoPlanAddStorage2" templateKey="W_LocationSelectInputStorageInfo2"/></TD>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#dad9ee height=5>
                ...
                <TD colSpan=7><h:label id="lbl_In_Area" templateKey="W_In_JavaSet"/><h:pulldown id="pul_Area" templateKey="W_Area"/></TD>
                <TD></TD></TR>
              <TR bgColor=#dad9ee>
                ...
                <TD noWrap bgColor=#dad9ee colSpan=7><h:label id="lbl_In_Location" templateKey="W_In_JavaSet"/><h:submitbutton id="btn_LocationDetail" templateKey="W_P_LocationDetail"/></TD>
              ...
              <TR bgColor=#dad9ee>
                ...
                <TD noWrap bgColor=#dad9ee colSpan=7><h:linkedpulldown id="pul_WorkPlace" templateKey="W_WorkPlace"/>&nbsp;&nbsp; 
                  <h:label id="lbl_Station" templateKey="W_Station"/><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:linkedpulldown id="pul_Station" templateKey="W_Station"/></TD>
                <TD width="100%" bgColor=#dad9ee></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_ItemCode" templateKey="W_ItemCode"/><h:label id="lbl_ItemCode_Require" templateKey="W_Require"/></TD>
