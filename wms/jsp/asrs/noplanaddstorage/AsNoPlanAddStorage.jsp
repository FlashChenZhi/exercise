<%-- $Id: AsNoPlanAddStorage.jsp 7536 2010-03-13 09:13:11Z okayama $ --%>
 ...
 * 
 * @version $Revision: 7536 $, $Date: 2010-03-13 18:13:11 +0900 (土, 13 3 2010) $
      ...
      border=0>
        ...
        <TR height=28>
          <TD width=7><IMG 
            ...
            width=7></TD>
          <TD width=7></TD>
          <TD noWrap><h:tab id="tab" templateKey="W_LocationSelectInputStorageInfo"/></TD>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_ItemCode" templateKey="W_ItemCode"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:submitbutton id="btn_LocationSearch" templateKey="W_P_LocationSearch"/></TD></TR>
              <TR bgColor=#b8b7d7>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_Location" templateKey="W_Location"/><h:label id="lbl_12" templateKey="W_Require"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_Location" templateKey="W_Location"/><h:submitbutton id="btn_LocationDetail" templateKey="W_P_LocationDetail"/>&nbsp;&nbsp; 
                  <h:label id="lbl_InputStyle" templateKey="W_InputStyle"/><h:label id="lbl_LocationStyle" templateKey="W_In_JavaSet"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
