        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_ItemCode" templateKey="W_ItemCode"/><h:label id="lbl_Require" templateKey="W_Require"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_ItemCode" templateKey="W_ItemCode_EntEvent"/><h:submitbutton id="btn_SearchItemCode" templateKey="W_P_Search"/>&nbsp;&nbsp; 
                  <h:label id="lbl_ItemName" templateKey="W_ItemName"/><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_ItemName" templateKey="W_ItemName"/><h:submitbutton id="btn_SearchItemName" templateKey="W_P_Search"/></TD></TR>
              <TR bgColor=#b8b7d7>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_TotalStockQty" templateKey="W_TotalStockQty"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:numbertextbox id="txt_TotalStockQty" templateKey="W_TotalStockQty"/><h:submitbutton id="btn_Display" templateKey="W_DisplayNoFunc"/>&nbsp;&nbsp; 
                  <h:label id="lbl_PickingQty" templateKey="W_PickingQty"/><h:label id="lbl_1" templateKey="W_Require"/><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:numbertextbox id="txt_PickingQty" templateKey="W_PickingQty"/>&nbsp;&nbsp; <h:label id="lbl_PriorityFlag" templateKey="W_PriorityFlag"/><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:pulldown id="pul_PriorityFlag" templateKey="W_PriorityFlag"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" 
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD noWrap bgColor=#b8b7d7 colSpan=4><h:checkbox id="chk_WorkListPrint" templateKey="W_WorkListPrint"/>&nbsp;&nbsp; <h:checkbox id="chk_ShortageListPrint" templateKey="W_ShortageListPrint"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD noWrap bgColor=#b8b7d7 colSpan=2><h:label id="lbl_EnteredLinesEnterableLines" templateKey="W_EnteredLinesEnterableLines"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:numbertextbox id="txt_EnteredLines" templateKey="W_EnteredLines"/><h:numbertextbox id="txt_EnterableLines" templateKey="W_EnterableLines"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD>
                <TD noWrap bgColor=#b8b7d7 colSpan=4><h:scrolllistcell id="lst_FaItemRetrieval" templateKey="W_FaItemRetrieval"/>&nbsp;</TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR>
  <TR>
    <TD><%-- footer --%>
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
