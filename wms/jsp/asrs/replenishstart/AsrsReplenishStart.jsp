<%-- $Id: AsrsReplenishStart.jsp 134 2008-10-08 21:57:16Z okamura $ --%>
 ...
 * 
 * @version $Revision: 134 $, $Date: 2008-10-09 06:57:16 +0900 (木, 09 10 2008) $
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7 height=5>
                <TD><h:label id="lbl_ListWorkNo" templateKey="W_ListWorkNo"/></TD>
                <TD><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD><h:freetextbox id="txt_ListWorkNo" templateKey="W_ListWorkNo"/></TD></TR>
              <TR bgColor=#b8b7d7>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp; </TD>
                <TD width="100%" bgColor=#b8b7d7>&nbsp;<h:listcell id="lst_ReplenishmentStart" templateKey="W_ReplenishmentStart"/></TD></TR></TBODY></TABLE>&nbsp;</TD></TR></TBODY></TABLE></TD></TR>
  <TR>
    <TD>
<%-- footer --%>
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
