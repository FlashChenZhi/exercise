<%-- $Id: AsOperationCycle.jsp 7134 2010-02-18 07:39:31Z shibamoto $ --%>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_InSearchDate" templateKey="AST_InSearchDate"/><h:label id="lbl_Range2" templateKey="W_Range"/><h:freetextbox id="txt_InToSearchDate" templateKey="AST_InToSearchDate"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp; &nbsp; </TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:scrolllistcell id="lst_ASRSOperationResult" templateKey="W_ASRSOperationResult"/></TD></TR></TBODY></TABLE>&nbsp;</TD></TR></TBODY></TABLE></TD></TR>
  <TR height=15>
    <TD height=15></TD></TR>
  <TR>
    <TD><%-- footer --%>
