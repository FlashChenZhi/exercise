<%-- $Id: AsRetrievalOrderCancel.jsp 7134 2010-02-18 07:39:31Z shibamoto $ --%>
      ...
      border=0>
        ...
        <TR height=28>
          <TD width=7><IMG 
            ...
            width=7></TD>
          <TD width=7></TD>
          <TD noWrap><h:tab id="tab_cancel" templateKey="W_RetrievalCancel"/></TD>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD noWrap bgColor=#b8b7d7><h:datetextbox id="txt_RetrievalPlanDate" templateKey="W_PlanDate"/><h:label id="lbl_InputStyle" templateKey="W_InputStyle"/><h:label id="lbl_Day" templateKey="W_InputStyleDay"/>　　</TD>
                <TD width="100%" bgColor=#b8b7d7>&nbsp;&nbsp; <h:label id="lbl_BatchNo" templateKey="W_BatchNo"/><IMG 
              ...
              <TR>
                ...
                <TD noWrap bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD noWrap bgColor=#b8b7d7 colSpan=4><h:freetextbox id="txt_OrderNoFrom" templateKey="W_OrderNo"/><h:label id="lbl_Range" templateKey="W_Range"/><h:freetextbox id="txt_OrderNoTo" templateKey="W_OrderNo"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl__Area" templateKey="W_Area"/></TD>
                <TD noWrap bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD noWrap bgColor=#b8b7d7 colSpan=4><h:pulldown id="pul_Area" templateKey="W_Area"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_WorkPlace" templateKey="W_WorkPlace"/></TD>
                <TD noWrap bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD noWrap bgColor=#b8b7d7 colSpan=4><h:linkedpulldown id="pul_WorkPlace" templateKey="W_WorkPlace"/>&nbsp;&nbsp; 
                  <h:label id="lbl_Station" templateKey="W_Station"/><IMG height=28 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif" 
                  width=24><h:linkedpulldown id="pul_Station" templateKey="W_Station"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              ...
              <TR>
                ...
                <TD></TD>
                <TD></TD>
                <TD></TD></TR></TBODY></TABLE><h:submitbutton id="btn_RetrievalCancel" templateKey="W_Set2"/>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_AllCheck" templateKey="W_AllCheck"/>&nbsp;&nbsp; 
                ...
                <TD width="100%" bgColor=#b8b7d7>
                  <TABLE>
                    ...
                    <TR>
                      ...
                      <TD><IMG 
                        src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                      <TD><h:datetextbox id="txt_LRRetrievalPlanDate" templateKey="W_PlanDate"/></TD></TR></TBODY></TABLE></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_ASRSRetrievalCancel" templateKey="W_ASRSRetrievalStart"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" 
