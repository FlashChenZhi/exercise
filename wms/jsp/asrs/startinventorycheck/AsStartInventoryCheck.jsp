<%-- $Id: AsStartInventoryCheck.jsp 5421 2009-11-06 10:26:26Z okayama $ --%>
 ...
 * 
 * @version $Revision: 5421 $, $Date: 2009-11-06 19:26:26 +0900 (金, 06 11 2009) $
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                ...
                <TD width="100%" bgColor=#dad9ee colSpan=2><h:pulldown id="pul_Area" templateKey="W_Area_Event"/></TD>
              ...
              <TR bgColor=#dad9ee>
                ...
                <TD width="100%" bgColor=#dad9ee></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_Loaction" templateKey="W_Location"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7 colSpan=2><h:freetextbox id="txt_StartLocation" templateKey="W_Location"/><h:label id="lbl_Range1" templateKey="W_Range"/><h:freetextbox id="txt_EndLocation" templateKey="W_Location"/><h:label id="lbl_InputStyle" templateKey="W_InputStyle"/><h:label id="lbl_In_LocationStyle" templateKey="W_In_JavaSet"/></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_ItemCode" templateKey="W_ItemCode"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7 colSpan=2><h:freetextbox id="txt_StartItemCode" templateKey="W_ItemCode"/><h:submitbutton id="btn_SearchFromItemCode" templateKey="W_P_Search"/><h:label id="lbl_Range2" templateKey="W_Range"/><h:freetextbox id="txt_EndItemCode" templateKey="W_ItemCode"/><h:submitbutton id="btn_SearchToItemCode" templateKey="W_P_Search"/></TD>
                <TD width="100%" bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7 colSpan=5><h:checkbox id="chk_CommonUse" templateKey="W_WorkListPrint"/></TD>
                <TD width="100%" 
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              ...
              <TR>
                ...
                <TD></TD>
                <TD></TD>
                <TD></TD></TR></TBODY></TABLE><h:submitbutton id="btn_Setting" templateKey="W_Set2"/>&nbsp;&nbsp; 
