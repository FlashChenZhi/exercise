<%-- $Id: WorkPlace2.jsp 6013 2009-11-18 01:13:51Z ota $ --%>
 ...
 * 
 * @version $Revision: 6013 $, $Date: 2009-11-18 10:13:51 +0900 (水, 18 11 2009) $
 * @author  $Author: ota $
--%>
<%--@@SYSTEM_TODO_START@@--%>
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:label id="lbl_In_StationNoWorkPlaceNo" templateKey="AST_In_Item"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_Search" templateKey="AST_P_Search"/></TD></TR>
              <TR bgColor=#b8b7d7>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              ...
              <TR>
                ...
                <TD></TD>
                <TD></TD>
                <TD></TD></TR></TBODY></TABLE><h:submitbutton id="btn_Add" templateKey="AST_Add"/></TD>
          <TD><IMG height=40 
