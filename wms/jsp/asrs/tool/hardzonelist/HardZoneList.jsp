<%-- $Id: HardZoneList.jsp 4118 2009-04-10 10:55:30Z ota $ --%>
...
/*  2003/12/11  INSERT  okamura END  */
								...
								if ( allshelf[countshelf].getHardZoneId() == 0 )
								{
										zone0_len++;
%>
...
<%
								...
								else if ( allshelf[countshelf].getHardZoneId() == 1 )
								{
										zone1_len++;
%>
...
<%
								...
								else if ( allshelf[countshelf].getHardZoneId() == 2 )
								{
										zone2_len++;
%>
...
<%
								...
								else if ( allshelf[countshelf].getHardZoneId() == 3 )
								{
										zone3_len++;
%>
...
<%
								...
								else if ( allshelf[countshelf].getHardZoneId() == 4 )
								{
										zone4_len++;
%>
...
<%
								...
								else if ( allshelf[countshelf].getHardZoneId() == 5 )
								{
										zone5_len++;
%>
...
<%
								...
								else if ( allshelf[countshelf].getHardZoneId() == 6 )
								{
										zone6_len++;
%>
...
<%
								...
								else if ( allshelf[countshelf].getHardZoneId() == 7 )
								{
										zone7_len++;
%>
...
<%
								...
								else if ( allshelf[countshelf].getHardZoneId() == 8 )
								{
										zone8_len++;
%>
...
<%
								...
								else if ( allshelf[countshelf].getHardZoneId() == 9 )
								{
										zone9_len++;
%>
