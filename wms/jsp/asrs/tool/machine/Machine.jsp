<%-- $Id: Machine.jsp 7958 2010-05-26 03:00:10Z kishimoto $ --%>
 ...
 * 
 * @version $Revision: 7958 $, $Date: 2010-05-26 12:00:10 +0900 (水, 26 5 2010) $
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_MachineName" templateKey="W_MachineName"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_MachineName" templateKey="W_MachineName"/></TD></TR>
              <TR bgColor=#b8b7d7>
