<%-- $Id: AccessNgShelf.jsp 4118 2009-04-10 10:55:30Z ota $ --%>
  ...
  <script>
     function dynamicAction()
     {
          if(event.srcElement.id == "btn_Cancel"){
               if(_isListcellEmpty('lst_AccessNgShelf'))
               {
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_Location" templateKey="AST_LocNumber"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_Bank" templateKey="AST_Bank"/><h:label id="lbl_Hyphen1" templateKey="AST_Hyphen"/><h:freetextbox id="txt_Bay" templateKey="AST_Bay"/><h:label id="lbl_Hyphen2" templateKey="AST_Hyphen"/><h:freetextbox id="txt_Level" templateKey="AST_Level"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_Width" templateKey="AST_Width"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:linkedpulldown id="pul_Width" templateKey="AST_Width"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_Range" templateKey="AST_Range"/></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_Address" templateKey="AST_Address"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_FAddress" templateKey="AST_FAddress"/>&nbsp;&nbsp; <h:label id="lbl_Hyphen3" templateKey="AST_Hyphen2"/>&nbsp; <h:freetextbox id="txt_TAddress" templateKey="AST_TAddress"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp; &nbsp; </TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_AccessNgShelf" templateKey="AST_S_AccessNgShelf"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD width="100%" 
