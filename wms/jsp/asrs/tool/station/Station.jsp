<%-- $Id: Station.jsp 87 2008-10-04 03:07:38Z admin $ --%>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:radiobutton id="rdo_PrivateStorage" templateKey="AST_PrivateStorage"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_PrivateRetrieval" templateKey="AST_PrivateRetrieval"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_StandShuttleCart" templateKey="AST_StandShuttleCart"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:radiobutton id="rdo_ConveyorStorageSide" templateKey="AST_ConveyorStorageSide"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_ConveyorRetrievalSide" templateKey="AST_ConveyorRetrievalSide"/></TD></TR>
              <TR>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:radiobutton id="rdo_LoadConfirmationSetup" templateKey="AST_LoadConfirmationSetup"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_PrecedenceSetup" templateKey="AST_PrecedenceSetup"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_Arrival" templateKey="AST_Arrival"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:radiobutton id="rdo_NotAssignedsArrive" templateKey="AST_NotAssignedsArrive"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_AssignedArrive" templateKey="AST_AssignedArrive"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_StyleInspection" templateKey="AST_StyleInspection"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:radiobutton id="rdo_NotAssignedsCarryStyle" templateKey="AST_NotAssignedsCarryStyle"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_AssignedCarryStyle" templateKey="AST_AssignedCarryStyle"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_WorkIndication" templateKey="AST_WorkIndication"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:radiobutton id="rdo_NotAssignedsWork" templateKey="AST_NotAssignedsWork"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_JobsDisplay" templateKey="AST_JobsDisplay"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_OperationDisplay" templateKey="AST_OperationDisplay"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_ReStoringWork" templateKey="AST_ReStoringWork"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:radiobutton id="rdo_NotAssignedsReStoring" templateKey="AST_NotAssignedsReStoring"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_AssignedReStoring" templateKey="AST_AssignedReStoring"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_ReStoringRouteIndication" templateKey="AST_ReStoringRouteIndication"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:radiobutton id="rdo_NotAssignedsReStoringCarry" templateKey="AST_NotAssignedsReStoringCarry"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_AssignedReStoringCarry" templateKey="AST_AssignedReStoringCarry"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_PayOut" templateKey="AST_PayOut"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:radiobutton id="rdo_NotAssignedsPayOut" templateKey="AST_NotAssignedsPayOut"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_AssignedPayOut" templateKey="AST_AssignedPayOut"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_ModeChange" templateKey="AST_ModeChange"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:radiobutton id="rdo_NotAssignedsMode" templateKey="AST_NotAssignedsMode"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_AWCModeChange" templateKey="AST_AWCModeChange"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_EquipmentModeChange" templateKey="AST_EquipmentModeChange"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_AutoModeChange" templateKey="AST_AutoModeChange"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:numbertextbox id="txt_MaxInstrucion" templateKey="AST_MaxInstruction"/>&nbsp;<h:label id="lbl_MaxPalletAQuantity" templateKey="AST_MaxPalletAQuantity"/><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:numbertextbox id="txt_MaxPalletQuantity" templateKey="AST_MaxPalletQuantity"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
