<%-- $Id: LstAsStoragePlan.jsp,v 1.7 2007/08/21 04:35:22 tanaka Exp $ --%>
 ...
 * 
 * @version $Revision: 1.7 $, $Date: 2007/08/21 04:35:22 $
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD>
                  ...
                  bgColor=#dad9ee border=0>
                    <TBODY><%-- listcell --%>
                    <TR bgColor=#b8b7d7>
                      <TD><h:listcell id="lst_ASRSStoragePlanList" templateKey="W_ASRSStoragePlanList"/></TD></TR></TBODY></TABLE>
                  <TABLE style="WIDTH: 100%" cellSpacing=0 cellPadding=0 
                  bgColor=#dad9ee border=0>
                    <TBODY>
                    <TR bgColor=#b8b7d7 height=7>
