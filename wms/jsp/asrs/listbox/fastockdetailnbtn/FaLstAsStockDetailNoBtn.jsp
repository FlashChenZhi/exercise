<%-- $Id: LstItem.jsp 5111 2009-10-09 08:02:48Z shibamoto $ --%>
 ...
 * 
 * @version $Revision: 5111 $, $Date: 2009-10-09 17:02:48 +0900 (金, 09 10 2009) $
    ...
    <TD>
      ...
      border=0>
        ...
        <TR bgColor=#b8b7d7 height=7>
          ...
          <TD width=7 bgColor=#dad9ee></TD>
          <TD></TD>
          <TD><h:scrolllistcell id="lst_LocationInquiryList" templateKey="W_LocationInquiryList"/></TD>
          <TD width=7 bgColor=#dad9ee></TD></TR>
        <TR bgColor=#b8b7d7 height=7>
          <TD width=7 bgColor=#dad9ee></TD>
          <TD colSpan=2></TD>
