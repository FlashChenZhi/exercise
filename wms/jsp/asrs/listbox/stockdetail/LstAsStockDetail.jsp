<%-- $Id: LstAsStockDetail.jsp 749 2008-10-27 10:44:33Z okayama $ --%>
 ...
 * 
 * @version $Revision: 749 $, $Date: 2008-10-27 19:44:33 +0900 (月, 27 10 2008) $
                ...
                <TD>
                  ...
                  bgColor=#dad9ee border=0>
                    <TBODY>
                          <%-- listcell --%>
                          <TR bgColor=#b8b7d7>
                      <TD><h:listcell id="lst_LocationDetailListIncludeB" templateKey="W_LocationDetailListIncludeButtonList"/></TD></TR></TBODY></TABLE>
                  <TABLE style="WIDTH: 100%" cellSpacing=0 cellPadding=0 
                  bgColor=#dad9ee border=0>
                    <TBODY>
                    <TR bgColor=#b8b7d7 height=7>
