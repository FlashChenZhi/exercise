<%-- $Id: LstAsStockDetailNoBtn.jsp 6011 2009-11-18 01:12:45Z kanda $ --%>
 ...
 * 
 * @version $Revision: 6011 $, $Date: 2009-11-18 10:12:45 +0900 (水, 18 11 2009) $
 * @author  $Author: kanda $
--%>
<%--@@SYSTEM_TODO_START@@--%>
                ...
                <TD>
                  ...
                  bgColor=#dad9ee border=0>
                    <TBODY>
                          <%-- listcell --%>
                          <TR bgColor=#b8b7d7>
                      <TD><h:listcell id="lst_LocationDetailListNoButton" templateKey="W_LocationDetailListNoButtonList"/></TD></TR></TBODY></TABLE>
                  <TABLE style="WIDTH: 100%" cellSpacing=0 cellPadding=0 
                  bgColor=#dad9ee border=0>
                    <TBODY>
                    <TR bgColor=#b8b7d7 height=7>
