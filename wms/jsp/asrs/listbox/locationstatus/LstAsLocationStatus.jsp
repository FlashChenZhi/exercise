<%-- $Id: LstAsLocationStatus.jsp 6580 2009-12-21 08:12:57Z okayama $ --%>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD>
                      ...
                      <TD>
                        <TABLE>
                          ...
                          <TR>
                            ...
                            <TD>&nbsp;&nbsp; <h:submitbutton id="btn_Close_Up" templateKey="W_Close"/></TD></TR></TBODY></TABLE></TD></TR>
                    <TR bgColor=#b8b7d7 height=7>
                  ...
                  bgColor=#dad9ee border=0>
                    <TBODY><%-- listcell --%>
                    <TR bgColor=#b8b7d7>
                      <TD><h:listcell id="lst_StatusByLocationWithButton" templateKey="W_StatusByLocationIncludeButtonList"/></TD></TR></TBODY></TABLE>
                  <TABLE style="WIDTH: 100%" cellSpacing=0 cellPadding=0 
                  bgColor=#dad9ee border=0>
                    <TBODY>
                    <TR bgColor=#b8b7d7 height=7>
                      ...
                      <TD>
                        <TABLE>
                          ...
                          <TR>
                            ...
                            <TD>&nbsp;&nbsp; <h:submitbutton id="btn_Close_Down" templateKey="W_Close"/></TD></TR></TBODY></TABLE></TD></TR>
                    <TR bgColor=#b8b7d7 height=7>
