<%-- $Id: LstAsLocationStock.jsp,v 1.2 2007/05/18 04:28:11 kamala Exp $ --%>
 ...
 * 
 * @version $Revision: 1.2 $, $Date: 2007/05/18 04:28:11 $
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD>
                  ...
                  bgColor=#dad9ee border=0>
                    <TBODY><%-- listcell --%>
                    <TR bgColor=#b8b7d7>
                      <TD><h:listcell id="lst_StockByLocationList" templateKey="W_StockByLocationList"/></TD></TR></TBODY></TABLE>
                  <TABLE style="WIDTH: 100%" cellSpacing=0 cellPadding=0 
                  bgColor=#dad9ee border=0>
                    <TBODY>
                    <TR bgColor=#b8b7d7 height=7>
