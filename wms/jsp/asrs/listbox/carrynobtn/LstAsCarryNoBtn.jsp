<%-- $Id: LstAsCarryNoBtn.jsp 5894 2009-11-16 04:21:58Z okayama $ --%>
 ...
 * 
 * @version $Revision: 5894 $, $Date: 2009-11-16 13:21:58 +0900 (月, 16 11 2009) $
    ...
    <TD><%-- header --%>
      ...
      border=0>
        ...
        <TR bgColor=#b8b7d7>
          <TD width=7 bgColor=#dad9ee></TD>
          <TD></TD>
          <TD><h:scrolllistcell id="lst_RestWorkNoButtonList" templateKey="W_RestWorkNoButtonList"/></TD>
          <TD width=7 bgColor=#dad9ee></TD></TR>
        <TR bgColor=#b8b7d7 height=7>
          <TD width=7 bgColor=#dad9ee></TD>
          <TD colSpan=2></TD>
