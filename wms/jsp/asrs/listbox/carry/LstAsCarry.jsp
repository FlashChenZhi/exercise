<%-- $Id: LstAsCarry.jsp 6686 2010-01-13 06:45:55Z okayama $ --%>
 ...
 * 
 * @version $Revision: 6686 $, $Date: 2010-01-13 15:45:55 +0900 (水, 13 1 2010) $
  ...
  <TR>
    <TD><%-- header --%>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#dad9ee 
        ...
        <TR>
          <TD width=7></TD>
          <TD><h:listcell id="lst_SearchCondition" templateKey="SearchConditionOneColumn"/></TD></TR>
        <TR height=7>
          <TD width=7></TD>
      ...
      border=0>
        ...
        <TR bgColor=#b8b7d7>
          <TD width=7 bgColor=#dad9ee></TD>
          <TD>&nbsp;&nbsp; </TD>
          <TD><h:scrolllistcell id="lst_RestWorkIncludeButtonList" templateKey="W_RestWorkIncludeButtonList"/></TD>
          <TD width=7 bgColor=#dad9ee></TD></TR>
        <TR bgColor=#b8b7d7 height=7>
          <TD width=7 bgColor=#dad9ee></TD>
          <TD colSpan=2></TD>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7>
                  <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
                    <TBODY>
                    <TR>
                      <TD><h:submitbutton id="btn_ReDisplayFunc" templateKey="W_ReDisplayFunc"/></TD>
                      <TD>&nbsp;&nbsp; <h:submitbutton id="btn_Close" templateKey="Close"/></TD>
                      <TD></TD></TR></TBODY></TABLE></TD>
                <TD><IMG height=40 
                  src="<%=request.getContextPath()%>/img/common/tab_rt3.gif" 
                  width=42 border=0></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE><%-- footer --%>
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
        <TR height=41>
