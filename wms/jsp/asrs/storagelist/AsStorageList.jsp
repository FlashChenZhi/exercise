<%-- $Id: AsStorageList.jsp 7134 2010-02-18 07:39:31Z shibamoto $ --%>
    ...
    <TD><%-- title --%>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#b8b7d7 
        ...
        <TR bgColor=#b8b7d7>
          ...
          <TD bgColor=#b8b7d7><IMG 
            src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
          <TD noWrap bgColor=#b8b7d7 colSpan=6><h:pulldown id="pul_FStorageWorkKind" templateKey="W_F_StorageWorkKind"/></TD>
          <TD bgColor=#b8b7d7><IMG 
            src="<%=request.getContextPath()%>/img/common/spacer.gif" 
            width=7 border=0></TD>
          <TD bgColor=#dad9ee><IMG 
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:listcell id="lst_ASRSStorageWorkList" templateKey="W_ASRSStorageWorkList"/></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
