<%-- $Id: AsWorkStart.jsp 5421 2009-11-06 10:26:26Z okayama $ --%>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD>
                <TD width="100%" bgColor=#b8b7d7 colSpan=2><h:scrolllistcell id="lst_AsrsWorkStart" templateKey="W_ASRSSetList"/></TD>
                <TD width="100%" bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
      ...
      <TABLE style="MARGIN-LEFT: 7px" cellSpacing=0 cellPadding=0 border=0>
        ...
        <TR>
          ...
          <TD bgColor=#b8b7d7>
            ...
            <h:submitbutton id="btn_ReDisplayFunc" templateKey="W_ReDisplayFunc"/>&nbsp;&nbsp; 
            <h:submitbutton id="btn_RemainWork" templateKey="W_P_RestWorkList"/></TD>
          <TD><IMG height=40 
