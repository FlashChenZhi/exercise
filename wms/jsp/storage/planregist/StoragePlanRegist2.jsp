<%-- $Id: StoragePlanRegist2.jsp 7004 2010-02-16 01:37:51Z fukuwa $ --%>
 ...
 * 
 * @version $Revision: 7004 $, $Date: 2010-02-16 10:37:51 +0900 (火, 16 2 2010) $
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
              <TR bgColor=#dad9ee>
                <TD noWrap bgColor=#dad9ee><h:label id="lbl_StoragePlanDate" templateKey="W_StoregePlanDate"/></TD>
                ...
                <TD bgColor=#dad9ee colSpan=6><h:label id="lbl_SlipNumber" templateKey="W_SlipNumber"/><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:label id="lbl_InSlip" templateKey="W_In_JavaSet"/></TD>
              ...
              <TR>
                ...
                <TD noWrap bgColor=#b8b7d7 colSpan=6><h:label id="lbl_BranchNo" templateKey="W_BranchNo"/><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:numbertextbox id="txt_BranchNo" templateKey="W_BranchNo"/></TD>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD noWrap bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD noWrap bgColor=#b8b7d7 colSpan=7><h:freetextbox id="txt_ItemCode" templateKey="W_ItemCode"/><h:submitbutton id="btn_PSearchItem" templateKey="W_P_Search"/>&nbsp;&nbsp; 
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD noWrap bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD noWrap bgColor=#b8b7d7 colSpan=7><h:pulldown id="pul_StorageArea" templateKey="W_Area_Event"/>&nbsp;&nbsp; <h:label id="lbl_StoraeLocation" templateKey="W_StoraeLocation"/><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_StorageLocation" templateKey="W_Location"/><h:label id="lbl_InputStyle" templateKey="W_InputStyle"/><h:label id="lbl_InLocationStyle" templateKey="W_In_JavaSet"/></TD>
                <TD width="100%" bgColor=#b8b7d7></TD>
                <TD width="100%" 
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_StoragePlanInput" templateKey="W_StoragePlanInput"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" 
