            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD width="100%" bgColor=#b8b7d7><h:datetextbox id="txt_StoragePlanDate" templateKey="W_PlanDate"/><h:label id="lbl_InputStyle" templateKey="W_InputStyle"/><h:label id="lbl_Day" templateKey="W_InputStyleDay"/>&nbsp;&nbsp; <h:label id="lbl_ItemCode" templateKey="W_ItemCode"/><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_FromItemCode" templateKey="W_ItemCode"/><h:label id="lbl_Range" templateKey="W_Range"/><h:freetextbox id="txt_ToItemCode" templateKey="W_ItemCode"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD width="100%" bgColor=#b8b7d7><h:checkbox id="chk_IssueReport" templateKey="W_IssueReport"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp; </TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_StorageListStart" templateKey="W_StorageListStart"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD width="100%" 
