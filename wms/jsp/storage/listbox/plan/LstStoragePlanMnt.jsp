<%-- $Id: LstStoragePlanMnt.jsp 6577 2009-12-21 06:00:24Z okayama $ --%>
 ...
 * 
 * @version $Revision: 6577 $, $Date: 2009-12-21 15:00:24 +0900 (月, 21 12 2009) $
    ...
    <TD><%-- header --%>
      ...
      border=0>
        ...
        <TR bgColor=#b8b7d7>
          <TD width=7 bgColor=#dad9ee></TD>
          <TD></TD>
          <TD><h:scrolllistcell id="lst_StoragePlan" templateKey="W_StoragePlanList"/></TD>
          <TD width=7 bgColor=#dad9ee></TD></TR>
        <TR bgColor=#b8b7d7 height=7>
          <TD width=7 bgColor=#dad9ee></TD>
          <TD colSpan=2></TD>
