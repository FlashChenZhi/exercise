<%-- $Id: StorageProgress.jsp 87 2008-10-04 03:07:38Z admin $ --%>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7 colSpan=3>
                  ...
                  <TABLE>
                    <TBODY>
                    <TR>
                      <TD><h:listcell id="lst_StorageProgress_up" templateKey="W_StorageProgress"/></TD></TR></TBODY></TABLE></TD></TR>
              <TR bgColor=#b8b7d7>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7 colSpan=3>
                  <TABLE>
                    <TBODY>
                    <TR>
                      <TD><h:listcell id="lst_StorageProgress_down" templateKey="W_StorageProgress"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
            <TABLE>
              <TBODY>
              <TR>
