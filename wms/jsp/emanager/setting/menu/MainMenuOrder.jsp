<%-- $Id: MainMenuOrder.jsp 87 2008-10-04 03:07:38Z admin $ --%>
...
<h:head>
  <script>
	function dynamicAction()
	{
		...
		{
			if( !validate(document.getElementById('ltb_MainMenuOrder').value) ) 
			{
				clearMessage();
				_setMessage('<%= HTMLUtils.escapeScript(HTMLUtils.encode(MessageResources.getText("6403030"))) %>', 2);
				return true;
			}
		}
	}
