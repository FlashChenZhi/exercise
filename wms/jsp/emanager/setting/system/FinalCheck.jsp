<%-- $Id: FinalCheck.jsp 87 2008-10-04 03:07:38Z admin $ --%>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7>&nbsp; &nbsp; <h:submitbutton id="btn_Start" templateKey="T_Start_finalCheck"/>&nbsp; 
                  <h:submitbutton id="btn_Clear" templateKey="T_Clear"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7>&nbsp;</TD></TR>
              <TR bgColor=#b8b7d7>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp;&nbsp; &nbsp;</TD>
                <TD width="100%" bgColor=#b8b7d7><h:scrolllistcell id="lst_FinalCheck" templateKey="T_FinalCheck"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD width="100%" 
