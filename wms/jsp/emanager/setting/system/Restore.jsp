<%-- $Id: Restore.jsp 87 2008-10-04 03:07:38Z admin $ --%>
...
<h:head>
  <script>
	function dynamicAction()
	{
		...
		{
			if( !validate(document.getElementById('txt_FileBrows').value) ) 
			{
				clearMessage();
				_setMessage('<%= HTMLUtils.escapeScript(HTMLUtils.encode(MessageResources.getText("6403022"))) %>', 2);
				document.all.txt_FileBrows.focus();
				return true;
			}
		}
	}
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_FolderBrows" templateKey="T_FolderBrows"/><h:label id="lbl_Require" templateKey="T_Require"/></TD>
