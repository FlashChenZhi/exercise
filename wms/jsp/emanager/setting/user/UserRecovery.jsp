<%-- $Id: UserRecovery.jsp 87 2008-10-04 03:07:38Z admin $ --%>
  ...
  <script>
	function dynamicAction()
	{
		if(event.srcElement.id == "btn_Commit")
		{
			...
			{
				clearMessage();
				_setMessage('<%= HTMLUtils.escapeScript(HTMLUtils.encode(MessageResources.getText("6403053"))) %>', 2);
				return true;
			}
		}
	}
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#dad9ee>
                ...
                <TD width="100%" bgColor=#dad9ee><h:freetextbox id="txt_UserId" templateKey="T_UserId"/><h:submitbutton id="btn_UserIdSearch" templateKey="T_P_Search"/></TD></TR>
              <TR bgColor=#dad9ee>
                <TD noWrap bgColor=#dad9ee><h:label id="lbl_JobMenu" templateKey="T_JobMenu"/></TD>
                <TD bgColor=#dad9ee><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#dad9ee><h:submitbutton id="btn_LockCancellation" templateKey="T_LockCancellation"/>&nbsp;&nbsp; 
                  <h:submitbutton id="btn_PasswordReissue" templateKey="T_PasswordReissue"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_UserId2" templateKey="T_UserID"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_R_UserId" templateKey="T_UserId"/></TD></TR>
              <TR bgColor=#b8b7d7>
              ...
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_StateOfLock" templateKey="T_StateOfLock"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_StateOfLock" templateKey="T_StateOfLock"/></TD></TR>
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_Password" templateKey="T_UserRecoveryPassword"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_PasswordAgain" templateKey="T_PasswordAgain"/><h:label id="lbl_RequirePasswordAgain" templateKey="T_Require"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_PasswordAgain" templateKey="T_UserRecoveryPassword"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_PwdExpires" templateKey="T_PwdExpires"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:datetextbox id="txt_PwdExpires" templateKey="T_PwdExpires"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
