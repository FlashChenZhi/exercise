<%-- $Id: TerminalChangeList.jsp 6714 2010-01-20 01:36:47Z kajiwara $ --%>
    ...
    <TD>
      ...
      border=0>
        ...
        <TR bgColor=#b8b7d7 height=7>
          ...
          <TD width=7 bgColor=#dad9ee></TD>
          <TD></TD>
          <TD><h:scrolllistcell id="lst_TerminalChange" templateKey="T_TerminalChange"/></TD>
          <TD width=7 bgColor=#dad9ee></TD></TR>
        <TR bgColor=#b8b7d7 height=7>
          <TD width=7 bgColor=#dad9ee></TD>
          <TD colSpan=2></TD>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7>
                  <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
                    ...
                    <TR>
                      <TD></TD>
                      <TD><h:submitbutton id="btn_Commit" templateKey="T_CommitSync"/>&nbsp; 
                        <h:submitbutton id="btn_Close" templateKey="T_Close"/></TD>
