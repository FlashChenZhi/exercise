<%-- $Id: AccessLog.jsp 7765 2010-03-31 02:29:07Z shibamoto $ --%>
...
<script>
	...
	{
		if (targetElement == "btn_View" || targetElement == "btn_Search" )
		{
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_DSNo" templateKey="T_DsNo"/><h:submitbutton id="btn_Search" templateKey="T_SearchPopup"/>&nbsp;&nbsp; 
