<%-- $Id: SearchMainteLog1.jsp 87 2008-10-04 03:07:38Z admin $ --%>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_CsvFile" templateKey="T_CsvFile"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_CsvFile" templateKey="T_CsvFile"/><h:submitbutton id="btn_Search" templateKey="T_P_Search"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
        ...
        <TR>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              ...
              <TR>
                <TD></TD>
                <TD><h:submitbutton id="btn_Add" templateKey="T_Add"/></TD>
                <TD></TD>
                <TD></TD>
                <TD></TD>
                <TD>&nbsp;&nbsp;&nbsp;</TD>
        ...
        <TR>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              <TBODY>
              <TR>
                <TD><h:submitbutton id="btn_Commit" templateKey="T_CommitSync"/></TD>
                <TD></TD>
                <TD></TD>
                <TD></TD>
                <TD></TD>
                <TD>&nbsp;&nbsp;&nbsp;</TD>
                <TD><h:submitbutton id="btn_Cancel" templateKey="T_BC_Cancel"/></TD></TR></TBODY></TABLE></TD>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;&nbsp; </TD>
                <TD width="100%" bgColor=#b8b7d7><h:checkbox id="chk_IncludeLog" templateKey="T_IncludeLog"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:scrolllistcell id="lst_ReadList" templateKey="T_ReadList"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
