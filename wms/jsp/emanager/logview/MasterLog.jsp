<%-- $Id: MasterLog.jsp 7765 2010-03-31 02:29:07Z shibamoto $ --%>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_Master" templateKey="T_Master"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:pulldown id="pul_Master" templateKey="T_Master"/></TD></TR>
              <TR bgColor=#b8b7d7>
                ...
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_DsNo" templateKey="T_DsNo"/><h:submitbutton id="btn_SearchPopup" templateKey="T_SearchPopup"/>&nbsp;&nbsp; 
                  <h:freetextbox id="txt_R_PageName" templateKey="T_R_PageName"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
