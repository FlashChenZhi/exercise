<%-- $Id: DsNoList.jsp 6714 2010-01-20 01:36:47Z kajiwara $ --%>
  ...
  <TR>
    <TD>
        ...
        <TR bgColor=#413a8a height=4>
          <TD width=7></TD>
          <TD height=4><h:label id="lbl_In_SettingName" templateKey="T_In_SettingName"/></TD></TR>
        <TR bgColor=#413a8a height=4>
      ...
      border=0>
        ...
        <TR bgColor=#b8b7d7 height=7>
          ...
          <TD width=7 bgColor=#dad9ee></TD>
          <TD></TD>
          <TD><h:scrolllistcell id="lst_DsNoList" templateKey="T_DsNoList"/></TD>
          <TD width=7 bgColor=#dad9ee></TD></TR>
        <TR bgColor=#b8b7d7 height=7>
          <TD width=7 bgColor=#dad9ee></TD>
          <TD colSpan=2></TD>
