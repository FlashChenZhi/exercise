<%-- $Id: MainteLogList.jsp 6714 2010-01-20 01:36:47Z kajiwara $ --%>
  ...
  <TR>
    <TD>
        ...
        <TR bgColor=#413a8a height=4>
          <TD width=7></TD>
          <TD height=4><h:label id="lbl_ListName" templateKey="T_In_SettingName"/></TD></TR>
        <TR bgColor=#413a8a height=4>
        ...
        <TR height=23>
          ...
          <TD bgColor=white><h:message id="message" templateKey="T_LstOperationMsg"/></TD>
          <TD width=7></TD></TR>
        <TR>
      ...
      border=0>
        ...
        <TR bgColor=#b8b7d7>
          <TD width=7 bgColor=#dad9ee></TD>
          <TD width=7></TD>
          <TD><h:pager id="pager" templateKey="T_PagerSync"/></TD>
          <TD width=7 bgColor=#dad9ee></TD></TR>
        <TR bgColor=#b8b7d7 height=7>
          <TD width=7 bgColor=#dad9ee></TD>
          <TD colSpan=2></TD>
          ...
          <TD width=7 bgColor=#dad9ee></TD>
          <TD></TD>
          <TD><h:scrolllistcell id="lst_LogList" templateKey="T_SeachLogResultList"/></TD>
          <TD width=7 bgColor=#dad9ee></TD></TR>
        <TR bgColor=#b8b7d7 height=7>
          <TD width=7 bgColor=#dad9ee></TD>
          <TD colSpan=2></TD>
        ...
        border=0><TBODY>
        <TR bgColor=#dad9ee>
          <TD width=7 bgColor=#dad9ee><IMG height=1 src="<%=request.getContextPath()%>/img/common/spacer.gif" width=7 border=0></TD>
          <TD noWrap bgColor=#dad9ee>&nbsp;</TD>
          <TD bgColor=#dad9ee></TD>
          <TD width="100%" bgColor=#dad9ee></TD>
          <TD width=7 bgColor=#dad9ee><IMG height=1 src="<%=request.getContextPath()%>/img/common/spacer.gif" width=7 border=0></TD></TR>
        <TR bgColor=#b8b7d7>
          <TD width=7 bgColor=#dad9ee></TD>
          <TD noWrap bgColor=#b8b7d7><h:label id="lbl_Message" templateKey="T_Message"/></TD>
          <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
          <TD bgColor=#b8b7d7><h:textarea id="txa_Message" templateKey="T_LogMessage"/></TD>
          <TD width=7 bgColor=#dad9ee></TD></TR>
        <TR bgColor=#b8b7d7>
          <TD width=7 bgColor=#dad9ee></TD>
          <TD noWrap bgColor=#b8b7d7><h:label id="lbl_Detail" templateKey="T_Detail"/></TD>
          <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
          <TD bgColor=#b8b7d7><h:textarea id="txa_Detail" templateKey="T_LogDetail"/></TD>
          <TD width=7 bgColor=#dad9ee></TD></TR>
        <TR bgColor=#b8b7d7>
          <TD width=7 bgColor=#dad9ee></TD>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7>
                  <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
                    ...
                    <TR>
                      <TD></TD>
                      <TD><h:submitbutton id="btn_Close" templateKey="T_Close"/>&nbsp;<h:submitbutton id="btn_Clear" templateKey="T_Clear"/></TD>
