<%-- $Id: RetrievalPlanRegist.jsp 7134 2010-02-18 07:39:31Z shibamoto $ --%>
...
<h:head>
  <script>
    ...
    {
        if (targetElement == "btn_SearchRetrievalPlan" || targetElement == "btn_Next")
        {
            if ((document.all('txt_TicketNo').value).indexOf("*", 0) >= 0)
            {
                document.all('txt_TicketNo').focus();
      ...
      border=0>
        ...
        <TR height=28>
          <TD width=7><IMG 
            ...
            width=7></TD>
          <TD width=7></TD>
          <TD noWrap><h:tab id="Regist" templateKey="W_SetRegist"/></TD>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>
                  <TABLE>
                    <TBODY>
                    <TR>
                      <TD><h:label id="lbl_RetrievalPlanDate" templateKey="W_RetrievalPlanDate"/><h:label id="lbl_RequirePlanDate" templateKey="W_Require"/></TD>
                      <TD><IMG 
                        src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                      <TD><h:datetextbox id="txt_RetrievalPlanDate" templateKey="W_PlanDate"/><h:label id="lbl_InputStyle" templateKey="W_InputStyle"/><h:label id="lbl_Day" templateKey="W_InputStyleDay"/></TD></TR>
                    <TR>
                      <TD><h:label id="lbl_TicketNo" templateKey="W_SlipNumber"/><h:label id="lbl_RequireTicketNo" templateKey="W_Require"/></TD>
                      <TD><IMG 
                        src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                      <TD><h:freetextbox id="txt_TicketNo" templateKey="W_SlipNumber"/>&nbsp;&nbsp;&nbsp; 
</TD></TR></TBODY></TABLE></TD>
                <TD width="100%" bgColor=#b8b7d7>&nbsp;&nbsp; <h:submitbutton id="btn_SearchRetrievalPlan" templateKey="W_P_SearchPlan"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
