<%-- $Id: RetrievalPlanInquiry.jsp 7160 2010-02-19 09:03:02Z fukuwa $ --%>
 ...
 *
 * @version $Revision: 7160 $, $Date: 2010-02-19 18:03:02 +0900 (金, 19 2 2010) $
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7 colSpan=3><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:datetextbox id="txt_RetrievalPlanDate" templateKey="W_PlanDate"/><h:label id="lbl_InputStyle" templateKey="W_InputStyle"/><h:label id="lbl_Day" templateKey="W_InputStyleDay"/></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_SlipNo" templateKey="W_SlipNumber"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_SlipNo" templateKey="W_SlipNumber"/></TD>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_OrderNo" templateKey="W_OrderNo"/>&nbsp;&nbsp;&nbsp; 
                </TD>
                <TD bgColor=#b8b7d7><h:label id="lbl_CustomerCode" templateKey="W_CustomerCode"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_CustomerCode" templateKey="W_CustomerCode"/></TD>
                <TD bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_StartStatus" templateKey="W_StartStatus"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:pulldown id="pul_FStartStatus" templateKey="W_F_StartStatus"/></TD>
                <TD bgColor=#b8b7d7><h:label id="lbl_WorkStatus" templateKey="W_WorkStatus"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:pulldown id="pul_FWorkStatus" templateKey="W_F_WorkStatus"/></TD>
        ...
        <TR>
          <TD>
            <TABLE style="WIDTH: 100%" cellSpacing=0 cellPadding=0 border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD>
                <TD bgColor=#b8b7d7><h:listcell id="lst_RetrievalPlanList" templateKey="W_RetrievalPlanList"/></TD>
                <TD bgColor=#b8b7d7>&nbsp;&nbsp; </TD>
                <TD bgColor=#b8b7d7></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7></TD>
