<%-- $Id: RetrievalListStart.jsp 7134 2010-02-18 07:39:31Z shibamoto $ --%>
      ...
      border=0>
        ...
        <TR height=28>
          <TD width=7><IMG 
            ...
            width=7></TD>
          <TD width=7></TD>
          <TD noWrap><h:tab id="tab" templateKey="W_ListWorkStart"/></TD>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              ...
              <TR>
                ...
                <TD></TD>
                <TD></TD>
                <TD></TD></TR></TBODY></TABLE><h:submitbutton id="btn_WorkStart" templateKey="W_Start"/>&nbsp;&nbsp; 
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD width="100%" bgColor=#b8b7d7><h:checkbox id="chk_LIssueReport" templateKey="W_IssueReport"/></TD>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_RetrievalListStart" templateKey="W_RetrievalListStart"/></TD>
                <TD width="100%" bgColor=#b8b7d7>&nbsp;&nbsp; 
              &nbsp;</TD></TR></TBODY></TABLE>&nbsp;&nbsp; 
