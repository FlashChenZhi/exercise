<%-- $Id: RetrievalListMnt.jsp 7134 2010-02-18 07:39:31Z shibamoto $ --%>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_OrderNo" templateKey="W_OrderNo"/><h:label id="lbl_Range_Order" templateKey="W_Range"/><h:freetextbox id="txt_To_OrderNo" templateKey="W_OrderNo"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp; </TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_RetrievalListMaintenance" templateKey="W_RetrievalListMaintenance"/></TD></TR></TBODY></TABLE>&nbsp; 
