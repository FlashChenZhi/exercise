<%-- $Id: RetrievalPlanModify.jsp 7134 2010-02-18 07:39:31Z shibamoto $ --%>
      ...
      border=0>
        ...
        <TR height=28>
          <TD width=7><IMG 
            ...
            width=7></TD>
          <TD width=7></TD>
          <TD noWrap><h:tab id="tabSetModifyDelete" templateKey="W_SetModifyDelete"/></TD>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><h:datetextbox id="txt_RetrievalPlanDate" templateKey="W_PlanDate"/><h:label id="lbl_InputStyle" templateKey="W_InputStyle"/><h:label id="lbl_Day" templateKey="W_InputStyleDay"/></TD>
                <TD width="100%" bgColor=#b8b7d7 rowSpan=2>&nbsp;&nbsp; <h:submitbutton id="btn_SearchRetrievalPlan" templateKey="W_P_SearchPlan"/></TD>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_SlipNumber" templateKey="W_SlipNumber"/><h:label id="lbl_RequireSlipNumber" templateKey="W_Require"/></TD>
                <TD noWrap bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7><h:freetextbox id="txt_SlipNumber" templateKey="W_SlipNumber"/></TD></TR>
              <TR bgColor=#b8b7d7>
