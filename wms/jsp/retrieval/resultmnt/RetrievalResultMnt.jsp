<%-- $Id: RetrievalResultMnt.jsp 7134 2010-02-18 07:39:31Z shibamoto $ --%>
      ...
      border=0>
        ...
        <TR height=28>
          <TD width=7><IMG 
            ...
            width=7></TD>
          <TD width=7></TD>
          <TD noWrap><h:tab id="tab" templateKey="W_ResultMaintenance"/></TD>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=2><h:pulldown id="pul_RetrievalArea" templateKey="W_RetrievalArea"/></TD>
                <TD width="100%" bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7></TD>
                <TD width="100%" 
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>　</TD>
                <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_RetrievalResultMaintenance" templateKey="W_RetrievalResultMaintenance"/></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
