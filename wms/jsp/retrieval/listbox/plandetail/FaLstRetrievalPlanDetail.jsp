<%-- $Id: LstArea.jsp 444 2008-10-21 12:05:29Z nagao $ --%>
 ...
 *
 * @version $Revision: 444 $, $Date: 2008-10-21 21:05:29 +0900 (火, 21 10 2008) $
 * @author  $Author: nagao $
--%>
<%--@@SYSTEM_TODO_START@@--%>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#dad9ee border=0>
  ...
  <TR>
    <TD>
        ...
        <TR height=7>
          <TD width=7></TD>
          <TD><h:listcell id="lst_SearchCondition" templateKey="SearchConditionOneColumn"/></TD></TR></TBODY></TABLE><BR>
      ...
      border=0>
        ...
        <TR bgColor=#b8b7d7 height=7>
          ...
          <TD width=7 bgColor=#dad9ee></TD>
          <TD></TD>
          <TD><h:scrolllistcell id="lst_RetPlanInquiry" templateKey="W_RetPlanInquiryList"/></TD>
          <TD width=7 bgColor=#dad9ee></TD></TR>
        <TR bgColor=#b8b7d7 height=7>
          <TD width=7 bgColor=#dad9ee></TD>
          <TD colSpan=2></TD>
