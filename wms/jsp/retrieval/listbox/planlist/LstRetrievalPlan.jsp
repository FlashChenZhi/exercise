<%-- $Id: LstRetrievalPlan.jsp 87 2008-10-04 03:07:38Z admin $ --%>
                ...
                <TD>
                      ...
                      <TD>
                        <TABLE>
                          ...
                          <TR>
                            ...
                            <TD>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_Preview" templateKey="W_Preview"/>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_Print" templateKey="W_Print"/>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_XLS" templateKey="W_XLS"/>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_CSV" templateKey="W_CSV"/>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_Close_U" templateKey="Close"/></TD></TR></TBODY></TABLE></TD></TR>
                    <TR bgColor=#b8b7d7 height=7>
                  ...
                  bgColor=#dad9ee border=0>
                    <TBODY>
                          <%-- listcell --%>
                          <TR bgColor=#b8b7d7>
                      <TD><h:listcell id="lst_RetrievalPlanList" templateKey="W_RetrievalPlanList"/></TD></TR></TBODY></TABLE>
                  <TABLE style="WIDTH: 100%" cellSpacing=0 cellPadding=0 
                  bgColor=#dad9ee border=0>
                    <TBODY>
                    <TR bgColor=#b8b7d7 height=7>
                      <TD>&nbsp;<h:submitlabel id="slb_Download" templateKey="W_Download"/>&nbsp;<h:submitlabel id="slb_Preview" templateKey="W_Preview"/></TD></TR>
                         <%-- pager --%>
                          <TR bgColor=#b8b7d7>
                      <TD>
                        <TABLE>
