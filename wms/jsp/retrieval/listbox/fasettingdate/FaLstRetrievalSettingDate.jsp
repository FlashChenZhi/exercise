<%-- $Id: LstRetrievalStartDate.jsp 5625 2009-11-10 12:22:58Z yamashita $ --%>
    ...
    <TD>
      ...
      border=0>
        ...
        <TR bgColor=#b8b7d7 height=7>
          ...
          <TD width=7 bgColor=#dad9ee></TD>
          <TD></TD>
          <TD><h:scrolllistcell id="lst_FaRetrievalSettingDateList" templateKey="W_FaRetrievalSettingDateList"/></TD>
          <TD width=7 bgColor=#dad9ee></TD></TR>
        <TR bgColor=#b8b7d7 height=7>
          <TD width=7 bgColor=#dad9ee></TD>
          <TD colSpan=2></TD>
