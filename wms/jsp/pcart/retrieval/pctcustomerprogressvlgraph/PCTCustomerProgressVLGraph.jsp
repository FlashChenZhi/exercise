<%-- $Id: PCTCustomerProgressVLGraph.jsp 4235 2009-05-11 06:39:36Z okayama $ --%>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD noWrap bgColor=#b8b7d7>&nbsp;&nbsp; <h:verticalbarlinechart id="vbc_V_PCTCustomerProgress" templateKey="W_V_PCTCustomerProgress"/></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
              ...
              <TR bgColor=#b8b7d7>
                <TD width="100%" bgColor=#b8b7d7>
                  <TABLE cellSpacing=0 cellPadding=0>
                    ...
                    <TR>
                      <TD>&nbsp;&nbsp;&nbsp;</TD>
                      <TD>&nbsp;<BR><h:scrolllistcell id="lst_PCTCustomerProgress" templateKey="W_PCTCustomerProgress"/></TD></TR></TBODY></TABLE>&nbsp;</TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
