<%-- $Id: PCTRetResultWorkInquiry.jsp 3568 2009-03-17 03:03:11Z rnakai $ --%>
 ...
 * 
 * @version $Revision: 3568 $, $Date: 2009-03-17 12:03:11 +0900 (火, 17 3 2009) $
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:datetextbox id="txt_WorkDate" templateKey="W_WorkDate"/></TD></TR>
              <TR>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_CustomerCode" templateKey="W_CustomerCode"/><h:submitbutton id="btn_P_Search_CustomerCode" templateKey="W_P_Search"/>&nbsp;&nbsp;&nbsp;<h:freetextbox id="txt_CustomerName" templateKey="T_R_FunctionName"/></TD></TR>
              <TR>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_ItemCode" templateKey="W_ItemCode"/><h:submitbutton id="btn_P_Search_ItemCode" templateKey="W_P_Search"/>&nbsp;&nbsp;&nbsp;<h:freetextbox id="txt_ItemName" templateKey="W_R_ItemName"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_WorkStatus" templateKey="W_WorkStatus"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:pulldown id="pul_WorkStatus" templateKey="W_WorkStatusPCT2"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_User" templateKey="W_User"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_User" templateKey="W_User"/><h:submitbutton id="btn_P_Search_User" templateKey="W_P_Search"/>&nbsp;&nbsp; 
                  <h:freetextbox id="txt_UserName" templateKey="W_R_UserName"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
