<%-- $Id: PCTCustomerProgressGraph.jsp 4235 2009-05-11 06:39:36Z okayama $ --%>
		...
		function dynamicAction()
		{
			if (targetElement == "btn_Display" )
			{
				if (!_isValueInput('txt_ConsignorCode'))
				{
					...
					// 6003100={0}
					_setMessage('<%= jp.co.daifuku.bluedog.util.MessageResources.getText("6003100", DispResources.getText("LBL-P0015")) %>',2);
					return true;
				}
              ...
              <TR>
                ...
                <TD noWrap bgColor=#b8b7d7 colSpan=3>
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    ...
                    <TR>
                      <TD noWrap bgColor=#b8b7d7><h:label id="lbl_5" templateKey="W_BatchNo"/></TD>
                      <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                  ...
                  <TABLE>
                    <TBODY>
                    <TR>
                      <TD><h:listcell id="lst_PCTCustomerProgress1" templateKey="W_PCTCustomerProgress"/></TD></TR></TBODY></TABLE>
                  <TABLE>
                    <TBODY>
                    <TR>
                  ...
                  <TABLE>
                    <TBODY>
                    <TR>
                      <TD><h:listcell id="lst_PCTCustomerProgress2" templateKey="W_PCTCustomerProgress"/></TD></TR></TBODY></TABLE>
                  <TABLE>
                    <TBODY>
                    <TR>
                  ...
                  <TABLE>
                    <TBODY>
                    <TR>
                      <TD><h:listcell id="lst_PCTCustomerProgress3" templateKey="W_PCTCustomerProgress"/></TD></TR></TBODY></TABLE>
                  <TABLE>
                    <TBODY>
                    <TR>
                  ...
                  <TABLE>
                    <TBODY>
                    <TR>
                      <TD><h:listcell id="lst_PCTCustomerProgress4" templateKey="W_PCTCustomerProgress"/></TD></TR></TBODY></TABLE>
                  <TABLE>
                    <TBODY>
                    <TR>
