<%-- $Id: PCTRetWorkingInquiry.jsp 3780 2009-03-24 08:23:22Z dmori $ --%>
 ...
 * 
 * @version $Revision: 3780 $, $Date: 2009-03-24 17:23:22 +0900 (火, 24 3 2009) $
 * @author  $Author: dmori $
--%>
<%--@@SYSTEM_TODO_START@@--%>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_RegularCustomerCode" templateKey="W_RegularCustomerCode"/><h:submitbutton id="btn_P_Search_RegularCustomerCd" templateKey="W_P_Search"/>&nbsp;&nbsp;&nbsp;<h:freetextbox id="txt_RegularCustomerName" templateKey="T_R_FunctionName"/></TD></TR>
              <TR>
                ...
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_CustomerCode" templateKey="W_CustomerCode"/><h:submitbutton id="btn_P_Search_CustomerCode" templateKey="W_P_Search"/>&nbsp; 
                  &nbsp;<h:freetextbox id="txt_CustomerName" templateKey="T_R_FunctionName"/></TD></TR>
              <TR>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_ItemCode" templateKey="W_ItemCode"/><h:submitbutton id="btn_P_Search_ItemCode" templateKey="W_P_Search"/>&nbsp; 
                  &nbsp;<h:freetextbox id="txt_ItemName" templateKey="W_R_ItemName"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_lbl_WorkStatus" templateKey="W_WorkStatus"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:pulldown id="pul_WorkStatus" templateKey="W_WorkStatusPCT"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_User" templateKey="W_User"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_User" templateKey="W_User"/><h:submitbutton id="btn_User" templateKey="W_P_Search"/>&nbsp; 
                  &nbsp;<h:freetextbox id="txt_UserName" templateKey="T_R_FunctionName"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
