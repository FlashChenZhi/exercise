<%-- $Id: PCTFloorProgress.jsp 3986 2009-04-07 05:43:37Z rnakai $ --%>
 ...
 * 
 * @version $Revision: 3986 $, $Date: 2009-04-07 14:43:37 +0900 (火, 07 4 2009) $
        ...
        <TR>
          <TD>
            <TABLE style="WIDTH: 1130px; HEIGHT: 27px">
              <TBODY>
              <TR>
                <TD><h:scrolllistcell id="lst_PCTAreaProgress" templateKey="W_PCTAreaProgress"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR>
  <TR>
    <TD>
<%-- footer --%>
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
