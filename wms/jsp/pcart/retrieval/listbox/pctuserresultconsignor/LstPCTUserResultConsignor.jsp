<%-- $Id: LstPCTUserResultConsignor.jsp 6602 2009-12-23 01:16:12Z okayama $ --%>
        ...
        <TR>
          ...
          <TD><%-- search condition --%>
            ...
            border=0>
              ...
              <TR>
                <TD><BR><h:listcell id="lst_Header" templateKey="W_PCTUserResultAvg2Header"/></TD></TR>
              <TR height=7>
                <TD><h:listcell id="lst_UserResultSummaryAvg" templateKey="W_PCTUserResultSummaryAvg"/></TD></TR></TBODY></TABLE><BR><%-- list start --%>
                      ...
                      <TD>
                        <TABLE>
                          ...
                          <TR>
                            ...
                            <TD>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_Preview" templateKey="W_Preview"/>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_Print" templateKey="W_Print"/>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_XLS" templateKey="W_XLS"/>&nbsp;&nbsp; 
                              <h:submitbutton id="btn_Close_U" templateKey="Close"/></TD></TR></TBODY></TABLE></TD></TR>
                    <TR bgColor=#b8b7d7 height=7>
                      <TD colSpan=2>&nbsp;<h:listcell id="lst_UserResultConsignorList" templateKey="W_PCTUserResultConsignorList"/></TD></TR></TBODY></TABLE>
                  <TABLE style="WIDTH: 100%" cellSpacing=0 cellPadding=0 
                  bgColor=#dad9ee border=0>
                    <TBODY>
                    <TR bgColor=#b8b7d7 height=7>
                      <TD>&nbsp;<h:submitlabel id="slb_Download" templateKey="W_Download"/><h:submitlabel id="slb_Preview" templateKey="W_Preview"/></TD></TR><%-- pager --%>
                    <TR bgColor=#b8b7d7>
                      <TD>
                        <TABLE>
                          <TBODY>
