<%-- $Id: LstPCTUserResultWorkDate.jsp 6602 2009-12-23 01:16:12Z okayama $ --%>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD>
                  ...
                  bgColor=#dad9ee border=0>
                    ...
                    <TR bgColor=#b8b7d7 height=7>
                      <TD colSpan=2>&nbsp;<h:listcell id="lst_UserResultWorkDateList" templateKey="W_PCTUserResultWorkDateList"/></TD></TR></TBODY></TABLE>
                  <TABLE style="WIDTH: 100%" cellSpacing=0 cellPadding=0 
                  bgColor=#dad9ee border=0>
                    <TBODY>
                    <TR bgColor=#b8b7d7 height=7>
