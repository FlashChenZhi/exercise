<%-- $Id: LstPCTUserResultArea.jsp 6602 2009-12-23 01:16:12Z okayama $ --%>
                        ...
                        <TABLE>
                          ...
                          <TR>
                            ...
                            <TD>&nbsp;&nbsp; <h:submitbutton id="btn_Preview" templateKey="W_Preview"/>&nbsp;&nbsp; 
                              ...
                              <h:submitbutton id="btn_XLS" templateKey="W_XLS"/>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_Close_U" templateKey="Close"/></TD></TR></TBODY></TABLE></TD></TR>
                    <TR bgColor=#b8b7d7 height=7>
                      <TD colSpan=2>&nbsp;<h:listcell id="lst_UserResultAreaList" templateKey="W_PCTUserResultAreaList"/></TD></TR></TBODY></TABLE>
                  <TABLE style="WIDTH: 100%" cellSpacing=0 cellPadding=0 
                  bgColor=#dad9ee border=0>
                    <TBODY>
                    <TR bgColor=#b8b7d7 height=7>
