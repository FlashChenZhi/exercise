<%-- $Id: LstPCTRetPlanWorkInquiry.jsp 6602 2009-12-23 01:16:12Z okayama $ --%>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD>
                  ...
                  bgColor=#dad9ee border=0>
                    <TBODY><%-- listcell --%>
                    <TR bgColor=#b8b7d7>
                      <TD><h:listcell id="lst_PCTRetPlanWorkInquiry" templateKey="W_PCTRetPlanWorkInquiry"/></TD></TR></TBODY></TABLE>
                  <TABLE style="WIDTH: 100%" cellSpacing=0 cellPadding=0 
                  bgColor=#dad9ee border=0>
                    <TBODY>
                    <TR bgColor=#b8b7d7 height=7>
