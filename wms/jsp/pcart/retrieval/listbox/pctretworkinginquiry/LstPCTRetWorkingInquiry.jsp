<%-- $Id: LstPCTRetWorkingInquiry.jsp 6602 2009-12-23 01:16:12Z okayama $ --%>
        ...
        <TR>
          ...
          <TD>
            ...
            border=0>
              <TBODY>
              <TR height=7>
                <TD><h:listcell id="lst_SearchCondition" templateKey="W_PCTSearchConditionFourColumn"/><BR></TD></TR></TBODY></TABLE><%-- list start --%>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD>
                  ...
                  bgColor=#dad9ee border=0>
                    <TBODY><%-- listcell --%>
                    <TR bgColor=#b8b7d7>
                      <TD><h:listcell id="lst_PCTRetWorkingRequiry" templateKey="W_PCTRetWorkingInquiry"/></TD></TR></TBODY></TABLE>
                  <TABLE style="WIDTH: 100%" cellSpacing=0 cellPadding=0 
                  bgColor=#dad9ee border=0>
                    <TBODY>
                    <TR bgColor=#b8b7d7 height=7>
