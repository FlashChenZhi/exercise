<%-- $Id: LstPCTProductivityInquiry.jsp 3207 2009-03-02 05:30:50Z arai $ --%>
                ...
                <TD>
                  ...
                  bgColor=#dad9ee border=0>
                    <TBODY>
                          <%-- listcell --%>
                          <TR bgColor=#b8b7d7>
                      <TD><h:verticalbarlinechart id="vbc_VerticalChart" templateKey="W_V_PCTCustomerProgress"/></TD></TR></TBODY></TABLE></TD>
