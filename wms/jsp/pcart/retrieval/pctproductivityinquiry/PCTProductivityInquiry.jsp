<%-- $Id: PCTProductivityInquiry.jsp 3207 2009-03-02 05:30:50Z arai $ --%>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_UserIdFrom" templateKey="T_UserId"/><h:submitbutton id="btn_SearchFrom" templateKey="W_P_Search"/>&nbsp;&nbsp; 
                  <h:label id="lbl_Range" templateKey="W_Range"/><h:freetextbox id="txt_UserIdTo" templateKey="T_UserId"/><h:submitbutton id="btn_SearchTo" templateKey="W_P_Search"/><h:checkbox id="chk_Range" templateKey="W_DesignateRange"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
        ...
        <TR>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              <TBODY>
              <TR>
                <TD><h:submitbutton id="btn_Graph" templateKey="W_P_Graph"/></TD></TR></TBODY></TABLE></TD>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_PCTProductivityInquiry" templateKey="W_PCTProductivityInquiry"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" 
