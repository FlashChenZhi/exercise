<%-- $Id: WorkMntAll.jsp 3787 2009-03-25 05:12:55Z ose $ --%>
 ...
 * 
 * @version $Revision: 3787 $, $Date: 2009-03-25 14:12:55 +0900 (水, 25 3 2009) $
 * @author  $Author: ose $
--%>
<%--@@SYSTEM_TODO_START@@--%>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD width="100%" bgColor=#b8b7d7><h:radiobutton id="rdo_AllCompletion" templateKey="P_Group_AllCompletion"/>&nbsp;&nbsp; 
                  &nbsp;&nbsp; <h:radiobutton id="rdo_AllStockout" templateKey="P_Group_AllStockout"/>&nbsp;&nbsp;&nbsp; 
                  &nbsp; <h:radiobutton id="rdo_Delete" templateKey="P_Group_Delete"/></TD></TR>
              <TR bgColor=#b8b7d7>
              ...
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_RegularCustomerCode" templateKey="W_RegularConsignorCode"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_RegularCustomerCode" templateKey="W_RegularCustomerCode"/><h:submitbutton id="btn_SearchRegularCustomer" templateKey="W_P_Search"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_CustomerCoder" templateKey="W_CustomerCode"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_CustomerCode" templateKey="W_CustomerCode"/><h:submitbutton id="btn_SearchCustomor" templateKey="W_P_Search"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_OrderNo" templateKey="W_OrderNo"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_OrderNo" templateKey="W_OrderNoPCT"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
