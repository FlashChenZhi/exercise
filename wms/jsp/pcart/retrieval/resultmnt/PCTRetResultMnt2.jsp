<%-- $Id: PCTRetResultMnt2.jsp 4166 2009-04-20 02:16:51Z okayama $ --%>
 ...
 * 
 * @version $Revision: 4166 $, $Date: 2009-04-20 11:16:51 +0900 (月, 20 4 2009) $
  ...
  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
      ...
      border=0>
        ...
        <TR height=28>
          ...
          <TD width=7></TD>
          <TD noWrap></TD>
          <TD width="90%" height=28><h:tab id="tab_WorkMnt" templateKey="W_WorkMnt2"/></TD>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_ItemCode" templateKey="W_ItemCode"/><h:label id="lbl_RequireOrderNo" templateKey="W_Require"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
              ...
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_AreaNo" templateKey="W_Area"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
      ...
      <TABLE style="MARGIN-LEFT: 7px" cellSpacing=0 cellPadding=0 border=0>
        ...
        <TR>
          ...
          <TD bgColor=#b8b7d7>
            ...
            <h:submitbutton id="btn_Clear" templateKey="W_Clear"/>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_ItemUnit" templateKey="W_OrderUnit"/></TD>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_resultMntList" templateKey="W_PCTResultMnt2List"/></TD>
                <TD width="100%" bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp; &nbsp;</TD>
