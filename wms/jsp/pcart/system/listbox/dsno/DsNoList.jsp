<%-- $Id: DsNoList.jsp 6602 2009-12-23 01:16:12Z okayama $ --%>
    ...
    <TD><%-- header --%>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR bgColor=#413a8a height=4>
          <TD width=7></TD>
          <TD height=4><h:label id="lbl_SettingName" templateKey="T_In_SettingName"/></TD></TR>
        <TR bgColor=#413a8a height=4>
      ...
      border=0>
        ...
        <TR bgColor=#b8b7d7>
          <TD width=7 bgColor=#dad9ee></TD>
          <TD></TD>
          <TD><h:scrolllistcell id="lst_DSNoList" templateKey="W_DSNoList"/></TD>
          <TD width=7 bgColor=#dad9ee></TD></TR>
        <TR bgColor=#b8b7d7 height=7>
          <TD width=7 bgColor=#dad9ee></TD>
          <TD colSpan=2></TD>
