<%-- $Id: LstFolderSelect.jsp 3207 2009-03-02 05:30:50Z arai $ --%>
  ...
  <TABLE style="MARGIN-LEFT: 7px" cellSpacing=0 cellPadding=0 
      bgColor=#dad9ee border=0>
        ...
        <TR bgColor=#b8b7d7>
          ...
          <TD width="100%" bgColor=#b8b7d7><h:pulldown id="pul_Folder" templateKey="W_Folder"/><h:submitbutton id="btn_Up" templateKey="W_Up"/></TD></TR>
        <TR bgColor=#b8b7d7>
        ...
        <TR>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              <TBODY>
              <TR>
                <TD>&nbsp;<h:submitbutton id="btn_Select" templateKey="W_SelectSync"/>&nbsp;&nbsp; 
                  <h:submitbutton id="btn_Close" templateKey="Close"/></TD>
                <TD></TD>
                <TD></TD>
                <TD></TD>
                <TD></TD>
