<%-- $Id: LstPCTWeightDistinctionList.jsp 6602 2009-12-23 01:16:12Z okayama $ --%>
          ...
          <TD><%-- search condition --%>
            ...
            border=0>
              ...
              <TR height=14>
                <TD></TD></TR>
              <TR>
                <TD><h:listcell id="lst_SearchConditionTwoColumn" templateKey="SearchConditionTwoColumn"/></TD></TR>
              <TR height=7>
                        ...
                        <TABLE>
                          ...
                          <TR>
                            ...
                            <TD>&nbsp;&nbsp; <h:submitbutton id="btn_Preview" templateKey="W_Preview"/>&nbsp;&nbsp; 
                              <h:submitbutton id="btn_Print" templateKey="W_Print"/>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_XLS" templateKey="W_XLS"/>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_Close_U" templateKey="Close"/></TD></TR></TBODY></TABLE>&nbsp;</TD></TR></TBODY></TABLE>
                  <TABLE style="WIDTH: 100%" cellSpacing=0 cellPadding=0 
                  bgColor=#dad9ee border=0>
                    <TBODY><%-- listcell --%>
                    <TR bgColor=#b8b7d7>
                      <TD><h:listcell id="lst_PCTWeightDistinctionList" templateKey="W_LstPCTWeightDistinctionList"/></TD></TR></TBODY></TABLE>
                  <TABLE style="WIDTH: 100%" cellSpacing=0 cellPadding=0 
                  bgColor=#dad9ee border=0>
                    <TBODY>
                    <TR bgColor=#b8b7d7 height=7>
                      ...
                      <TD>
                        <TABLE>
                          ...
                          <TR>
                            ...
                            <TD>&nbsp;&nbsp; <h:submitbutton id="btn_Close_D" templateKey="Close"/></TD></TR></TBODY></TABLE>&nbsp;</TD></TR></TBODY></TABLE></TD>
