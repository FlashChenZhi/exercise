<%-- $Id: PCTCustomerMasterRegist.jsp 3422 2009-03-13 07:13:49Z dmori $ --%>
 ...
 * 
 * @version $Revision: 3422 $, $Date: 2009-03-13 16:13:49 +0900 (金, 13 3 2009) $
 * @author  $Author: dmori $
--%>
<%--@@SYSTEM_TODO_START@@--%>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_CustomerCode" templateKey="W_CustomerCode"/><h:label id="lbl_RequireCustomer" templateKey="W_Require"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_CustomerCode" templateKey="W_CustomerCode"/><h:submitbutton id="btn_Search" templateKey="W_P_Search"/></TD></TR>
              <TR>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_WorkPriority" templateKey="W_WorkPriority"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:pulldown id="pul_WorkPriority" templateKey="W_WorkPriority"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
