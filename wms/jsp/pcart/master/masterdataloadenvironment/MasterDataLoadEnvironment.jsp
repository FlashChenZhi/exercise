<%-- $Id: MasterDataLoadEnvironment.jsp 7891 2010-04-29 02:32:10Z kumano $ --%>
 ...
 * 
 * @version $Revision: 7891 $, $Date: 2010-04-29 11:32:10 +0900 (木, 29 4 2010) $
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD noWrap bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:scrolllistcell id="lst_DataLoadEnvironment" templateKey="W_DataLoadEnvironment"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" 
        ...
        <TR>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              <TBODY>
              <TR>
                <TD><h:submitbutton id="btn_Set" templateKey="W_Set"/>&nbsp;&nbsp; 
