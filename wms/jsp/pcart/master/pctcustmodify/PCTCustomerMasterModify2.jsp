<%-- $Id: PCTCustomerMasterModify2.jsp 3995 2009-04-07 07:29:12Z okayama $ --%>
      ...
      border=0>
        ...
        <TR height=28>
          ...
          <TD><h:submitbutton id="btn_Back" templateKey="W_Back"/>&nbsp;&nbsp; 
            <h:submitbutton id="btn_MenuNoFunc" templateKey="To_MenuNoFunc"/></TD></TR></TBODY></TABLE>
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
        <TR height=5>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                ...
                <TD width="100%" bgColor=#dad9ee><h:label id="lbl_JavaSetConsignorCode" templateKey="W_In_JavaSet"/></TD></TR>
              <TR bgColor=#dad9ee>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:pulldown id="pul_WorkPriority" templateKey="W_WorkPriority"/></TD></TR>
              <TR bgColor=#b8b7d7>
