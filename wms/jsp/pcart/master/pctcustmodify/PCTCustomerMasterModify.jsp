<%-- $Id: PCTCustomerMasterModify.jsp 3421 2009-03-13 07:13:37Z dmori $ --%>
 ...
 * 
 * @version $Revision: 3421 $, $Date: 2009-03-13 16:13:37 +0900 (金, 13 3 2009) $
 * @author  $Author: dmori $
--%>
<%--@@SYSTEM_TODO_START@@--%>
  ...
  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
      ...
      border=0>
        ...
        <TR height=28>
          ...
          <TD width=7></TD>
          <TD noWrap><h:tab id="tab_1" templateKey="W_SetModifyDelete"/></TD>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_CustomerCode" templateKey="W_CustomerCode"/><h:submitbutton id="btn_Search" templateKey="W_P_Search"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
