<%-- $Id: PCTItemModify.jsp 3616 2009-03-17 09:44:03Z ose $ --%>
 ...
 * 
 * @version $Revision: 3616 $, $Date: 2009-03-17 18:44:03 +0900 (火, 17 3 2009) $
 * @author  $Author: ose $
--%>
<%--@@SYSTEM_TODO_START@@--%>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_ItemCode" templateKey="W_ItemCode"/><h:label id="lbl_1" templateKey="W_Require"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_LotEnteringQty" templateKey="W_LotEnteringQty"/><h:label id="lbl_RequireItem" templateKey="W_Require"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:numbertextbox id="txt_LotEnteringQty" templateKey="W_LotEnteringQty"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
