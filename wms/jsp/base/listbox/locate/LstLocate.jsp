<%-- $Id: LstLocate.jsp 6059 2009-11-19 01:59:49Z fukuwa $ --%>
 ...
 * 
 * @version $Revision: 6059 $, $Date: 2009-11-19 10:59:49 +0900 (木, 19 11 2009) $
    ...
    <TD><%-- header --%>
      ...
      border=0>
        ...
        <TR bgColor=#b8b7d7>
          <TD width=7 bgColor=#dad9ee></TD>
          <TD></TD>
          <TD><h:scrolllistcell id="lst_Locate" templateKey="W_ASRSLocationList"/></TD>
          <TD width=7 bgColor=#dad9ee></TD></TR>
        <TR bgColor=#b8b7d7 height=7>
          <TD width=7 bgColor=#dad9ee></TD>
          <TD colSpan=2></TD>
