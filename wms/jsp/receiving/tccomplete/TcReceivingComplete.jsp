<%-- $Id: 05_uppertab-lower.jsp,v 1.1.1.1 2008/08/25 02:20:21 okamura Exp $ --%>
 ...
 * 
 * @version $Revision: 1.1.1.1 $, $Date: 2008/08/25 02:20:21 $
...
<script>
        function dynamicAction()
        {
            ...
            {
                if (!_isValueInput('txt_ReceivingPlanDate'))
                {
                    document.all('txt_ReceivingPlanDate').focus();
                    // 6003100={0}を入力してください。
                    _setMessage('<%= HTMLUtils.escapeScript(HTMLUtils.encode(MessageResources.getText("6003100", DispResources.getText("LBL-W0535")))) %>',2);
                    return true;
                }
      ...
      border=0>
        ...
        <TR height=28>
          <TD width=7><IMG 
            ...
            width=7></TD>
          <TD width=7></TD>
          <TD noWrap><h:tab id="tab" templateKey="W_AllDecision"/></TD>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_ReceivingPlanDate" templateKey="W_ReceivingPlanDate"/><h:label id="lbl_2" templateKey="W_Require"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:datetextbox id="txt_ReceivingPlanDate" templateKey="W_PlanDate"/><h:label id="lbl_InputStyle" templateKey="W_InputStyle"/><h:label id="lbl_Day" templateKey="W_InputStyleDay"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_SupplierCode" templateKey="W_SupplierCode"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_SupplierCode" templateKey="W_SupplierCode"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
      <TABLE style="MARGIN-LEFT: 7px" cellSpacing=0 cellPadding=0 border=0>
        ...
        <TR>
          ...
          <TD bgColor=#b8b7d7>
            ...
            <h:submitbutton id="btn_Decision" templateKey="W_Decision"/>&nbsp;&nbsp; 
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7 colSpan=2><h:pager id="pgr_U" templateKey="Pager"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp; </TD>
                <TD bgColor=#b8b7d7>&nbsp;</TD>
                <TD width="100%" bgColor=#b8b7d7>&nbsp;</TD></TR>
              ...
              <TR>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7 colSpan=2><h:listcell id="lst_TcReceivingWorkList" templateKey="W_TcReceivingWorkList"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              ...
              <TR>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7 colSpan=2><h:pager id="pgr_D" templateKey="Pager"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" 
