<%-- $Id: TcReceivingShortageMnt.jsp,v 1.2 2008/04/14 07:35:39 okamura Exp $ --%>
 ...
 * 
 * @version $Revision: 1.2 $, $Date: 2008/04/14 07:35:39 $
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_ReceivingPlanDate" templateKey="W_ReceivingPlanDate"/></TD>
                <TD noWrap bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD noWrap bgColor=#b8b7d7 colSpan=4><h:datetextbox id="txt_ReceivingPlanDate" templateKey="W_PlanDate"/><h:label id="lbl_InputStyle" templateKey="W_InputStyle"/><h:label id="lbl_Day" templateKey="W_InputStyleDay"/>&nbsp;&nbsp; 
                  &nbsp;&nbsp;&nbsp; </TD>
              ...
              <TR>
                ...
                <TD noWrap bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD noWrap bgColor=#b8b7d7><h:freetextbox id="txt_SupplierCode" templateKey="W_SupplierCode"/></TD>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_SlipNumber" templateKey="W_SlipNumber"/></TD>
                <TD noWrap bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD noWrap bgColor=#b8b7d7><h:freetextbox id="txt_SlipNumber" templateKey="W_SlipNumber"/></TD>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
                ...
                <TD noWrap bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD noWrap bgColor=#b8b7d7><h:freetextbox id="txt_ItemCode" templateKey="W_ItemCode"/>&nbsp;&nbsp;&nbsp; 
                </TD>
        ...
        <TR>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              <TBODY>
              <TR>
                <TD><h:submitbutton id="btn_ShortageDecision" templateKey="W_ShortageDecision"/>&nbsp;&nbsp; 
                  <h:submitbutton id="btn_ShortageCancel" templateKey="W_ShortageCancel"/>&nbsp;&nbsp; 
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7><h:listcell id="lst_ReceivingShortageMnt" templateKey="W_ReceivingShortageMnt"/></TD>
                <TD width="100%" bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp; </TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD>
