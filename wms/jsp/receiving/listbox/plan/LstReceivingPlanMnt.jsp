<%-- $Id: LstReceivingPlanMnt.jsp 6575 2009-12-21 05:56:19Z okayama $ --%>
 ...
 * 
 * @version $Revision: 6575 $, $Date: 2009-12-21 14:56:19 +0900 (月, 21 12 2009) $
  ...
  <TR>
    <TD><%-- header --%>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#dad9ee 
        ...
        <TR>
          <TD>&nbsp;&nbsp;&nbsp;</TD>
          <TD><%-- search condition --%><BR><%-- list start --%>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD>
                  ...
                  bgColor=#dad9ee border=0>
                    <TBODY><%-- listcell --%>
                    <TR bgColor=#b8b7d7>
                      <TD><h:listcell id="lst_ReceivingPlanSearch" templateKey="W_ReceivingPlanSearch"/></TD></TR></TBODY></TABLE>
                  <TABLE style="WIDTH: 100%" cellSpacing=0 cellPadding=0 
                  bgColor=#dad9ee border=0>
                    <TBODY>
                    <TR bgColor=#b8b7d7 height=7>
