<%-- $Id: LstCustomerHistory.jsp 7711 2010-03-21 07:34:09Z shibamoto $ --%>
 ...
 *
 * @version $Revision: 7711 $, $Date: 2010-03-21 16:34:09 +0900 (日, 21 3 2010) $
                ...
                <TD>
                  ...
                  bgColor=#dad9ee border=0>
                    <TBODY>
                          <%-- listcell --%>
                          <TR bgColor=#b8b7d7>
                      <TD><h:listcell id="lst_CustomerHistoryList" templateKey="W_CustomerHistoryList"/></TD></TR></TBODY></TABLE>
                  <TABLE style="WIDTH: 100%" cellSpacing=0 cellPadding=0
                  bgColor=#dad9ee border=0>
                    <TBODY>
                    <TR bgColor=#b8b7d7 height=7>
                ...
                <TD bgColor=#b8b7d7>
                  <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
                    ...
                    <TR>
                      ...
                      <TD></TD>
                      <TD></TD>
                      <TD></TD></TR></TBODY></TABLE>&nbsp;&nbsp;<h:submitbutton id="btn_Close_D" templateKey="W_Close"/>&nbsp;&nbsp;
                </TD>
                <TD><IMG height=40 src="<%=request.getContextPath()%>/img/common/tab_rt3.gif" width=42 border=0></TD></TR></TBODY></TABLE></TD>                <TD>&nbsp;&nbsp;&nbsp;</TD></TR></TBODY></TABLE>
          <TD>&nbsp;&nbsp;&nbsp;</TD></TR></TBODY></TABLE>
