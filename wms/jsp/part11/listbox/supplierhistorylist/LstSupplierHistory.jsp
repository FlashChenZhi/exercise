<%-- $Id: LstSupplierHistory.jsp 7711 2010-03-21 07:34:09Z shibamoto $ --%>
                ...
                <TD>
                  ...
                  bgColor=#dad9ee border=0>
                    <TBODY>
                          <%-- listcell --%>
                          <TR bgColor=#b8b7d7>
                      <TD><h:listcell id="lst_SupplierHistoryList" templateKey="W_SupplierHistoryList"/></TD></TR></TBODY></TABLE>
                  <TABLE style="WIDTH: 100%" cellSpacing=0 cellPadding=0
                  bgColor=#dad9ee border=0>
                    <TBODY>
                    <TR bgColor=#b8b7d7 height=7>
