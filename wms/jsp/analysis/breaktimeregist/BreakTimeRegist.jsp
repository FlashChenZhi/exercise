<%-- $Id: BreakTimeRegist.jsp 7134 2010-02-18 07:39:31Z shibamoto $ --%>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_BreakTime" templateKey="W_BreakTime"/><h:label id="lbl_BreakStartRequire" templateKey="W_Require"/><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:timetextbox id="txt_BreakStartTime" templateKey="W_BreakStartTime"/><h:label id="lbl_range" templateKey="W_Range"/><h:timetextbox id="txt_BreakEndTime" templateKey="W_BreakEndTime"/><h:label id="lbl_InputStyle" templateKey="W_InputStyle"/><h:label id="lbl_1" templateKey="W_InputStyleHHmm"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD width="100%" bgColor=#b8b7d7><BR></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp; </TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_BreakTimeList" templateKey="W_BreakTimeList"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" 
        bgColor=#b8b7d7><BR></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR>
  <TR>
    <TD><%-- footer --%>
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
