<%-- $Id: WorkingUnitQtyMainte.jsp 2088 2008-12-12 10:13:50Z rnakai $ --%>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_ItemCode" templateKey="W_ItemCode"/><h:submitbutton id="btn_ItemSearch" templateKey="W_P_Search"/></TD></TR>
              <TR bgColor=#b8b7d7>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_WorkUnitQty" templateKey="W_WorkUnitQty"/></TD>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_WorkUnitRequire" templateKey="W_Require"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:numbertextbox id="txt_WorkUnitQty" templateKey="W_WorkUnitQty"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h:label id="lbl_WorkUnitQtyCmt" templateKey="W_WorkUnitQtyCmt"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
