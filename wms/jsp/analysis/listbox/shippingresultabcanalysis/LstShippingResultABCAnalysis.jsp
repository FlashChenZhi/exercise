<%-- $Id: LstShippingResultABCAnalysis.jsp 6580 2009-12-21 08:12:57Z okayama $ --%>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD>
                      ...
                      <TD>
                        <TABLE>
                          ...
                          <TR>
                            ...
                            <TD>&nbsp;&nbsp; <h:submitbutton id="btn_XLS" templateKey="W_XLS"/>&nbsp;&nbsp; 
                              <h:submitbutton id="btn_Close_U" templateKey="W_Close"/> 
                  ...
                  bgColor=#dad9ee border=0>
                    <TBODY><%-- listcell --%>
                    <TR bgColor=#b8b7d7>
                      <TD width=1><h:listcell id="lst_AbcList" templateKey="W_AbcDetailList"/></TD></TR></TBODY></TABLE>
                  <TABLE style="WIDTH: 100%" cellSpacing=0 cellPadding=0 
                  bgColor=#dad9ee border=0>
                    <TBODY>
                    <TR bgColor=#b8b7d7 height=7>
