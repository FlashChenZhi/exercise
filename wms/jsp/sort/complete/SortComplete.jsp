    ...
    <TD><%-- title --%>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#b8b7d7 
        ...
        <TR bgColor=#dad9ee height=5>
          <TD bgColor=#dad9ee colSpan=2><IMG 
            src="<%=request.getContextPath()%>/img/common/spacer.gif" 
        ...
        <TR bgColor=#b8b7d7>
          ...
          <TD noWrap bgColor=#b8b7d7 colSpan=4>
            <TABLE cellSpacing=0 cellPadding=0>
              <TBODY>
              <TR>
                <TD><h:label id="lbl_SortPlanDate" templateKey="W_SortPlanDate"/><h:label id="lbl_Require" templateKey="W_Require"/></TD>
                <TD><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD><h:datetextbox id="txt_PlanDate" templateKey="W_PlanDate"/><h:label id="lbl_InputStyle" templateKey="W_InputStyle"/><h:label id="lbl_Day" templateKey="W_InputStyleDay"/></TD>
                <TD>&nbsp;&nbsp;&nbsp;<h:label id="lbl_BatchNo" templateKey="W_BatchNo"/></TD>
                <TD><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD><h:freetextbox id="txt_BatchNo" templateKey="W_BatchNo"/></TD></TR>
              <TR>
                <TD><h:label id="lbl_ItemCode" templateKey="W_ItemCode"/>&nbsp;</TD>
                <TD><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD><h:freetextbox id="txt_ItemCode" templateKey="W_ItemCode"/></TD>
                <TD>&nbsp;&nbsp; <h:label id="lbl_CustomerCode" templateKey="W_CustomerCode"/></TD>
                <TD><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD><h:freetextbox id="txt_CustomerCode" templateKey="W_CustomerCode"/></TD></TR></TBODY></TABLE></TD>
          <TD bgColor=#b8b7d7><IMG 
            src="<%=request.getContextPath()%>/img/common/spacer.gif" 
            width=7 border=0></TD>
          <TD bgColor=#dad9ee><IMG 
        ...
        <TR bgColor=#b8b7d7>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7 colSpan=3><h:pager id="pgr_U" templateKey="Pager"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7>&nbsp;</TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7 colSpan=3><h:listcell id="lst_SortWorkList" templateKey="W_SortWorkList"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7>&nbsp;</TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7 colSpan=3><h:pager id="pgr_D" templateKey="Pager"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
