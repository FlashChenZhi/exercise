<%-- $Id: LstInventoryJobNo.jsp 676 2008-10-24 09:38:02Z ota $ --%>
 ...
 * 
 * @version $Revision: 676 $, $Date: 2008-10-24 18:38:02 +0900 (金, 24 10 2008) $
 * @author  $Author: ota $
--%>
<%--@@SYSTEM_TODO_START@@--%>
    ...
    <TD><%-- header --%>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#413a8a 
        ...
        <TR height=23>
          ...
          <TD width=7></TD></TR>
        <TR>
          <TD colSpan=4 height=4></TD></TR></TBODY></TABLE><%-- search condition --%>
      <TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#dad9ee 
        ...
        <TR height=7>
          <TD width=7></TD>
          <TD></TD></TR></TBODY></TABLE><%-- list start --%>
      ...
      border=0>
        ...
        <TR bgColor=#b8b7d7 height=7>
          ...
          <TD colSpan=2></TD>
          <TD width=7 bgColor=#dad9ee></TD></TR><%-- pager --%>
        <TR bgColor=#b8b7d7>
          <TD width=7 bgColor=#dad9ee></TD>
          <TD width=7></TD>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0>
              ...
              <TR>
                ...
                <TD><h:submitbutton id="btn_Print" templateKey="W_Print"/>&nbsp;</TD></TR></TBODY></TABLE>&nbsp;&nbsp; 
          </TD>
          <TD width=7 bgColor=#dad9ee></TD></TR><%-- listcell --%>
        <TR bgColor=#b8b7d7>
          <TD width=7 bgColor=#dad9ee></TD>
          <TD></TD>
          <TD><h:scrolllistcell id="lst_HostError" templateKey="W_LstHostError"/></TD>
          <TD width=7 bgColor=#dad9ee></TD></TR>
        <TR bgColor=#b8b7d7 height=7>
          <TD width=7 bgColor=#dad9ee></TD>
          <TD colSpan=2></TD>
          <TD width=7 bgColor=#dad9ee></TD></TR></TBODY></TABLE><%-- buttom --%>
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
        <TR>
          <TD>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7>
                  <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
                    ...
                    <TR>
                      <TD></TD>
                      <TD><h:submitbutton id="btn_Close" templateKey="W_Close"/></TD>
                      <TD></TD></TR></TBODY></TABLE></TD>
                <TD><IMG height=40 src="<%=request.getContextPath()%>/img/common/tab_rt3.gif" width=42 border=0></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE><%-- footer --%>
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
        <TR height=41>
