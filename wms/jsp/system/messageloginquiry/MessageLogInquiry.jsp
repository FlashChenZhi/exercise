<%-- $Id: MessageLogInquiry.jsp 6789 2010-01-22 08:55:42Z okayama $ --%>
    ...
    <TD><%-- title --%>
      ...
      border=0>
        ...
        <TR height=28>
          ...
          <TD width="90%" height=28><h:submitbutton id="btn_Menu" templateKey="To_Menu"/></TD>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD width="100%" bgColor=#b8b7d7><h:datetextbox id="txt_FromSearchDate" templateKey="W_SearchDate"/><h:timetextbox id="txt_FromSearchTime" templateKey="W_SearchTime"/><h:label id="lbl_Range" templateKey="W_Range"/><h:datetextbox id="txt_ToSearchDate" templateKey="W_SearchDate"/><h:timetextbox id="txt_ToSearchTime" templateKey="W_SearchTime"/><h:label id="lbl_InputStyle" templateKey="W_InputStyle"/><h:label id="lbl_In_JavaSet" templateKey="W_In_JavaSet"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_SearchCondition" templateKey="W_SearchCondition"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:radiobutton id="rdo_Log_All" templateKey="W_Log_All"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_Log_Information" templateKey="W_Log_Information"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_Log_Caution" templateKey="W_Log_Caution"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_Log_Warning" templateKey="W_Log_Warning"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_Log_Error" templateKey="W_Log_Error"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7><h:scrolllistcell id="lst_Log" templateKey="W_Log"/></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7>&nbsp;</TD>
