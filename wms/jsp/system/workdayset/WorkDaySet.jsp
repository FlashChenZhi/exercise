<%-- $Id: WorkDaySet.jsp 6789 2010-01-22 08:55:42Z okayama $ --%>
 ...
 * 
 * @version $Revision: 6789 $, $Date: 2010-01-22 17:55:42 +0900 (金, 22 1 2010) $
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_PresentWorkDate" templateKey="W_PresentWorkDate"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:datetextbox id="txt_PresentWorkDate" templateKey="W_WorkDate"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_ChangeWorkDate" templateKey="W_ChangeWorkDate"/><h:label id="lbl_Require" templateKey="W_Require"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:datetextbox id="txt_WorkDate" templateKey="W_WorkDate"/><h:label id="lbl_InputStyle" templateKey="W_InputStyle"/><h:label id="lbl_In_JavaSet" templateKey="W_In_JavaSet"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              ...
              <TR>
                ...
                <TD></TD>
                <TD></TD>
                <TD></TD></TR></TBODY></TABLE><h:submitbutton id="btn_Set" templateKey="W_Set2"/></TD>
          <TD><IMG height=40 
