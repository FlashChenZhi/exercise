<%-- $Id: RFTState.jsp 217 2008-10-15 02:56:14Z rnakai $ --%>
  ...
  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
      ...
      border=0>
        ...
        <TR height=28>
          ...
          <TD width=7></TD>
          <TD noWrap><h:tab id="tab_Maintenance" templateKey="W_Set"/></TD>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp; &nbsp; </TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_RFTState" templateKey="W_RFTState"/></TD></TR></TBODY></TABLE>&nbsp;</TD></TR></TBODY></TABLE>
