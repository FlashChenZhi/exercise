<%-- $Id: 02_uppertab-only.jsp 87 2008-10-04 03:07:38Z admin $ --%>
      ...
      border=0>
        ...
        <TR height=28>
          <TD width=7><IMG
            ...
            width=7></TD>
          <TD width=7></TD>
          <TD noWrap><h:tab id="tab" templateKey="W_Create"/></TD>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD align=right bgColor=#b8b7d7><h:submitbutton id="btn_CommunicationSuspendRestar" templateKey="W_CommunicationSuspendRestart"/><IMG
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_CommunicationSuspendRestar" templateKey="W_CommunicationSuspendRestart"/></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7>&nbsp;</TD>
              ...
              <TR>
                <TD noWrap bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD>
                <TD bgColor=#b8b7d7><h:scrolllistcell id="lst_HostCommunication" templateKey="W_HostCommunication"/>&nbsp;</TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
