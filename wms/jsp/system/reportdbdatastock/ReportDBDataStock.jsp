<%-- $Id: ReportDBDataStock.jsp 2194 2008-12-16 06:01:33Z mikuriya $ --%>
 ...
 * 
 * @version $Revision: 2194 $, $Date: 2008-12-16 15:01:33 +0900 (火, 16 12 2008) $
  ...
  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
      ...
      border=0>
        ...
        <TR height=28>
          ...
          <TD width=7></TD>
          <TD noWrap><h:tab id="tab" templateKey="W_StockInfoReport"/></TD>
