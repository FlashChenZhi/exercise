<%-- $Id: WorkerResultInquiry.jsp 7134 2010-02-18 07:39:31Z shibamoto $ --%>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_WorkContents" templateKey="W_WorkContents"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7><h:pulldown id="pul_FWorkContents" templateKey="W_F_WorkContents"/>&nbsp; &nbsp; </TD>
                <TD bgColor=#b8b7d7><h:label id="lbl_WorkDate" templateKey="W_WorkDate"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7><h:datetextbox id="txt_WorkDate" templateKey="W_WorkDate"/></TD>
                <TD bgColor=#b8b7d7><h:label id="lbl_Range" templateKey="W_Range"/></TD>
                <TD width="100%" bgColor=#b8b7d7><h:datetextbox id="txt_WorkDateTo" templateKey="W_WorkDate"/><h:label id="lbl_InputStyle" templateKey="W_InputStyle"/><h:label id="lbl_Day" templateKey="W_InputStyleDay"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_UserName" templateKey="W_UserName"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=6><h:freetextbox id="txt_UserName" templateKey="W_UserName"/><h:submitbutton id="btn_PSearchUserName" templateKey="W_P_Search"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_GroupCondition" templateKey="W_GroupCondition"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=6><h:radiobutton id="rdo_DetailDisplay" templateKey="W_GroupCondition_DetailDisplay"/>&nbsp;&nbsp;&nbsp; 
                  &nbsp; <h:radiobutton id="rdo_TotalDisplayDayUnit" templateKey="W_GroupCondition_TotalDisplayDayUnit"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_TotalDisplayInPeriod" templateKey="W_GroupCondition_TotalDisplayInPeriod"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
        ...
        <TR>
          <TD>
            <TABLE style="WIDTH: 100%" cellSpacing=0 cellPadding=0 border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD>
                <TD bgColor=#b8b7d7><h:listcell id="lst_ResultByUserList" templateKey="W_ResultByUserList"/></TD>
