<%-- $Id: StockModify.jsp 7181 2010-02-22 09:57:59Z fukuwa $ --%>
 ...
 * 
 * @version $Revision: 7181 $, $Date: 2010-02-22 18:57:59 +0900 (月, 22 2 2010) $
  ...
  <TR>
    <TD><%-- title --%>
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD width="100%" bgColor=#b8b7d7><h:pulldown id="pul_Area" templateKey="W_Area_Event"/>&nbsp;&nbsp; <h:label id="lbl_Location" templateKey="W_Location"/><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_Location" templateKey="W_Location"/><h:label id="lbl_InputStyle" templateKey="W_InputStyle"/><h:label id="lbl_LocationStyle" templateKey="W_In_JavaSet"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_ItemCode" templateKey="W_ItemCode"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_ItemCode" templateKey="W_ItemCode"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              ...
              <TR>
                ...
                <TD></TD>
                <TD></TD>
                <TD></TD></TR></TBODY></TABLE><h:submitbutton id="btn_ModifySubmit" templateKey="W_ModifySet"/></TD>
      ...
      bgColor=#b8b7d7 border=0>
        ...
        <TR>
          <TD>&nbsp;&nbsp;&nbsp;</TD>
          <TD><h:listcell id="lst_StockInfo" templateKey="W_StockInfoModifyDelete"/></TD></TR>
        <TR>
          <TD></TD>
