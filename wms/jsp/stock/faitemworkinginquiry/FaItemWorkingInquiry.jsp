    ...
    <TD><%-- title --%>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#b8b7d7 
        ...
        <TR bgColor=#dad9ee height=5>
          ...
          <TD bgColor=#dad9ee></TD>
          <TD bgColor=#dad9ee colSpan=3></TD>
        ...
        <TR bgColor=#dad9ee>
          ...
          <TD noWrap bgColor=#dad9ee colSpan=5><h:pulldown id="pul_Area" templateKey="W_Area"/></TD>
          <TD bgColor=#dad9ee><IMG 
            src="<%=request.getContextPath()%>/img/common/spacer.gif" 
        ...
        <TR bgColor=#b8b7d7>
          ...
          <TD bgColor=#b8b7d7><IMG 
            src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
          <TD noWrap bgColor=#b8b7d7 colSpan=3><h:freetextbox id="txt_FromItemCode_EntEvent" templateKey="W_ItemCode_EntEvent"/><h:submitbutton id="btn_SearchFromItemCode" templateKey="W_P_Search"/>&nbsp;&nbsp; 
            <h:label id="lbl_FromItemName" templateKey="W_FromItemName"/><IMG 
            src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_FromItemName" templateKey="W_ItemName"/><h:submitbutton id="btn_SearchFromItemName" templateKey="W_P_Search"/></TD>
        ...
        <TR>
          ...
          <TD bgColor=#b8b7d7><IMG 
            src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
          <TD noWrap bgColor=#b8b7d7 colSpan=3><h:freetextbox id="txt_ToItemCode_EntEvent" templateKey="W_ItemCode_EntEvent"/><h:submitbutton id="btn_SearchToItemCode" templateKey="W_P_Search"/>&nbsp;&nbsp; 
            <h:label id="lbl_ToItemName" templateKey="W_ToItemName"/><IMG 
            src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_ToItemName" templateKey="W_ItemName"/><h:submitbutton id="btn_SearchToItemName" templateKey="W_P_Search"/></TD>
          <TD width="100%" bgColor=#b8b7d7 colSpan=2></TD>
          <TD bgColor=#dad9ee><IMG 
            src="<%=request.getContextPath()%>/img/common/spacer.gif" 
            width=7 border=0></TD></TR>
        <TR bgColor=#b8b7d7>
          ...
          <TD bgColor=#b8b7d7><IMG 
            src="<%=request.getContextPath()%>/img/common/spacer.gif" 
            width=7 border=0></TD>
          <TD noWrap bgColor=#b8b7d7><h:label id="lbl_Type" templateKey="W_Type"/></TD>
          <TD bgColor=#b8b7d7><IMG 
            src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
          <TD noWrap bgColor=#b8b7d7><h:radiobutton id="rdo_Search_CountByItemCode" templateKey="W_Search_CountByItemCode"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <h:radiobutton id="rdo_Search_CountByItemCodeAndL" templateKey="W_Search_CountByItemCodeAndLotNo"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <h:radiobutton id="rdo_Search_DetailsPerItemCode" templateKey="W_Search_DetailsPerItemCode"/></TD>
        ...
        <TR bgColor=#b8b7d7>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD noWrap bgColor=#b8b7d7 colSpan=3><h:pager id="pager" templateKey="Pager"/>&nbsp;</TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7 colSpan=3></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7 colSpan=3><h:scrolllistcell id="lst_FaStockInquiry" templateKey="W_FaStockInquiry"/>&nbsp;</TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7 colSpan=3></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7 colSpan=3></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7 colSpan=3></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7 colSpan=3></TD></TR></TBODY></TABLE></TD>
