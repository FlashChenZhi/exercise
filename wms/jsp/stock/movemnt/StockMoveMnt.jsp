<%-- $Id: StockMoveMnt.jsp 7010 2010-02-16 02:03:00Z fukuwa $ --%>
 ...
 * 
 * @version $Revision: 7010 $, $Date: 2010-02-16 11:03:00 +0900 (火, 16 2 2010) $
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_FromMoveArea" templateKey="W_FromMoveArea"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7><h:pulldown id="pul_FromMoveArea" templateKey="W_Area_Event"/></TD>
                ...
                <TD bgColor=#b8b7d7><h:freetextbox id="txt_Location" templateKey="W_Location"/><h:label id="lbl_InputStyle" templateKey="W_InputStyle"/><h:label id="lbl_LocationStyle" templateKey="W_In_JavaSet"/></TD>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=3><h:freetextbox id="txt_ItemCode" templateKey="W_ItemCode"/></TD>
                <TD width="100%" 
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD noWrap bgColor=#b8b7d7>
                  <TABLE>
                    <TBODY>
                    <TR>
                      <TD colSpan=2><h:checkbox id="chk_LIssueReport" templateKey="W_IssueReport"/></TD>
                      <TD></TD></TR>
                    <TR>
                      <TD><h:listcell id="lst_StockMoveMaintenance" templateKey="W_StockMoveMaintenance"/></TD></TR></TBODY></TABLE></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp;&nbsp; </TD>
                <TD noWrap 
