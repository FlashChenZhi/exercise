<%-- $Id: LstItemWorkingStock.jsp 87 2008-10-04 03:07:38Z admin $ --%>
    ...
    <TD>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#dad9ee 
        ...
        <TABLE style="WIDTH: 100%" cellSpacing=0 cellPadding=0 
                        ...
                        <TABLE>
                          ...
                          <TR>
                            ...
                            <TD>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_Preview" templateKey="W_Preview"/>&nbsp;&nbsp; 
                              ...
                              <h:submitbutton id="btn_XLS" templateKey="W_XLS"/>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_CSV" templateKey="W_CSV"/>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_Close_U" templateKey="Close"/></TD></TR></TBODY></TABLE></TD>
                    <TR bgColor=#b8b7d7 height=7>
            ...
            <%-- listcell --%>
            <TR bgColor=#b8b7d7>
                      <TD><h:listcell id="lst_StockByItemList" templateKey="W_StockByItemList"/></TD></TR></TBODY></TABLE>
                  <TABLE style="WIDTH: 100%" cellSpacing=0 cellPadding=0 
                  bgColor=#dad9ee border=0>
                    <TBODY>
                    <TR bgColor=#b8b7d7 height=7>
