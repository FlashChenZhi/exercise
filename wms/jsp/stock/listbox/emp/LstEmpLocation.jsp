<%-- $Id: LstEmpLocation.jsp 6580 2009-12-21 08:12:57Z okayama $ --%>
  ...
  <TR>
    <TD><%-- header --%>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#dad9ee 
        ...
        <TR>
          <TD width=7>&nbsp;&nbsp;&nbsp; </TD>
          <TD><h:listcell id="lst_SearchCondition" templateKey="SearchConditionTwoColumn"/></TD></TR></TBODY></TABLE>
      <TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#dad9ee 
        border=0><TBODY>
        <TR height=7>
      ...
      border=0>
        ...
        <TR>
          ...
          <TD bgColor=#b8b7d7><h:scrolllistcell id="lst_EmpLocationList" templateKey="W_LocationList"/></TD>
          <TD width=7 bgColor=#dad9ee></TD></TR>
