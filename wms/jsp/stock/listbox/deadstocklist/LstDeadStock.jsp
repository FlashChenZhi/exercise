<%-- $Id: LstDeadStock.jsp 87 2008-10-04 03:07:38Z admin $ --%>
                ...
                <TD>
                        ...
                        <TABLE>
                          ...
                          <TR>
                            ...
                            <TD>&nbsp;&nbsp; <h:submitbutton id="btn_Preview" templateKey="W_Preview"/>&nbsp;&nbsp; 
                              ...
                              <h:submitbutton id="btn_Csv" templateKey="W_CSV"/>&nbsp;&nbsp; 
                  ...
                  bgColor=#dad9ee border=0>
                    <TBODY>
                          <%-- listcell --%>
                          <TR bgColor=#b8b7d7>
                      <TD><h:listcell id="lst_LongDwellList" templateKey="W_LongDwellList"/></TD></TR></TBODY></TABLE>
                  <TABLE style="WIDTH: 100%" cellSpacing=0 cellPadding=0 
                  bgColor=#dad9ee border=0>
                    <TBODY>
                    <TR bgColor=#b8b7d7 height=7>
