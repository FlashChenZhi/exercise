<%-- $Id: LstStock.jsp 149 2008-10-09 07:48:07Z nakai $ --%>
 ...
 * 
 * @version $Revision: 149 $, $Date:: 2008-10-04 12:07:38 +0900$
 * @author  $Author: nakai $
--%>
<%--@@SYSTEM_TODO_START@@--%>
                ...
                <TD>
                  ...
                  bgColor=#dad9ee border=0>
                    <TBODY>
                          <%-- listcell --%>
                          <TR bgColor=#b8b7d7>
                      <TD><h:listcell id="lst_LocationDetailList" templateKey="W_LocationDetailList"/></TD></TR></TBODY></TABLE>
                  <TABLE style="WIDTH: 100%" cellSpacing=0 cellPadding=0 
                  bgColor=#dad9ee border=0>
                    <TBODY>
                    <TR bgColor=#b8b7d7 height=7>
