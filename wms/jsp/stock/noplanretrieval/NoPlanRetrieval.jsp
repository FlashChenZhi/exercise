<%-- $Id: NoPlanRetrieval.jsp 7198 2010-02-23 09:08:40Z fukuwa $ --%>
 ...
 * 
 * @version $Revision: 7198 $, $Date: 2010-02-23 18:08:40 +0900 (火, 23 2 2010) $
...
<script>
		function dynamicAction()
		{
			...
			{
				if (_isValueInput('txt_RetrievalLocation_From') && _isValueInput('txt_RetrievalLocation_To'))
				{
					if (!_isCorrectRange(document.all('txt_RetrievalLocation_From').value, document.all('txt_RetrievalLocation_To').value))
					{
						document.all('txt_RetrievalLocation_To').focus();
				        //6023135=JnÍAII菬lɂĂB
						_setMessage('<%= HTMLUtils.escapeScript(HTMLUtils.encode(MessageResources.getText("6023135"))) %>',2);
						return true;
					}
				}
			}
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_ItemCode" templateKey="W_ItemCode"/><h:label id="lbl_RequireRetrievalPlanDate" templateKey="W_Require"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_ItemCode" templateKey="W_ItemCode"/>&nbsp;&nbsp; <h:label id="lbl_LotNo" templateKey="W_LotNo"/><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_LotNo" templateKey="W_LotNo"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_RetrievalArea" templateKey="W_RetrievalArea"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:pulldown id="pul_RetrievalArea" templateKey="W_Area_Event"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_RetrievalLocation" templateKey="W_RetrievalLocation"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_FromLocation" templateKey="W_Location"/><h:label id="lbl_Range" templateKey="W_Range"/><h:freetextbox id="txt_ToLocation" templateKey="W_Location"/><h:label id="lbl_InputStyle" templateKey="W_InputStyle"/><h:label id="lbl_LocationStyle" templateKey="W_In_JavaSet"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD width="100%" bgColor=#b8b7d7>
                  <TABLE>
                    <TBODY>
                    <TR>
                      <TD><h:checkbox id="chk_IssueReport" templateKey="W_IssueReport"/></TD>
                      <TD>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </TD>
                      <TD>&nbsp;&nbsp;&nbsp; </TD>
                      <TD>&nbsp;&nbsp;&nbsp; </TD></TR>
                    <TR>
                      ...
                      <TD><IMG 
                        src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                      <TD><h:freetextbox id="txt_Detail_ItemCode" templateKey="W_ItemCode"/></TD>
                      <TD><h:freetextbox id="txt_Detail_ItemName" templateKey="W_ItemName"/></TD></TR></TBODY></TABLE></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp; </TD>
                <TD bgColor=#b8b7d7></TD>
