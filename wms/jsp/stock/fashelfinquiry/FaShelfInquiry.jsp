      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#b8b7d7 
        ...
        <TR>
          ...
          <TD bgColor=#b8b7d7 colSpan=3><IMG 
            src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:pulldown id="pul_Area" templateKey="W_Area_Event"/></TD>
          <TD bgColor=#b8b7d7></TD>
        ...
        <TR bgColor=#b8b7d7>
          ...
          <TD bgColor=#b8b7d7 colSpan=3><IMG 
            src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:checkbox id="chk_StoredLocation" templateKey="W_StoredLocation"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
            <h:checkbox id="chk_EmptyLocation" templateKey="W_EmptyLocation"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
            <h:checkbox id="chk_WorkLocation" templateKey="W_WorkLocation"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
            <h:checkbox id="chk_ProhibitedLocation" templateKey="W_ProhibitedLocation"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
            <h:checkbox id="chk_UnreachableLocation" templateKey="W_UnreachableLocation"/></TD>
          <TD bgColor=#b8b7d7><IMG 
            src="<%=request.getContextPath()%>/img/common/spacer.gif" 
            width=7 border=0></TD>
          <TD bgColor=#dad9ee><IMG 
        ...
        <TR bgColor=#b8b7d7>
          ...
          <TD bgColor=#b8b7d7><IMG 
            src="<%=request.getContextPath()%>/img/common/spacer.gif" 
            width=7 border=0></TD>
          <TD noWrap bgColor=#b8b7d7><h:label id="lbl_StLocate" templateKey="W_StLocate"/></TD>
          <TD bgColor=#b8b7d7><IMG 
            src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
          <TD noWrap bgColor=#b8b7d7 colSpan=2><h:freetextbox id="txt_FromLocation" templateKey="W_Location"/>&nbsp;&nbsp; <h:label id="lbl_Range" templateKey="W_Range"/>&nbsp;&nbsp; <h:label id="lbl_EdLocate" templateKey="W_EdLocate"/><IMG 
            src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_ToLocation" templateKey="W_Location"/><h:label id="lbl_InputStyle" templateKey="W_InputStyle"/><h:label id="lbl_In_LocationStyle" templateKey="W_In_JavaSet"/></TD>
          <TD bgColor=#b8b7d7><IMG 
            src="<%=request.getContextPath()%>/img/common/spacer.gif" 
            width=7 border=0></TD>
          <TD bgColor=#dad9ee><IMG 
        ...
        <TR bgColor=#b8b7d7>
          ...
          <TD bgColor=#b8b7d7><IMG 
            src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
          <TD noWrap bgColor=#b8b7d7><h:freetextbox id="txt_ItemCode_EntEvent" templateKey="W_ItemCode_EntEvent"/><h:submitbutton id="btn_SearchItemCode" templateKey="W_P_Search"/></TD>
          <TD width="100%" bgColor=#b8b7d7>&nbsp;&nbsp; <h:label id="lbl_ItemName" templateKey="W_ItemName"/><IMG 
            src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_ItemName" templateKey="W_ItemName"/><h:submitbutton id="btn_SearchItemName" templateKey="W_P_Search"/></TD>
          <TD bgColor=#b8b7d7><IMG 
            src="<%=request.getContextPath()%>/img/common/spacer.gif" 
            width=7 border=0></TD>
          <TD bgColor=#dad9ee><IMG 
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7><h:scrolllistcell id="lst_FaShelfInquiry" templateKey="W_FaShelfInquiry"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7>&nbsp;</TD></TR>
