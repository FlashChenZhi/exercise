<%-- $Id: ItemMasterRegist.jsp 4478 2009-06-23 01:01:46Z kishimoto $ --%>
 ...
 * 
 * @version $Revision: 4478 $, $Date: 2009-06-23 10:01:46 +0900 (火, 23 6 2009) $
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_ItemCode" templateKey="W_ItemCode"/><h:label id="lbl_Require" templateKey="W_Require"/> 
                </TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_ItemCode" templateKey="W_ItemCode"/><h:submitbutton id="btn_Search" templateKey="W_P_Search"/></TD></TR>
              <TR bgColor=#b8b7d7>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:numbertextbox id="txt_LowerStockQty" templateKey="W_LowerQty"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
