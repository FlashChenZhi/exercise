<%-- $Id: FaItemMasterMnt.jsp 5986 2009-11-17 10:27:17Z fukuwa $ --%>
 ...
 * 
 * @version $Revision: 5986 $, $Date: 2009-11-17 19:27:17 +0900 (火, 17 11 2009) $
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#dad9ee>
                <TD noWrap bgColor=#dad9ee><h:label id="lbl_ItemCode_U" templateKey="W_ItemCode"/><h:label id="lbl_RequireItemCode" templateKey="W_Require"/></TD>
                <TD bgColor=#dad9ee><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#dad9ee><h:freetextbox id="txt_ItemCode_U" templateKey="W_ItemCode"/><h:submitbutton id="btn_P_SearchItemCode" templateKey="W_P_Search"/></TD></TR>
              <TR bgColor=#dad9ee>
                <TD noWrap bgColor=#dad9ee><h:label id="lbl_ProcessFlag" templateKey="W_ProcessFlag"/></TD>
                <TD bgColor=#dad9ee><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#dad9ee><h:submitbutton id="btn_Set" templateKey="W_Set5"/>&nbsp;&nbsp; 
                  <h:submitbutton id="btn_Modify" templateKey="W_Modify"/>&nbsp;&nbsp; 
                  <h:submitbutton id="btn_Delet" templateKey="W_Delet"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_ItemCode_D" templateKey="W_ItemCode"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_ItemCode_D" templateKey="W_ItemCode"/></TD></TR>
              <TR bgColor=#b8b7d7>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_UsageType" templateKey="W_UsageType"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:radiobutton id="rdo_UsageType_generally" templateKey="W_UsageType_generally"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_UsageType_temporarily" templateKey="W_UsageType_temporarily"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
