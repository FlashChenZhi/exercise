<%-- $Id: SoftZoneMasterMnt.jsp 6349 2009-12-03 10:43:38Z fukuwa $ --%>
 ...
 * 
 * @version $Revision: 6349 $, $Date: 2009-12-03 19:43:38 +0900 (木, 03 12 2009) $
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:linkedpulldown id="pul_SoftZone" templateKey="W_SoftZone"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_Range" templateKey="W_Range2"/></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_Bank" templateKey="W_Bank"/><h:label id="lbl_Ast_Bank" templateKey="W_Require"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_BankFrom" templateKey="W_Bank"/><h:label id="lbl_Range2" templateKey="W_Range"/><h:freetextbox id="txt_BankTo" templateKey="W_Bank"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_Bay" templateKey="W_Bay"/><h:label id="lbl_Ast_Bay" templateKey="W_Require"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_BayFrom" templateKey="W_Bay"/><h:label id="lbl_Range3" templateKey="W_Range"/><h:freetextbox id="txt_BayTo" templateKey="W_Bay"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_Level" templateKey="W_Level"/><h:label id="lbl_Ast_Level" templateKey="W_Require"/></TD>
                <TD bgColor=#b8b7d7><IMG 
                  src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_LevelFrom" templateKey="W_Level"/><h:label id="lbl_Range4" templateKey="W_Range"/><h:freetextbox id="txt_LevelTo" templateKey="W_Level"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp; &nbsp; </TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_ZoneMaintenanceRange" templateKey="W_ZoneMaintenanceRange"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" 
