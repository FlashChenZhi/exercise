// $Id: PCTUserResultAreaListParams.java 5329 2009-10-29 05:35:28Z shibamoto $
 ...
 */
public class PCTUserResultAreaListParams
        extends Params
{
    //------------------------------------------------------------
    ...
    /** AREA_NAME1 */
    public static final ParamKey AREA_NAME1 = new ParamKey("AREA_NAME1");

    /** AREA_NO */
    public static final ParamKey AREA_NO = new ParamKey("AREA_NO");

    /** AREA_NO1 */
    public static final ParamKey AREA_NO1 = new ParamKey("AREA_NO1");
     ...
     * Default constructor
     */
    public PCTUserResultAreaListParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public PCTUserResultAreaListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public PCTUserResultAreaListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
