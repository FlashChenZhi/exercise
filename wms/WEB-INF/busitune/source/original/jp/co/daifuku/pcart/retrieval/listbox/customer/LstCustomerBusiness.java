...
import jp.co.daifuku.pcart.retrieval.listbox.customer.LstCustomer;
        ...
        extends LstCustomer
{
    ...
    private ScrollListCellModel _lcm_lst_CustomerList;
            ...
            throws Exception
    {
        ...
        _lcm_lst_CustomerList = new ScrollListCellModel(lst_CustomerList, LST_CUSTOMERLIST_KEYS, locale);
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            inparam.set(LstCustomerDASCHParams.REGULAR_CUSTOMER_CODE, requestParam.get(LstCustomerParams.REGULAR_CUSTOMER_CODE));
