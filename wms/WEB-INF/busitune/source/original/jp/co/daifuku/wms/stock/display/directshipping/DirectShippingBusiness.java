// $Id: DirectShippingBusiness.java 7443 2010-03-08 04:18:39Z okayama $
...
import jp.co.daifuku.wms.stock.display.directshipping.DirectShipping;
import jp.co.daifuku.wms.stock.display.directshipping.ViewStateKeys;
        ...
        extends DirectShipping
{
    ...
    private static final ListCellKey KEY_LST_SHIPPING_AREA = new ListCellKey("LST_SHIPPING_AREA", new AreaCellColumn(), true, false);
    ...
    private static final ListCellKey KEY_LST_SHIPPING_CASE_QTY = new ListCellKey("LST_SHIPPING_CASE_QTY", new NumberCellColumn(0), true, false);

    /** lst_NoPlanShipping(LST_SHIPPING_PIECE_QTY) */
    private static final ListCellKey KEY_LST_SHIPPING_PIECE_QTY = new ListCellKey("LST_SHIPPING_PIECE_QTY", new NumberCellColumn(0), true, false);
    ...
    {
        // process call.
        btn_ShippingStart_Click_Process();
    }
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            {
                viewState.setObject(ViewStateKeys.MASTER, outparam.get(DirectShippingSCHParams.MASTER_FLAG));
            }
     ...
     * @throws Exception
     */
    private void btn_ShippingStart_Click_Process()
            throws Exception
    {
        // get locale.
        DfkUserInfo ui = (DfkUserInfo)getUserInfo();
        ...
        try
        {
            ...
            for (int i = 1; i <= _lcm_lst_NoPlanShipping.size(); i++)
            {
                ...
                lineparam.set(DirectShippingSCHParams.HARD_WARE_TYPE, "");
                inparamList.add(lineparam);
            }
