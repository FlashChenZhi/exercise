// $Id: PCTRetWorkingInquiryBusiness.java 5329 2009-10-29 05:35:28Z shibamoto $
...
import jp.co.daifuku.pcart.retrieval.display.pctretworkinginquiry.PCTRetWorkingInquiry;
        ...
        extends PCTRetWorkingInquiry
{
            ...
            throws Exception
    {
        ...
        inparam.set(LstUserIdParams.USER, txt_User.getValue());
            ...
            throws Exception
    {
        ...
        txt_User.setValue(outparam.get(LstUserIdParams.USER));
            ...
            throws Exception
    {
        ...
        redirect("/pcart/retrieval/listbox/pctretworkinginquiry/LstPCTRetWorkingInquiry.do", forwardParam, "/Progress.do");
    }
            ...
            throws Exception
    {
        ...
        txt_ConsignorName.validate(this, false);
        ...
        txt_RegularCustomerName.validate(this, false);
        ...
        pul_WorkStatus.validate(this, false);
        ...
        try
        {
            ...
            inparam.set(PCTRetWorkingInquiryDASCHParams.CONSIGNOR_NAME, txt_ConsignorName.getValue());
            ...
            inparam.set(PCTRetWorkingInquiryDASCHParams.REGULAR_CUSTOMER_NAME, txt_RegularCustomerName.getValue());
            inparam.set(PCTRetWorkingInquiryDASCHParams.CUSTOMER_CODE, txt_CustomerCode.getValue());
            inparam.set(PCTRetWorkingInquiryDASCHParams.CUSTOMER_NAME, txt_CustomerName.getValue());
            ...
            inparam.set(PCTRetWorkingInquiryDASCHParams.ITEM_NAME, txt_ItemName.getValue());
            ...
            inparam.set(PCTRetWorkingInquiryDASCHParams.USER_NAME, txt_UserName.getValue());
            ...
            while (dasch.next())
            {
                ...
                expparam.set(PctRetWorkingInqListParams.REGULAR_CUSTOMER_CODE, outparam.get(PCTRetWorkingInquiryDASCHParams.REGULAR_CUSTOMER_CODE));
                expparam.set(PctRetWorkingInqListParams.REGULAR_CUSTOMER_NAME, outparam.get(PCTRetWorkingInquiryDASCHParams.REGULAR_CUSTOMER_NAME));
                ...
                expparam.set(PctRetWorkingInqListParams.PLAN_AREA_NO, outparam.get(PCTRetWorkingInquiryDASCHParams.PLAN_AREA_NO));
                expparam.set(PctRetWorkingInqListParams.PLAN_ZONE_NO, outparam.get(PCTRetWorkingInquiryDASCHParams.PLAN_ZONE_NO));
                expparam.set(PctRetWorkingInqListParams.PLAN_LOCATION_NO, outparam.get(PCTRetWorkingInquiryDASCHParams.PLAN_LOCATION_NO));
