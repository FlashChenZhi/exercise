// $Id: LstAsStoragePlanBusiness.java 6805 2010-01-22 10:46:39Z kanda $
...
import jp.co.daifuku.wms.asrs.listbox.storageplan.LstAsStoragePlan;
 ...
 *
 * @version $Revision: 6805 $, $Date:: 2010-01-22 19:46:39 +0900#$
        ...
        extends LstAsStoragePlan
{
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            inparam.set(LstAsStoragePlanDASCHParams.CONSIGNOR_CODE, requestParam.get(LstAsStoragePlanParams.CONSIGNOR_CODE));
