// $Id: StorageStartListParams.java 5290 2009-10-28 04:29:37Z kishimoto $
 ...
 */
public class StorageStartListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * @throws IOException
     */
    public StorageStartListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public StorageStartListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
