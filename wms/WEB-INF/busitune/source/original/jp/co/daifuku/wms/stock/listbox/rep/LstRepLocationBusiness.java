// $Id: LstRepLocationBusiness.java 6825 2010-01-22 10:55:42Z kanda $
...
import jp.co.daifuku.wms.stock.listbox.rep.LstRepLocation;
 ...
 *
 * @version $Revision: 6825 $, $Date:: 2010-01-22 19:55:42 +0900#$
        ...
        extends LstRepLocation
{
    ...
    private static final ListCellKey KEY_LST_CASE_QTY = new ListCellKey("LST_CASE_QTY", new NumberCellColumn(0), true, false);
    ...
    /** lst_ReplenishmentCandidacyList keys */
            ...
            throws Exception
    {
        ...
        _lcm_lst_ReplenishmentCandidacyList = new ListCellModel(lst_ReplenishmentCandidacyList, LST_REPLENISHMENTCANDIDACYLIST_KEYS, locale);
