// $Id: AsRetrievalOrderCancelBusiness.java 7543 2010-03-15 00:25:17Z ota $
...
import jp.co.daifuku.wms.asrs.display.ordercancel.AsRetrievalOrderCancel;
import jp.co.daifuku.wms.asrs.display.ordercancel.ViewStateKeys;
        ...
        extends AsRetrievalOrderCancel
{
    ...
    private static final ListCellKey KEY_HIDDEN_LINE_COUNT = new ListCellKey("HIDDEN_LINE_COUNT", new NumberCellColumn(0), false, false);
    ...
    {
        // process call.
        btn_RetrievalCancel_Click_Process();
    }
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            AsRetrievalOrderCancelSCHParams inparam = new AsRetrievalOrderCancelSCHParams();
            ...
            inparam.set(AsRetrievalOrderCancelSCHParams.AREA, _pdm_pul_Area.getSelectedValue());
            inparam.set(AsRetrievalOrderCancelSCHParams.WORK_PLACE, _pdm_pul_WorkPlace.getSelectedValue());
     ...
     * @throws Exception
     */
    private void btn_RetrievalCancel_Click_Process()
            throws Exception
    {
        // input validation.
        ...
        try
        {
            ...
            for (int i = 1; i <= _lcm_lst_ASRSRetrievalCancel.size(); i++)
            {
                ...
                AsRetrievalOrderCancelSCHParams lineparam = new AsRetrievalOrderCancelSCHParams();
                ...
                lineparam.set(AsRetrievalOrderCancelSCHParams.BATCH_NO, viewState.getObject(ViewStateKeys.BATCH_NO));
                lineparam.set(AsRetrievalOrderCancelSCHParams.ORDER_NO_FROM, viewState.getObject(ViewStateKeys.ORDER_NO_FROM));
                lineparam.set(AsRetrievalOrderCancelSCHParams.ORDER_NO_TO, viewState.getObject(ViewStateKeys.ORDER_NO_TO));
                lineparam.set(AsRetrievalOrderCancelSCHParams.RETRIEVAL_PLAN_DATE, viewState.getObject(ViewStateKeys.RETRIEVAL_PLAN_DATE));
            ...
            inparam.set(AsRetrievalOrderCancelSCHParams.RETRIEVAL_PLAN_DATE, viewState.getObject(ViewStateKeys.RETRIEVAL_PLAN_DATE));
            inparam.set(AsRetrievalOrderCancelSCHParams.STATION, viewState.getObject(ViewStateKeys.STATION));
            inparam.set(AsRetrievalOrderCancelSCHParams.WORK_PLACE, viewState.getObject(ViewStateKeys.WORK_PLACE));
            inparam.set(AsRetrievalOrderCancelSCHParams.CONSIGNOR_CODE, viewState.getObject(ViewStateKeys.CONSIGNOR_CODE));
