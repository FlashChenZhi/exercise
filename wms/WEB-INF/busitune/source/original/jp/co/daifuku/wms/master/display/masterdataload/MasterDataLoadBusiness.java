// $Id: MasterDataLoadBusiness.java 7850 2010-04-21 05:32:46Z shibamoto $
package jp.co.daifuku.wms.master.display.masterdataload;
...
import jp.co.daifuku.wms.master.display.masterdataload.MasterDataLoad;
import jp.co.daifuku.wms.master.schedule.MasterDataLoadSCH;
import jp.co.daifuku.wms.master.schedule.MasterDataLoadSCHParams;
        ...
        extends MasterDataLoad
{
    ...
    /** lst_LoadData(LST_FILES_COUNT) */
    private static final ListCellKey KEY_LST_FILES_COUNT = new ListCellKey("LST_FILES_COUNT", new NumberCellColumn(0), true, false);
            ...
            throws Exception
    {
        ...
        _lcm_lst_LoadData.setToolTipVisible(KEY_LST_FILES_COUNT, false);
    }
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            for (Params outparam : outparams)
            {
                ...
                line.setValue(KEY_LST_FILES_COUNT, outparam.get(MasterDataLoadSCHParams.FILES_COUNT));
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            for (int i = 1; i <= _lcm_lst_LoadData.size(); i++)
            {
                ...
                lineparam.set(MasterDataLoadSCHParams.FILES_COUNT, line.getValue(KEY_LST_FILES_COUNT));
