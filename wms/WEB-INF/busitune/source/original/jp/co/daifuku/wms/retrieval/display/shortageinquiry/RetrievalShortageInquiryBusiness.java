// $Id: RetrievalShortageInquiryBusiness.java 7446 2010-03-08 04:20:52Z okayama $
...
import jp.co.daifuku.wms.retrieval.display.shortageinquiry.RetrievalShortageInquiry;
        ...
        extends RetrievalShortageInquiry
{
    ...
    private static final ListCellKey KEY_LST_PLAN_LOT_NO = new ListCellKey("LST_PLAN_LOT_NO", new StringCellColumn(), false, false);
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            for (Params outparam : outparams)
            {
                ...
                line.setValue(KEY_LST_REPLENISHMENT_CASE_QTY, outparam.get(RetrievalShortageInquiryDASCHParams.REP_CASE_QTY));
                line.setValue(KEY_LST_REPLENISHMENT_PIECE_QTY, outparam.get(RetrievalShortageInquiryDASCHParams.REP_PIECE_QTY));
                line.setValue(KEY_LST_SHORTAGE_CASE_QTY, outparam.get(RetrievalShortageInquiryDASCHParams.SHORTAGE_CASE_QTY));
                line.setValue(KEY_LST_SHORTAGE_PIECE_QTY, outparam.get(RetrievalShortageInquiryDASCHParams.SHORTAGE_PIECE_QTY));
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            while (dasch.next())
            {
                ...
                expparam.set(ShortageCheckListParams.DFK_USER_NAME, outparam.get(RetrievalShortageInquiryDASCHParams.DFK_USER_NAME));
                ...
                expparam.set(ShortageCheckListParams.ALLOCATE_NO, outparam.get(RetrievalShortageInquiryDASCHParams.ALLOCATED_PATTERN_NO));
                ...
                expparam.set(ShortageCheckListParams.CUSTOMER_CODE, outparam.get(RetrievalShortageInquiryDASCHParams.CUSTOMER_CODE));
                expparam.set(ShortageCheckListParams.CUSTOMER_NAME, outparam.get(RetrievalShortageInquiryDASCHParams.CUSTOMER_NAME));
                ...
                expparam.set(ShortageCheckListParams.PLAN_CASE_QTY, outparam.get(RetrievalShortageInquiryDASCHParams.PLAN_CASE_QTY));
                expparam.set(ShortageCheckListParams.PLAN_PIECE_QTY, outparam.get(RetrievalShortageInquiryDASCHParams.PLAN_PIECE_QTY));
                expparam.set(ShortageCheckListParams.REP_CASE_QTY, outparam.get(RetrievalShortageInquiryDASCHParams.REP_CASE_QTY));
                expparam.set(ShortageCheckListParams.REP_PIECE_QTY, outparam.get(RetrievalShortageInquiryDASCHParams.REP_PIECE_QTY));
                expparam.set(ShortageCheckListParams.SHORTAGE_CASE_QTY, outparam.get(RetrievalShortageInquiryDASCHParams.SHORTAGE_CASE_QTY));
                expparam.set(ShortageCheckListParams.SHORTAGE_PIECE_QTY, outparam.get(RetrievalShortageInquiryDASCHParams.SHORTAGE_PIECE_QTY));
