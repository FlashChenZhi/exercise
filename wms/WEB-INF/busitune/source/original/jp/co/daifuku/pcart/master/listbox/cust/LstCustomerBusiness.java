...
import jp.co.daifuku.pcart.master.listbox.cust.LstCustomer;
        ...
        extends LstCustomer
{
    ...
    private static final ListCellKey KEY_HIDDEN_JOB_PRIORITY = new ListCellKey("HIDDEN_JOB_PRIORITY", new StringCellColumn(), false, false);
    ...
    private static final ListCellKey KEY_LST_JOB_PRIORITY = new ListCellKey("LST_JOB_PRIORITY", new StringCellColumn(), true, false);

    /** lst_PCTCustomerList keys */
    ...
    private ScrollListCellModel _lcm_lst_PCTCustomerList;
            ...
            throws Exception
    {
        ...
        _lcm_lst_PCTCustomerList = new ScrollListCellModel(lst_PCTCustomerList, LST_PCTCUSTOMERLIST_KEYS, locale);
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            for (Params outparam : outparams)
            {
                ...
                line.setValue(KEY_LST_JOB_PRIORITY, outparam.get(LstCustomerDASCHParams.JOB_PRIORITY));
