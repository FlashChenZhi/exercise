...
import jp.co.daifuku.wms.system.exporter.DataLoadCheckListParams;
        ...
        extends LstHostError
{
    ...
    private static final ListCellKey KEY_LST_ITEM_NO = new ListCellKey("LST_ITEM_NO", new NumberCellColumn(0), true, false);
    ...
    private ScrollListCellModel _lcm_lst_HostError;
            ...
            throws Exception
    {
        ...
        _lcm_lst_HostError = new ScrollListCellModel(lst_HostError, LST_HOSTERROR_KEYS, locale);
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            exporter = factory.newPVExporter("DataLoadCheckList", getSession());
            ...
            for (int i = 1; i <= _lcm_lst_HostError.size(); i++)
            {
                ...
                DataLoadCheckListParams expparam = new DataLoadCheckListParams();
                expparam.set(DataLoadCheckListParams.DFK_DS_NO, "");
                expparam.set(DataLoadCheckListParams.DFK_USER_ID, "");
                expparam.set(DataLoadCheckListParams.DFK_USER_NAME, "");
                expparam.set(DataLoadCheckListParams.LOAD_TYPE, line.getValue(KEY_LST_LOAD_TYPE));
                expparam.set(DataLoadCheckListParams.SYS_DAY, "");
                expparam.set(DataLoadCheckListParams.SYS_TIME, "");
                expparam.set(DataLoadCheckListParams.FILE_NAME, line.getValue(KEY_LST_FILE_NAME));
                expparam.set(DataLoadCheckListParams.START_DAY, line.getValue(KEY_LST_START_DAY));
                expparam.set(DataLoadCheckListParams.START_TIME, line.getValue(KEY_LST_START_TIME));
                expparam.set(DataLoadCheckListParams.FILE_LINE_NO, line.getValue(KEY_LST_FILE_LINE_NO));
                expparam.set(DataLoadCheckListParams.ERROR_LEVEL, line.getValue(KEY_LST_ERROR_LEVEL));
                expparam.set(DataLoadCheckListParams.ERROR_DETAIL, line.getValue(KEY_LST_ERROR_DETAILS));
                expparam.set(DataLoadCheckListParams.ITEM_NO, line.getValue(KEY_LST_ITEM_NO));
                expparam.set(DataLoadCheckListParams.DATA, line.getValue(KEY_LST_DATA));
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            // open exporter.
            ExporterFactory factory = new WmsExporterFactory(locale, ui);
            exporter = factory.newPrinterExporter("DataLoadCheckList", false);
            exporter.open();
