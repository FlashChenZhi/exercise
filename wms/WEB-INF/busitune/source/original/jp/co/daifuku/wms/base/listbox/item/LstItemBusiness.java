// $Id: LstItemBusiness.java 5290 2009-10-28 04:29:37Z kishimoto $
...
import jp.co.daifuku.wms.base.listbox.item.LstItem;
        ...
        extends LstItem
{
    ...
    /** lst_Item(LST_ITEM_TYPE) */
    private static final ListCellKey KEY_LST_ITEM_TYPE = new ListCellKey("LST_ITEM_TYPE", new StringCellColumn(), true, false);
    ...
    private ScrollListCellModel _lcm_lst_Item;
            ...
            throws Exception
    {
        ...
        // initialize lst_Item.
        _lcm_lst_Item = new ScrollListCellModel(lst_Item, LST_ITEM_KEYS, locale);
        ...
        _lcm_lst_Item.setToolTipVisible(KEY_LST_ITEM_TYPE, false);
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            inparam.set(LstItemDASCHParams.FROM_TO_FLAG, requestParam.get(LstItemParams.FROM_TO_FLAG));
            inparam.set(LstItemDASCHParams.TO_ITEM_CODE, requestParam.get(LstItemParams.TO_ITEM_CODE));
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            for (Params outparam : outparams)
            {
                ...
                line.setValue(KEY_LST_ITEM_TYPE, outparam.get(LstItemDASCHParams.ITEM_TYPE));
            ...
            throws Exception
    {
        ...
        outparam.set(LstItemParams.ENTERING_QTY, line.getValue(KEY_HIDDEN_ENTERING_QTY));
        outparam.set(LstItemParams.JAN, line.getValue(KEY_HIDDEN_JAN));
        outparam.set(LstItemParams.ITF, line.getValue(KEY_HIDDEN_ITF));
        outparam.set(LstItemParams.UPPER_QTY, line.getValue(KEY_HIDDEN_UPPER_QTY));
        outparam.set(LstItemParams.LOWER_QTY, line.getValue(KEY_HIDDEN_LOWER_QTY));
        ...
        outparam.set(LstItemParams.SOFT_ZONE_ID, line.getValue(KEY_HIDDEN_SOFT_ZONE_ID));
        outparam.set(LstItemParams.SOFT_ZONE_NAME, line.getValue(KEY_LST_SOFTZONE_NAME));
        outparam.set(LstItemParams.ITEM_TYPE, line.getValue(KEY_LST_ITEM_TYPE));
