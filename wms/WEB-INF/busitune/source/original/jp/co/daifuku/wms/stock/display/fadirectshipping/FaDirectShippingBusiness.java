// $Id: FaDirectShippingBusiness.java 7955 2010-05-25 04:00:07Z shibamoto $
        ...
        extends FaDirectShipping
{
    ...
    private ScrollListCellModel _lcm_lst_FaNoPlanShipping;
            ...
            throws Exception
    {
        ...
        _lcm_lst_FaNoPlanShipping = new ScrollListCellModel(lst_FaNoPlanShipping, LST_FANOPLANSHIPPING_KEYS, locale);
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            inparam.set(FaDirectShippingSCHParams.ITEM_NAME, lbl_ItemName.getValue());
            ...
            inparam.set(FaDirectShippingSCHParams.SHIPPING_CASE_QTY, txt_StorageQty.getValue());
