// $Id: AsrsEmptyShelfListParams.java 5290 2009-10-28 04:29:37Z kishimoto $
 ...
 */
public class AsrsEmptyShelfListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * Default constructor
     */
    public AsrsEmptyShelfListParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public AsrsEmptyShelfListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public AsrsEmptyShelfListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
