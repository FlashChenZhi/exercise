// $Id: WorkerResultInquiryBusiness.java 7442 2010-03-08 04:17:40Z okayama $
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            while (dasch.next())
            {
                ...
                expparam.set(WorkerResultInqListParams.FROM_WORK_DAY, outparam.get(WorkerResultInquiryDASCHParams.FROM_WORK_DAY));
                expparam.set(WorkerResultInqListParams.TO_WORK_DAY, outparam.get(WorkerResultInquiryDASCHParams.TO_WORK_DAY));
                ...
                expparam.set(WorkerResultInqListParams.WORK_DETAIL, outparam.get(WorkerResultInquiryDASCHParams.WORK_DETAIL));
                expparam.set(WorkerResultInqListParams.WORK_START_TIME, outparam.get(WorkerResultInquiryDASCHParams.WORK_START_TIME));
                expparam.set(WorkerResultInqListParams.WORK_END_TIME, outparam.get(WorkerResultInquiryDASCHParams.WORK_END_TIME));
                expparam.set(WorkerResultInqListParams.REAL_WORK_TIME, outparam.get(WorkerResultInquiryDASCHParams.REAL_WORK_TIME));
                expparam.set(WorkerResultInqListParams.WORK_QTY, outparam.get(WorkerResultInquiryDASCHParams.WORK_QTY));
                expparam.set(WorkerResultInqListParams.WORK_CNT, outparam.get(WorkerResultInquiryDASCHParams.WORK_CNT));
                expparam.set(WorkerResultInqListParams.WORK_QTY_HOUR, outparam.get(WorkerResultInquiryDASCHParams.WORK_QTY_HOUR));
                expparam.set(WorkerResultInqListParams.WORK_CNT_HOUR, outparam.get(WorkerResultInquiryDASCHParams.WORK_CNT_HOUR));
                expparam.set(WorkerResultInqListParams.TERMINAL_NO, outparam.get(WorkerResultInquiryDASCHParams.TERMINAL_NO));
