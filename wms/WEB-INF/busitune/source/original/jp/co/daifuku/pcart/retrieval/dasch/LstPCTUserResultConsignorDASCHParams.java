// $Id: LstPCTUserResultConsignorDASCHParams.java 5290 2009-10-28 04:29:37Z kishimoto $
 ...
 */
public class LstPCTUserResultConsignorDASCHParams
        extends WmsDASCHParams
{
    ...
    /** AVG_CART_COUNT */
    public static final ParamKey AVG_CART_COUNT = new ParamKey("AVG_CART_COUNT");
     ...
     * Default constructor
     */
    public LstPCTUserResultConsignorDASCHParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public LstPCTUserResultConsignorDASCHParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public LstPCTUserResultConsignorDASCHParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
