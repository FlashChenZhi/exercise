// $Id: LstStockBusiness.java 6826 2010-01-22 10:55:54Z kanda $
...
import jp.co.daifuku.wms.stock.listbox.stocklist.LstStock;
import jp.co.daifuku.wms.stock.listbox.stocklist.LstStockParams;

/**
 * BusiTuneでジェネレートされたクラスです。
 * ここに具体的なクラスの説明を記述して下さい。
 *
 * @version $Revision: 6826 $, $Date:: 2010-01-22 19:55:54 +0900#$
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            for (Params outparam : outparams)
            {
                ...
                line.setValue(KEY_LST_SEARCH_CONDITION, outparam.get(LstStockDASCHParams.SEARCH_CONDITION));
                line.setValue(KEY_LST_COLUMN_2, outparam.get(LstStockDASCHParams.COLUMN_2));
                line.setValue(KEY_LST_COLUMN_3, outparam.get(LstStockDASCHParams.COLUMN_3));
                line.setValue(KEY_LST_COLUMN_4, outparam.get(LstStockDASCHParams.COLUMN_4));
