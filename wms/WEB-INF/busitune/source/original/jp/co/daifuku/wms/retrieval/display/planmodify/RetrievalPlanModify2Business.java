// $Id: RetrievalPlanModify2Business.java 7545 2010-03-15 00:25:43Z ota $
...
import jp.co.daifuku.wms.retrieval.display.planmodify.RetrievalPlanModify2;
        ...
        extends RetrievalPlanModify2
{
            ...
            throws Exception
    {
        ...
        txt_PlanCaseQty.setValue(line.getValue(KEY_LST_JAN));
        txt_PlanPieceQty.setValue(line.getValue(KEY_LST_ITF));
        txt_LotNo.setValue(line.getValue(KEY_LST_LOT_NO));
        txt_JanCode.setValue(line.getValue(KEY_LST_PLAN_CASE_QTY));
        txt_CaseITF.setValue(line.getValue(KEY_LST_PLAN_PIECE_QTY));
