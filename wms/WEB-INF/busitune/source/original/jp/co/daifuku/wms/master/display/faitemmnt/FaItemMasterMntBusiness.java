// $Id: FaItemMasterMntBusiness.java 7401 2010-03-05 12:08:12Z shibamoto $
        ...
        extends FaItemMasterMnt
{
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            part11List.add(viewState.getString(ViewStateKeys.VS_TEMPORARY_TYPE), "");
            part11Writer.createOperationLog(ui, ConvertUtil.objectToInt(viewState.getObject(ViewStateKeys.VS_PROCESS_KEY)), part11List);
