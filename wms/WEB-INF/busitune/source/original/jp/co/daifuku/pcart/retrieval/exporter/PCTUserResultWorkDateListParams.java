// $Id: PCTUserResultWorkDateListParams.java 5329 2009-10-29 05:35:28Z shibamoto $
 ...
 */
public class PCTUserResultWorkDateListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * Default constructor
     */
    public PCTUserResultWorkDateListParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public PCTUserResultWorkDateListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public PCTUserResultWorkDateListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
