// $Id: LstAsLocationStockParams.java 7404 2010-03-05 13:25:51Z shibamoto $
 ...
 */
public class LstAsLocationStockParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * デフォルトコンストラクターです。
     */
    public LstAsLocationStockParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public LstAsLocationStockParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public LstAsLocationStockParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
