// $Id: PCTUserResultConsignorListParams.java 5329 2009-10-29 05:35:28Z shibamoto $
 ...
 */
public class PCTUserResultConsignorListParams
        extends Params
{
    //------------------------------------------------------------
    ...
    /** CONSIGNOR_CODE1 */
    public static final ParamKey CONSIGNOR_CODE1 = new ParamKey("CONSIGNOR_CODE1");

    /** CONSIGNOR_NAME */
    public static final ParamKey CONSIGNOR_NAME = new ParamKey("CONSIGNOR_NAME");

    /** CONSIGNOR_NAME1 */
    public static final ParamKey CONSIGNOR_NAME1 = new ParamKey("CONSIGNOR_NAME1");
     ...
     * Default constructor
     */
    public PCTUserResultConsignorListParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public PCTUserResultConsignorListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public PCTUserResultConsignorListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
