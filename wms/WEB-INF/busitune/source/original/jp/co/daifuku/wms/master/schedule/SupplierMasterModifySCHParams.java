 ...
 */
public class SupplierMasterModifySCHParams
        extends ScheduleParams
{
    ...
    /** LAST_USE_DATE */
    public static final ParamKey LAST_USE_DATE = new ParamKey("LAST_USE_DATE");

    /** PROCESS_FLAG */
    public static final ParamKey PROCESS_FLAG = new ParamKey("PROCESS_FLAG");

    /** SETTING_NAME */
    public static final ParamKey SETTING_NAME = new ParamKey("SETTING_NAME");
     ...
     * Default constructor
     */
    public SupplierMasterModifySCHParams()
    {
        super();
    }
