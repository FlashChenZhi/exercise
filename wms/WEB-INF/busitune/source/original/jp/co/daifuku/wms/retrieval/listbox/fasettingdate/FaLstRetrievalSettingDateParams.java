 ...
 */
public class FaLstRetrievalSettingDateParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * デフォルトコンストラクターです。
     */
    public FaLstRetrievalSettingDateParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public FaLstRetrievalSettingDateParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public FaLstRetrievalSettingDateParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
