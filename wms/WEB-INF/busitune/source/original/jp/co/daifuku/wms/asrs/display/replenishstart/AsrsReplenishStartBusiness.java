// $Id: AsrsReplenishStartBusiness.java 7452 2010-03-08 04:28:56Z okayama $
...
import jp.co.daifuku.wms.asrs.display.replenishstart.AsrsReplenishStart;
import jp.co.daifuku.wms.asrs.display.replenishstart.ViewStateKeys;
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            for (int i = 1; i <= _lcm_lst_ReplenishmentStart.size(); i++)
            {
                ...
                lineparam.set(AsrsReplenishStartSCHParams.ERROR_ALLOC_CARRY, "ErrorAllocCarry");
