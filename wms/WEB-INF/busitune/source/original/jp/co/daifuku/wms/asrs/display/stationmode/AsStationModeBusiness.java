// $Id: AsStationModeBusiness.java 7423 2010-03-06 08:36:58Z shibamoto $
        ...
        extends AsStationMode
{
    ...
    private ScrollListCellModel _lcm_lst_AsStationMode;
            ...
            throws Exception
    {
        ...
        _lcm_lst_AsStationMode = new ScrollListCellModel(lst_AsStationMode, LST_ASSTATIONMODE_KEYS, locale);
            ...
            throws Exception
    {
        ...
        line.addToolTip("", KEY_HIDDEN_STATION_TYPE);
