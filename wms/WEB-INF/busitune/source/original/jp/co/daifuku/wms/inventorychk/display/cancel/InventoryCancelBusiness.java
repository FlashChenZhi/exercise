// $Id: InventoryCancelBusiness.java 7449 2010-03-08 04:24:04Z okayama $
...
import jp.co.daifuku.wms.inventorychk.display.cancel.InventoryCancel;
        ...
        extends InventoryCancel
{
    ...
    private static final ListCellKey KEY_HIDDEN_LASTUPDATE_DATE = new ListCellKey("HIDDEN_LASTUPDATE_DATE", new DateCellColumn(DATE_FORMAT.LONG, TIME_FORMAT.HMS), false, false);
    ...
    private static final ListCellKey KEY_LST_CYCLE_COUNT_START_DATETIME = new ListCellKey("LST_CYCLE_COUNT_START_DATETIME", new DateCellColumn(DATE_FORMAT.LONG, TIME_FORMAT.HMS), true, false);
