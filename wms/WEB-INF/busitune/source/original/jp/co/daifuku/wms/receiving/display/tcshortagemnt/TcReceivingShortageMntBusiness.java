// $Id: TcReceivingShortageMntBusiness.java 7448 2010-03-08 04:22:42Z okayama $
...
import jp.co.daifuku.wms.receiving.display.tcshortagemnt.TcReceivingShortageMnt;
import jp.co.daifuku.wms.receiving.display.tcshortagemnt.ViewStateKeys;
        ...
        extends TcReceivingShortageMnt
{
    ...
    private static final ListCellKey KEY_LST_HIDDEN_LAST_UPDATEDATE_KEY = new ListCellKey("LST_HIDDEN_LAST_UPDATEDATE_KEY", new DateCellColumn(DATE_FORMAT.LONG, TIME_FORMAT.HMS), false, false);
    ...
    {
        // process call.
        btn_ShortageDecision_Click_Process();
    }
    ...
    {
        // process call.
        btn_ShortageCancel_Click_Process();
    }
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            TcReceivingShortageMntSCHParams inparam = new TcReceivingShortageMntSCHParams();
     ...
     * @throws Exception
     */
    private void btn_ShortageDecision_Click_Process()
            throws Exception
    {
        // input validation.
        ...
        try
        {
            ...
            for (int i = 1; i <= _lcm_lst_ReceivingShortageMnt.size(); i++)
            {
                ...
                TcReceivingShortageMntSCHParams lineparam = new TcReceivingShortageMntSCHParams();
     ...
     * @throws Exception
     */
    private void btn_ShortageCancel_Click_Process()
            throws Exception
    {
        // input validation.
        boolean existEditedRow = false;
