 ...
 */
public class StockByLocationListParams
        extends Params
{
    //------------------------------------------------------------
    ...
    /** SEARCH_ITEM_CODE */
    public static final ParamKey SEARCH_ITEM_CODE = new ParamKey("SEARCH_ITEM_CODE");

    /** SEARCH_LOCATION_STATUS */
    public static final ParamKey SEARCH_LOCATION_STATUS = new ParamKey("SEARCH_LOCATION_STATUS");
     ...
     * Default constructor
     */
    public StockByLocationListParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public StockByLocationListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public StockByLocationListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
