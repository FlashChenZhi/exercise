// $Id: PCTItemDelete2Business.java 5290 2009-10-28 04:29:37Z kishimoto $
...
import jp.co.daifuku.pcart.master.display.pctitemdelete.PCTItemDelete2;
        ...
        extends PCTItemDelete2
{
     ...
     * @throws Exception
     */
    private void btn_Start_Click_Process(boolean confirm)
            throws Exception
    {
        // get locale.
        DfkUserInfo ui = (DfkUserInfo)getUserInfo();
        ...
        try
        {
            ...
            inparam.set(PCTItemDelete2SCHParams.LAST_UPDATE_DATE, txt_R_FileCreationDate.getValue());
