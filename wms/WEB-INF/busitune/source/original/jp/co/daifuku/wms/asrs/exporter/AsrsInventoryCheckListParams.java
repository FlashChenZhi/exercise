// $Id: AsrsInventoryCheckListParams.java 5290 2009-10-28 04:29:37Z kishimoto $
 ...
 */
public class AsrsInventoryCheckListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * Default constructor
     */
    public AsrsInventoryCheckListParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public AsrsInventoryCheckListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public AsrsInventoryCheckListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
