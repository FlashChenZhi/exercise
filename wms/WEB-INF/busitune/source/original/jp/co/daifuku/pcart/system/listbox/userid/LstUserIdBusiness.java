...
import jp.co.daifuku.pcart.system.listbox.userid.LstUserId;
        ...
        extends LstUserId
{
    ...
    private static final ListCellKey KEY_LST_ROLE_ID = new ListCellKey("LST_ROLE_ID", new StringCellColumn(), true, false);
    ...
    private ScrollListCellModel _lcm_lst_UserIdList;
            ...
            throws Exception
    {
        ...
        _lcm_lst_UserIdList = new ScrollListCellModel(lst_UserIdList, LST_USERIDLIST_KEYS, locale);
