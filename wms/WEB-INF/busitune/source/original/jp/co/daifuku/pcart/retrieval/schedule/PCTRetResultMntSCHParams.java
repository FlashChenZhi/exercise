 ...
 */
public class PCTRetResultMntSCHParams
        extends ScheduleParams
{
    ...
    /** BATCHSTATUS_FLAG_COMPLETION */
    public static final ParamKey BATCHSTATUS_FLAG_COMPLETION = new ParamKey("BATCHSTATUS_FLAG_COMPLETION");

    /** BATCHSTATUS_FLAG_MAINTENANCE_COMPLETION */
    public static final ParamKey BATCHSTATUS_FLAG_MAINTENANCE_COMPLETION = new ParamKey("BATCHSTATUS_FLAG_MAINTENANCE_COMPLETION");
     ...
     * Default constructor
     */
    public PCTRetResultMntSCHParams()
    {
        super();
    }
