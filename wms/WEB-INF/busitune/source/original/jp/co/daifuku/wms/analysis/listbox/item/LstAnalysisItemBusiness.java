// $Id: LstAnalysisItemBusiness.java 6808 2010-01-22 10:48:44Z kanda $
...
import jp.co.daifuku.wms.analysis.listbox.item.LstAnalysisItem;
 ...
 *
 * @version $Revision: 6808 $, $Date:: 2010-01-22 19:48:44 +0900#$
        ...
        extends LstAnalysisItem
{
    ...
    /** lst_Item(LST_COLUMN_5) */
    private static final ListCellKey KEY_LST_COLUMN_5 = new ListCellKey("LST_COLUMN_5", new StringCellColumn(), true, false);
            ...
            throws Exception
    {
        ...
        _lcm_lst_Item.setToolTipVisible(KEY_LST_COLUMN_5, false);
    }
