// $Id: AreaModifyBusiness.java 5290 2009-10-28 04:29:37Z kishimoto $
...
import jp.co.daifuku.wms.master.display.areamodify.AreaModify;
 ...
 */
public class AreaModifyBusiness
        extends AreaModify
{
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            inparam.set(AreaModifySCHParams.AREA_NO, _pdm_pul_Area.getSelectedValue());
            ...
            // forward.
            forward("/master/areamodify/AreaModify2.do");
        }
        catch (Exception ex)
        {
            ex.printStackTrace();
