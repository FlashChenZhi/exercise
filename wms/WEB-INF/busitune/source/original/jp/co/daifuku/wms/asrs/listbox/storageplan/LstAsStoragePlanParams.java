// $Id: LstAsStoragePlanParams.java 5290 2009-10-28 04:29:37Z kishimoto $
 ...
 */
public class LstAsStoragePlanParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * @throws IOException
     */
    public LstAsStoragePlanParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public LstAsStoragePlanParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
