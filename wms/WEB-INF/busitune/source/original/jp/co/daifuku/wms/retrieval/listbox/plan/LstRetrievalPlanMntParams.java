// $Id: LstRetrievalPlanMntParams.java 5290 2009-10-28 04:29:37Z kishimoto $
 ...
 */
public class LstRetrievalPlanMntParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * デフォルトコンストラクターです。
     */
    public LstRetrievalPlanMntParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public LstRetrievalPlanMntParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public LstRetrievalPlanMntParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
