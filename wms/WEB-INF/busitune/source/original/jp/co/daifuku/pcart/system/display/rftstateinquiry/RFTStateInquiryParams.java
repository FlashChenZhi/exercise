// $Id: RFTStateInquiryParams.java 5290 2009-10-28 04:29:37Z kishimoto $
 ...
 */
public class RFTStateInquiryParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * @throws IOException
     */
    public RFTStateInquiryParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public RFTStateInquiryParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
