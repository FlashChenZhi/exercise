// $Id: LstPCTRetResultWorkInquiryBusiness.java 5329 2009-10-29 05:35:28Z shibamoto $
...
import jp.co.daifuku.pcart.retrieval.listbox.pctretresultworkinquiry.LstPCTRetResultWorkInquiry;
        ...
        extends LstPCTRetResultWorkInquiry
{
    ...
    private static final ListCellKey KEY_LST_WORK_DAY = new ListCellKey("LST_WORK_DAY", new DateCellColumn(DATE_FORMAT.LONG, null), true, false);
    ...
    /** lst_PCTRetResultWorkInquiry keys */
            ...
            throws Exception
    {
        ...
        _lcm_lst_PCTRetResultWorkInquiry = new ListCellModel(lst_PCTRetResultWorkInquiry, LST_PCTRETRESULTWORKINQUIRY_KEYS, locale);
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            inparam.set(LstPCTRetResultWorkInquiryDASCHParams.CONSIGNOR_CODE, requestParam.get(LstPCTRetResultWorkInquiryParams.CONSIGNOR_CODE));
            inparam.set(LstPCTRetResultWorkInquiryDASCHParams.WORK_DAY, requestParam.get(LstPCTRetResultWorkInquiryParams.WORK_DAY));
            inparam.set(LstPCTRetResultWorkInquiryDASCHParams.BATCH_NO, requestParam.get(LstPCTRetResultWorkInquiryParams.BATCH_NO));
            inparam.set(LstPCTRetResultWorkInquiryDASCHParams.BATCH_SEQ_NO, requestParam.get(LstPCTRetResultWorkInquiryParams.BATCH_SEQ_NO));
            inparam.set(LstPCTRetResultWorkInquiryDASCHParams.AREA_NO, requestParam.get(LstPCTRetResultWorkInquiryParams.AREA_NO));
            inparam.set(LstPCTRetResultWorkInquiryDASCHParams.REGULAR_CUSTOMER_CODE, requestParam.get(LstPCTRetResultWorkInquiryParams.REGULAR_CUSTOMER_CODE));
            inparam.set(LstPCTRetResultWorkInquiryDASCHParams.CUSTOMER_CODE, requestParam.get(LstPCTRetResultWorkInquiryParams.CUSTOMER_CODE));
            inparam.set(LstPCTRetResultWorkInquiryDASCHParams.ORDER_NO, requestParam.get(LstPCTRetResultWorkInquiryParams.ORDER_NO));
            inparam.set(LstPCTRetResultWorkInquiryDASCHParams.ITEM_CODE, requestParam.get(LstPCTRetResultWorkInquiryParams.ITEM_CODE));
            inparam.set(LstPCTRetResultWorkInquiryDASCHParams.JOB_STATUS, requestParam.get(LstPCTRetResultWorkInquiryParams.JOB_STATUS));
            inparam.set(LstPCTRetResultWorkInquiryDASCHParams.USER_ID, requestParam.get(LstPCTRetResultWorkInquiryParams.USER_ID));
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            for (Params outparam : outparams)
            {
                ...
                line.setValue(KEY_HIDDEN_CONSIGNOR_CODE, outparam.get(LstPCTRetResultWorkInquiryDASCHParams.CONSIGNOR_CODE));
                line.setValue(KEY_HIDDEN_CONSIGNOR_NAME, outparam.get(LstPCTRetResultWorkInquiryDASCHParams.CONSIGNOR_NAME));
                line.setValue(KEY_HIDDEN_REGULAR_CUSTOMER_CODE, outparam.get(LstPCTRetResultWorkInquiryDASCHParams.REGULAR_CUSTOMER_CODE));
                line.setValue(KEY_HIDDEN_CUSTOMER_CODE, outparam.get(LstPCTRetResultWorkInquiryDASCHParams.CUSTOMER_CODE));
                ...
                line.setValue(KEY_LST_REGULAR_CUSTOMER_NAME, outparam.get(LstPCTRetResultWorkInquiryDASCHParams.REGULAR_CUSTOMER_NAME));
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            for (int i = 1; i <= _lcm_lst_PCTRetResultWorkInquiry.size(); i++)
            {
                ...
                expparam.set(PctRetResultWorkInqListParams.SYS_DAY, "");
                expparam.set(PctRetResultWorkInqListParams.SYS_TIME, "");
