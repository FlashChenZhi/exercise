// $Id: ItemMasterModify2Business.java 7575 2010-03-15 09:46:22Z okayama $
...
import jp.co.daifuku.wms.master.display.itemmodify.ItemMasterModify2;
        ...
        extends ItemMasterModify2
{
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            part11List.add(viewState.getString(ViewStateKeys.VS_CASE_ENTERING_QTY), "0");
            part11List.add(viewState.getString(ViewStateKeys.VS_JAN_CODE), "");
            part11List.add(viewState.getString(ViewStateKeys.VS_CASE_ITF), "");
            part11List.add(viewState.getString(ViewStateKeys.VS_UPPER_STOCK_QTY), "0");
            part11List.add(viewState.getString(ViewStateKeys.VS_LOWER_STOCK_QTY), "0");
