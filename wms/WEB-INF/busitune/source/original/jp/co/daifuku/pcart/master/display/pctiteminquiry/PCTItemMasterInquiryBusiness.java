// $Id: PCTItemMasterInquiryBusiness.java 5329 2009-10-29 05:35:28Z shibamoto $
...
import jp.co.daifuku.pcart.master.display.pctiteminquiry.PCTItemMasterInquiry;
        ...
        extends PCTItemMasterInquiry
{
            ...
            throws Exception
    {
        ...
        inparam.set(PCTLstItemParams.SEARCHTABLE, InParameter.SEARCH_TABLE_MASTER);
        inparam.set(PCTLstItemParams.TO_ITEM_CODE, txt_ItemCode2.getValue());
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            while (dasch.next())
            {
                ...
                expparam.set(PCTItemMasterListParams.LOCATION_NO, outparam.get(PCTItemMasterInquiryDASCHParams.LOCATION_NO));
                expparam.set(PCTItemMasterListParams.SINGLE_WEIGHT, outparam.get(PCTItemMasterInquiryDASCHParams.SINGLE_WEIGHT));
                expparam.set(PCTItemMasterListParams.WEGHT_DISTINCT_RATE, outparam.get(PCTItemMasterInquiryDASCHParams.WEIGHT_DISTINCT_RATE));
                expparam.set(PCTItemMasterListParams.MAX_INSPECTION_UNIT_QTY, outparam.get(PCTItemMasterInquiryDASCHParams.MAX_INSPECTION_UNIT_QTY));
                ...
                expparam.set(PCTItemMasterListParams.ITEM_PICTURE_FLAG, outparam.get(PCTItemMasterInquiryDASCHParams.ITEM_PICTURE_REGIST));
