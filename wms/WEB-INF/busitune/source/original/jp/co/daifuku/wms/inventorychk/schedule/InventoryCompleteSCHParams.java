        ...
        extends ScheduleParams
{
    ...
    /** CURRENT_STOCK_CASE_QTY */
    public static final ParamKey CURRENT_STOCK_CASE_QTY = new ParamKey("CURRENT_STOCK_CASE_QTY");

    /** CURRENT_STOCK_PIECE_QTY */
    public static final ParamKey CURRENT_STOCK_PIECE_QTY = new ParamKey("CURRENT_STOCK_PIECE_QTY");

    /** CYCLE_COUNT_CASE_QTY */
    public static final ParamKey CYCLE_COUNT_CASE_QTY = new ParamKey("CYCLE_COUNT_CASE_QTY");

    /** CYCLE_COUNT_PIECE_QTY */
    public static final ParamKey CYCLE_COUNT_PIECE_QTY = new ParamKey("CYCLE_COUNT_PIECE_QTY");
