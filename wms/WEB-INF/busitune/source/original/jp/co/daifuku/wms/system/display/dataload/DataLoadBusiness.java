// $Id: DataLoadBusiness.java 7850 2010-04-21 05:32:46Z shibamoto $
package jp.co.daifuku.wms.system.display.dataload;
...
import jp.co.daifuku.wms.system.display.dataload.DataLoad;
import jp.co.daifuku.wms.system.schedule.DataLoadSCH;
import jp.co.daifuku.wms.system.schedule.DataLoadSCHParams;
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            for (Params outparam : outparams)
            {
                ...
                line.setValue(KEY_LST_FILES_COUNT, outparam.get(DataLoadSCHParams.FILES_COUNT));
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            for (int i = 1; i <= _lcm_lst_LoadData.size(); i++)
            {
                ...
                lineparam.set(DataLoadSCHParams.FILES_COUNT, line.getValue(KEY_LST_FILES_COUNT));
