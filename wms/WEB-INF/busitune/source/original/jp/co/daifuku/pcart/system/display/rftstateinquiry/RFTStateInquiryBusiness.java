// $Id: RFTStateInquiryBusiness.java 7955 2010-05-25 04:00:07Z shibamoto $
...
import jp.co.daifuku.pcart.system.display.rftstateinquiry.RFTStateInquiry;
import jp.co.daifuku.pcart.system.display.rftstateinquiry.ViewStateKeys;
        ...
        extends RFTStateInquiry
{
    ...
    private static final ListCellKey KEY_LST_TERMINAL_FLAG = new ListCellKey("LST_TERMINAL_FLAG", new StringCellColumn(), true, false);
            ...
            throws Exception
    {
        ...
        _grp_rdo_CollectCondition = new RadioButtonGroup(new RadioButton[]{rdo_DisplayOder_Area, rdo_DisplayOder_RFTNo}, locale);
