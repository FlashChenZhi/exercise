// $Id: LstAsCarryNoBtnBusiness.java 6796 2010-01-22 10:43:24Z kanda $
...
import jp.co.daifuku.wms.asrs.listbox.carrynobtn.LstAsCarryNoBtn;
 ...
 *
 * @version $Revision: 6796 $, $Date:: 2010-01-22 19:43:24 +0900#$
        ...
        extends LstAsCarryNoBtn
{
    ...
    private ScrollListCellModel _lcm_lst_RestWorkNoButtonList;
            ...
            throws Exception
    {
        ...
        _lcm_lst_RestWorkNoButtonList = new ScrollListCellModel(lst_RestWorkNoButtonList, LST_RESTWORKNOBUTTONLIST_KEYS, locale);
            ...
            throws Exception
    {
        ...
        line.addToolTip("", KEY_HDN_SOURCE_STATION_NAME);
        line.addToolTip("", KEY_HDN_DEST_STATION_NAME);
        line.addToolTip("", KEY_HDN_WORK_TYPE);
        line.addToolTip("", KEY_HDN_RETRIEVAL_DETAIL);
