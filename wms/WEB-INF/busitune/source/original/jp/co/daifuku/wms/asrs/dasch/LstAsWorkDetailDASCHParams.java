// $Id: LstAsWorkDetailDASCHParams.java 5290 2009-10-28 04:29:37Z kishimoto $
 ...
 */
public class LstAsWorkDetailDASCHParams
        extends WmsDASCHParams
{
    ...
    //------------------------------------------------------------
    /** ALLOC */
    public static final ParamKey ALLOC = new ParamKey("ALLOC");
     ...
     * Default constructor
     */
    public LstAsWorkDetailDASCHParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public LstAsWorkDetailDASCHParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public LstAsWorkDetailDASCHParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
