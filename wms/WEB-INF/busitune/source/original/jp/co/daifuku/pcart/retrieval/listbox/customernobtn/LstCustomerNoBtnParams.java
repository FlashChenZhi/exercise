// $Id: LstCustomerNoBtnParams.java 5290 2009-10-28 04:29:37Z kishimoto $
 ...
 */
public class LstCustomerNoBtnParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * @throws IOException
     */
    public LstCustomerNoBtnParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public LstCustomerNoBtnParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
