// $Id: ItemMasterListParams.java 5290 2009-10-28 04:29:37Z kishimoto $
package jp.co.daifuku.wms.master.exporter;
 ...
 */
public class ItemMasterListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * @throws IOException
     */
    public ItemMasterListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public ItemMasterListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
