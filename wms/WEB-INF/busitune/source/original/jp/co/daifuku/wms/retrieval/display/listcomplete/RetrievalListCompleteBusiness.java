// $Id: RetrievalListCompleteBusiness.java 7846 2010-04-21 05:10:31Z shibamoto $
...
import jp.co.daifuku.wms.retrieval.display.listcomplete.RetrievalListComplete;
import jp.co.daifuku.wms.retrieval.display.listcomplete.ViewStateKeys;
 ...
 *
 * @version $Revision: 7846 $, $Date:: 2010-04-21 14:10:31 +0900#$
        ...
        extends RetrievalListComplete
{
            ...
            throws Exception
    {
        ...
        line.addToolTip("", KEY_HIDDEN_PLAN_AREA_NAME);
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            for (Params outparam : outparams)
            {
                ...
                line.setValue(KEY_HIDDEN_PLAN_LOT, outparam.get(RetrievalListCompleteSCHParams.PLAN_LOT));
                ...
                line.setValue(KEY_LST_ITEM_CODE, outparam.get(RetrievalListCompleteSCHParams.CODE));
                line.setValue(KEY_LST_ITEM_NAME, outparam.get(RetrievalListCompleteSCHParams.NAME));
                line.setValue(KEY_LST_PLAN_LOT_NO, outparam.get(RetrievalListCompleteSCHParams.LOT_NO));
                line.setValue(KEY_LST_ENTERING_QTY, outparam.get(RetrievalListCompleteSCHParams.QTY));
                line.setValue(KEY_LST_PLAN_CASE_QTY, outparam.get(RetrievalListCompleteSCHParams.CASE_QTY));
                line.setValue(KEY_LST_PLAN_PIECE_QTY, outparam.get(RetrievalListCompleteSCHParams.PIECE_QTY));
                line.setValue(KEY_LST_RESULT_CASE_QTY, outparam.get(RetrievalListCompleteSCHParams.CASE_QTY));
                line.setValue(KEY_LST_RESULT_PIECE_QTY, outparam.get(RetrievalListCompleteSCHParams.PIECE_QTY));
                ...
                txt_LRRetrievalPlanDate.setValue(outparam.get(RetrievalListCompleteSCHParams.LR_RETRIEVAL_PLAN_DATE));
                txt_LRListWorkNo.setValue(outparam.get(RetrievalListCompleteSCHParams.LR_LIST_WORK_NO));
                txt_OrderNo.setValue(outparam.get(RetrievalListCompleteSCHParams.ORDER_NO));
                viewState.setObject(ViewStateKeys.CONSIGNOR_CODE, outparam.get(RetrievalListCompleteSCHParams.CONSIGNOR_CODE));
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            for (int i = 1; i <= _lcm_lst_RetrievalListResultInput.size(); i++)
            {
                ...
                lineparam.set(RetrievalListCompleteSCHParams.PLAN_LOT, line.getValue(KEY_HIDDEN_PLAN_LOT));
                ...
                lineparam.set(RetrievalListCompleteSCHParams.CODE, line.getValue(KEY_LST_ITEM_CODE));
                lineparam.set(RetrievalListCompleteSCHParams.NAME, line.getValue(KEY_LST_ITEM_NAME));
                lineparam.set(RetrievalListCompleteSCHParams.LOT_NO, line.getValue(KEY_LST_PLAN_LOT_NO));
                lineparam.set(RetrievalListCompleteSCHParams.QTY, line.getValue(KEY_LST_ENTERING_QTY));
                lineparam.set(RetrievalListCompleteSCHParams.CASE_QTY, line.getValue(KEY_LST_PLAN_CASE_QTY));
                lineparam.set(RetrievalListCompleteSCHParams.PIECE_QTY, line.getValue(KEY_LST_PLAN_PIECE_QTY));
                lineparam.set(RetrievalListCompleteSCHParams.CASE_QTY, line.getValue(KEY_LST_RESULT_CASE_QTY));
                lineparam.set(RetrievalListCompleteSCHParams.PIECE_QTY, line.getValue(KEY_LST_RESULT_PIECE_QTY));
                lineparam.set(RetrievalListCompleteSCHParams.SHORTAGE, line.getValue(KEY_LST_SHORTAGE));
                lineparam.set(RetrievalListCompleteSCHParams.INITIAL_INPUT_RETRIEVAL_NO, viewState.getObject(ViewStateKeys.INITIAL_INPUT_RETRIEVAL_NO));
                lineparam.set(RetrievalListCompleteSCHParams.LIST_WORK_NO, viewState.getObject(ViewStateKeys.LIST_WORK_NO));
                lineparam.set(RetrievalListCompleteSCHParams.RETRIEVAL_PLAN_DATE, viewState.getObject(ViewStateKeys.RETRIEVAL_PLAN_DATE));
                lineparam.set(RetrievalListCompleteSCHParams.LR_LIST_WORK_NO, txt_LRListWorkNo.getValue());
            ...
            for (int i = 1; i <= _lcm_lst_RetrievalListResultInput.size(); i++)
            {
                ...
                if (lst_RetrievalListResultInput.getChecked(_lcm_lst_RetrievalListResultInput.getColumnIndex(KEY_LST_SHORTAGE)))
                {
                    part11List.add("1", "");
                }
                else
            ...
            throws Exception
    {
        ...
        for (int i = 1; i <= _lcm_lst_RetrievalListResultInput.size(); i++)
        {
            ...
            lst_RetrievalListResultInput.setCurrentRow(i);
            clearLine.setValue(KEY_LST_RESULT_CASE_QTY, null);
            clearLine.setValue(KEY_LST_RESULT_PIECE_QTY, null);
