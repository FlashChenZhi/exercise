// $Id: PCTRetRftNoWorkInquiryBusiness.java 5329 2009-10-29 05:35:28Z shibamoto $
...
import jp.co.daifuku.pcart.retrieval.display.pctretrftnoworkinquiry.PCTRetRftNoWorkInquiry;
        ...
        extends PCTRetRftNoWorkInquiry
{
            ...
            throws Exception
    {
        ...
        redirect("/pcart/retrieval/listbox/pctretrftnoworkinquiry/LstPCTRetRftNoWorkInquiry.do", forwardParam, "/Progress.do");
    }
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            while (dasch.next())
            {
                ...
                expparam.set(PctRetRftNoWorkInqListParams.REGULAR_CUSTOMER_CODE, outparam.get(PCTRetRftNoWorkInquiryDASCHParams.REGULAR_CUSTOMER_CODE));
                expparam.set(PctRetRftNoWorkInqListParams.REGULAR_CUSTOMER_NAME, outparam.get(PCTRetRftNoWorkInquiryDASCHParams.REGULAR_CUSTOMER_NAME));
                ...
                expparam.set(PctRetRftNoWorkInqListParams.PLAN_LOCATION_NO, outparam.get(PCTRetRftNoWorkInquiryDASCHParams.PLAN_LOCATION));
