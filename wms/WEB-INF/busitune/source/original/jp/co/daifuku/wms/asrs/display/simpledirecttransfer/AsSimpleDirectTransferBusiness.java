...
import jp.co.daifuku.wms.asrs.display.simpledirecttransfer.AsSimpleDirectTransfer;
        ...
        extends AsSimpleDirectTransfer
{
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            _pdm_pul_FromStation.init(conn, StationType.DIRECT_TRANSFER_FROM, Distribution.UNUSE, Distribution.UNUSE);
