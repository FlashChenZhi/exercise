// $Id: InventoryCompleteBusiness.java 7449 2010-03-08 04:24:04Z okayama $
...
import jp.co.daifuku.wms.inventorychk.display.complete.InventoryComplete;
import jp.co.daifuku.wms.inventorychk.display.complete.ViewStateKeys;
        ...
        extends InventoryComplete
{
            ...
            throws Exception
    {
        ...
        line.addToolTip("LBL-W0141", KEY_LST_CYCLE_COUNT_PIECE_QTY);
        line.addToolTip("LBL-W0459", KEY_LST_CURRENT_STOCK_CASE_QTY);
        line.addToolTip("LBL-W0460", KEY_LST_CURRENT_STOCK_PIECE_QTY);
    }
    ...
    {
        // clear.
        rdo_LocationRange.setChecked(true);
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            inparam.set(InventoryCompleteSCHParams.AREA, _pdm_pul_Area.getSelectedValue());
            inparam.set(InventoryCompleteSCHParams.LOCATION_FROM, txt_LocationFrom.getValue());
            inparam.set(InventoryCompleteSCHParams.LOCATION_TO, txt_LocationTo.getValue());
            ...
            for (Params outparam : outparams)
            {
                ...
                lst_InventoryResult_SetLineToolTip(line);
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            inparam.set(InventoryCompleteDASCHParams.LOCATION_FROM, txt_LocationFrom.getValue());
            inparam.set(InventoryCompleteDASCHParams.LOCATION_TO, txt_LocationTo.getValue());
            ...
            while (dasch.next())
            {
                ...
                expparam.set(InventoryDifferenceListParams.DFK_DS_NO, outparam.get(InventoryCompleteDASCHParams.DFK_DS_NO));
                expparam.set(InventoryDifferenceListParams.DFK_USER_ID, outparam.get(InventoryCompleteDASCHParams.DFK_USER_ID));
                expparam.set(InventoryDifferenceListParams.DFK_USER_NAME, outparam.get(InventoryCompleteDASCHParams.DFK_USER_NAME));
                expparam.set(InventoryDifferenceListParams.AREA_NO, outparam.get(InventoryCompleteDASCHParams.AREA_NO));
                expparam.set(InventoryDifferenceListParams.AREA_NAME, outparam.get(InventoryCompleteDASCHParams.AREA_NAME));
                expparam.set(InventoryDifferenceListParams.SYS_DAY, outparam.get(InventoryCompleteDASCHParams.SYS_DAY));
                expparam.set(InventoryDifferenceListParams.SYS_TIME, outparam.get(InventoryCompleteDASCHParams.SYS_TIME));
                expparam.set(InventoryDifferenceListParams.LOCATION_NO, outparam.get(InventoryCompleteDASCHParams.LOCATION_NO));
                expparam.set(InventoryDifferenceListParams.ITEM_CODE, outparam.get(InventoryCompleteDASCHParams.ITEM_CODE));
                expparam.set(InventoryDifferenceListParams.ITEM_NAME, outparam.get(InventoryCompleteDASCHParams.ITEM_NAME));
                expparam.set(InventoryDifferenceListParams.LOT_NO, outparam.get(InventoryCompleteDASCHParams.LOT_NO));
                expparam.set(InventoryDifferenceListParams.ENTERING_QTY, outparam.get(InventoryCompleteDASCHParams.ENTERING_QTY));
                expparam.set(InventoryDifferenceListParams.BEFORE_STOCK_CASE_QTY, outparam.get(InventoryCompleteDASCHParams.BEFORE_STOCK_CASE_QTY));
                expparam.set(InventoryDifferenceListParams.BEFORE_STOCK_PIECE_QTY, outparam.get(InventoryCompleteDASCHParams.BEFORE_STOCK_PIECE_QTY));
                expparam.set(InventoryDifferenceListParams.INVENTORY_STOCK_CASE_QTY, outparam.get(InventoryCompleteDASCHParams.INVENTORY_STOCK_CASE_QTY));
                expparam.set(InventoryDifferenceListParams.INVENTORY_STOCK_PIECE_QTY, outparam.get(InventoryCompleteDASCHParams.INVENTORY_STOCK_PIECE_QTY));
                expparam.set(InventoryDifferenceListParams.AFTER_STOCK_CASE_QTY, outparam.get(InventoryCompleteDASCHParams.AFTER_STOCK_CASE_QTY));
                expparam.set(InventoryDifferenceListParams.AFTER_STOCK_PIECE_QTY, outparam.get(InventoryCompleteDASCHParams.AFTER_STOCK_PIECE_QTY));
                expparam.set(InventoryDifferenceListParams.DIFFERENCE_CASE_QTY, outparam.get(InventoryCompleteDASCHParams.DIFFERENCE_CASE_QTY));
                expparam.set(InventoryDifferenceListParams.DIFFERENCE_PIECE_QTY, outparam.get(InventoryCompleteDASCHParams.DIFFERENCE_PIECE_QTY));
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            for (int i = 1; i <= _lcm_lst_InventoryResult.size(); i++)
            {
                ...
                lineparam.set(InventoryCompleteSCHParams.AREA, line.getValue(KEY_LST_AREA));
                lineparam.set(InventoryCompleteSCHParams.LOCATION, line.getValue(KEY_LST_LOCATION));
                ...
                lineparam.set(InventoryCompleteSCHParams.LOT, line.getValue(KEY_LST_LOT));
                lineparam.set(InventoryCompleteSCHParams.CASE_PACK, line.getValue(KEY_LST_CASE_PACK));
                ...
                lineparam.set(InventoryCompleteSCHParams.CYCLE_COUNT_CASE_QTY, line.getValue(KEY_LST_CYCLE_COUNT_CASE_QTY));
                lineparam.set(InventoryCompleteSCHParams.CYCLE_COUNT_PIECE_QTY, line.getValue(KEY_LST_CYCLE_COUNT_PIECE_QTY));
                lineparam.set(InventoryCompleteSCHParams.CURRENT_STOCK_CASE_QTY, line.getValue(KEY_LST_CURRENT_STOCK_CASE_QTY));
                lineparam.set(InventoryCompleteSCHParams.CURRENT_STOCK_PIECE_QTY, line.getValue(KEY_LST_CURRENT_STOCK_PIECE_QTY));
                lineparam.set(InventoryCompleteSCHParams.LIST_WORK_NO, viewState.getObject(ViewStateKeys.LIST_WORK_NO));
                lineparam.set(InventoryCompleteSCHParams.ROW_NO, 0);
            ...
            // set input parameters.
            InventoryCompleteSCHParams inparam = new InventoryCompleteSCHParams();
            inparam.set(InventoryCompleteSCHParams.AREA, viewState.getObject(ViewStateKeys.AREA));
            inparam.set(InventoryCompleteSCHParams.INVENTORY, viewState.getObject(ViewStateKeys.INVENTORY));
