...
import jp.co.daifuku.wms.asrs.listbox.faworkdetail.FaLstAsWorkDetail;
        ...
        extends FaLstAsWorkDetail
{
    ...
    private ScrollListCellModel _lcm_lst_WorkInquiryList;
            ...
            throws Exception
    {
        ...
        _lcm_lst_WorkInquiryList = new ScrollListCellModel(lst_WorkInquiryList, LST_WORKINQUIRYLIST_KEYS, locale);
