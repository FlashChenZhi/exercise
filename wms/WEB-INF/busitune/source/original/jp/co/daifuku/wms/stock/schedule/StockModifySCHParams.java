 ...
 */
public class StockModifySCHParams
        extends ScheduleParams
{
    ...
    /** LASTUPDATEDATE */
    public static final ParamKey LASTUPDATEDATE = new ParamKey("LASTUPDATEDATE");
    ...
    /** MODIFY_CASE_QTY */
    public static final ParamKey MODIFY_CASE_QTY = new ParamKey("MODIFY_CASE_QTY");

    /** MODIFY_PIECE_QTY */
    public static final ParamKey MODIFY_PIECE_QTY = new ParamKey("MODIFY_PIECE_QTY");
    ...
    /** STOCKID */
    public static final ParamKey STOCKID = new ParamKey("STOCKID");
