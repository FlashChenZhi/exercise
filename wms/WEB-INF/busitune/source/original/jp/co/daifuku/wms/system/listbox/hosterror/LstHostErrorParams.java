 ...
 */
public class LstHostErrorParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * @throws IOException
     */
    public LstHostErrorParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public LstHostErrorParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
