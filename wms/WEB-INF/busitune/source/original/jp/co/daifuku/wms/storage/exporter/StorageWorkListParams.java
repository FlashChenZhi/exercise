// $Id: StorageWorkListParams.java 5290 2009-10-28 04:29:37Z kishimoto $
 ...
 */
public class StorageWorkListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * @throws IOException
     */
    public StorageWorkListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public StorageWorkListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
