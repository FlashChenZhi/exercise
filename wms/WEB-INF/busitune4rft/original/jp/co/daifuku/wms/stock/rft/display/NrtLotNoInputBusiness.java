 ...
 */
public class NrtLotNoInputBusiness
        extends AbstractHSBusiness
{
    ...
    //------------------------------------------------------------
    /** SCREEN_NAME */
    private static final String SCREEN_NAME = "NrtLotNoInput";
     ...
     * @return executed result
     */
    public HSResult resultLotNo_Enter(DataSheetFactory dsf, Locale locale)
    {
        // initialize DataSheets.
