 ...
 */
public class ConsignorInputBusiness
        extends AbstractHSBusiness
{
    ...
    //------------------------------------------------------------
    /** SCREEN_NAME */
    private static final String SCREEN_NAME = "ConsignorInput";
    ...
    public HSResult ent_Click(DataSheetFactory dsf, Locale locale)
    {
        ...
        // input validation.
        if (StringUtil.isBlank(consignorDataSheet.getText(ConsignorDataSheet.CONSIGNOR_CODE)))
        {
            setBeep(RftConst.BEEP);
            setFocus("ConsignorCode");
        ...
        try
        {
            ...
            inparam.set(ConsignorInputSCHParams.CONSIGNOR_CODE, consignorDataSheet.getValue(ConsignorDataSheet.CONSIGNOR_CODE));
            ...
            for (Params outparam : outparams)
            {
                ...
                commonDataSheet.setValue(CommonDataSheet.HAS_MASTER_PACK, outparam.get(ConsignorInputSCHParams.HAS_MASTER_PACK));
                break;
            }
