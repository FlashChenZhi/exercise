 ...
 */
public class ShippingShortageListDataSheet
        extends BasicDSModel
{
    ...
    //------------------------------------------------------------
    /** DATASHEET_NAME */
    private static final String DATASHEET_NAME = "ShippingShortageListDataSheet";
    ...
    /** SHORTAGE_CASE_QTY */
    public static final DSKey SHORTAGE_CASE_QTY = new DSKey("SHORTAGE_CASE_QTY", new DSNumberField(0), true);

    /** SHORTAGE_PIECE_QTY */
    public static final DSKey SHORTAGE_PIECE_QTY = new DSKey("SHORTAGE_PIECE_QTY", new DSNumberField(0), true);
     ...
     * @param locale Locale
     */
    public ShippingShortageListDataSheet(DataSheetFactory dsf, Locale locale)
    {
