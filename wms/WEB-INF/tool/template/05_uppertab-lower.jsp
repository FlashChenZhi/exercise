...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#DAD9EE">
  <tr>
    ...
    <%-- upper display --%>
    <table bgcolor="#B8B7D7" width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr height="5" bgcolor="#DAD9EE">
        <td bgcolor="#DAD9EE" colspan="2"><IMG src="<%=request.getContextPath()%>/img/common/spacer.gif" width="14px" border=0></td>           
        <td bgcolor="#DAD9EE"></td>
        <td bgcolor="#DAD9EE"></td>
        <td bgcolor="#DAD9EE"></td>
        <td bgcolor="#DAD9EE" width="100%"></td>
        <td bgcolor="#DAD9EE" colspan="2"><IMG src="<%=request.getContextPath()%>/img/common/spacer.gif" width="14px" border=0></td>
      </tr>
      <tr bgcolor="#DAD9EE">
        <td bgcolor="#DAD9EE" colspan="2"><IMG src="<%=request.getContextPath()%>/img/common/spacer.gif" width="14px" border=0></td>
      ...
      <tr bgcolor="#B8B7D7">
        ...
        <td bgcolor="#B8B7D7"><IMG src="<%=request.getContextPath()%>/img/common/spacer.gif" width="7px" border=0></td>            
        <td nowrap bgcolor="#B8B7D7"></td>
        <td bgcolor="#B8B7D7"><img src="img/common/icon_colon3.gif"></td>
        <td nowrap bgcolor="#B8B7D7"></td>
        <td bgcolor="#B8B7D7" width="100%"></td>
        <td bgcolor="#B8B7D7"><IMG src="<%=request.getContextPath()%>/img/common/spacer.gif" width="7px" border=0></td>
        <td bgcolor="#DAD9EE"><IMG src="<%=request.getContextPath()%>/img/common/spacer.gif" width="7px" border=0></td>
      </tr>
      <tr bgcolor="#B8B7D7">
    ...
    <table bgcolor="#B8B7D7" width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr bgcolor="#B8B7D7">
        <td bgcolor="#DAD9EE"><IMG src="<%=request.getContextPath()%>/img/common/spacer.gif" width="7px" border=0></td>
        <td><IMG src="<%=request.getContextPath()%>/img/common/spacer.gif" width="7px" border=0></td>
        <td>
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr bgcolor="#B8B7D7" >
              <td nowrap bgcolor="#B8B7D7">○○○</td>
