// $Id: LstRegistCustomer.java 6602 2009-12-23 01:16:12Z okayama $
 ...
 */
public class LstRegistCustomer extends Page
{
	...
	/**
	 * ControlID	lst_Customer
	 * TemplateKey	W_CustomerList
	 * ControlType	ScrollListCell
	 */
	public jp.co.daifuku.bluedog.ui.control.ScrollListCell lst_Customer = jp.co.daifuku.bluedog.ui.control.ScrollListCellFactory.getInstance("lst_Customer" , "W_CustomerList");
