// $Id: LstPCTWeightDistinctionList.java 6602 2009-12-23 01:16:12Z okayama $
 ...
 */
public class LstPCTWeightDistinctionList extends Page
{
	...
	/**
	 * ControlID	lst_PCTWeightDistinctionList
	 * TemplateKey	W_LstPCTWeightDistinctionList
	 * ControlType	ListCell
	 */
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_PCTWeightDistinctionList = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_PCTWeightDistinctionList" , "W_LstPCTWeightDistinctionList");
