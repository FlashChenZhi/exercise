// $Id: ZoneMentLocation.java 3915 2009-04-01 08:33:44Z tanaka $
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 3915 $, $Date: 2009-04-01 17:33:44 +0900 (水, 01 4 2009) $
 * @author  $Author: tanaka $
 */
public class ZoneMentLocation extends Page
{
	...
	/**
	 * ControlID	tab
	 * TemplateKey	W_ZoneMaintLocation
	 * ControlType	Tab
	 */
	public jp.co.daifuku.bluedog.ui.control.Tab tab = jp.co.daifuku.bluedog.ui.control.TabFactory.getInstance("tab" , "W_ZoneMaintLocation");
	 ...
	 * TemplateKey	W_ZoneMentLocation
	 * ControlType	ScrollListCell
	 */
	public jp.co.daifuku.bluedog.ui.control.ScrollListCell lst_ZoneMentenance = jp.co.daifuku.bluedog.ui.control.ScrollListCellFactory.getInstance("lst_ZoneMentenance" , "W_ZoneMentLocation");
