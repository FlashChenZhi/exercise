// $Id: MasterDataReportEnvironmentSCH.java 7277 2010-02-26 07:43:50Z okayama $
...
import static jp.co.daifuku.pcart.master.schedule.MasterDataReportEnvironmentSCHParams.*;
...
/**
 * マスタデータ報告環境設定のスケジュール処理を行います。
 *
 * @version $Revision: 7277 $, $Date:: 2010-02-26 16:43:50 +0900#$
 * @author  BusiTune 1.0 Generator.
 * @author  Last commit: $Author: okayama $
 */
public class MasterDataReportEnvironmentSCH
        extends AbstractSCH
{
    //------------------------------------------------------------
     ...
     */
    public MasterDataReportEnvironmentSCH(Connection conn, Class parent, Locale locale, DfkUserInfo ui) throws CommonException
    {
