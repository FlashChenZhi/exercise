// $Id: PCTItemModifyBusiness.java 4256 2009-05-12 04:47:22Z okayama $
...
/**
 * 商品マスタ修正・削除（基本情報設定）の画面処理を行います。
 *
 * @version $Revision: 4256 $, $Date:: 2009-05-12 13:47:22 +0900#$
        ...
        extends PCTItemModify
{
            ...
            throws Exception
    {
        ...
        // DFKLOOK:ここから修正
        if (viewState.getObject(ViewStateKeys.VS_LOT_QTY) != null)
        {
            txt_LotEnteringQty.setValue(Integer.valueOf(String.valueOf(viewState.getObject(ViewStateKeys.VS_LOT_QTY))));
        }

        // 前画面から戻ってきた場合はpage_Load処理は終了
