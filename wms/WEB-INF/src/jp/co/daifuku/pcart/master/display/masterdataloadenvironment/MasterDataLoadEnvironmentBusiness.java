// $Id: MasterDataLoadEnvironmentBusiness.java 7996 2011-07-06 00:52:24Z kitamaki $
        ...
        extends MasterDataLoadEnvironment
{
    ...
    */   
     ...
     * @throws Exception
     */
    public void lst_DataLoadEnvironment_Click(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_DataLoadEnvironment_ColumClick(ActionEvent e)
            throws Exception
    {
    }
            ...
            throws Exception
    {
        ...
        for (int i = 1; i <= _lcm_lst_DataLoadEnvironment.size(); i++)
        {
            ...
            lst_DataLoadEnvironment.validate(checkline.getIndex(KEY_LST_DATA_ID_NAME), true);
        }
        if (!existEditedRow)
        {
            // DFKLOOK:ここから修正
