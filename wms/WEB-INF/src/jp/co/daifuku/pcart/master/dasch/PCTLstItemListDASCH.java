// $Id: PCTLstItemListDASCH.java 4689 2009-07-16 00:23:45Z okayama $
...
import static jp.co.daifuku.pcart.master.dasch.PCTLstItemListDASCHParams.*;
...
/**
 * 商品マスタ一覧に必要なリストボックスや帳票の検索処理を行います。
 *
 * @version $Revision: 4689 $, $Date:: 2009-07-16 09:23:45 +0900#$
 * @author  BusiTune 1.0 Generator.
 * @author  Last commit: $Author: okayama $
 */
public class PCTLstItemListDASCH
        extends AbstractWmsDASCH
{
     ...
     * @param ui ユーザ情報
     */
    public PCTLstItemListDASCH(Connection conn, Class parent, Locale locale, DfkUserInfo ui)
    {
            ...
            throws CommonException
    {
        ...
        for (PCTItem ent : ents)
        {
            ...
            // 棚No.
            p.set(LOCATION_NO, WmsFormatter.toDispLocation(ent.getLocationNo1(), WmsParam.DEFAULT_LOCATE_STYLE));
            // 単重量
            p.set(SINGLE_WEIGHT, Formatter.getNumFormat(ent.getSingleWeight()));
            // 重量誤差率
            p.set(WEIGHT_DISTINCT_RATE, ent.getWeightDistinctRate());
            // 最大検品単位数
            p.set(MAX_INSPECTION_QTY, ent.getMaxInspectionUnitQty());
            // 最終更新日時
            ...
            throws CommonException
    {
        ...
        if (!param.getString(ITEM_PICTURE_REGIST).equals(DisplayText.getText("LBL-W1276")))
        {
            String pictureFlag =
                    String.valueOf(PCTDisplayUtil.getItemPictureFlag(param.getString(ITEM_PICTURE_REGIST)));
            key.setKey(_PICTURE, pictureFlag.toUpperCase());
        }
