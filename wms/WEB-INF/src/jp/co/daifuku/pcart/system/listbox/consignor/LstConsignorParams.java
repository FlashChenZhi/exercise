// $Id$
package jp.co.daifuku.pcart.system.listbox.consignor;
 ...
 */
public class LstConsignorParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * @throws IOException
     */
    public LstConsignorParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public LstConsignorParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
