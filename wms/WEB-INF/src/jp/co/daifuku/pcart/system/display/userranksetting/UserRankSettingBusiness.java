// $Id: UserRankSettingBusiness.java 7162 2010-02-19 09:32:59Z shibamoto $
        ...
        extends UserRankSetting
{
    ...
    private static final ListCellKey KEY_LST_PRE_LEVEL =
            new ListCellKey("LST_PRE_LEVEL", new StringCellColumn(), true, false);

    /** lst_UserLevelSet(LST_SET_LEVEL) */
    private static final ListCellKey KEY_LST_SET_LEVEL =
            new ListCellKey("LST_SET_LEVEL", new StringCellColumn(), true, true);

    /** lst_UserLevelSet kyes */
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            for (Params outparam : outparams)
            {
                ...
                line.setValue(KEY_LST_PRE_LEVEL,
                        DisplayResource.getLevelName(outparam.getString(UserRankSettingSCHParams.PRE_LEVEL)));
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            for (int i = 1; i <= _lcm_lst_UserLevelSet.size(); i++)
            {
                ...
                if (!line.getValue(KEY_LST_PRE_LEVEL).equals(
                        DisplayResource.getLevelName(line.getStringValue(KEY_LST_SET_LEVEL))))
                {
                    ...
                    lineparam.set(UserRankSettingSCHParams.USER_ID_FROM,
                            viewState.getObject(ViewStateKeys.VS_USER_ID_FROM));
            ...
            if (!sch.startSCH(inparams))
            {
                ...
                _lcm_lst_UserLevelSet.addHighlight(sch.getNgCellRow(), ControlColor.Warning);
