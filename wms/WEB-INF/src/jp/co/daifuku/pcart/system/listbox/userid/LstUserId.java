...
public class LstUserId extends Page
{
	...
	/**
	 * ControlID	lst_UserIdList
	 * TemplateKey	W_UserIdList
	 * ControlType	ScrollListCell
	 */
	public jp.co.daifuku.bluedog.ui.control.ScrollListCell lst_UserIdList = jp.co.daifuku.bluedog.ui.control.ScrollListCellFactory.getInstance("lst_UserIdList" , "W_UserIdList");
