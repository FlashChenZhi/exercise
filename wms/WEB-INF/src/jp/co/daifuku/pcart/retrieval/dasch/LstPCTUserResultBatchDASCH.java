// $Id: LstPCTUserResultBatchDASCH.java 5739 2009-11-12 13:28:36Z kumano $
...
import static jp.co.daifuku.pcart.retrieval.dasch.LstPCTUserResultBatchDASCHParams.*;
...
import jp.co.daifuku.pcart.retrieval.dbhandler.PCTUserResultBatchFinder;
...
/**
 * バッチ別実績照会に必要なリストボックスや帳票の検索処理を行います。
 *
 * @version $Revision: 5739 $, $Date:: 2009-11-12 22:28:36 +0900#$
 * @author  BusiTune 1.0 Generator.
 * @author  Last commit: $Author: kumano $
 */
public class LstPCTUserResultBatchDASCH
        extends AbstractWmsDASCH
{
     ...
     * @param ui ユーザ情報
     */
    public LstPCTUserResultBatchDASCH(Connection conn, Class parent, Locale locale, DfkUserInfo ui)
    {
            ...
            throws CommonException
    {
        ...
        _finder = new PCTUserResultBatchFinder(getConnection());
    ...
    protected void convertDetail(Params ioParam, PCTPickingResult inResult)
    {
        try
        {
            ...
            // バッチNo
            ioParam.set(BATCH_NO, inResult.getBatchNo());
            // 生産率
