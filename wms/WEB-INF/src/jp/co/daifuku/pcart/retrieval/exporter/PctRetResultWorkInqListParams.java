// $Id: PctRetResultWorkInqListParams.java 4691 2009-07-16 00:28:49Z kumano $
 ...
 */
public class PctRetResultWorkInqListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * Default constructor
     */
    public PctRetResultWorkInqListParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public PctRetResultWorkInqListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public PctRetResultWorkInqListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
