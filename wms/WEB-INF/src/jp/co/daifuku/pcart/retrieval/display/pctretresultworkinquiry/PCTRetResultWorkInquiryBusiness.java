// $Id: PCTRetResultWorkInquiryBusiness.java 7522 2010-03-13 06:01:48Z shibamoto $
        ...
        extends PCTRetResultWorkInquiry
{
            ...
            throws Exception
    {
        ...
        redirect("/pcart/retrieval/listbox/pctretresultworkinquiry/LstPCTRetResultWorkInquiry.do", forwardParam,
                "/Progress.do");
    }
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            while (dasch.next())
            {
                ...
                expparam.set(PctRetResultWorkInqListParams.CONSIGNOR_CODE,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.CONSIGNOR_CODE));
                expparam.set(PctRetResultWorkInqListParams.CONSIGNOR_NAME,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.CONSIGNOR_NAME));
                ...
                expparam.set(PctRetResultWorkInqListParams.REGULAR_CUSTOMER_CODE,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.REGULAR_CUSTOMER_CODE));
                expparam.set(PctRetResultWorkInqListParams.REGULAR_CUSTOMER_NAME,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.REGULAR_CUSTOMER_NAME));
                expparam.set(PctRetResultWorkInqListParams.CUSTOMER_CODE,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.CUSTOMER_CODE));
                expparam.set(PctRetResultWorkInqListParams.CUSTOMER_NAME,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.CUSTOMER_NAME));
                ...
                expparam.set(PctRetResultWorkInqListParams.PLAN_LOCATION_NO,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.LOCATION_NO));
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            while (dasch.next())
            {
                ...
                expparam.set(PctRetResultWorkInqListParams.CONSIGNOR_NAME,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.CONSIGNOR_NAME));
                expparam.set(PctRetResultWorkInqListParams.WORK_DAY,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.WORK_DAY));
                expparam.set(PctRetResultWorkInqListParams.BATCH_NO,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.BATCH_NO));
                expparam.set(PctRetResultWorkInqListParams.BATCH_SEQ_NO,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.BATCH_SEQ_NO));
                expparam.set(PctRetResultWorkInqListParams.REGULAR_CUSTOMER_CODE,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.REGULAR_CUSTOMER_CODE));
                expparam.set(PctRetResultWorkInqListParams.REGULAR_CUSTOMER_NAME,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.REGULAR_CUSTOMER_NAME));
                ...
                expparam.set(PctRetResultWorkInqListParams.CUSTOMER_NAME,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.CUSTOMER_NAME));
                expparam.set(PctRetResultWorkInqListParams.ORDER_NO,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.ORDER_NO));
                expparam.set(PctRetResultWorkInqListParams.ITEM_CODE,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.ITEM_CODE));
                expparam.set(PctRetResultWorkInqListParams.ITEM_NAME,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.ITEM_NAME));
                expparam.set(PctRetResultWorkInqListParams.JAN_CODE,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.JAN));
                expparam.set(PctRetResultWorkInqListParams.ITF, outparam.get(PCTRetResultWorkInquiryDASCHParams.ITF));
                expparam.set(PctRetResultWorkInqListParams.BUNDLE_ITF,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.BUNDLE_ITF));
                expparam.set(PctRetResultWorkInqListParams.LOT_QTY,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.LOT_QTY));
                expparam.set(PctRetResultWorkInqListParams.PLAN_QTY,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.PLAN_QTY));
                expparam.set(PctRetResultWorkInqListParams.RESULT_QTY,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.RESULT_QTY));
                expparam.set(PctRetResultWorkInqListParams.STATUS,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.JOB_STATUS));
                expparam.set(PctRetResultWorkInqListParams.PLAN_AREA_NO,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.AREA_NO));
                expparam.set(PctRetResultWorkInqListParams.PLAN_ZONE_NO,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.ZONE_NO));
                expparam.set(PctRetResultWorkInqListParams.PLAN_LOCATION_NO,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.LOCATION_NO));
                expparam.set(PctRetResultWorkInqListParams.TERMINAL_NO,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.TERMINAL_NO));
                expparam.set(PctRetResultWorkInqListParams.USER_NAME,
                        outparam.get(PCTRetResultWorkInquiryDASCHParams.USER_NAME));
                if (!exporter.write(expparam))
                {
                    //DFKLOOK start
                    // XLS最大件数出力メッセージ対応
