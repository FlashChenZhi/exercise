// $Id: LstPCTRetResultWorkInquiryParams.java 3339 2009-03-11 08:26:51Z rnakai $
 ...
 *
 * @version $Revision: 3339 $, $Date:: 2009-03-11 17:26:51 +0900#$
 * @author  BusiTune 1.0 Generator.
 * @author  Last commit: $Author: rnakai $
 */
public class LstPCTRetResultWorkInquiryParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * デフォルトコンストラクターです。
     */
    public LstPCTRetResultWorkInquiryParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public LstPCTRetResultWorkInquiryParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public LstPCTRetResultWorkInquiryParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
