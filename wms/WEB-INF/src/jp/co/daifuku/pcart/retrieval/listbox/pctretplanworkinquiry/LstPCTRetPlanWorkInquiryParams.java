// $Id: LstPCTRetPlanWorkInquiryParams.java 3516 2009-03-16 08:38:54Z okayama $
 ...
 *
 * @version $Revision: 3516 $, $Date:: 2009-03-16 17:38:54 +0900#$
 * @author  BusiTune 1.0 Generator.
 * @author  Last commit: $Author: okayama $
 */
public class LstPCTRetPlanWorkInquiryParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * デフォルトコンストラクターです。
     */
    public LstPCTRetPlanWorkInquiryParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public LstPCTRetPlanWorkInquiryParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public LstPCTRetPlanWorkInquiryParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
