// $Id: LstPCTUserResultWorkDateParams.java 3601 2009-03-17 07:25:46Z ota $
 ...
 */
public class LstPCTUserResultWorkDateParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * デフォルトコンストラクターです。
     */
    public LstPCTUserResultWorkDateParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public LstPCTUserResultWorkDateParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public LstPCTUserResultWorkDateParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
