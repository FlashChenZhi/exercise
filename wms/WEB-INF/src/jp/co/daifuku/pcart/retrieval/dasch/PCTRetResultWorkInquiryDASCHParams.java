// $Id: PCTRetResultWorkInquiryDASCHParams.java 3353 2009-03-12 00:29:05Z rnakai $
 ...
 *
 * @version $Revision: 3353 $, $Date:: 2009-03-12 09:29:05 +0900#$
 * @author  BusiTune 1.0 Generator.
 * @author  Last commit: $Author: rnakai $
 */
public class PCTRetResultWorkInquiryDASCHParams
        extends WmsDASCHParams
{
     ...
     * Default constructor
     */
    public PCTRetResultWorkInquiryDASCHParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public PCTRetResultWorkInquiryDASCHParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public PCTRetResultWorkInquiryDASCHParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
