// $Id: PCTUserResultWorkDateFinder.java 6438 2009-12-11 09:32:59Z kumano $
// Handler v3.8
 ...
 */
public class PCTUserResultWorkDateFinder
        extends PCTUserResultOrderInfoFinder
{
     ...
     */
    public PCTUserResultWorkDateFinder(Connection conn)
    {
        super(conn);
    }
    ...
    {
        return (String)info.getValue(PCTPickingResult.WORK_DAY, "");
    }
            ...
            throws ReadWriteException
    {
        ...
        // 取得項目
        // 作業日
        key.setCollect(PCTPickingResult.WORK_DAY);
