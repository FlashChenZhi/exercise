// $Id: LstPCTUserResultBatchBusiness.java 7707 2010-03-20 07:23:11Z okayama $
        ...
        extends LstPCTUserResultBatch
{
            ...
            throws Exception
    {
        ...
        _lcm_lst_UserResultBatchList.setToolTipVisible(KEY_LST_BATCH_NO, true);
        _lcm_lst_UserResultBatchList.setToolTipVisible(KEY_LST_PRODUCTION_RATE, true);
        _lcm_lst_UserResultBatchList.setToolTipVisible(KEY_LST_WORKER_COUNT, true);
        _lcm_lst_UserResultBatchList.setToolTipVisible(KEY_LST_TERMINAL_COUNT, true);
        _lcm_lst_UserResultBatchList.setToolTipVisible(KEY_LST_START_TIME, true);
        _lcm_lst_UserResultBatchList.setToolTipVisible(KEY_LST_END_TIME, true);
        _lcm_lst_UserResultBatchList.setToolTipVisible(KEY_LST_OPERATE_TIME, true);
        _lcm_lst_UserResultBatchList.setToolTipVisible(KEY_LST_ORDER_COUNT, true);
        _lcm_lst_UserResultBatchList.setToolTipVisible(KEY_LST_ORDER_COUNT_PER_HOUR, true);
        _lcm_lst_UserResultBatchList.setToolTipVisible(KEY_LST_BOX_COUNT, true);
        _lcm_lst_UserResultBatchList.setToolTipVisible(KEY_LST_BOX_COUNT_PER_HOUR, true);
        _lcm_lst_UserResultBatchList.setToolTipVisible(KEY_LST_LINE_COUNT, true);
        _lcm_lst_UserResultBatchList.setToolTipVisible(KEY_LST_LINE_COUNT_PER_HOUR, true);
        _lcm_lst_UserResultBatchList.setToolTipVisible(KEY_LST_LOT_QTY, true);
        _lcm_lst_UserResultBatchList.setToolTipVisible(KEY_LST_LOT_QTY_PER_HOUR, true);
        _lcm_lst_UserResultBatchList.setToolTipVisible(KEY_LST_PIECE_QTY, true);
        _lcm_lst_UserResultBatchList.setToolTipVisible(KEY_LST_PIECE_QTY_PER_HOUR, true);
        _lcm_lst_UserResultBatchList.setToolTipVisible(KEY_LST_BOX_COUNT_PER_ORDER, true);
        _lcm_lst_UserResultBatchList.setToolTipVisible(KEY_LST_LINE_COUNT_PER_ORDER, true);
        _lcm_lst_UserResultBatchList.setToolTipVisible(KEY_LST_LOT_QTY_PER_LINE_COUNT, true);
        _lcm_lst_UserResultBatchList.setToolTipVisible(KEY_LST_PIECE_QTY_PER_LINE_COUNT, true);
        _lcm_lst_UserResultBatchList.setToolTipVisible(KEY_LST_MISS_RATE, true);
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            inparam.set(LstPCTUserResultBatchDASCHParams.WORKDAY_FROM,
                    requestParam.get(LstPCTUserResultBatchParams.WORKDAY_FROM));
            inparam.set(LstPCTUserResultBatchDASCHParams.WORKDAY_TO,
                    requestParam.get(LstPCTUserResultBatchParams.WORKDAY_TO));
            ...
            inparam.set(LstPCTUserResultBatchDASCHParams.WEDNESDAY,
                    requestParam.get(LstPCTUserResultBatchParams.WEDNESDAY));
            inparam.set(LstPCTUserResultBatchDASCHParams.THURSDAY,
                    requestParam.get(LstPCTUserResultBatchParams.THURSDAY));
            inparam.set(LstPCTUserResultBatchDASCHParams.FRIDAY, requestParam.get(LstPCTUserResultBatchParams.FRIDAY));
            inparam.set(LstPCTUserResultBatchDASCHParams.SATURDAY,
                    requestParam.get(LstPCTUserResultBatchParams.SATURDAY));
            inparam.set(LstPCTUserResultBatchDASCHParams.SUNDAY, requestParam.get(LstPCTUserResultBatchParams.SUNDAY));
            inparam.set(LstPCTUserResultBatchDASCHParams.CONSIGNOR_CODE,
                    requestParam.get(LstPCTUserResultBatchParams.CONSIGNOR_CODE));
            inparam.set(LstPCTUserResultBatchDASCHParams.AREA_NO, requestParam.get(LstPCTUserResultBatchParams.AREA_NO));
            inparam.set(LstPCTUserResultBatchDASCHParams.BATCH_NO,
                    requestParam.get(LstPCTUserResultBatchParams.BATCH_NO));
            ...
            inparam.set(LstPCTUserResultBatchDASCHParams.COLLECT_CONDITION,
                    requestParam.get(LstPCTUserResultBatchParams.COLLECT_CONDITION));
            inparam.set(LstPCTUserResultBatchDASCHParams.DISPLAY_RANK,
                    requestParam.get(LstPCTUserResultBatchParams.DISPLAY_RANK));
            inparam.set(LstPCTUserResultBatchDASCHParams.USEDAY_OF_WEEK_FLAG,
                    requestParam.get(LstPCTUserResultBatchParams.USEDAY_OF_WEEK_FLAG));
            ...
            for (Params outparam : outparams)
            {
                ...
                if (isSet)
                {
                    // 条件リストセル
                    lst_SearchCondition_Make(inparam, conn,
                            outparam.getString(LstPCTUserResultBatchDASCHParams.CONSIGNOR_NAME));
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            for (int i = 1; i <= _lcm_lst_UserResultBatchList.size(); i++)
            {
                ...
                expparam.set(PctUserResultBatchListParams.SYS_DAY, DbDateUtil.getTimeStamp());
                expparam.set(PctUserResultBatchListParams.SYS_TIME, DbDateUtil.getTimeStamp());
                expparam.set(PctUserResultBatchListParams.WORK_DAY_FROM, WmsFormatter.toDate(searchWorkDayFrom));
                expparam.set(PctUserResultBatchListParams.WORK_DAY_TO, WmsFormatter.toDate(searchWorkDayTo));
                expparam.set(PctUserResultBatchListParams.WEEK_DAY, searchWeekDay);
                expparam.set(PctUserResultBatchListParams.BATCH_NO, searchBatchNo);
                expparam.set(PctUserResultBatchListParams.LEVEL, searchLevel);
                expparam.set(PctUserResultBatchListParams.CONSIGNOR_CODE, searchConsignorCode);
                expparam.set(PctUserResultBatchListParams.CONSIGNOR_NAME, searchConsignorName);
                expparam.set(PctUserResultBatchListParams.AREA_NO, searchAreaNo);
                expparam.set(PctUserResultBatchListParams.AREA_NAME, searchAreaName);
                ...
                expparam.set(PctUserResultBatchListParams.PRODUCTION_RATE_AVG, avgProducate);
                expparam.set(PctUserResultBatchListParams.HEADS_AVG, avgWorkerCnt);
                expparam.set(PctUserResultBatchListParams.CNT_AVG, avgTermCnt);
                expparam.set(PctUserResultBatchListParams.WORK_TIME_AVG, avgWorkTime);
                expparam.set(PctUserResultBatchListParams.ORDER_CNT_AVG, avgOderCnt);
                expparam.set(PctUserResultBatchListParams.ORDER_CNT_PER_HOUR_AVG, avgOrderCntPerH);
                expparam.set(PctUserResultBatchListParams.BOX_CNT_AVG, avgBoxCnt);
                expparam.set(PctUserResultBatchListParams.BOX_CNT_PER_HOUR_AVG, avgBoxCntPerH);
                expparam.set(PctUserResultBatchListParams.LINE_CNT_AVG, avgLineCnt);
                expparam.set(PctUserResultBatchListParams.LINE_CNT_PER_HOUR_AVG, avgLineCntPerH);
                expparam.set(PctUserResultBatchListParams.LOT_CNT_AVG, avgLotQty);
                expparam.set(PctUserResultBatchListParams.LOT_CNT_PER_HOUR_AVG, avgLotQtyPerH);
                expparam.set(PctUserResultBatchListParams.PIECE_CNT_AVG, avgPeiceQty);
                expparam.set(PctUserResultBatchListParams.PIECE_CNT_PER_HOUR_AVG, avgPeiceQtyPerH);
                expparam.set(PctUserResultBatchListParams.BOX_PER_ORDER_AVG, avgBoxPerOder);
                expparam.set(PctUserResultBatchListParams.LINE_PER_ORDER_AVG, avgLinePerOder);
                expparam.set(PctUserResultBatchListParams.LOT_PER_LINE_AVG, avgLotQtyPerLine);
                expparam.set(PctUserResultBatchListParams.PIECE_PER_LINE_AVG, avgPeiceQtyPerLine);
                expparam.set(PctUserResultBatchListParams.MISS_AVG, avgMissRate);
            ...
            throws Exception
    {
        try
        {
            ...
            String dayOfWeek = "";
            // 月曜
            if (inParam.getBoolean(LstPCTUserResultBatchDASCHParams.MONDAY))
            {
                dayOfWeek += DispResources.getText("CHK-P0001");
            }
            // 火曜
            if (inParam.getBoolean(LstPCTUserResultBatchDASCHParams.TUESDAY))
            {
                dayOfWeek += DispResources.getText("CHK-P0002");
            }
            // 水曜
            if (inParam.getBoolean(LstPCTUserResultBatchDASCHParams.WEDNESDAY))
            {
                dayOfWeek += DispResources.getText("CHK-P0003");
            }
            // 木曜
            if (inParam.getBoolean(LstPCTUserResultBatchDASCHParams.THURSDAY))
            {
                dayOfWeek += DispResources.getText("CHK-P0004");
            }
            // 金曜
            if (inParam.getBoolean(LstPCTUserResultBatchDASCHParams.FRIDAY))
            {
                dayOfWeek += DispResources.getText("CHK-P0005");
            }
            // 土曜
            if (inParam.getBoolean(LstPCTUserResultBatchDASCHParams.SATURDAY))
            {
                dayOfWeek += DispResources.getText("CHK-P0006");
            }
            // 日曜
            if (inParam.getBoolean(LstPCTUserResultBatchDASCHParams.SUNDAY))
            {
            ...
            // エリア名称
            String areaName = "";
            if (!WmsParam.ALL_AREA_NO.equals(inParam.getString(LstPCTUserResultBatchDASCHParams.AREA_NO)))
            {
                AreaController aController = new AreaController(conn, this.getClass());
                areaName = aController.getAreaName(inParam.getString(LstPCTUserResultBatchDASCHParams.AREA_NO));
            }
            else
            {
            ...
            // レベル
            String level = "";
            if (inParam.getBoolean(LstPCTUserResultBatchDASCHParams.LEVEL_A))
            {
                level = DispResources.getText("LBL-P0247");
            }
            if (inParam.getBoolean(LstPCTUserResultBatchDASCHParams.LEVEL_B))
            {
                level = level + DispResources.getText("LBL-P0248");
            }
            if (inParam.getBoolean(LstPCTUserResultBatchDASCHParams.LEVEL_C))
            {
            ...
            cellLine.setValue(KEY_HIDDEN_BATCH_NO, inParam.getString(LstPCTUserResultBatchDASCHParams.BATCH_NO));
            cellLine.setValue(KEY_HIDDEN_LEVEL, level);
            cellLine.setValue(KEY_HIDDEN_CONSIGNOR_CODE,
                    inParam.getString(LstPCTUserResultBatchDASCHParams.CONSIGNOR_CODE));
            cellLine.setValue(
                    KEY_HIDDEN_CONSIGNOR_NAME,
                    StringUtil.isBlank(inParam.getString(LstPCTUserResultBatchDASCHParams.CONSIGNOR_CODE)) ? ""
                                                                                                          : consignorName);
            cellLine.setValue(KEY_HIDDEN_AREA_NO, inParam.getString(LstPCTUserResultBatchDASCHParams.AREA_NO));
            ...
            cellLine.setValue(KEY_LST_SEARCH_CONDITION_2, inParam.getString(LstPCTUserResultBatchDASCHParams.AREA_NO));
            // エリア名称
            ...
            cellLine.setValue(KEY_LST_SEARCH_CONDITION_2, inParam.getString(LstPCTUserResultBatchDASCHParams.BATCH_NO));
            // レベル
    ...
    protected void setListAvg(Params outParam)
    {
        ...
        try
        {
            ...
            lst_UserResultSummaryAvg.setValue(ListAvg.PRODUCTION_RATE,
                    (outParam.getString(LstPCTUserResultBatchDASCHParams.AVG_PRODUCTION_RATE)));
            // 人数(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.WORKER_CNT,
                    (outParam.getString(LstPCTUserResultBatchDASCHParams.AVG_WORKER_COUNT)));
            // 台数(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.TERMINAL_CNT,
                    (outParam.getString(LstPCTUserResultBatchDASCHParams.AVG_TERMINAL_COUNT)));
            // 作業時間（延べ）(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.TOTAL_WORK_TIME,
                    (outParam.getString(LstPCTUserResultBatchDASCHParams.AVG_OPERATE_TIME)));
            // オーダー数(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.ORDER_CNT,
                    (outParam.getString(LstPCTUserResultBatchDASCHParams.AVG_ORDER_COUNT)));
            // オーダー数/H(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.ORDER_CNT_PER_HOUR,
                    (outParam.getString(LstPCTUserResultBatchDASCHParams.AVG_ORDER_COUNT_PER_HOUR)));
            // 箱数(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.BOX_CNT,
                    (outParam.getString(LstPCTUserResultBatchDASCHParams.AVG_BOX_COUNT)));
            // 箱数/H(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.BOX_CNT_PER_HOUR,
                    (outParam.getString(LstPCTUserResultBatchDASCHParams.AVG_BOX_COUNT_PER_HOUR)));
            // 行数(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.LINE_CNT,
                    (outParam.getString(LstPCTUserResultBatchDASCHParams.AVG_LINE_COUNT)));
            // 行数/H(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.LINE_CNT_PER_HOUR,
                    (outParam.getString(LstPCTUserResultBatchDASCHParams.AVG_LINE_COUNT_PER_HOUR)));
            // 数量（ロット）(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.LOT_QTY,
                    (outParam.getString(LstPCTUserResultBatchDASCHParams.AVG_LOT_QTY)));
            // 数量（ロット）/H(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.LOT_QTY_PER_HOUR,
                    (outParam.getString(LstPCTUserResultBatchDASCHParams.AVG_LOT_QTY_PER_HOUR)));
            // 数量（バラ）(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.PIECE_QTY,
                    (outParam.getString(LstPCTUserResultBatchDASCHParams.AVG_PIECE_QTY)));
            // 数量（バラ）/H(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.PIECE_QTY_PER_HOUR,
                    (outParam.getString(LstPCTUserResultBatchDASCHParams.AVG_PIECE_QTY_PER_HOUR)));
            // 箱/オーダー(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.BOX_CNT_PER_ORDER,
                    (outParam.getString(LstPCTUserResultBatchDASCHParams.AVG_BOX_COUNT_PER_ORDER)));
            // 行/オーダー(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.LINE_CNT_PER_ORDER,
                    (outParam.getString(LstPCTUserResultBatchDASCHParams.AVG_LINE_COUNT_PER_ORDER)));
            // ロット/行(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.LOT_QTY_PER_LINE,
                    (outParam.getString(LstPCTUserResultBatchDASCHParams.AVG_LOT_QTY_PER_LINE_COUNT)));
            // バラ/行(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.PIECE_QTY_PER_LINE,
                    (outParam.getString(LstPCTUserResultBatchDASCHParams.AVG_PIECE_QTY_PER_LINE_COUNT)));
            // ミス率(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.MISS_RATE,
                    (outParam.getString(LstPCTUserResultBatchDASCHParams.AVG_MISS_RATE)));
        }
        catch (Exception e)
        {
            e.printStackTrace();
    ...
    protected void errorProcessing()
    {
        ...
        lst_UserResultBatchList.setVisible(false);
