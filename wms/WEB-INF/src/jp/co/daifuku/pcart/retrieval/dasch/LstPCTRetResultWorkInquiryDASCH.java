// $Id: LstPCTRetResultWorkInquiryDASCH.java 4689 2009-07-16 00:23:45Z okayama $
 ...
 */
import static jp.co.daifuku.pcart.retrieval.dasch.LstPCTRetResultWorkInquiryDASCHParams.*;
...
/**
 * PCT作業実績照会一覧に必要なリストボックスや帳票の検索処理を行います。
 *
 * @version $Revision: 4689 $, $Date:: 2009-07-16 09:23:45 +0900#$
 * @author  BusiTune 1.0 Generator.
 * @author  Last commit: $Author: okayama $
 */
public class LstPCTRetResultWorkInquiryDASCH
        extends AbstractWmsDASCH
{
     ...
     * @param ui ユーザ情報
     */
    public LstPCTRetResultWorkInquiryDASCH(Connection conn, Class parent, Locale locale, DfkUserInfo ui)
    {
