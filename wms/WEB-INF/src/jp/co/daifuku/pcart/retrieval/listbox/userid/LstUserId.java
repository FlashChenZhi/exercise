// $Id: LstUserId.java 6602 2009-12-23 01:16:12Z okayama $
 ...
 */
public class LstUserId extends Page
{
	...
	/**
	 * ControlID	lst_PCTUserIdList
	 * TemplateKey	W_PCTUserIdList
	 * ControlType	ScrollListCell
	 */
	public jp.co.daifuku.bluedog.ui.control.ScrollListCell lst_PCTUserIdList = jp.co.daifuku.bluedog.ui.control.ScrollListCellFactory.getInstance("lst_PCTUserIdList" , "W_PCTUserIdList");
