// $Id: LstPCTUserResultWorkerParams.java 3601 2009-03-17 07:25:46Z ota $
 ...
 */
public class LstPCTUserResultWorkerParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * デフォルトコンストラクターです。
     */
    public LstPCTUserResultWorkerParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public LstPCTUserResultWorkerParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public LstPCTUserResultWorkerParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
