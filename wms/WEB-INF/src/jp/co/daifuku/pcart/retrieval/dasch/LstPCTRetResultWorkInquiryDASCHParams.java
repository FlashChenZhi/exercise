// $Id: LstPCTRetResultWorkInquiryDASCHParams.java 3341 2009-03-11 08:27:50Z rnakai $
 ...
 *
 * @version $Revision: 3341 $, $Date:: 2009-03-11 17:27:50 +0900#$
 * @author  BusiTune 1.0 Generator.
 * @author  Last commit: $Author: rnakai $
 */
public class LstPCTRetResultWorkInquiryDASCHParams
        extends WmsDASCHParams
{
     ...
     * Default constructor
     */
    public LstPCTRetResultWorkInquiryDASCHParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public LstPCTRetResultWorkInquiryDASCHParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public LstPCTRetResultWorkInquiryDASCHParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
