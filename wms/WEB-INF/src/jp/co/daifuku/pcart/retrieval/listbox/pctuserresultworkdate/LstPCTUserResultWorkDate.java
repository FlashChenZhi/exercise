// $Id: LstPCTUserResultWorkDate.java 6602 2009-12-23 01:16:12Z okayama $
 ...
 */
public class LstPCTUserResultWorkDate extends Page
{
	...
	/**
	 * ControlID	lst_UserResultWorkDateList
	 * TemplateKey	W_PCTUserResultWorkDateList
	 * ControlType	ListCell
	 */
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_UserResultWorkDateList = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_UserResultWorkDateList" , "W_PCTUserResultWorkDateList");
