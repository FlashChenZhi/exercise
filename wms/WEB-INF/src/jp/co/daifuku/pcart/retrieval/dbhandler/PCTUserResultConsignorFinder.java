// $Id: PCTUserResultConsignorFinder.java 6438 2009-12-11 09:32:59Z kumano $
// Handler v3.8
 ...
 */
public class PCTUserResultConsignorFinder
        extends PCTUserResultOrderInfoFinder
{
     ...
     */
    public PCTUserResultConsignorFinder(Connection conn)
    {
        super(conn);
    }
     ...
     * @return ConsignorCode 荷主コード
     */
    @Override
    protected String getKey(PCTPickingResult info)
    {
        return info.getConsignorCode();
    }
