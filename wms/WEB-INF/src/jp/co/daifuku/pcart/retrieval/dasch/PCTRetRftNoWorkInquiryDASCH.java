// $Id: PCTRetRftNoWorkInquiryDASCH.java 4689 2009-07-16 00:23:45Z okayama $
        ...
        extends AbstractWmsDASCH
{
    ...
    /** 保存用のフィールド ユーザ名称(<code>_USER_NAME</code>) */
     ...
     * @param ui ユーザ情報
     */
    public PCTRetRftNoWorkInquiryDASCH(Connection conn, Class parent, Locale locale, DfkUserInfo ui)
    {
            ...
            throws CommonException
    {
        ...
        {
            // 号機No.
            p.set(PCART_RFT_NO, ent.getTerminalNo());
            // ユーザ名称
