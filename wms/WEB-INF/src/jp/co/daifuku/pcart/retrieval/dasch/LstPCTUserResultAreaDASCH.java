// $Id: LstPCTUserResultAreaDASCH.java 5739 2009-11-12 13:28:36Z kumano $
...
import static jp.co.daifuku.pcart.retrieval.dasch.LstPCTUserResultAreaDASCHParams.*;
...
import jp.co.daifuku.pcart.retrieval.dbhandler.PCTUserResultAreaFinder;
...
/**
 * エリア別実績照会に必要なリストボックスや帳票の検索処理を行います。
 *
 * @version $Revision: 5739 $, $Date:: 2009-11-12 22:28:36 +0900#$
 * @author  BusiTune 1.0 Generator.
 * @author  Last commit: $Author: kumano $
 */
public class LstPCTUserResultAreaDASCH
        extends AbstractWmsDASCH
{
     ...
     * @param ui ユーザ情報
     */
    public LstPCTUserResultAreaDASCH(Connection conn, Class parent, Locale locale, DfkUserInfo ui)
    {
            ...
            throws CommonException
    {
        ...
        _finder = new PCTUserResultAreaFinder(getConnection());
    ...
    protected void convertDetail(Params ioParam, PCTPickingResult inResult)
    {
        try
        {
            ...
            // エリアNo
            ioParam.set(AREA_NO, inResult.getAreaNo());
            // エリア名称
            ioParam.set(AREA_NAME, inResult.getAreaName());
            // 生産率
