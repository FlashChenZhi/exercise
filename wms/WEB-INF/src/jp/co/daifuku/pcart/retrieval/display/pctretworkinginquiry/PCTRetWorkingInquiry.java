// $Id: PCTRetWorkingInquiry.java 3776 2009-03-24 08:22:05Z dmori $
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 3776 $, $Date: 2009-03-24 17:22:05 +0900 (火, 24 3 2009) $
 * @author  $Author: dmori $
 */
public class PCTRetWorkingInquiry extends Page
{
	...
	/**
	 * ControlID	lbl_lbl_WorkStatus
	 * TemplateKey	W_WorkStatus
	 * ControlType	Label
	 */
	public jp.co.daifuku.bluedog.ui.control.Label lbl_lbl_WorkStatus = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_lbl_WorkStatus" , "W_WorkStatus");

	/**
	 * ControlID	pul_WorkStatus
	 * TemplateKey	W_WorkStatusPCT
	 * ControlType	PullDown
	 */
	public jp.co.daifuku.bluedog.ui.control.PullDown pul_WorkStatus = jp.co.daifuku.bluedog.ui.control.PullDownFactory.getInstance("pul_WorkStatus" , "W_WorkStatusPCT");
	 ...
	 * ControlType	SubmitButton
	 */
	public jp.co.daifuku.bluedog.ui.control.SubmitButton btn_User = jp.co.daifuku.bluedog.ui.control.SubmitButtonFactory.getInstance("btn_User" , "W_P_Search");
	 ...
	 * ControlType	FreeTextBox
	 */
	public jp.co.daifuku.bluedog.ui.control.FreeTextBox txt_UserName = jp.co.daifuku.bluedog.ui.control.FreeTextBoxFactory.getInstance("txt_UserName" , "T_R_FunctionName");
