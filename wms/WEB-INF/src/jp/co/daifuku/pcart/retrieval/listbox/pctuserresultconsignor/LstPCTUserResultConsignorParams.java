// $Id: LstPCTUserResultConsignorParams.java 3601 2009-03-17 07:25:46Z ota $
 ...
 *
 * @version $Revision: 3601 $, $Date:: 2009-03-17 16:25:46 +0900#$
 * @author  BusiTune 1.0 Generator.
 * @author  Last commit: $Author: ota $
 */
public class LstPCTUserResultConsignorParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * デフォルトコンストラクターです。
     */
    public LstPCTUserResultConsignorParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public LstPCTUserResultConsignorParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public LstPCTUserResultConsignorParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
