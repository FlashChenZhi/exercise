// $Id: LstPCTUserResultAreaParams.java 3601 2009-03-17 07:25:46Z ota $
 ...
 */
public class LstPCTUserResultAreaParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * デフォルトコンストラクターです。
     */
    public LstPCTUserResultAreaParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public LstPCTUserResultAreaParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public LstPCTUserResultAreaParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
