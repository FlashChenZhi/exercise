// $Id: LstPCTUserResultConsignorBusiness.java 7707 2010-03-20 07:23:11Z okayama $
        ...
        extends LstPCTUserResultConsignor
{
    ...
    /** lst_UserResultConsignorList kyes */
            ...
            throws Exception
    {
        ...
        _lcm_lst_UserResultConsignorList =
                new ListCellModel(lst_UserResultConsignorList, LST_USERRESULTCONSIGNORLIST_KEYS, locale);
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            inparam.set(LstPCTUserResultConsignorDASCHParams.WORKDAY_FROM,
                    requestParam.get(LstPCTUserResultConsignorParams.WORKDAY_FROM));
            inparam.set(LstPCTUserResultConsignorDASCHParams.WORKDAY_TO,
                    requestParam.get(LstPCTUserResultConsignorParams.WORKDAY_TO));
            inparam.set(LstPCTUserResultConsignorDASCHParams.MONDAY,
                    requestParam.get(LstPCTUserResultConsignorParams.MONDAY));
            inparam.set(LstPCTUserResultConsignorDASCHParams.TUESDAY,
                    requestParam.get(LstPCTUserResultConsignorParams.TUESDAY));
            inparam.set(LstPCTUserResultConsignorDASCHParams.WEDNESDAY,
                    requestParam.get(LstPCTUserResultConsignorParams.WEDNESDAY));
            inparam.set(LstPCTUserResultConsignorDASCHParams.THURSDAY,
                    requestParam.get(LstPCTUserResultConsignorParams.THURSDAY));
            inparam.set(LstPCTUserResultConsignorDASCHParams.FRIDAY,
                    requestParam.get(LstPCTUserResultConsignorParams.FRIDAY));
            inparam.set(LstPCTUserResultConsignorDASCHParams.SATURDAY,
                    requestParam.get(LstPCTUserResultConsignorParams.SATURDAY));
            inparam.set(LstPCTUserResultConsignorDASCHParams.SUNDAY,
                    requestParam.get(LstPCTUserResultConsignorParams.SUNDAY));
            inparam.set(LstPCTUserResultConsignorDASCHParams.CONSIGNOR_CODE,
                    requestParam.get(LstPCTUserResultConsignorParams.CONSIGNOR_CODE));
            inparam.set(LstPCTUserResultConsignorDASCHParams.AREA_NO,
                    requestParam.get(LstPCTUserResultConsignorParams.AREA_NO));
            inparam.set(LstPCTUserResultConsignorDASCHParams.BATCH_NO,
                    requestParam.get(LstPCTUserResultConsignorParams.BATCH_NO));
            inparam.set(LstPCTUserResultConsignorDASCHParams.LEVEL_A,
                    requestParam.get(LstPCTUserResultConsignorParams.LEVEL_A));
            inparam.set(LstPCTUserResultConsignorDASCHParams.LEVEL_B,
                    requestParam.get(LstPCTUserResultConsignorParams.LEVEL_B));
            inparam.set(LstPCTUserResultConsignorDASCHParams.LEVEL_C,
                    requestParam.get(LstPCTUserResultConsignorParams.LEVEL_C));
            inparam.set(LstPCTUserResultConsignorDASCHParams.COLLECT_CONDITION,
                    requestParam.get(LstPCTUserResultConsignorParams.COLLECT_CONDITION));
            inparam.set(LstPCTUserResultConsignorDASCHParams.DISPLAY_RANK,
                    requestParam.get(LstPCTUserResultConsignorParams.DISPLAY_RANK));
            inparam.set(LstPCTUserResultConsignorDASCHParams.USEDAY_OF_WEEK_FLAG,
                    requestParam.get(LstPCTUserResultConsignorParams.USEDAY_OF_WEEK_FLAG));
            ...
            for (Params outparam : outparams)
            {
                ...
                if (isSet)
                {
                    // 条件リストセル
                    lst_SearchCondition_Make(inparam, conn,
                            outparam.getString(LstPCTUserResultConsignorDASCHParams.CONSIGNOR_NAME));
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            for (int i = 1; i <= _lcm_lst_UserResultConsignorList.size(); i++)
            {
                ...
                expparam.set(PctUserResultConsignorListParams.SYS_DAY, DbDateUtil.getTimeStamp());
                expparam.set(PctUserResultConsignorListParams.SYS_TIME, DbDateUtil.getTimeStamp());
                expparam.set(PctUserResultConsignorListParams.WORK_DAY_FROM, WmsFormatter.toDate(searchWorkDayFrom));
                expparam.set(PctUserResultConsignorListParams.WORK_DAY_TO, WmsFormatter.toDate(searchWorkDayTo));
                expparam.set(PctUserResultConsignorListParams.WEEK_DAY, searchWeekDay);
                expparam.set(PctUserResultConsignorListParams.BATCH_NO, searchBatchNo);
                expparam.set(PctUserResultConsignorListParams.LEVEL, searchLevel);
                expparam.set(PctUserResultConsignorListParams.CONSIGNOR_CODE, searchConsignorCode);
                expparam.set(PctUserResultConsignorListParams.CONSIGNOR_NAME, searchConsignorName);
                expparam.set(PctUserResultConsignorListParams.AREA_NO, searchAreaNo);
                expparam.set(PctUserResultConsignorListParams.AREA_NAME, searchAreaName);
                ...
                expparam.set(PctUserResultConsignorListParams.PRODUCTION_RATE_AVG, avgProducate);
                expparam.set(PctUserResultConsignorListParams.HEADS_AVG, avgWorkerCnt);
                expparam.set(PctUserResultConsignorListParams.CNT_AVG, avgTermCnt);
                expparam.set(PctUserResultConsignorListParams.WORK_TIME_AVG, avgWorkTime);
                expparam.set(PctUserResultConsignorListParams.ORDER_CNT_AVG, avgOderCnt);
                expparam.set(PctUserResultConsignorListParams.ORDER_CNT_PER_HOUR_AVG, avgOrderCntPerH);
                expparam.set(PctUserResultConsignorListParams.BOX_CNT_AVG, avgBoxCnt);
                expparam.set(PctUserResultConsignorListParams.BOX_CNT_PER_HOUR_AVG, avgBoxCntPerH);
                expparam.set(PctUserResultConsignorListParams.LINE_CNT_AVG, avgLineCnt);
                expparam.set(PctUserResultConsignorListParams.LINE_CNT_PER_HOUR_AVG, avgLineCntPerH);
                expparam.set(PctUserResultConsignorListParams.LOT_CNT_AVG, avgLotQty);
                expparam.set(PctUserResultConsignorListParams.LOT_CNT_PER_HOUR_AVG, avgLotQtyPerH);
                expparam.set(PctUserResultConsignorListParams.PIECE_CNT_AVG, avgPeiceQty);
                expparam.set(PctUserResultConsignorListParams.PIECE_CNT_PER_HOUR_AVG, avgPeiceQtyPerH);
                expparam.set(PctUserResultConsignorListParams.BOX_PER_ORDER_AVG, avgBoxPerOder);
                expparam.set(PctUserResultConsignorListParams.LINE_PER_ORDER_AVG, avgLinePerOder);
                expparam.set(PctUserResultConsignorListParams.LOT_PER_LINE_AVG, avgLotQtyPerLine);
                expparam.set(PctUserResultConsignorListParams.PIECE_PER_LINE_AVG, avgPeiceQtyPerLine);
                expparam.set(PctUserResultConsignorListParams.MISS_AVG, avgMissRate);
            ...
            throws Exception
    {
        try
        {
            ...
            String dayOfWeek = "";
            // 月曜
            if (inParam.getBoolean(LstPCTUserResultConsignorDASCHParams.MONDAY))
            {
                dayOfWeek += DispResources.getText("CHK-P0001");
            }
            // 火曜
            if (inParam.getBoolean(LstPCTUserResultConsignorDASCHParams.TUESDAY))
            {
                dayOfWeek += DispResources.getText("CHK-P0002");
            }
            // 水曜
            if (inParam.getBoolean(LstPCTUserResultConsignorDASCHParams.WEDNESDAY))
            {
                dayOfWeek += DispResources.getText("CHK-P0003");
            }
            // 木曜
            if (inParam.getBoolean(LstPCTUserResultConsignorDASCHParams.THURSDAY))
            {
                dayOfWeek += DispResources.getText("CHK-P0004");
            }
            // 金曜
            if (inParam.getBoolean(LstPCTUserResultConsignorDASCHParams.FRIDAY))
            {
                dayOfWeek += DispResources.getText("CHK-P0005");
            }
            // 土曜
            if (inParam.getBoolean(LstPCTUserResultConsignorDASCHParams.SATURDAY))
            {
                dayOfWeek += DispResources.getText("CHK-P0006");
            }
            // 日曜
            if (inParam.getBoolean(LstPCTUserResultConsignorDASCHParams.SUNDAY))
            {
            ...
            // エリア名称
            String areaName = "";
            if (!WmsParam.ALL_AREA_NO.equals(inParam.getString(LstPCTUserResultConsignorDASCHParams.AREA_NO)))
            {
                AreaController aController = new AreaController(conn, this.getClass());
                areaName = aController.getAreaName(inParam.getString(LstPCTUserResultConsignorDASCHParams.AREA_NO));
            }
            else
            {
            ...
            // レベル
            String level = "";
            if (inParam.getBoolean(LstPCTUserResultConsignorDASCHParams.LEVEL_A))
            {
                level = DispResources.getText("LBL-P0247");
            }
            if (inParam.getBoolean(LstPCTUserResultConsignorDASCHParams.LEVEL_B))
            {
                level = level + DispResources.getText("LBL-P0248");
            }
            if (inParam.getBoolean(LstPCTUserResultConsignorDASCHParams.LEVEL_C))
            {
            ...
            cellLine.setValue(KEY_HIDDEN_BATCH_NO, inParam.getString(LstPCTUserResultConsignorDASCHParams.BATCH_NO));
            cellLine.setValue(KEY_HIDDEN_LEVEL, level);
            cellLine.setValue(KEY_HIDDEN_CONSIGNOR_CODE,
                    inParam.getString(LstPCTUserResultConsignorDASCHParams.CONSIGNOR_CODE));
            cellLine.setValue(
                    KEY_HIDDEN_CONSIGNOR_NAME,
                    StringUtil.isBlank(inParam.getString(LstPCTUserResultConsignorDASCHParams.CONSIGNOR_CODE)) ? ""
                                                                                                              : consignorName);
            cellLine.setValue(KEY_HIDDEN_AREA_NO, inParam.getString(LstPCTUserResultConsignorDASCHParams.AREA_NO));
            ...
            cellLine.setValue(KEY_LST_SEARCH_CONDITION_2,
                    inParam.getString(LstPCTUserResultConsignorDASCHParams.AREA_NO));
            // エリア名称
            ...
            cellLine.setValue(KEY_LST_SEARCH_CONDITION_2,
                    inParam.getString(LstPCTUserResultConsignorDASCHParams.BATCH_NO));
            // レベル
    ...
    protected void setListAvg(Params outParam)
    {
        ...
        try
        {
            ...
            lst_UserResultSummaryAvg.setValue(ListAvg.PRODUCTION_RATE,
                    (outParam.getString(LstPCTUserResultConsignorDASCHParams.AVG_PRODUCTION_RATE)));
            // 人数(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.WORKER_CNT,
                    (outParam.getString(LstPCTUserResultConsignorDASCHParams.AVG_WORKER_COUNT)));
            // 台数(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.TERMINAL_CNT,
                    (outParam.getString(LstPCTUserResultConsignorDASCHParams.AVG_CART_COUNT)));
            // 作業時間（延べ）(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.TOTAL_WORK_TIME,
                    (outParam.getString(LstPCTUserResultConsignorDASCHParams.AVG_OPERATE_TIME)));
            // オーダー数(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.ORDER_CNT,
                    (outParam.getString(LstPCTUserResultConsignorDASCHParams.AVG_ORDER_COUNT)));
            // オーダー数/H(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.ORDER_CNT_PER_HOUR,
                    (outParam.getString(LstPCTUserResultConsignorDASCHParams.AVG_ORDER_COUNT_PER_HOUR)));
            // 箱数(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.BOX_CNT,
                    (outParam.getString(LstPCTUserResultConsignorDASCHParams.AVG_BOX_COUNT)));
            // 箱数/H(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.BOX_CNT_PER_HOUR,
                    (outParam.getString(LstPCTUserResultConsignorDASCHParams.AVG_BOX_COUNT_PER_HOUR)));
            // 行数(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.LINE_CNT,
                    (outParam.getString(LstPCTUserResultConsignorDASCHParams.AVG_LINE_COUNT)));
            // 行数/H(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.LINE_CNT_PER_HOUR,
                    (outParam.getString(LstPCTUserResultConsignorDASCHParams.AVG_LINE_COUNT_PER_HOUR)));
            // 数量（ロット）(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.LOT_QTY,
                    (outParam.getString(LstPCTUserResultConsignorDASCHParams.AVG_LOT_QTY)));
            // 数量（ロット）/H(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.LOT_QTY_PER_HOUR,
                    (outParam.getString(LstPCTUserResultConsignorDASCHParams.AVG_LOT_QTY_PER_HOUR)));
            // 数量（バラ）(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.PIECE_QTY,
                    (outParam.getString(LstPCTUserResultConsignorDASCHParams.AVG_PIECE_QTY)));
            // 数量（バラ）/H(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.PIECE_QTY_PER_HOUR,
                    (outParam.getString(LstPCTUserResultConsignorDASCHParams.AVG_PIECE_QTY_PER_HOUR)));
            // 箱/オーダー(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.BOX_CNT_PER_ORDER,
                    (outParam.getString(LstPCTUserResultConsignorDASCHParams.AVG_BOX_COUNT_PER_ORDER)));
            // 行/オーダー(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.LINE_CNT_PER_ORDER,
                    (outParam.getString(LstPCTUserResultConsignorDASCHParams.AVG_LINE_COUNT_PER_ORDER)));
            // ロット/行(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.LOT_QTY_PER_LINE,
                    (outParam.getString(LstPCTUserResultConsignorDASCHParams.AVG_LOT_QTY_PER_LINE_COUNT)));
            // バラ/行(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.PIECE_QTY_PER_LINE,
                    (outParam.getString(LstPCTUserResultConsignorDASCHParams.AVG_PIECE_QTY_PER_LINE_COUNT)));
            // ミス率(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.MISS_RATE,
                    (outParam.getString(LstPCTUserResultConsignorDASCHParams.AVG_MISS_RATE)));
        }
        catch (Exception e)
        {
            e.printStackTrace();
    ...
    protected void errorProcessing()
    {
        ...
        lst_UserResultConsignorList.setVisible(false);
