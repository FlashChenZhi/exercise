// $Id: LstPCTUserResultWorkDateBusiness.java 7707 2010-03-20 07:23:11Z okayama $
        ...
        extends LstPCTUserResultWorkDate
{
    ...
    private static final ListCellKey KEY_LST_AVG_TERMINAL_COUNT =
            new ListCellKey("LST_AVG_TERMINAL_COUNT", new StringCellColumn(), true, false);

    /** lst_UserResultSummaryAvg(LST_AVG_WORK_TIME) */
    private static final ListCellKey KEY_LST_AVG_WORK_TIME =
            new ListCellKey("LST_AVG_WORK_TIME", new StringCellColumn(), true, false);

    /** lst_UserResultSummaryAvg(LST_AVG_ORDER_QTY) */
    private static final ListCellKey KEY_LST_AVG_ORDER_QTY =
            new ListCellKey("LST_AVG_ORDER_QTY", new StringCellColumn(), true, false);

    /** lst_UserResultSummaryAvg(LST_AVG_ORDER_QTY_PER_HOUR) */
    private static final ListCellKey KEY_LST_AVG_ORDER_QTY_PER_HOUR =
            new ListCellKey("LST_AVG_ORDER_QTY_PER_HOUR", new StringCellColumn(), true, false);
    ...
    private static final ListCellKey KEY_LST_WORK_DATE =
            new ListCellKey("LST_WORK_DATE", new DateCellColumn(DateCellColumn.DATE_TYPE_LONG,
    ...
    private static final ListCellKey KEY_LST_WORKER_COUNT =
            new ListCellKey("LST_WORKER_COUNT", new NumberCellColumn(0), true, false);

    /** lst_UserResultWorkDateList(LST_TERMINAL_COUNT) */
    private static final ListCellKey KEY_LST_TERMINAL_COUNT =
            new ListCellKey("LST_TERMINAL_COUNT", new NumberCellColumn(0), true, false);
    ...
    /** lst_UserResultWorkDateList(LST_WORK_TIME) */
    private static final ListCellKey KEY_LST_WORK_TIME =
            new ListCellKey("LST_WORK_TIME", new StringCellColumn(), true, false);

    /** lst_UserResultWorkDateList(LST_ORDER_QTY) */
    private static final ListCellKey KEY_LST_ORDER_QTY =
            new ListCellKey("LST_ORDER_QTY", new NumberCellColumn(0), true, false);

    /** lst_UserResultWorkDateList(LST_ORDER_QTY_PER_HOUR) */
    private static final ListCellKey KEY_LST_ORDER_QTY_PER_HOUR =
            new ListCellKey("LST_ORDER_QTY_PER_HOUR", new NumberCellColumn(0), true, false);
    ...
    private static final ListCellKey KEY_LST_BOX_COUNT_PER_HOUR =
            new ListCellKey("LST_BOX_COUNT_PER_HOUR", new NumberCellColumn(0), true, false);
    ...
    private static final ListCellKey KEY_LST_LINE_COUNT_PER_HOUR =
            new ListCellKey("LST_LINE_COUNT_PER_HOUR", new NumberCellColumn(0), true, false);
    ...
    private static final ListCellKey KEY_LST_LOT_QTY_PER_HOUR =
            new ListCellKey("LST_LOT_QTY_PER_HOUR", new NumberCellColumn(0), true, false);
    ...
    private static final ListCellKey[] LST_USERRESULTSUMMARYAVG_KEYS = {
            ...
            KEY_LST_AVG_WORK_TIME,
            KEY_LST_AVG_ORDER_QTY,
            ...
            KEY_LST_AVG_ORDER_QTY_PER_HOUR,
    ...
    /** lst_UserResultWorkDateList kyes */
            ...
            throws Exception
    {
        ...
        _lcm_lst_UserResultSummaryAvg.setToolTipVisible(KEY_LST_AVG_WORK_TIME, false);
        _lcm_lst_UserResultSummaryAvg.setToolTipVisible(KEY_LST_AVG_ORDER_QTY, false);
        _lcm_lst_UserResultSummaryAvg.setToolTipVisible(KEY_LST_AVG_ORDER_QTY_PER_HOUR, false);
        ...
        _lcm_lst_UserResultWorkDateList =
                new ListCellModel(lst_UserResultWorkDateList, LST_USERRESULTWORKDATELIST_KEYS, locale);
        ...
        _lcm_lst_UserResultWorkDateList.setToolTipVisible(KEY_LST_WORK_TIME, true);
        _lcm_lst_UserResultWorkDateList.setToolTipVisible(KEY_LST_ORDER_QTY, true);
        _lcm_lst_UserResultWorkDateList.setToolTipVisible(KEY_LST_ORDER_QTY_PER_HOUR, true);
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            inparam.set(LstPCTUserResultWorkDateDASCHParams.WORKDAY_FROM,
                    requestParam.get(LstPCTUserResultWorkDateParams.WORKDAY_FROM));
            inparam.set(LstPCTUserResultWorkDateDASCHParams.WORKDAY_TO,
                    requestParam.get(LstPCTUserResultWorkDateParams.WORKDAY_TO));
            inparam.set(LstPCTUserResultWorkDateDASCHParams.MONDAY,
                    requestParam.get(LstPCTUserResultWorkDateParams.MONDAY));
            inparam.set(LstPCTUserResultWorkDateDASCHParams.TUESDAY,
                    requestParam.get(LstPCTUserResultWorkDateParams.TUESDAY));
            inparam.set(LstPCTUserResultWorkDateDASCHParams.WEDNESDAY,
                    requestParam.get(LstPCTUserResultWorkDateParams.WEDNESDAY));
            inparam.set(LstPCTUserResultWorkDateDASCHParams.THURSDAY,
                    requestParam.get(LstPCTUserResultWorkDateParams.THURSDAY));
            inparam.set(LstPCTUserResultWorkDateDASCHParams.FRIDAY,
                    requestParam.get(LstPCTUserResultWorkDateParams.FRIDAY));
            inparam.set(LstPCTUserResultWorkDateDASCHParams.SATURDAY,
                    requestParam.get(LstPCTUserResultWorkDateParams.SATURDAY));
            inparam.set(LstPCTUserResultWorkDateDASCHParams.SUNDAY,
                    requestParam.get(LstPCTUserResultWorkDateParams.SUNDAY));
            inparam.set(LstPCTUserResultWorkDateDASCHParams.CONSIGNOR_CODE,
                    requestParam.get(LstPCTUserResultWorkDateParams.CONSIGNOR_CODE));
            inparam.set(LstPCTUserResultWorkDateDASCHParams.AREA_NO,
                    requestParam.get(LstPCTUserResultWorkDateParams.AREA_NO));
            inparam.set(LstPCTUserResultWorkDateDASCHParams.BATCH_NO,
                    requestParam.get(LstPCTUserResultWorkDateParams.BATCH_NO));
            inparam.set(LstPCTUserResultWorkDateDASCHParams.LEVEL_A,
                    requestParam.get(LstPCTUserResultWorkDateParams.LEVEL_A));
            inparam.set(LstPCTUserResultWorkDateDASCHParams.LEVEL_B,
                    requestParam.get(LstPCTUserResultWorkDateParams.LEVEL_B));
            inparam.set(LstPCTUserResultWorkDateDASCHParams.LEVEL_C,
                    requestParam.get(LstPCTUserResultWorkDateParams.LEVEL_C));
            inparam.set(LstPCTUserResultWorkDateDASCHParams.COLLECT_CONDITION,
                    requestParam.get(LstPCTUserResultWorkDateParams.COLLECT_CONDITION));
            inparam.set(LstPCTUserResultWorkDateDASCHParams.DISPLAY_RANK,
                    requestParam.get(LstPCTUserResultWorkDateParams.DISPLAY_RANK));
            inparam.set(LstPCTUserResultWorkDateDASCHParams.USEDAY_OF_WEEK_FLAG,
                    requestParam.get(LstPCTUserResultWorkDateParams.USEDAY_OF_WEEK_FLAG));
            ...
            for (Params outparam : outparams)
            {
                ...
                line.setValue(KEY_LST_PRODUCTION_RATE,
                ...
                line.setValue(KEY_LST_WORK_TIME, outparam.get(LstPCTUserResultWorkDateDASCHParams.OPERATE_TIME));
                line.setValue(KEY_LST_ORDER_QTY, outparam.get(LstPCTUserResultWorkDateDASCHParams.ORDER_COUNT));
                line.setValue(KEY_LST_ORDER_QTY_PER_HOUR,
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            String avgTermCnt = avghLine.getStringValue(KEY_LST_AVG_TERMINAL_COUNT);
            String avgWorkTime = avghLine.getStringValue(KEY_LST_AVG_WORK_TIME);
            String avgOderCnt = avghLine.getStringValue(KEY_LST_AVG_ORDER_QTY);
            String avgOrderCntPerH = avghLine.getStringValue(KEY_LST_AVG_ORDER_QTY_PER_HOUR);
            ...
            for (int i = 1; i <= _lcm_lst_UserResultWorkDateList.size(); i++)
            {
                ...
                expparam.set(PctUserResultWorkDateListParams.SYS_DAY, DbDateUtil.getTimeStamp());
                expparam.set(PctUserResultWorkDateListParams.SYS_TIME, DbDateUtil.getTimeStamp());
                expparam.set(PctUserResultWorkDateListParams.WORK_DAY_FROM, searchWorkDayFrom);
                expparam.set(PctUserResultWorkDateListParams.WORK_DAY_TO, searchWorkDayTo);
                expparam.set(PctUserResultWorkDateListParams.WEEK_DAY, searchWeekDay);
                expparam.set(PctUserResultWorkDateListParams.BATCH_NO, searchBatchNo);
                expparam.set(PctUserResultWorkDateListParams.LEVEL, searchLevel);
                expparam.set(PctUserResultWorkDateListParams.CONSIGNOR_CODE, searchConsignorCode);
                expparam.set(PctUserResultWorkDateListParams.CONSIGNOR_NAME, searchConsignorName);
                expparam.set(PctUserResultWorkDateListParams.AREA_NO, searchAreaNo);
                expparam.set(PctUserResultWorkDateListParams.AREA_NAME, searchAreaName);
                ...
                expparam.set(PctUserResultWorkDateListParams.WORK_TIME, line.getValue(KEY_LST_WORK_TIME));
                expparam.set(PctUserResultWorkDateListParams.ORDER_CNT, line.getValue(KEY_LST_ORDER_QTY));
                expparam.set(PctUserResultWorkDateListParams.ORDER_CNT_PER_HOUR, line.getValue(KEY_LST_ORDER_QTY_PER_HOUR));
                ...
                expparam.set(PctUserResultWorkDateListParams.PRODUCTION_RATE_AVG, avgProducate);
                expparam.set(PctUserResultWorkDateListParams.HEADS_AVG, avgWorkerCnt);
                expparam.set(PctUserResultWorkDateListParams.CNT_AVG, avgTermCnt);
                expparam.set(PctUserResultWorkDateListParams.WORK_TIME_AVG, avgWorkTime);
                expparam.set(PctUserResultWorkDateListParams.ORDER_CNT_AVG, avgOderCnt);
                expparam.set(PctUserResultWorkDateListParams.ORDER_CNT_PER_HOUR_AVG, avgOrderCntPerH);
                expparam.set(PctUserResultWorkDateListParams.BOX_CNT_AVG, avgBoxCnt);
                expparam.set(PctUserResultWorkDateListParams.BOX_CNT_PER_HOUR_AVG, avgBoxCntPerH);
                expparam.set(PctUserResultWorkDateListParams.LINE_CNT_AVG, avgLineCnt);
                expparam.set(PctUserResultWorkDateListParams.LINE_CNT_PER_HOUR_AVG, avgLineCntPerH);
                expparam.set(PctUserResultWorkDateListParams.LOT_CNT_AVG, avgLotQty);
                expparam.set(PctUserResultWorkDateListParams.LOT_CNT_PER_HOUR_AVG, avgLotQtyPerH);
                expparam.set(PctUserResultWorkDateListParams.PIECE_CNT_AVG, avgPeiceQty);
                expparam.set(PctUserResultWorkDateListParams.PIECE_CNT_PER_HOUR_AVG, avgPeiceQtyPerH);
                expparam.set(PctUserResultWorkDateListParams.BOX_PER_ORDER_AVG, avgBoxPerOder);
                expparam.set(PctUserResultWorkDateListParams.LINE_PER_ORDER_AVG, avgLinePerOder);
                expparam.set(PctUserResultWorkDateListParams.LOT_PER_LINE_AVG, avgLotQtyPerLine);
                expparam.set(PctUserResultWorkDateListParams.PIECE_PER_LINE_AVG, avgPeiceQtyPerLine);
                expparam.set(PctUserResultWorkDateListParams.MISS_AVG, avgMissRate);
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            for (int i = 1; i <= _lcm_lst_UserResultWorkDateList.size(); i++)
            {
                ...
                expparam.set(PctUserResultWorkDateListParams.SYS_DAY, DbDateUtil.getTimeStamp());
                expparam.set(PctUserResultWorkDateListParams.SYS_TIME, DbDateUtil.getTimeStamp());
                expparam.set(PctUserResultWorkDateListParams.WORK_DAY_FROM, WmsFormatter.toDate(searchWorkDayFrom));
                expparam.set(PctUserResultWorkDateListParams.WORK_DAY_TO, WmsFormatter.toDate(searchWorkDayTo));
                expparam.set(PctUserResultWorkDateListParams.WEEK_DAY, searchWeekDay);
                expparam.set(PctUserResultWorkDateListParams.BATCH_NO, searchBatchNo);
                expparam.set(PctUserResultWorkDateListParams.LEVEL, searchLevel);
                expparam.set(PctUserResultWorkDateListParams.CONSIGNOR_CODE, searchConsignorCode);
        ...
        try
        {
            ...
            for (int i = 1; i <= _lcm_lst_UserResultWorkDateList.size(); i++)
            {
                ...
                expparam.set(PctUserResultWorkDateListParams.ORDER_CNT_PER_HOUR,
                        line.getValue(KEY_LST_ORDER_QTY_PER_HOUR));
                expparam.set(PctUserResultWorkDateListParams.BOX_CNT, line.getValue(KEY_LST_BOX_COUNT));
                expparam.set(PctUserResultWorkDateListParams.BOX_CNT_PER_HOUR,
                        line.getValue(KEY_LST_BOX_COUNT_PER_HOUR));
                expparam.set(PctUserResultWorkDateListParams.LINE_CNT, line.getValue(KEY_LST_LINE_COUNT));
                ...
                expparam.set(PctUserResultWorkDateListParams.LINE_PER_ORDER,
                        line.getValue(KEY_LST_LINE_COUNT_PER_ORDER));
                expparam.set(PctUserResultWorkDateListParams.LOT_PER_LINE,
                        line.getValue(KEY_LST_LOT_QTY_PER_LINE_COUNT));
    ...
    protected void setListAvg(Params outParam)
    {
        ...
        try
        {
            ...
            lst_UserResultSummaryAvg.setValue(ListAvg.PRODUCTION_RATE,
                    (outParam.getString(LstPCTUserResultWorkDateDASCHParams.AVG_PRODUCTION_RATE)));
            // 人数(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.WORKER_CNT,
                    (outParam.getString(LstPCTUserResultWorkDateDASCHParams.AVG_WORKER_COUNT)));
            // 台数(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.TERMINAL_CNT,
                    (outParam.getString(LstPCTUserResultWorkDateDASCHParams.AVG_TERMINAL_COUNT)));
            // 作業時間（延べ）(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.TOTAL_WORK_TIME,
                    (outParam.getString(LstPCTUserResultWorkDateDASCHParams.AVG_OPERATE_TIME)));
            // オーダー数(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.ORDER_CNT,
                    (outParam.getString(LstPCTUserResultWorkDateDASCHParams.AVG_ORDER_COUNT)));
            // オーダー数/H(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.ORDER_CNT_PER_HOUR,
                    (outParam.getString(LstPCTUserResultWorkDateDASCHParams.AVG_ORDER_COUNT_PER_HOUR)));
            // 箱数(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.BOX_CNT,
                    (outParam.getString(LstPCTUserResultWorkDateDASCHParams.AVG_BOX_COUNT)));
            // 箱数/H(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.BOX_CNT_PER_HOUR,
                    (outParam.getString(LstPCTUserResultWorkDateDASCHParams.AVG_BOX_COUNT_PER_HOUR)));
            // 行数(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.LINE_CNT,
                    (outParam.getString(LstPCTUserResultWorkDateDASCHParams.AVG_LINE_COUNT)));
            // 行数/H(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.LINE_CNT_PER_HOUR,
                    (outParam.getString(LstPCTUserResultWorkDateDASCHParams.AVG_LINE_COUNT_PER_HOUR)));
            // 数量（ロット）(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.LOT_QTY,
                    (outParam.getString(LstPCTUserResultWorkDateDASCHParams.AVG_LOT_QTY)));
            // 数量（ロット）/H(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.LOT_QTY_PER_HOUR,
                    (outParam.getString(LstPCTUserResultWorkDateDASCHParams.AVG_LOT_QTY_PER_HOUR)));
            // 数量（バラ）(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.PIECE_QTY,
                    (outParam.getString(LstPCTUserResultWorkDateDASCHParams.AVG_PIECE_QTY)));
            // 数量（バラ）/H(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.PIECE_QTY_PER_HOUR,
                    (outParam.getString(LstPCTUserResultWorkDateDASCHParams.AVG_PIECE_QTY_PER_HOUR)));
            // 箱/オーダー(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.BOX_CNT_PER_ORDER,
                    (outParam.getString(LstPCTUserResultWorkDateDASCHParams.AVG_BOX_COUNT_PER_ORDER)));
            // 行/オーダー(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.LINE_CNT_PER_ORDER,
                    (outParam.getString(LstPCTUserResultWorkDateDASCHParams.AVG_LINE_COUNT_PER_ORDER)));
            // ロット/行(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.LOT_QTY_PER_LINE,
                    (outParam.getString(LstPCTUserResultWorkDateDASCHParams.AVG_LOT_QTY_PER_LINE_COUNT)));
            // バラ/行(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.PIECE_QTY_PER_LINE,
                    (outParam.getString(LstPCTUserResultWorkDateDASCHParams.AVG_PIECE_QTY_PER_LINE_COUNT)));
            // ミス率(平均)
            lst_UserResultSummaryAvg.setValue(ListAvg.MISS_RATE,
                    (outParam.getString(LstPCTUserResultWorkDateDASCHParams.AVG_MISS_RATE)));
        }
        catch (Exception e)
        {
            e.printStackTrace();
    ...
    protected void errorProcessing()
    {
        ...
        lst_UserResultWorkDateList.setVisible(false);
