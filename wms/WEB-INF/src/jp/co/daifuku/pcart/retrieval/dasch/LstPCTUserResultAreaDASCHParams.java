// $Id: LstPCTUserResultAreaDASCHParams.java 4075 2009-04-10 09:21:05Z okayama $
 ...
 */
public class LstPCTUserResultAreaDASCHParams
        extends WmsDASCHParams
{
    ...
    /** AVG_ORDER_COUNT_PER_HOUR_AVG */
    public static final ParamKey AVG_ORDER_COUNT_PER_HOUR_AVG = new ParamKey("AVG_ORDER_COUNT_PER_HOUR_AVG");
    ...
    /** GROUP_DATE_SELECT */
    public static final ParamKey GROUP_DATE_SELECT = new ParamKey("GROUP_DATE_SELECT");
    ...
    /** LINE_CNLINE_COUNT_PER_HOURT_PER_HOUR */
    public static final ParamKey LINE_CNLINE_COUNT_PER_HOURT_PER_HOUR = new ParamKey("LINE_CNLINE_COUNT_PER_HOURT_PER_HOUR");
    ...
    /** LOTLOT_QTY_CNT */
    public static final ParamKey LOTLOT_QTY_CNT = new ParamKey("LOTLOT_QTY_CNT");
    ...
    /** TO_WORK_DATE */
    public static final ParamKey TO_WORK_DATE = new ParamKey("TO_WORK_DATE");
    ...
    /** WORKDAY */
    public static final ParamKey WORKDAY = new ParamKey("WORKDAY");
     ...
     * Default constructor
     */
    public LstPCTUserResultAreaDASCHParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public LstPCTUserResultAreaDASCHParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public LstPCTUserResultAreaDASCHParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
