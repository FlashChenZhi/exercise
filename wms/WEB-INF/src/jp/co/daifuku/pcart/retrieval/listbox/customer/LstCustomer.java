...
public class LstCustomer extends Page
{
	...
	/**
	 * ControlID	lst_CustomerList
	 * TemplateKey	W_CustomerList
	 * ControlType	ScrollListCell
	 */
	public jp.co.daifuku.bluedog.ui.control.ScrollListCell lst_CustomerList = jp.co.daifuku.bluedog.ui.control.ScrollListCellFactory.getInstance("lst_CustomerList" , "W_CustomerList");
