// $Id: PctRetWorkingInqListParams.java 4691 2009-07-16 00:28:49Z kumano $
 ...
 */
public class PctRetWorkingInqListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * Default constructor
     */
    public PctRetWorkingInqListParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public PctRetWorkingInqListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public PctRetWorkingInqListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
