// $Id: RestoreBusiness.java 3965 2009-04-06 02:55:05Z admin $
...
// 2008/12/25 K.Matsuda End
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            List tabeles = EmProperties.getList(EmProperties.getProperty("Restore.Tables"));
            //コネクションを取得
            ...
            while (itr.hasNext())
            {
                ...
                BackupUtils.ldFile(filePath, tableName, conn);
            }
            ...
            // write operation log
            //EManagerLogger.writeUserMainteLog(getUserInfo().getUserId(), "Restore");
        }
