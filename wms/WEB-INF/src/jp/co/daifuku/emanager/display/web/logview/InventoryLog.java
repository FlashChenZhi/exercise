// $Id: InventoryLog.java 7765 2010-03-31 02:29:07Z shibamoto $
 ...
 */
public class InventoryLog extends Page
{
	...
	/**
	 * ControlID	btn_SearchPopup
	 * TemplateKey	T_SearchPopup
	 * ControlType	SubmitButton
	 */
	public jp.co.daifuku.bluedog.ui.control.SubmitButton btn_SearchPopup = jp.co.daifuku.bluedog.ui.control.SubmitButtonFactory.getInstance("btn_SearchPopup" , "T_SearchPopup");
	 ...
	 * ControlType	Label
	 */
	public jp.co.daifuku.bluedog.ui.control.Label lbl_Area = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_Area" , "T_Area");
	 ...
	 * TemplateKey	T_Location
	 * ControlType	Label
	 */
	public jp.co.daifuku.bluedog.ui.control.Label lbl_Location = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_Location" , "T_Location");
	...
	/**
	 * ControlID	lbl_InputStyleLocation
	 * TemplateKey	W_InputStyle
	 * ControlType	Label
	 */
	public jp.co.daifuku.bluedog.ui.control.Label lbl_InputStyleLocation = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_InputStyleLocation" , "W_InputStyle");
	 ...
	 * TemplateKey	T_ItemCode
	 * ControlType	Label
	 */
	public jp.co.daifuku.bluedog.ui.control.Label lbl_ItemCode = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_ItemCode" , "T_ItemCode");
	 ...
	 * ControlType	FreeTextBox
	 */
	public jp.co.daifuku.bluedog.ui.control.FreeTextBox txt_ItemCode = jp.co.daifuku.bluedog.ui.control.FreeTextBoxFactory.getInstance("txt_ItemCode" , "T_ItemCode");
	 ...
	 * ControlType	Label
	 */
	public jp.co.daifuku.bluedog.ui.control.Label lbl_LOTNo = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_LOTNo" , "T_LOTNo");
	 ...
	 * ControlType	FreeTextBox
	 */
	public jp.co.daifuku.bluedog.ui.control.FreeTextBox txt_LotNo = jp.co.daifuku.bluedog.ui.control.FreeTextBoxFactory.getInstance("txt_LotNo" , "T_LotNo");
