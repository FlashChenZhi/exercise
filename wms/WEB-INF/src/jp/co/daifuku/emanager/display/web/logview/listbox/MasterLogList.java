// $Id: MasterLogList.java 6715 2010-01-20 01:37:21Z kajiwara $
...
public class MasterLogList extends Page
{
	// Class variables -----------------------------------------------
	...
	public jp.co.daifuku.bluedog.ui.control.Pager pgr_PagerSync = jp.co.daifuku.bluedog.ui.control.PagerFactory.getInstance("pgr_PagerSync" , "T_PagerSync");
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_UserMasterUpdateLog = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_UserMasterUpdateLog" , "T_UserMasterUpdateLog");
