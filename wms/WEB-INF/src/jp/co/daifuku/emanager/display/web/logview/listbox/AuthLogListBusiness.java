// $Id: AuthLogListBusiness.java 3965 2009-04-06 02:55:05Z admin $
...
public class AuthLogListBusiness
        extends AuthLogList
{
            ...
            throws Exception
    {
        ...
        //画面名称をセットする
        this.lbl_ListName.setResourceKey("TLE-T0102");
        ...
        Date startDate = (Date)this.session.getAttribute(LOGDATESTART);
        Date endDate = (Date)this.session.getAttribute(LOGDATEEND);
        ...
        try
        {
            ...
            //			 合計数取得
            //	total = handler.findCountAuthView(stTime, edTime, userId, logClassInt);
            ...
            {
                // 合計数取得				
                total = handler.findCountAuthTemp(stTime, edTime, userId, logClassInt);
            }
            //			 1ページの表示件数
            ...
            throws Exception
    {
        ...
        {
            // 合計数取得
            logInfo_Array = logHandler.findAllAuthTemp(stTime, edTime, userId, logClassInt, next_index, next_end);
        }
