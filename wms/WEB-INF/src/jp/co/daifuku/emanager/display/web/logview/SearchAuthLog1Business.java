// $Id: SearchAuthLog1Business.java 3965 2009-04-06 02:55:05Z admin $
 ...
 */
public class SearchAuthLog1Business
        extends SearchAuthLog1
        implements EmConstants
{
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            LogInfo[] logInfo = handler.findAllAuthLogbyDistinct();
            ...
            throws Exception
    {
        ...
        String userId = userhandler.getUserID() == null ? ""
                                                       : userhandler.getUserID();
        String ipAddr = this.httpRequest.getRemoteAddr();
            ...
            throws Exception
    {
        ...
        // 2画面目に遷移
        forward("/emanager/logview/SearchAuthLog2.do");
    }

    /**
     * 「全取消」ボタンがクリックされたときに呼び出されます。
     * @param e  ActionEvent
     * @throws Exception
     */
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            // 削除処理
            handler.deleteAuthTempByFileName(fileName);
    ...
    /**
     * CSVファイルの「検索」ボタンがクリックされたときに呼び出されます。
     * @param e  ActionEvent
     * @throws Exception
     */
            ...
            throws Exception
    {
        ...
        // パラメータ情報の作成
        param.addParameter(CsvLogFileListBusiness.KEY, CsvLogFileListBusiness.COM_AUTHENTICATIONLOG);
