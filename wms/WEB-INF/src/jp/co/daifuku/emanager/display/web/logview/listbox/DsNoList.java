// $Id: DsNoList.java 6715 2010-01-20 01:37:21Z kajiwara $
...
public class DsNoList extends Page
{
	...
	// Class variables -----------------------------------------------
	public jp.co.daifuku.bluedog.ui.control.Label lbl_In_SettingName = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_In_SettingName" , "T_In_SettingName");
	...
	public jp.co.daifuku.bluedog.ui.control.ScrollListCell lst_DsNoList = jp.co.daifuku.bluedog.ui.control.ScrollListCellFactory.getInstance("lst_DsNoList" , "T_DsNoList");
