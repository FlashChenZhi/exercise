// $Id: SearchMainteLog2Business.java 3965 2009-04-06 02:55:05Z admin $
...
public class SearchMainteLog2Business
        extends SearchMainteLog2
        implements EmConstants
{
            ...
            throws Exception
    {
        ...
        // ユーザメンテナンス
        item1.setValue("1");
        item1.setResourceKey("PUL-T0007");
        item1.setSelected(true);

        // 端末メンテナンス
        item2.setValue("2");
        item2.setResourceKey("PUL-T0008");
        item2.setSelected(false);

        // ロールメンテナンス
        item3.setValue("3");
        item3.setResourceKey("PUL-T0009");
        item3.setSelected(false);

        // メニューメンテナンス
        item4.setValue("4");
        item4.setResourceKey("PUL-T0010");
        item4.setSelected(false);

        // システムメンテナンス
        item5.setValue("5");
        item5.setResourceKey("PUL-T0011");
    ...
    {
        //1画面目に遷移
        forward("/emanager/logview/SearchMainteLog1.do");
    }
            ...
            throws Exception
    {
        ...
        //処理中画面->結果画面
        redirect("/emanager/logview/listbox/MainteLogList.do", param, "/Progress.do");
    }
