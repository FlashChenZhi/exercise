// $Id: CsvLogExport.java 3965 2009-04-06 02:55:05Z admin $
...
public class CsvLogExport extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.Tab tab = jp.co.daifuku.bluedog.ui.control.TabFactory.getInstance("tab" , "T_MakeLog");
	...
	public jp.co.daifuku.bluedog.ui.control.Label lbl_ExportLog = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_ExportLog" , "T_ExportLog");
	public jp.co.daifuku.bluedog.ui.control.CheckBox chk_AuthLog = jp.co.daifuku.bluedog.ui.control.CheckBoxFactory.getInstance("chk_AuthLog" , "T_AuthLog");
	public jp.co.daifuku.bluedog.ui.control.CheckBox chk_MainteLog = jp.co.daifuku.bluedog.ui.control.CheckBoxFactory.getInstance("chk_MainteLog" , "T_MainteLog");
