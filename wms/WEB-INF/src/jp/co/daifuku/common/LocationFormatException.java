...
/**<jp>
 * ロケーションのフォーマット編集において、異常が発生した場合に使用する例外です。
 * 
 * <BR>
...
public class LocationFormatException
        extends CommonException
{
    ...
    public LocationFormatException(String msg)
    {
        super(msg);
    }
    ...
    public LocationFormatException(int msgNo, Object[] params)
    {
     ...
     * @param cause 例外の発生元
     */
    public LocationFormatException(Throwable cause)
    {
        super(cause);
    }
