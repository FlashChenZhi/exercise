 ...
 * @author  $Author: ota $
 */
public class Width extends Page
{
	...
	/**
	 * ControlID	lbl_WidthId
	 * TemplateKey	AST_WidthId
	 * ControlType	Label
	 */
	public jp.co.daifuku.bluedog.ui.control.Label lbl_WidthId = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_WidthId" , "AST_WidthId");

	/**
	 * ControlID	txt_WidthId
	 * TemplateKey	AST_WidthId
	 * ControlType	NumberTextBox
	 */
	public jp.co.daifuku.bluedog.ui.control.NumberTextBox txt_WidthId = jp.co.daifuku.bluedog.ui.control.NumberTextBoxFactory.getInstance("txt_WidthId" , "AST_WidthId");
	 ...
	 * ControlType	NumberTextBox
	 */
	public jp.co.daifuku.bluedog.ui.control.NumberTextBox txt_Width = jp.co.daifuku.bluedog.ui.control.NumberTextBoxFactory.getInstance("txt_Width" , "AST_Width");

	/**
	 * ControlID	lbl_MaxStorage
	 * TemplateKey	AST_MaxStorage
	 * ControlType	Label
	 */
	public jp.co.daifuku.bluedog.ui.control.Label lbl_MaxStorage = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_MaxStorage" , "AST_MaxStorage");

	/**
	 * ControlID	txt_MaxStorage
	 * TemplateKey	AST_MaxStorage
	 * ControlType	NumberTextBox
	 */
	public jp.co.daifuku.bluedog.ui.control.NumberTextBox txt_MaxStorage = jp.co.daifuku.bluedog.ui.control.NumberTextBoxFactory.getInstance("txt_MaxStorage" , "AST_MaxStorage");

	/**
	 * ControlID	lbl_WidthName
	 * TemplateKey	AST_WidthName
	 * ControlType	Label
	 */
	public jp.co.daifuku.bluedog.ui.control.Label lbl_WidthName = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_WidthName" , "AST_WidthName");

	/**
	 * ControlID	txt_WidthName
	 * TemplateKey	AST_WidthName
	 * ControlType	FreeTextBox
	 */
	public jp.co.daifuku.bluedog.ui.control.FreeTextBox txt_WidthName = jp.co.daifuku.bluedog.ui.control.FreeTextBoxFactory.getInstance("txt_WidthName" , "AST_WidthName");
	...
	/**
	 * ControlID	lst_Width
	 * TemplateKey	AST_S_Width
	 * ControlType	ListCell
	 */
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_Width = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_Width" , "AST_S_Width");
