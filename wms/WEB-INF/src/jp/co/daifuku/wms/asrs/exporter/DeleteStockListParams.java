 ...
 */
public class DeleteStockListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * @throws IOException
     */
    public DeleteStockListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public DeleteStockListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
