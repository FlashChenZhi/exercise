// $Id: LstAsWorkDetailBusiness.java 6841 2010-01-22 11:06:31Z kanda $
 ...
 * 作業明細一覧の画面処理を行います。
 *
 * @version $Revision: 6841 $, $Date: 2010-01-22 20:06:31 +0900 (金, 22 1 2010) $
        ...
        extends LstAsWorkDetail
{
     ...
     */
    protected void lst_SearchCondition_Make(LstAsWorkDetailDASCHParams inParam)
    {
        try
        {
            // リストセルエリアをクリアする
            ...
            lst_SearchCondition.setValue(2, inParam.getString(LstAsWorkDetailDASCHParams.WORK_NO));
        }
        catch (Exception exc)
        {
            exc.printStackTrace();
