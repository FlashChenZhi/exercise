// $Id: AsNoPlanRetrievalListDASCHParams.java 4547 2009-06-30 05:54:36Z kumano $
 ...
 */
public class AsNoPlanRetrievalListDASCHParams
        extends WmsDASCHParams
{
     ...
     * Default constructor
     */
    public AsNoPlanRetrievalListDASCHParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public AsNoPlanRetrievalListDASCHParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public AsNoPlanRetrievalListDASCHParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
