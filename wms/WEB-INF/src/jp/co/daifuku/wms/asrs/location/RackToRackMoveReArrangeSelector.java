// $Id: RackToRackMoveReArrangeSelector.java 5977 2009-11-17 09:02:10Z ota $
 ...
 * 指定されたゾーンの空棚が存在しない場合、通常検索を行いません。
 * <BR>
...
public class RackToRackMoveReArrangeSelector
        extends RackToRackMoveSelector
{
    ...
    {
        return ("$Revision: 5977 $,$Date: 2009-11-17 18:02:10 +0900 (火, 17 11 2009) $");
    }
    ...
    public RackToRackMoveReArrangeSelector(Connection conn, ZoneSelector zs)
    {
        super(conn, zs);
    }
