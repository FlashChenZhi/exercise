 ...
 * @author  $Author: admin $
 */
public class LstAsLocationStock extends Page
{
	...
	/**
	 * ControlID	lst_StockByLocationList
	 * TemplateKey	W_StockByLocationList
	 * ControlType	ListCell
	 */
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_StockByLocationList = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_StockByLocationList" , "W_StockByLocationList");
