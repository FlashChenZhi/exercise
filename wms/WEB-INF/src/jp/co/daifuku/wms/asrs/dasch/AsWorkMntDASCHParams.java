// $Id: AsWorkMntDASCHParams.java 3208 2009-03-02 05:42:52Z arai $
 ...
 */
public class AsWorkMntDASCHParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * @throws IOException
     */
    public AsWorkMntDASCHParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public AsWorkMntDASCHParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
