// $Id: ReStoringPlanInqListParams.java 7348 2010-03-04 04:17:40Z kishimoto $
 ...
 */
public class ReStoringPlanInqListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * Default constructor
     */
    public ReStoringPlanInqListParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public ReStoringPlanInqListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public ReStoringPlanInqListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
