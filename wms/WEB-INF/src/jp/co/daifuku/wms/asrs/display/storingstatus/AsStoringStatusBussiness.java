...
/**
 * AS/RS 格納状況照会の画面処理を行います。
 *
 * @version $Revision: 1.2 $, $Date: 2009/02/24 02:08:20 $
        ...
        extends AsStoringStatus
{
    ...
    private ListCellModel _lcm_lst_AsStoringStatus;
            ...
            throws Exception
    {
        ...
        _lcm_lst_AsStoringStatus = new ListCellModel(lst_AsStoringStatus, LST_ASSTORINGSTATUS_KEYS, locale);
