// $Id: ASRSNoPlanStorageListParams.java 4592 2009-07-03 02:48:47Z kumano $
 ...
 */
public class ASRSNoPlanStorageListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * Default constructor
     */
    public ASRSNoPlanStorageListParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public ASRSNoPlanStorageListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public ASRSNoPlanStorageListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
