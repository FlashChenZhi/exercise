 ...
 * @author  $Author: admin $
 */
public class LstAsStoragePlan extends Page
{
	...
	/**
	 * ControlID	lst_ASRSStoragePlanList
	 * TemplateKey	W_ASRSStoragePlanList
	 * ControlType	ListCell
	 */
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_ASRSStoragePlanList = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_ASRSStoragePlanList" , "W_ASRSStoragePlanList");
