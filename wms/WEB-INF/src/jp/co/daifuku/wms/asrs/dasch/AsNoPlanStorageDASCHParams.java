 ...
 */
public class AsNoPlanStorageDASCHParams
        extends WmsDASCHParams
{
    ...
    public static final ParamKey RETRIEVAL_STATION_NO = new ParamKey("RETRIEVAL_STATION_NO");

    /** SEARCH_DATE */
    public static final ParamKey SEARCH_DATE = new ParamKey("SEARCH_DATE");

    /** SETTING_UNITKEY */
    public static final ParamKey SETTING_UNITKEY = new ParamKey("SETTING_UNITKEY");
    ...
    /** STORAGE_STATION_NO */
    public static final ParamKey STORAGE_STATION_NO = new ParamKey("STORAGE_STATION_NO");
     ...
     * Default constructor
     */
    public AsNoPlanStorageDASCHParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public AsNoPlanStorageDASCHParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public AsNoPlanStorageDASCHParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
