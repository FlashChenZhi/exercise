// $Id: ASRSNoPlanRetrievalListParams.java 4596 2009-07-03 05:26:21Z kumano $
 ...
 */
public class ASRSNoPlanRetrievalListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * Default constructor
     */
    public ASRSNoPlanRetrievalListParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public ASRSNoPlanRetrievalListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public ASRSNoPlanRetrievalListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
