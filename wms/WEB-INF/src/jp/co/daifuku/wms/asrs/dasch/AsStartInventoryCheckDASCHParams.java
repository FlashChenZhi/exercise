// $Id: AsStartInventoryCheckDASCHParams.java 3208 2009-03-02 05:42:52Z arai $
 ...
 */
public class AsStartInventoryCheckDASCHParams
        extends Params
{
    //------------------------------------------------------------
    ...
    /** 終了検索日時 */
    public static final ParamKey SEARCH_TO_DATE = new ParamKey("SEARCH_TO_DATE");
    // DFKLOOK end
     ...
     * Default constructor
     */
    public AsStartInventoryCheckDASCHParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public AsStartInventoryCheckDASCHParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public AsStartInventoryCheckDASCHParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
