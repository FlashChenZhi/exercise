// $Id: AsNoPlanRetrievalListDASCH.java 4804 2009-08-10 06:26:35Z shibamoto $
...
import static jp.co.daifuku.wms.asrs.dasch.AsNoPlanRetrievalListDASCHParams.*;
...
/**
 * AS/RS 予定外出庫作業リスト発行に必要なリストボックスや帳票の検索処理を行います。
 *
 * @version $Revision: 4804 $, $Date:: 2009-08-10 15:26:35 +0900#$
 * @author  BusiTune 1.0 Generator.
 * @author  Last commit: $Author: shibamoto $
 */
public class AsNoPlanRetrievalListDASCH
        extends AbstractWmsDASCH
{
     ...
     * @param ui ユーザ情報
     */
    public AsNoPlanRetrievalListDASCH(Connection conn, Class parent, Locale locale, DfkUserInfo ui)
    {
            ...
            throws CommonException
    {
        ...
        if (isSet)
        {
            ...
            // ソート順
            // 作業No.、出庫棚、ｵｰﾀﾞNo.、商品ｺｰﾄﾞ、ﾛｯﾄNo.　の昇順
            // 作業No.
