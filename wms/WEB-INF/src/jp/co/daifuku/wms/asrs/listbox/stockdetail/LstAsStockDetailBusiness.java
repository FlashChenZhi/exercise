        ...
        extends LstAsStockDetail
{
     ...
     * @throws Exception
     */
    public void lst_SearchConditionTwoColumn_EnterKey(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_SearchConditionTwoColumn_TabKey(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_SearchConditionTwoColumn_InputComplete(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_SearchConditionTwoColumn_Server(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_SearchConditionTwoColumn_Change(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_LocationDetailListIncludeB_EnterKey(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_LocationDetailListIncludeB_TabKey(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_LocationDetailListIncludeB_InputComplete(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_LocationDetailListIncludeB_ColumClick(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_LocationDetailListIncludeB_Server(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_LocationDetailListIncludeB_Change(ActionEvent e)
            throws Exception
    {
    }
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            // DFKLOOK:ここから修正
            // Businessから受け取ったパラメータを保持
            viewState.setObject(ViewStateKeys.PROCESS_TYPE, requestParam.get(LstAsStockDetailParams.PROCESS_TYPE));

            // 検索条件表示
            lst_SearchConditionTwoColumn_Make(inparam);
            
            // 親画面からエリアNoが渡されていない場合
            if (StringUtil.isBlank(requestParam.getString(LstAsStockDetailParams.AREA_NO)))
            {
                // 対象データはありませんでした。
            ...
            // 親画面から棚Noが渡されていない場合
            if (StringUtil.isBlank(requestParam.getString(LstAsStockDetailParams.LOCATION_NO)))
            {
                // (6003100){0}を入力してください。
                message.setMsgResourceKey(WmsMessageFormatter.format(6003100, DispResources.getText("LBL-W0138")));
                return;
            }
            // DFKLOOK:ここまで修正
        ...
        catch (Exception ex)
        {
            ...
            // DFKLOOK:ここから修正
            // リストセル不可視対応
            lst_LocationDetailListIncludeB.setVisible(false);
            // DFKLOOK:ここまで修正
        }
        finally
        {
            ...
            throws Exception
    {
        ...
        ListCellLine line2 = _lcm_lst_SearchConditionTwoColumn.get(1);
        outparam.set(LstAsStockDetailParams.AREA_NO, line2.getStringValue(KEY_LST_COLUMN_2));
        outparam.set(LstAsStockDetailParams.AREA_NAME, line2.getValue(KEY_LST_COLUMN_4));
        // 検索条件二行目
        lst_SearchConditionTwoColumn.setCurrentRow(2);
        ListCellLine line3 = _lcm_lst_SearchConditionTwoColumn.get(2);
        outparam.set(LstAsStockDetailParams.LOCATION_NO, line3.getStringValue(KEY_LST_COLUMN_2));
        // DFKLOOK:ここまで修正
     ...
     * @throws Exception 全ての例外を報告します。
     */
    protected void lst_SearchConditionTwoColumn_Make(LstAsStockDetailDASCHParams param)
            throws Exception
    {
        // コネクション生成
        Connection conn = null;
        ...
        try
        {
            ...
            // エリアマスタ情報コントローラー
            AreaController areaCnt = new AreaController(conn, getClass());

            // 検索条件一行目設定(エリアNo.、エリア名称)
            ListCellLine line = _lcm_lst_SearchConditionTwoColumn.getNewLine();
            line.setValue(KEY_LST_SEARCH_CONDITION, DispResources.getText("LBL-W0228"));
            line.setValue(KEY_LST_COLUMN_2, param.getString(LstAsStockDetailDASCHParams.AREA_NO));
            line.setValue(KEY_LST_COLUMN_3, DispResources.getText("LBL-W0229"));
            if (WmsParam.ALL_AREA_NO.equals(param.getString(LstAsStockDetailDASCHParams.AREA_NO)))
            {
                line.setValue(KEY_LST_COLUMN_4, DisplayText.getText("CMB-W0023"));
            }
            else
            {
                line.setValue(KEY_LST_COLUMN_4,
                        areaCnt.getAreaName(param.getString(LstAsStockDetailDASCHParams.AREA_NO)));
            }
            ...
            line.setValue(KEY_LST_SEARCH_CONDITION, DispResources.getText("LBL-W0138"));
            String location = areaCnt.toParamLocation(param.getString(LstAsStockDetailDASCHParams.LOCATION_NO));
            line.setValue(KEY_LST_COLUMN_2, areaCnt.toDispLocation(
                    param.getString(LstAsStockDetailDASCHParams.AREA_NO), location));
            lst_SearchConditionTwoColumn_SetLineToolTip(line);
            _lcm_lst_SearchConditionTwoColumn.add(line);
        }
        catch (Exception ex)
        {
            ...
            // リストボックスのクリアを行います
            _lcm_lst_SearchConditionTwoColumn.resetEditRow();
            _lcm_lst_SearchConditionTwoColumn.resetHighlight();
