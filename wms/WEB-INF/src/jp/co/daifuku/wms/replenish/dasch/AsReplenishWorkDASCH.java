...
import static jp.co.daifuku.wms.replenish.dasch.AsReplenishWorkDASCHParams.*;

/**
 * AS/RS 補充作業リスト発行に必要なリストボックスや帳票の検索処理を行います。
 *
 * @version $Revision: 7585 $, $Date: 2010-03-15 20:21:44 +0900 (月, 15 3 2010) $
 * @author  BusiTune 1.0 Generator.
 * @author  Last commit: $Author: ota $
 */
public class AsReplenishWorkDASCH
        extends AbstractWmsDASCH
{
     ...
     * @param ui ユーザ情報
     */
    public AsReplenishWorkDASCH(Connection conn, Class parent, Locale locale, DfkUserInfo ui)
    {
            ...
            throws CommonException
    {
        ...
        for (MoveWorkInfo ent : ents)
        {
            ...
            // 補充元エリア(名称)
            p.set(RETRIEVAL_AREA_NAME, ent.getValue(Area.AREA_NAME));
            // 作業区分
    ...
    private SearchKey createSearchKey(Params param, boolean isSet)
    {
        ...
        // 取得条件
        key.setSettingUnitKey((String[])param.get(AS_SETTING_UKEYS), true);
        ...
        key.setJoin(MoveWorkInfo.WORK_CONN_KEY, WorkInfo.JOB_NO);
