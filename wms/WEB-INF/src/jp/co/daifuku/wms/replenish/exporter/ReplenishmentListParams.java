// $Id: ReplenishmentListParams.java 7400 2010-03-05 11:45:20Z okayama $
 ...
 */
public class ReplenishmentListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * Default constructor
     */
    public ReplenishmentListParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public ReplenishmentListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public ReplenishmentListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
