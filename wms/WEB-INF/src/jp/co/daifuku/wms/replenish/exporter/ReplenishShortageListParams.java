 ...
 */
public class ReplenishShortageListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * Default constructor
     */
    public ReplenishShortageListParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public ReplenishShortageListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public ReplenishShortageListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
