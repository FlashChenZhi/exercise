// $Id: LstInventoryJobNoDASCHParams.java 3208 2009-03-02 05:42:52Z arai $
 ...
 */
public class LstInventoryJobNoDASCHParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * Default constructor
     */
    public LstInventoryJobNoDASCHParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public LstInventoryJobNoDASCHParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public LstInventoryJobNoDASCHParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
