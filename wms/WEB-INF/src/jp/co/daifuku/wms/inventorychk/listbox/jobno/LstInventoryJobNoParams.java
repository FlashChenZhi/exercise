// $Id: LstInventoryJobNoParams.java 7389 2010-03-05 09:29:24Z okayama $
 ...
 */
public class LstInventoryJobNoParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * デフォルトコンストラクターです。
     */
    public LstInventoryJobNoParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public LstInventoryJobNoParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public LstInventoryJobNoParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
