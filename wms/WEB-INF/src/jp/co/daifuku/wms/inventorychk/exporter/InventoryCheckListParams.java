// $Id: InventoryCheckListParams.java 4662 2009-07-14 10:04:34Z kumano $
 ...
 *
 * @version $Revision: 4662 $, $Date:: 2009-07-14 19:04:34 +0900#$
 * @author  BusiTune 1.0 Generator.
 * @author  Last commit: $Author: kumano $
 */
public class InventoryCheckListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * Default constructor
     */
    public InventoryCheckListParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public InventoryCheckListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public InventoryCheckListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
