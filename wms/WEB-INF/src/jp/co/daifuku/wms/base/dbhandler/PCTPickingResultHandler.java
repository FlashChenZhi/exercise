// $Id: PCTPickingResultHandler.java 3213 2009-03-02 06:59:20Z arai $
...
/**
 * PCTPICKINGRESULT用のデータベースハンドラです。
 * 
...
public class PCTPickingResultHandler
        extends AbstractDBHandler
{
     ...
     */
    public PCTPickingResultHandler(Connection conn)
    {
        // super(conn, PCTPickingResult.STORE_NAME) ;
    ...
    {
        return "$Id: PCTPickingResultHandler.java 3213 2009-03-02 06:59:20Z arai $" ;
    }
}
