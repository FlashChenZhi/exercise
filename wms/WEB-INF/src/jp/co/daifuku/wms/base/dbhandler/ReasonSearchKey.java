// $Id: ReasonSearchKey.java,v 1.1.1.1 2009/02/10 08:55:29 arai Exp $
// Handler v3.8
        ...
        extends DefaultSQLSearchKey
{
     ...
     * 生成します。
     */
    public ReasonSearchKey()
    {
        super(Reason.STORE_NAME) ;
    }
    ...
    {
        setKey(Reason.REASON_TYPE, HandlerUtil.toObject(value)) ;
    }
    ...
    {
        setKey(Reason.REASON_TYPE, ArrayUtil.toObjectArray(values), true) ;
    }
    ...
    {
        setKey(Reason.REASON_TYPE, ArrayUtil.toObjectArray(values), !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(Reason.REASON_TYPE, ArrayUtil.toObjectArray(values), and_or_toNext) ;
    }
    ...
    {
        setKey(Reason.REASON_TYPE, HandlerUtil.toObject(value), compcode, "", "", true) ;
    }
    ...
    {
        setKey(Reason.REASON_TYPE, HandlerUtil.toObject(value), compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(Reason.REASON_TYPE, HandlerUtil.toObject(value), compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setOrder(Reason.REASON_TYPE, ascorder) ;
    }
    ...
    {
        setCollect(Reason.REASON_TYPE, sqlfunc, null) ;
    }

    /**
     * 理由区分に対する名称(<code>REASON_NAME</code>)の検索値をセットします。
     * 
     * @param value 理由区分に対する名称(<code>REASON_NAME</code>)<br>
     * 文字列の検索値をセット理由区分に対する名称(<code>REASON_NAME</code>)します。
     */
    public void setReasonName(String value)
    {
        setKey(Reason.REASON_NAME, value) ;
    }

    /**
     * 理由区分に対する名称(<code>REASON_NAME</code>)の検索値をセットします。<br>
     * 検索条件として、この次に指定されるものとは"AND"で結ばれます。
     * 
    ...
    {
        setKey(Reason.REASON_NAME, values, true) ;
    }
    ...
    {
        setKey(Reason.REASON_NAME, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(Reason.REASON_NAME, values, and_or_toNext) ;
    }
    ...
    {
        setKey(Reason.REASON_NAME, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(Reason.REASON_NAME, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(Reason.REASON_NAME, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }

    /**
     * 理由区分に対する名称(<code>REASON_NAME</code>)のソート順をセットします。
     * 
     * @param ascorder 昇順(true)又は降順(false)を指定します。
     */
    public void setReasonNameOrder(boolean ascorder)
    {
        setOrder(Reason.REASON_NAME, ascorder) ;
    }
    ...
    /**
     * 理由区分に対する名称(<code>REASON_NAME</code>)のグループ順をセットします。
     */
    public void setReasonNameGroup()
    {
        setGroup(Reason.REASON_NAME) ;
    }
    ...
    /**
     * 理由区分に対する名称(<code>REASON_NAME</code>)の情報取得を設定します。
     */
    public void setReasonNameCollect()
    {
        setCollect(Reason.REASON_NAME) ;
    }
    ...
    {
        setCollect(Reason.REASON_NAME, sqlfunc, null) ;
    }
    ...
    {
        setKey(Reason.LAST_USED_DATE, value) ;
    }
    ...
    {
        setKey(Reason.LAST_USED_DATE, values, true) ;
    }
    ...
    {
        setKey(Reason.LAST_USED_DATE, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(Reason.LAST_USED_DATE, values, and_or_toNext) ;
    }
    ...
    {
        setKey(Reason.LAST_USED_DATE, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(Reason.LAST_USED_DATE, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(Reason.LAST_USED_DATE, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setOrder(Reason.LAST_USED_DATE, ascorder) ;
    }
    ...
    {
        setGroup(Reason.LAST_USED_DATE) ;
    }
    ...
    {
        setCollect(Reason.LAST_USED_DATE) ;
    }
    ...
    {
        setCollect(Reason.LAST_USED_DATE, sqlfunc, null) ;
    }
    ...
    {
        setKey(Reason.REGIST_DATE, value) ;
    }
    ...
    {
        setKey(Reason.REGIST_DATE, values, true) ;
    }
    ...
    {
        setKey(Reason.REGIST_DATE, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(Reason.REGIST_DATE, values, and_or_toNext) ;
    }
    ...
    {
        setKey(Reason.REGIST_DATE, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(Reason.REGIST_DATE, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(Reason.REGIST_DATE, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setOrder(Reason.REGIST_DATE, ascorder) ;
    }
    ...
    {
        setCollect(Reason.REGIST_DATE, sqlfunc, null) ;
    }
    ...
    {
        setKey(Reason.REGIST_PNAME, value) ;
    }
    ...
    {
        setKey(Reason.REGIST_PNAME, values, true) ;
    }
    ...
    {
        setKey(Reason.REGIST_PNAME, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(Reason.REGIST_PNAME, values, and_or_toNext) ;
    }
    ...
    {
        setKey(Reason.REGIST_PNAME, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(Reason.REGIST_PNAME, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(Reason.REGIST_PNAME, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setOrder(Reason.REGIST_PNAME, ascorder) ;
    }
    ...
    {
        setCollect(Reason.REGIST_PNAME) ;
    }
    ...
    {
        setCollect(Reason.REGIST_PNAME, sqlfunc, null) ;
    }
    ...
    {
        setKey(Reason.LAST_UPDATE_DATE, value) ;
    }
    ...
    {
        setKey(Reason.LAST_UPDATE_DATE, values, true) ;
    }
    ...
    {
        setKey(Reason.LAST_UPDATE_DATE, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(Reason.LAST_UPDATE_DATE, values, and_or_toNext) ;
    }
    ...
    {
        setKey(Reason.LAST_UPDATE_DATE, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(Reason.LAST_UPDATE_DATE, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(Reason.LAST_UPDATE_DATE, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setOrder(Reason.LAST_UPDATE_DATE, ascorder) ;
    }
    ...
    {
        setGroup(Reason.LAST_UPDATE_DATE) ;
    }
    ...
    {
        setCollect(Reason.LAST_UPDATE_DATE) ;
    }
    ...
    {
        setCollect(Reason.LAST_UPDATE_DATE, sqlfunc, null) ;
    }
    ...
    {
        setKey(Reason.LAST_UPDATE_PNAME, value) ;
    }
    ...
    {
        setKey(Reason.LAST_UPDATE_PNAME, values, true) ;
    }
    ...
    {
        setKey(Reason.LAST_UPDATE_PNAME, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(Reason.LAST_UPDATE_PNAME, values, and_or_toNext) ;
    }
    ...
    {
        setKey(Reason.LAST_UPDATE_PNAME, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(Reason.LAST_UPDATE_PNAME, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(Reason.LAST_UPDATE_PNAME, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setOrder(Reason.LAST_UPDATE_PNAME, ascorder) ;
    }
    ...
    {
        setGroup(Reason.LAST_UPDATE_PNAME) ;
    }
    ...
    {
        setCollect(Reason.LAST_UPDATE_PNAME) ;
    }
    ...
    {
        setCollect(Reason.LAST_UPDATE_PNAME, sqlfunc, null) ;
    }
    ...
    {
        return "$Id: ReasonSearchKey.java,v 1.1.1.1 2009/02/10 08:55:29 arai Exp $" ;
    }
}
