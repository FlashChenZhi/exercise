// $Id: ShipResultHandler.java 5127 2009-10-13 12:20:06Z ota $
...
public class ShipResultHandler
        extends AbstractDBHandler
{
     ...
     */
    public ShipResultHandler(Connection conn)
    {
        // super(conn, ShipResult.STORE_NAME) ;
        super(conn, ShipResult.$storeMetaData) ;
    }
    ...
    {
        return "$Id: ShipResultHandler.java 5127 2009-10-13 12:20:06Z ota $" ;
    }
}
