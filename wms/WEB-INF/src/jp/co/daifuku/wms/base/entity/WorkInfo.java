// $Id: WorkInfo.java 5127 2009-10-13 12:20:06Z ota $
        ...
        implements SystemDefine
{
    ...
    //------------------------------------------------------------
    /** テーブル名定義 */
    public static final String STORE_NAME = "DNWORKINFO" ;
     ...
     * RFT作業状態フラグ :             RFT_STATUS_FLAG     varchar2(1)
     ...
     * オーダー連番(間口No) :          ORDER_SERIAL_NO     varchar2(1)
    ...
    /** フィールド定義 (RFT作業状態フラグ(<code>RFT_STATUS_FLAG</code>)) */
    public static final FieldName RFT_STATUS_FLAG = new FieldName(STORE_NAME, "RFT_STATUS_FLAG") ;
    ...
    /** フィールド定義 (オーダー連番(間口No)(<code>ORDER_SERIAL_NO</code>)) */
    public static final FieldName ORDER_SERIAL_NO = new FieldName(STORE_NAME, "ORDER_SERIAL_NO") ;
    ...
    /** フィールド定義 (スキップ回数(<code>SKIP_CNT</code>)) */
    public static final FieldName SKIP_CNT = new FieldName(STORE_NAME, "SKIP_CNT") ;
    ...
    /**
     * RFT作業状態フラグ(<code>RFT_STATUS_FLAG</code>) に値をセットします。
     * @param value セットする値RFT_STATUS_FLAG
     */
    public void setRftStatusFlag(String value)  // @@GEN_V3@@
    {
        setValue(RFT_STATUS_FLAG, value);
    }

    /**
     * RFT作業状態フラグ(<code>RFT_STATUS_FLAG</code>) から値を取得します。
     * @return RFT_STATUS_FLAG
     */
    public String getRftStatusFlag()  // @@GEN_V3@@
    {
        return String.valueOf(getValue(RFT_STATUS_FLAG, "")) ;
    }
    ...
    /**
     * オーダー連番(間口No)(<code>ORDER_SERIAL_NO</code>) に値をセットします。
     * @param value セットする値ORDER_SERIAL_NO
     */
    public void setOrderSerialNo(String value)  // @@GEN_V3@@
    {
        setValue(ORDER_SERIAL_NO, value);
    }

    /**
     * オーダー連番(間口No)(<code>ORDER_SERIAL_NO</code>) から値を取得します。
     * @return ORDER_SERIAL_NO
     */
    public String getOrderSerialNo()  // @@GEN_V3@@
    {
        return String.valueOf(getValue(ORDER_SERIAL_NO, "")) ;
    }
    ...
    /**
     * スキップ回数(<code>SKIP_CNT</code>) に値をセットします。
     * @param value セットする値SKIP_CNT
     */
    public void setSkipCnt(int value)  // @@GEN_V3@@
    {
        setValue(SKIP_CNT, HandlerUtil.toObject(value));
    }

    /**
     * スキップ回数(<code>SKIP_CNT</code>) から値を取得します。
     * @return SKIP_CNT
     */
    public int getSkipCnt()  // @@GEN_V3@@
    {
        return getBigDecimal(SKIP_CNT, BigDecimal.ZERO).intValue() ;
    }
    ...
    {
        return "$Id: WorkInfo.java 5127 2009-10-13 12:20:06Z ota $" ;
    }
}
