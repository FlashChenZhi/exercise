// $Id: FixedLocateHistImpAlterKey.java 5127 2009-10-13 12:20:06Z ota $
...
public class FixedLocateHistImpAlterKey
        extends DefaultSQLAlterKey
{
    ...
    public static final StoreMetaData $storeMetaData = FixedLocateHistImp.$storeMetaData;
     ...
     * インスタンスを生成します。
     */
    public FixedLocateHistImpAlterKey()
    {
    ...
    {
        setAdhocUpdateValue(FixedLocateHistImp.LOG_DATE, value) ;
    }
    ...
    {
        setAdhocUpdateValue(FixedLocateHistImp.LOG_DATE_GMT, value) ;
    }
    ...
    {
        setAdhocUpdateValue(FixedLocateHistImp.USER_ID, value) ;
    }
    ...
    {
        setAdhocUpdateValue(FixedLocateHistImp.USER_NAME, value) ;
    }
    ...
    {
        setAdhocUpdateValue(FixedLocateHistImp.TERMINAL_NO, value) ;
    }
    ...
    {
        setAdhocUpdateValue(FixedLocateHistImp.TERMINAL_NAME, value) ;
    }
    ...
    {
        setAdhocUpdateValue(FixedLocateHistImp.IP_ADDRESS, value) ;
    }
    ...
    {
        setAdhocUpdateValue(FixedLocateHistImp.DS_NO, value) ;
    }
    ...
    {
        setAdhocUpdateValue(FixedLocateHistImp.PAGENAMERESOURCEKEY, value) ;
    }
    ...
    {
        setAdhocUpdateValue(FixedLocateHistImp.UPDATE_KIND, value) ;
    }
    ...
    {
        setAdhocUpdateValue(FixedLocateHistImp.CONSIGNOR_CODE, value) ;
    }
    ...
    {
        setAdhocUpdateValue(FixedLocateHistImp.ITEM_CODE, value) ;
    }
    ...
    {
        setAdhocUpdateValue(FixedLocateHistImp.AREA_NO, value) ;
    }
    ...
    {
        setAdhocUpdateValue(FixedLocateHistImp.LOCATION_NO, value) ;
    }
    ...
    {
        setAdhocUpdateValue(FixedLocateHistImp.REPLENISHMENT_QTY, HandlerUtil.toObject(value)) ;
    }
     ...
     * 文字列の検索値を修正後棚No.(<code>UPDATE_LOCATION_NO</code>)にセットします。
     */
    ...
    /**
     * 修正後棚No.(<code>UPDATE_LOCATION_NO</code>)の更新値をセットします。
     * @param value 修正後棚No.(<code>UPDATE_LOCATION_NO</code>)更新値
     */
    public void updateUpdateLocationNo(String value)
    {
        setAdhocUpdateValue(FixedLocateHistImp.UPDATE_LOCATION_NO, value) ;
    }
     ...
     * 数値の検索値を修正後最大保管量(<code>UPDATE_REPLENISHMENT_QTY</code>)にセットします。
     */
    ...
    /**
     * 修正後最大保管量(<code>UPDATE_REPLENISHMENT_QTY</code>)の更新値をセットします。
     * @param value 修正後最大保管量(<code>UPDATE_REPLENISHMENT_QTY</code>)更新値
     */
    public void updateUpdateReplenishmentQty(int value)
    {
        setAdhocUpdateValue(FixedLocateHistImp.UPDATE_REPLENISHMENT_QTY, HandlerUtil.toObject(value)) ;
    }
    ...
    {
        setAdhocUpdateValue(FixedLocateHistImp.LOCATION_STYLE, value) ;
    }
    ...
    {
        setUpdateWithColumn(FixedLocateHistImp.REPLENISHMENT_QTY, source, addvalue);
    }

    /**
     * 修正後最大保管量(<code>UPDATE_REPLENISHMENT_QTY</code>)に他のカラムを基本にした加減算値セットします。
     * @param source セットするカラム
     * @param addvalue 加減算する値。加減算なしの時は nullをセットします。
     */
    public void updateUpdateReplenishmentQtyWithColumn(FieldName source, BigDecimal addvalue)
    {
        setUpdateWithColumn(FixedLocateHistImp.UPDATE_REPLENISHMENT_QTY, source, addvalue);
    }
    ...
    {
        return "$Id: FixedLocateHistImpAlterKey.java 5127 2009-10-13 12:20:06Z ota $" ;
    }
}
