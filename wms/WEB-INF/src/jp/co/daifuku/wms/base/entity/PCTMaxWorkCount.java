// $Id: PCTMaxWorkCount.java 3213 2009-03-02 06:59:20Z arai $
        ...
        implements SystemDefine
{
    ...
    //------------------------------------------------------------
    /** テーブル名定義 */
    public static final String STORE_NAME = "DMPCTMAXWORKCOUNT" ;

    /*
     * テーブル名: DMPCTMAXWORKCOUNT
     * エリアNo. :                     AREA_NO             varchar2(4)
     * 最大作業数 :                    MAX_WORK_CNT        number
    ...
    /** フィールド定義 (最大作業数(<code>MAX_WORK_CNT</code>)) */
    public static final FieldName MAX_WORK_CNT = new FieldName(STORE_NAME, "MAX_WORK_CNT") ;
    ...
    /**
     * 最大作業数(<code>MAX_WORK_CNT</code>) に値をセットします。
     * @param value セットする値MAX_WORK_CNT
     */
    public void setMaxWorkCnt(int value)  // @@GEN_V3@@
    {
        setValue(MAX_WORK_CNT, HandlerUtil.toObject(value));
    }

    /**
     * 最大作業数(<code>MAX_WORK_CNT</code>) から値を取得します。
     * @return MAX_WORK_CNT
     */
    public int getMaxWorkCnt()  // @@GEN_V3@@
    {
        return getBigDecimal(MAX_WORK_CNT, BigDecimal.ZERO).intValue() ;
    }
    ...
    {
        return "$Id: PCTMaxWorkCount.java 3213 2009-03-02 06:59:20Z arai $" ;
    }
}
