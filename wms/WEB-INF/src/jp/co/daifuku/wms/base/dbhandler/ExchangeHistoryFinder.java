// $Id: ExchangeHistoryFinder.java 5129 2009-10-13 12:52:36Z ota $
...
/**
 * データベースからExchangeHistory表を検索してResultSetからEntity配列を
 * 取得するためのクラスです。<br>
 * 画面に検索結果を一覧表示する場合このクラスを使用します。
 *
 * @version $Revision: 5129 $, $Date: 2009-10-13 21:52:36 +0900 (火, 13 10 2009) $
 * @author  shimizu
 * @author  Last commit: $Author: ota $
 */
public class ExchangeHistoryFinder
        extends AbstractDBFinder
{
     ...
     */
    public ExchangeHistoryFinder(Connection conn)
    {
    ...
    {
        return ("$Revision: 5129 $,$Date: 2009-10-13 21:52:36 +0900 (火, 13 10 2009) $") ;
    }
}
