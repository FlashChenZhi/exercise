// $Id: MoveResult.java 5127 2009-10-13 12:20:06Z ota $
        ...
        implements SystemDefine
{
    ...
    //------------------------------------------------------------
    /** テーブル名定義 */
    public static final String STORE_NAME = "DNMOVERESULT" ;
     ...
     * 移動出庫ユーザ名称 :            RETRIEVAL_USER_NAME varchar2(40)
     ...
     * 移動入庫ユーザ名称 :            STORAGE_USER_NAME   varchar2(40)
    ...
    /** フィールド定義 (移動出庫ユーザ名称(<code>RETRIEVAL_USER_NAME</code>)) */
    public static final FieldName RETRIEVAL_USER_NAME = new FieldName(STORE_NAME, "RETRIEVAL_USER_NAME") ;
    ...
    /** フィールド定義 (移動入庫ユーザ名称(<code>STORAGE_USER_NAME</code>)) */
    public static final FieldName STORAGE_USER_NAME = new FieldName(STORE_NAME, "STORAGE_USER_NAME") ;
    ...
    /**
     * 移動出庫ユーザ名称(<code>RETRIEVAL_USER_NAME</code>) に値をセットします。
     * @param value セットする値RETRIEVAL_USER_NAME
     */
    public void setRetrievalUserName(String value)  // @@GEN_V3@@
    {
        setValue(RETRIEVAL_USER_NAME, value);
    }

    /**
     * 移動出庫ユーザ名称(<code>RETRIEVAL_USER_NAME</code>) から値を取得します。
     * @return RETRIEVAL_USER_NAME
     */
    public String getRetrievalUserName()  // @@GEN_V3@@
    {
        return String.valueOf(getValue(RETRIEVAL_USER_NAME, "")) ;
    }
    ...
    /**
     * 移動入庫ユーザ名称(<code>STORAGE_USER_NAME</code>) に値をセットします。
     * @param value セットする値STORAGE_USER_NAME
     */
    public void setStorageUserName(String value)  // @@GEN_V3@@
    {
        setValue(STORAGE_USER_NAME, value);
    }

    /**
     * 移動入庫ユーザ名称(<code>STORAGE_USER_NAME</code>) から値を取得します。
     * @return STORAGE_USER_NAME
     */
    public String getStorageUserName()  // @@GEN_V3@@
    {
        return String.valueOf(getValue(STORAGE_USER_NAME, "")) ;
    }
    ...
    {
        return "$Id: MoveResult.java 5127 2009-10-13 12:20:06Z ota $" ;
    }
}
