// $Id: ReceivingResultHandler.java 5127 2009-10-13 12:20:06Z ota $
...
public class ReceivingResultHandler
        extends AbstractDBHandler
{
     ...
     */
    public ReceivingResultHandler(Connection conn)
    {
        // super(conn, ReceivingResult.STORE_NAME) ;
        super(conn, ReceivingResult.$storeMetaData) ;
    }
    ...
    {
        return "$Id: ReceivingResultHandler.java 5127 2009-10-13 12:20:06Z ota $" ;
    }
}
