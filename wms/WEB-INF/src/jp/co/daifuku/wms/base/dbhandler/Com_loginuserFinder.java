// $Id: Com_loginuserFinder.java 8061 2013-05-24 10:24:10Z kishimoto $
...
/**
 * データベースからCom_loginuser表を検索してResultSetからEntity配列を
 * 取得するためのクラスです。<br>
 ...
 */
public class Com_loginuserFinder
        extends AbstractDBFinder
{
     ...
     */
    public Com_loginuserFinder(Connection conn)
    {
    ...
    {
        return ("$Revision: 8061 $,$Date: 2013-05-24 19:24:10 +0900 (金, 24 5 2013) $") ;
    }
}
