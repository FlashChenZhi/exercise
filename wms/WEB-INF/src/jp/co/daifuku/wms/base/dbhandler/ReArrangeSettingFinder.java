// $Id: ReArrangeSettingFinder.java 4122 2009-04-10 10:58:38Z ota $
...
/**
 * データベースからReArrangeSetting表を検索してResultSetからEntity配列を
 * 取得するためのクラスです。<br>
 ...
 */
public class ReArrangeSettingFinder
        extends AbstractDBFinder
{
     ...
     */
    public ReArrangeSettingFinder(Connection conn)
    {
        super(conn, ReArrangeSetting.$storeMetaData) ;
    }
