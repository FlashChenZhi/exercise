        ...
        extends LstItem
{
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            inparam.set(LstItemDASCHParams.IS_ITEM_CODE_SEARCH, Boolean.TRUE);
            ...
            lst_SearchCondition.setValue(2, inparam.getString(LstItemDASCHParams.ITEM_CODE));
            // DFKLOOK end
            ...
            throws Exception
    {
        ...
        outparam.set(LstItemParams.TEMPORARY_TYPE_NAME, line.getValue(KEY_LST_TEMPORARY_TYPE_NAME));
        outparam.set(LstItemParams.TEMPORARY_TYPE, line.getValue(KEY_HIDDEN_TEMPORARY_TYPE));
