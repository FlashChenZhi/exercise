// $Id: RftAlterKey.java 4152 2009-04-16 04:51:03Z rnakai $
// $LastChangedRevision: 4152 $
 ...
 * RFT用の更新キークラスです。
 *
 * @version $Revision: 4152 $, $Date: 2009-04-16 13:51:03 +0900 (木, 16 4 2009) $
 * @author  ss
        ...
        extends DefaultSQLAlterKey
{
    ...
    public static final StoreMetaData $storeMetaData = Rft.$storeMetaData;
    ...
    {
        setAdhocUpdateValue(Rft.RFT_NO, value) ;
    }
    ...
    {
        setAdhocUpdateValue(Rft.USER_ID, value) ;
    }
    ...
    {
        setAdhocUpdateValue(Rft.JOB_TYPE, value) ;
    }
    ...
    {
        setAdhocUpdateValue(Rft.STATUS_FLAG, value) ;
    }
     ...
     * 文字列の検索値を端末区分(<code>TERMINAL_TYPE</code>)にセットします。
     */
    ...
    /**
     * 端末区分(<code>TERMINAL_TYPE</code>)の更新値をセットします。
     * @param value 端末区分(<code>TERMINAL_TYPE</code>)更新値
     */
    public void updateTerminalType(String value)
    {
        setAdhocUpdateValue(Rft.TERMINAL_TYPE, value) ;
    }
     ...
     * 文字列の検索値を端末IPアドレス(<code>IP_ADDRESS</code>)にセットします。
     */
    ...
    /**
     * 端末IPアドレス(<code>IP_ADDRESS</code>)の更新値をセットします。
     * @param value 端末IPアドレス(<code>IP_ADDRESS</code>)更新値
     */
    public void updateIpAddress(String value)
    {
        setAdhocUpdateValue(Rft.IP_ADDRESS, value) ;
    }
     ...
     * 文字列の検索値を無線状態フラグ(<code>RADIO_FLAG</code>)にセットします。
     */
    ...
    /**
     * 無線状態フラグ(<code>RADIO_FLAG</code>)の更新値をセットします。
     * @param value 無線状態フラグ(<code>RADIO_FLAG</code>)更新値
     */
    public void updateRadioFlag(String value)
    {
        setAdhocUpdateValue(Rft.RADIO_FLAG, value) ;
    }
     ...
     * 日付の検索値を休憩開始日時(<code>REST_START_DATE</code>)にセットします。
     */
    ...
    /**
     * 休憩開始日時(<code>REST_START_DATE</code>)の更新値をセットします。
     * @param value 休憩開始日時(<code>REST_START_DATE</code>)更新値
     */
    public void updateRestStartDate(Date value)
    {
        setAdhocUpdateValue(Rft.REST_START_DATE, value) ;
    }
     ...
     * 文字列の検索値を作業区分詳細(<code>JOB_DETAILS</code>)にセットします。
     */
    ...
    /**
     * 作業区分詳細(<code>JOB_DETAILS</code>)の更新値をセットします。
     * @param value 作業区分詳細(<code>JOB_DETAILS</code>)更新値
     */
    public void updateJobDetails(String value)
    {
        setAdhocUpdateValue(Rft.JOB_DETAILS, value) ;
    }
    ...
    {
        setAdhocUpdateValue(Rft.CONSIGNOR_CODE, value) ;
    }
    ...
    {
        setAdhocUpdateValue(Rft.AREA_NO, value) ;
    }
    ...
    {
        setAdhocUpdateValue(Rft.BATCH_SEQ_NO, value) ;
    }
    ...
    {
        setAdhocUpdateValue(Rft.SETTING_UNIT_KEY, value) ;
    }
    ...
    {
        setAdhocUpdateValue(Rft.REGIST_DATE, value) ;
    }
    ...
    {
        setAdhocUpdateValue(Rft.REGIST_PNAME, value) ;
    }
    ...
    {
        setAdhocUpdateValue(Rft.LAST_UPDATE_DATE, value) ;
    }
    ...
    {
        setAdhocUpdateValue(Rft.LAST_UPDATE_PNAME, value) ;
    }
    ...
    {
        return "$Id: RftAlterKey.java 4152 2009-04-16 04:51:03Z rnakai $" ;
    }
}
