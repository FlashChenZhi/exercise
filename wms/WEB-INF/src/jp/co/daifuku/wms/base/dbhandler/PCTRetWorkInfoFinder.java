// $Id: PCTRetWorkInfoFinder.java 3213 2009-03-02 06:59:20Z arai $
...
/**
 * データベースからPCTRetWorkInfo表を検索してResultSetからEntity配列を
 * 取得するためのクラスです。<br>
 ...
 */
public class PCTRetWorkInfoFinder
        extends AbstractDBFinder
{
     ...
     */
    public PCTRetWorkInfoFinder(Connection conn)
    {
        super(conn, PCTRetWorkInfo.$storeMetaData) ;
    }
