// $Id: WorkListHandler.java 5151 2009-10-19 04:50:37Z okamura $
        ...
        extends AbstractDBHandler
{
     ...
     */
    public WorkListHandler(Connection conn)
    {
        // super(conn, WorkList.STORE_NAME) ;
        super(conn, WorkList.$storeMetaData) ;
    }
    ...
    {
        return "$Id: WorkListHandler.java 5151 2009-10-19 04:50:37Z okamura $" ;
    }
}
