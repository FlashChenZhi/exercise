// $Id: HostToEWNHandler.java 2841 2009-01-20 21:50:48Z admin $
        ...
        extends AbstractDBHandler
{
     ...
     */
    public HostToEWNHandler(Connection conn)
    {
        // super(conn, HostToEWN.STORE_NAME) ;
        super(conn, HostToEWN.$storeMetaData);
    }
    ...
    {
        return "$Id: HostToEWNHandler.java 2841 2009-01-20 21:50:48Z admin $";
    }
}
