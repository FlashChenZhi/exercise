// $Id: PCTRetResultFinder.java 3213 2009-03-02 06:59:20Z arai $
...
/**
 * データベースからPCTRetResult表を検索してResultSetからEntity配列を
 * 取得するためのクラスです。<br>
 ...
 */
public class PCTRetResultFinder
        extends AbstractDBFinder
{
     ...
     */
    public PCTRetResultFinder(Connection conn)
    {
