// $Id: ItemHistoryHandler.java 5127 2009-10-13 12:20:06Z ota $
...
public class ItemHistoryHandler
        extends AbstractDBHandler
{
     ...
     */
    public ItemHistoryHandler(Connection conn)
    {
        // super(conn, ItemHistory.STORE_NAME) ;
        super(conn, ItemHistory.$storeMetaData) ;
    }
    ...
    {
        return "$Id: ItemHistoryHandler.java 5127 2009-10-13 12:20:06Z ota $" ;
    }
}
