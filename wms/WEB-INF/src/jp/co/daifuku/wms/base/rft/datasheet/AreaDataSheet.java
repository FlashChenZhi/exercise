// $Id: AreaDataSheet.java 8041 2012-05-17 09:39:40Z nagao $
        ...
        extends BasicDSModel
{
    ...
    //------------------------------------------------------------
    /** DATASHEET_NAME */
    private static final String DATASHEET_NAME = "AreaDataSheet";

    /** AREA_NAME */
    public static final DSKey AREA_NAME = new DSKey("AREA_NAME", new DSStringField(), false, 0);
     ...
     * @param locale Locale
     */
    public AreaDataSheet(DataSheetFactory dsf, Locale locale)
    {
    ...
    {
        return "$Id: AreaDataSheet.java 8041 2012-05-17 09:39:40Z nagao $";
    }
}
//end of class
