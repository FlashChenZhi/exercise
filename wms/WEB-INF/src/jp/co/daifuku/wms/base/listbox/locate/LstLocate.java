// $Id: LstLocate.java 6033 2009-11-18 05:01:54Z fukuwa $
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 6033 $, $Date: 2009-11-18 14:01:54 +0900 (水, 18 11 2009) $
 * @author  $Author: fukuwa $
 */
public class LstLocate extends Page
{
	...
	/**
	 * ControlID	lst_Locate
	 * TemplateKey	W_ASRSLocationList
	 * ControlType	ScrollListCell
	 */
	public jp.co.daifuku.bluedog.ui.control.ScrollListCell lst_Locate = jp.co.daifuku.bluedog.ui.control.ScrollListCellFactory.getInstance("lst_Locate" , "W_ASRSLocationList");
