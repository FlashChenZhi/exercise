// $Id: StockHistoryFinder.java 5127 2009-10-13 12:20:06Z ota $
...
/**
 * データベースからStockHistory表を検索してResultSetからEntity配列を
 * 取得するためのクラスです。<br>
 ...
 */
public class StockHistoryFinder
        extends AbstractDBFinder
{
     ...
     */
    public StockHistoryFinder(Connection conn)
    {
        super(conn, StockHistory.$storeMetaData) ;
    }
