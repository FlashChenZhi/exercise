// $Id: DeleteStockAlterKey.java 4872 2009-08-21 02:25:41Z ota $
...
public class DeleteStockAlterKey
        extends DefaultSQLAlterKey
{
    ...
    public static final StoreMetaData $storeMetaData = DeleteStock.$storeMetaData;
    ...
    {
        setAdhocUpdateValue(DeleteStock.SYSTEM_CONN_KEY, value) ;
    }
     ...
     * 文字列の検索値を商品ｺｰﾄﾞ(<code>ITEM_CODE</code>)にセットします。
     */
    ...
    /**
     * 商品ｺｰﾄﾞ(<code>ITEM_CODE</code>)の更新値をセットします。
     * @param value 商品ｺｰﾄﾞ(<code>ITEM_CODE</code>)更新値
     */
    public void updateItemCode(String value)
    {
        setAdhocUpdateValue(DeleteStock.ITEM_CODE, value) ;
    }
     ...
     * 文字列の検索値をﾛｯﾄNo.(<code>LOT_NO</code>)にセットします。
     */
    ...
    /**
     * ﾛｯﾄNo.(<code>LOT_NO</code>)の更新値をセットします。
     * @param value ﾛｯﾄNo.(<code>LOT_NO</code>)更新値
     */
    public void updateLotNo(String value)
    {
        setAdhocUpdateValue(DeleteStock.LOT_NO, value) ;
    }
    ...
    {
        setAdhocUpdateValue(DeleteStock.AREA_NO, value) ;
    }
     ...
     * 文字列の検索値を棚(<code>LOCATION_NO</code>)にセットします。
     */
    ...
    /**
     * 棚(<code>LOCATION_NO</code>)の更新値をセットします。
     * @param value 棚(<code>LOCATION_NO</code>)更新値
     */
    public void updateLocationNo(String value)
    {
        setAdhocUpdateValue(DeleteStock.LOCATION_NO, value) ;
    }
    ...
    {
        setAdhocUpdateValue(DeleteStock.STOCK_QTY, HandlerUtil.toObject(value)) ;
    }
    ...
    {
        setAdhocUpdateValue(DeleteStock.STORAGE_DATE, value) ;
    }
    ...
    {
        setAdhocUpdateValue(DeleteStock.REGIST_DATE, value) ;
    }
    ...
    {
        setAdhocUpdateValue(DeleteStock.REGIST_PNAME, value) ;
    }
    ...
    {
        setAdhocUpdateValue(DeleteStock.LAST_UPDATE_DATE, value) ;
    }
    ...
    {
        setAdhocUpdateValue(DeleteStock.LAST_UPDATE_PNAME, value) ;
    }
    ...
    {
        setUpdateWithColumn(DeleteStock.STOCK_QTY, source, addvalue);
    }
    ...
    {
        return "$Id: DeleteStockAlterKey.java 4872 2009-08-21 02:25:41Z ota $" ;
    }
}
