 ...
 * @author  $Author: admin $
 */
public class LstItemName extends Page
{
	...
	/**
	 * ControlID	lst_Item
	 * TemplateKey	W_ItemNameList
	 * ControlType	ScrollListCell
	 */
	public jp.co.daifuku.bluedog.ui.control.ScrollListCell lst_Item = jp.co.daifuku.bluedog.ui.control.ScrollListCellFactory.getInstance("lst_Item" , "W_ItemNameList");
