// $Id: PalletHandler.java 4122 2009-04-10 10:58:38Z ota $
        ...
        extends AbstractDBHandler
{
     ...
     */
    public PalletHandler(Connection conn)
    {
        // super(conn, Pallet.STORE_NAME) ;
        super(conn, Pallet.$storeMetaData) ;
    }
    ...
    {
        return "$Id: PalletHandler.java 4122 2009-04-10 10:58:38Z ota $" ;
    }
}
