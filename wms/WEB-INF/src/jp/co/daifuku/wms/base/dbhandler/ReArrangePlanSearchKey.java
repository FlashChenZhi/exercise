// $Id: ReArrangePlanSearchKey.java 4122 2009-04-10 10:58:38Z ota $
...
public class ReArrangePlanSearchKey
        extends DefaultSQLSearchKey
{
    ...
    {
        setOrder(ReArrangePlan.SCHEDULE_NO, ascorder) ;
    }
    ...
    {
        setGroup(ReArrangePlan.SCHEDULE_NO) ;
    }
    ...
    {
        setCollect(ReArrangePlan.SCHEDULE_NO) ;
    }
    ...
    {
        setCollect(ReArrangePlan.SCHEDULE_NO, sqlfunc, null) ;
    }
    ...
    {
        setOrder(ReArrangePlan.WH_STATION_NO, ascorder) ;
    }
    ...
    {
        setGroup(ReArrangePlan.WH_STATION_NO) ;
    }
    ...
    {
        setCollect(ReArrangePlan.WH_STATION_NO) ;
    }
    ...
    {
        setCollect(ReArrangePlan.WH_STATION_NO, sqlfunc, null) ;
    }
    ...
    {
        setOrder(ReArrangePlan.AISLE_STATION_NO, ascorder) ;
    }
    ...
    {
        setGroup(ReArrangePlan.AISLE_STATION_NO) ;
    }
    ...
    {
        setCollect(ReArrangePlan.AISLE_STATION_NO) ;
    }
    ...
    {
        setCollect(ReArrangePlan.AISLE_STATION_NO, sqlfunc, null) ;
    }
     ...
     * 文字列の検索値をセット配置替え区分(<code>REARRANGE_TYPE</code>)します。
     */
    ...
    /**
     * 配置替え区分(<code>REARRANGE_TYPE</code>)のソート順をセットします。
     * 
     * @param ascorder 昇順(true)又は降順(false)を指定します。
     */
    public void setRearrangeTypeOrder(boolean ascorder)
    {
        setOrder(ReArrangePlan.REARRANGE_TYPE, ascorder) ;
    }
     ...
     */
    @Deprecated
    public void setRearrangeTypeOrder(int prio, boolean ascorder)
    {
        setOrder(ReArrangePlan.REARRANGE_TYPE, ascorder) ;
    }

    /**
     * 配置替え区分(<code>REARRANGE_TYPE</code>)のグループ順をセットします。
     */
    public void setRearrangeTypeGroup()
    {
        setGroup(ReArrangePlan.REARRANGE_TYPE) ;
    }
     ...
     */
    @Deprecated
    public void setRearrangeTypeGroup(int prio)
    {
        setGroup(ReArrangePlan.REARRANGE_TYPE) ;
    }

    /**
     * 配置替え区分(<code>REARRANGE_TYPE</code>)の情報取得を設定します。
     */
    public void setRearrangeTypeCollect()
    {
        setCollect(ReArrangePlan.REARRANGE_TYPE) ;
    }
     ...
     * {0} は、カラム名に置き換えられます。
     */
    public void setRearrangeTypeCollect(String sqlfunc)
    {
        setCollect(ReArrangePlan.REARRANGE_TYPE, sqlfunc, null) ;
    }
    ...
    {
        setOrder(ReArrangePlan.PALLET_ID, ascorder) ;
    }
    ...
    {
        setGroup(ReArrangePlan.PALLET_ID) ;
    }
    ...
    {
        setCollect(ReArrangePlan.PALLET_ID) ;
    }
    ...
    {
        setCollect(ReArrangePlan.PALLET_ID, sqlfunc, null) ;
    }
    ...
    {
        setOrder(ReArrangePlan.STATUS_FLAG, ascorder) ;
    }
    ...
    {
        setGroup(ReArrangePlan.STATUS_FLAG) ;
    }
    ...
    {
        setCollect(ReArrangePlan.STATUS_FLAG) ;
    }
    ...
    {
        setCollect(ReArrangePlan.STATUS_FLAG, sqlfunc, null) ;
    }
    ...
    {
        setOrder(ReArrangePlan.REGIST_DATE, ascorder) ;
    }
    ...
    {
        setGroup(ReArrangePlan.REGIST_DATE) ;
    }
    ...
    {
        setCollect(ReArrangePlan.REGIST_DATE) ;
    }
    ...
    {
        setCollect(ReArrangePlan.REGIST_DATE, sqlfunc, null) ;
    }
    ...
    {
        setOrder(ReArrangePlan.REGIST_PNAME, ascorder) ;
    }
    ...
    {
        setGroup(ReArrangePlan.REGIST_PNAME) ;
    }
    ...
    {
        setCollect(ReArrangePlan.REGIST_PNAME) ;
    }
    ...
    {
        setCollect(ReArrangePlan.REGIST_PNAME, sqlfunc, null) ;
    }
    ...
    {
        setOrder(ReArrangePlan.LAST_UPDATE_DATE, ascorder) ;
    }
    ...
    {
        setGroup(ReArrangePlan.LAST_UPDATE_DATE) ;
    }
    ...
    {
        setCollect(ReArrangePlan.LAST_UPDATE_DATE) ;
    }
    ...
    {
        setCollect(ReArrangePlan.LAST_UPDATE_DATE, sqlfunc, null) ;
    }
    ...
    {
        setOrder(ReArrangePlan.LAST_UPDATE_PNAME, ascorder) ;
    }
    ...
    {
        setGroup(ReArrangePlan.LAST_UPDATE_PNAME) ;
    }
    ...
    {
        setCollect(ReArrangePlan.LAST_UPDATE_PNAME) ;
    }
    ...
    {
        setCollect(ReArrangePlan.LAST_UPDATE_PNAME, sqlfunc, null) ;
    }
    ...
    {
        return "$Id: ReArrangePlanSearchKey.java 4122 2009-04-10 10:58:38Z ota $" ;
    }
}
