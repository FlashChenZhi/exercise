// $Id: FixedLocateHistory.java 5127 2009-10-13 12:20:06Z ota $
...
/**
 * FIXEDLOCATEHISTORYのエンティティクラスです。
 *
...
public class FixedLocateHistory
        ...
        implements SystemDefine
{
    ...
    //------------------------------------------------------------
    /** テーブル名定義 */
    public static final String STORE_NAME = "DNFIXEDLOCATEHISTORY" ;

    /*
     * テーブル名: DNFIXEDLOCATEHISTORY
     ...
     * 修正後棚No. :                   UPDATE_LOCATION_NO  varchar2(8)
    ...
    {
        return "$Id: FixedLocateHistory.java 5127 2009-10-13 12:20:06Z ota $" ;
    }
}
