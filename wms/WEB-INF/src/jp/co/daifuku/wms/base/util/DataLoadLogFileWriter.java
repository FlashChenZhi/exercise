...
//$Id: DataLoadLogFileWriter.java 87 2008-10-04 03:07:38Z admin $
/*
 ...
 * @author  $Author: admin $
 */
public class DataLoadLogFileWriter
{
    // Class fields --------------------------------------------------
    /**
     * 正常異常区分(異常)
     ...
     */
    public DataLoadLogFileWriter(String str)
    {
        _messageVec = new Vector<String>(200);
        setFileName(str);
    }
