// $Id: WorkingUnitHandler.java 5127 2009-10-13 12:20:06Z ota $
...
public class WorkingUnitHandler
        extends AbstractDBHandler
{
     ...
     */
    public WorkingUnitHandler(Connection conn)
    {
        // super(conn, WorkingUnit.STORE_NAME) ;
        super(conn, WorkingUnit.$storeMetaData) ;
    }
    ...
    {
        return "$Id: WorkingUnitHandler.java 5127 2009-10-13 12:20:06Z ota $" ;
    }
}
