// $Id: ReportNoPlanRetrieval.java 1545 2008-11-25 09:33:35Z dmori $
...
/**
 * REPORTNOPLANRETRIEVALのエンティティクラスです。
 *
...
public class ReportNoPlanRetrieval
        extends AbstractEntity
{
    ...
    //------------------------------------------------------------
    /** Name of File */
    public static final String STORE_NAME = "REPORTNOPLANRETRIEVAL";

    /*
     * ファイル名: REPORTNOPLANRETRIEVAL
     ...
     * 出庫エリア :                    RESULT_AREA_NO      X(4)
     * 出庫棚 :                        RESULT_LOCATION_NO  N(8)
    ...
    /**
     * 出庫エリア(<code>RESULT_AREA_NO</code>) に値をセットします。
    ...
    /**
     * 出庫エリア(<code>RESULT_AREA_NO</code>) から値を取得します。
     * @return    出庫エリア
     */
    ...
    /**
     * 出庫棚(<code>RESULT_LOCATION_NO</code>) に値をセットします。
    ...
    /**
     * 出庫棚(<code>RESULT_LOCATION_NO</code>) から値を取得します。
     * @return    出庫棚
     */
    ...
    {
        return "$Id: ReportNoPlanRetrieval.java 1545 2008-11-25 09:33:35Z dmori $";
    }
}
