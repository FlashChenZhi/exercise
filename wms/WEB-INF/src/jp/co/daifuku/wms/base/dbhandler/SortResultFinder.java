// $Id: SortResultFinder.java 5127 2009-10-13 12:20:06Z ota $
...
/**
 * データベースからSortResult表を検索してResultSetからEntity配列を
 * 取得するためのクラスです。<br>
        ...
        extends AbstractDBFinder
{
     ...
     */
    public SortResultFinder(Connection conn)
    {
        super(conn, SortResult.$storeMetaData) ;
    }
