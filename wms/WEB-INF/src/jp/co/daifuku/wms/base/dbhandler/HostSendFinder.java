// $Id: HostSendFinder.java 5127 2009-10-13 12:20:06Z ota $
...
/**
 * データベースからHostSend表を検索してResultSetからEntity配列を
 * 取得するためのクラスです。<br>
        ...
        extends AbstractDBFinder
{
    ...
    {
        super(conn, HostSend.$storeMetaData) ;
    }
