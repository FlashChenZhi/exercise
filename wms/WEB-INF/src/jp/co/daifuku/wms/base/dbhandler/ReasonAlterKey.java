// $Id: ReasonAlterKey.java,v 1.1.1.1 2009/02/10 08:55:29 arai Exp $
// Handler v3.8
        ...
        extends DefaultSQLAlterKey
{
    ...
    public static final StoreMetaData $storeMetaData = Reason.$storeMetaData;
    ...
    {
        setAdhocUpdateValue(Reason.REASON_TYPE, HandlerUtil.toObject(value)) ;
    }
     ...
     * 文字列の検索値を理由区分に対する名称(<code>REASON_NAME</code>)にセットします。
     */
    ...
    /**
     * 理由区分に対する名称(<code>REASON_NAME</code>)の更新値をセットします。
     * @param value 理由区分に対する名称(<code>REASON_NAME</code>)更新値
     */
    public void updateReasonName(String value)
    {
        setAdhocUpdateValue(Reason.REASON_NAME, value) ;
    }
    ...
    {
        setAdhocUpdateValue(Reason.LAST_USED_DATE, value) ;
    }
    ...
    {
        setAdhocUpdateValue(Reason.REGIST_DATE, value) ;
    }
    ...
    {
        setAdhocUpdateValue(Reason.REGIST_PNAME, value) ;
    }
    ...
    {
        setAdhocUpdateValue(Reason.LAST_UPDATE_DATE, value) ;
    }
    ...
    {
        setAdhocUpdateValue(Reason.LAST_UPDATE_PNAME, value) ;
    }
    ...
    {
        setUpdateWithColumn(Reason.REASON_TYPE, source, addvalue);
    }
    ...
    {
        return "$Id: ReasonAlterKey.java,v 1.1.1.1 2009/02/10 08:55:29 arai Exp $" ;
    }
}
