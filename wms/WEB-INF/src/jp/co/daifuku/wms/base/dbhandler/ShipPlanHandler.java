// $Id: ShipPlanHandler.java 5127 2009-10-13 12:20:06Z ota $
        ...
        extends AbstractDBHandler
{
     ...
     */
    public ShipPlanHandler(Connection conn)
    {
        // super(conn, ShipPlan.STORE_NAME) ;
        super(conn, ShipPlan.$storeMetaData) ;
    }
    ...
    {
        return "$Id: ShipPlanHandler.java 5127 2009-10-13 12:20:06Z ota $" ;
    }
}
