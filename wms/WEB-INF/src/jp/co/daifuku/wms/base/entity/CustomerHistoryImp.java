// $Id: CustomerHistoryImp.java 2610 2009-01-08 08:13:44Z ota $
...
/**
 * CUSTOMERHISTORYIMPのエンティティクラスです。
 *
...
public class CustomerHistoryImp
        ...
        implements SystemDefine
{
    ...
    //------------------------------------------------------------
    /** テーブル名定義 */
    public static final String STORE_NAME = "DNCUSTOMERHISTORYIMP" ;

    /*
     * テーブル名: DNCUSTOMERHISTORYIMP
     ...
     * 出荷先名 :                      CUSTOMER_NAME       varchar2(40)
    ...
    /** フィールド定義 (出荷先名(<code>CUSTOMER_NAME</code>)) */
    ...
    /**
     * 出荷先名(<code>CUSTOMER_NAME</code>) から値を取得します。
    ...
    {
        return "$Id: CustomerHistoryImp.java 2610 2009-01-08 08:13:44Z ota $" ;
    }
}
