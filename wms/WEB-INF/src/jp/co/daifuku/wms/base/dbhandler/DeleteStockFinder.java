// $Id: DeleteStockFinder.java 4872 2009-08-21 02:25:41Z ota $
...
/**
 * データベースからDeleteStock表を検索してResultSetからEntity配列を
 * 取得するためのクラスです。<br>
 ...
 */
public class DeleteStockFinder
        extends AbstractDBFinder
{
     ...
     */
    public DeleteStockFinder(Connection conn)
    {
    ...
    {
        return ("$Revision: 4872 $,$Date: 2009-08-21 11:25:41 +0900 (金, 21 8 2009) $") ;
    }
}
