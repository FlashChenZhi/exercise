// $Id: PCTAllUserResultSearchKey.java 3213 2009-03-02 06:59:20Z arai $
...
public class PCTAllUserResultSearchKey
        extends DefaultSQLSearchKey
{
     ...
     * 生成します。
     */
    public PCTAllUserResultSearchKey()
    {
    ...
    {
        setOrder(PCTAllUserResult.CONSIGNOR_CODE, ascorder) ;
    }
    ...
    {
        setGroup(PCTAllUserResult.CONSIGNOR_CODE) ;
    }
    ...
    {
        setCollect(PCTAllUserResult.CONSIGNOR_CODE) ;
    }
    ...
    {
        setCollect(PCTAllUserResult.CONSIGNOR_CODE, sqlfunc, null) ;
    }
    ...
    {
        setOrder(PCTAllUserResult.AREA_NO, ascorder) ;
    }
    ...
    {
        setGroup(PCTAllUserResult.AREA_NO) ;
    }
    ...
    {
        setCollect(PCTAllUserResult.AREA_NO) ;
    }
    ...
    {
        setCollect(PCTAllUserResult.AREA_NO, sqlfunc, null) ;
    }
    ...
    {
        setOrder(PCTAllUserResult.RANK, ascorder) ;
    }
    ...
    {
        setGroup(PCTAllUserResult.RANK) ;
    }
    ...
    {
        setCollect(PCTAllUserResult.RANK) ;
    }
    ...
    {
        setCollect(PCTAllUserResult.RANK, sqlfunc, null) ;
    }
     ...
     * 数値の検索値をセットロット作業基準値(<code>LOT_STANDARD_VALUE</code>)します。
     */
    ...
    /**
     * ロット作業基準値(<code>LOT_STANDARD_VALUE</code>)のソート順をセットします。
     * 
     * @param ascorder 昇順(true)又は降順(false)を指定します。
     */
    public void setLotStandardValueOrder(boolean ascorder)
    {
        setOrder(PCTAllUserResult.LOT_STANDARD_VALUE, ascorder) ;
    }
     ...
     */
    @Deprecated
    public void setLotStandardValueOrder(int prio, boolean ascorder)
    {
        setOrder(PCTAllUserResult.LOT_STANDARD_VALUE, ascorder) ;
    }

    /**
     * ロット作業基準値(<code>LOT_STANDARD_VALUE</code>)のグループ順をセットします。
     */
    public void setLotStandardValueGroup()
    {
        setGroup(PCTAllUserResult.LOT_STANDARD_VALUE) ;
    }
     ...
     */
    @Deprecated
    public void setLotStandardValueGroup(int prio)
    {
        setGroup(PCTAllUserResult.LOT_STANDARD_VALUE) ;
    }

    /**
     * ロット作業基準値(<code>LOT_STANDARD_VALUE</code>)の情報取得を設定します。
     */
    public void setLotStandardValueCollect()
    {
        setCollect(PCTAllUserResult.LOT_STANDARD_VALUE) ;
    }
     ...
     * {0} は、カラム名に置き換えられます。
     */
    public void setLotStandardValueCollect(String sqlfunc)
    {
        setCollect(PCTAllUserResult.LOT_STANDARD_VALUE, sqlfunc, null) ;
    }
     ...
     * 数値の検索値をセットオーダー作業基準値(<code>ORDER_STANDARD_VALUE</code>)します。
     */
    ...
    /**
     * オーダー作業基準値(<code>ORDER_STANDARD_VALUE</code>)のソート順をセットします。
     * 
     * @param ascorder 昇順(true)又は降順(false)を指定します。
     */
    public void setOrderStandardValueOrder(boolean ascorder)
    {
        setOrder(PCTAllUserResult.ORDER_STANDARD_VALUE, ascorder) ;
    }
     ...
     */
    @Deprecated
    public void setOrderStandardValueOrder(int prio, boolean ascorder)
    {
        setOrder(PCTAllUserResult.ORDER_STANDARD_VALUE, ascorder) ;
    }

    /**
     * オーダー作業基準値(<code>ORDER_STANDARD_VALUE</code>)のグループ順をセットします。
     */
    public void setOrderStandardValueGroup()
    {
        setGroup(PCTAllUserResult.ORDER_STANDARD_VALUE) ;
    }
     ...
     */
    @Deprecated
    public void setOrderStandardValueGroup(int prio)
    {
        setGroup(PCTAllUserResult.ORDER_STANDARD_VALUE) ;
    }

    /**
     * オーダー作業基準値(<code>ORDER_STANDARD_VALUE</code>)の情報取得を設定します。
     */
    public void setOrderStandardValueCollect()
    {
        setCollect(PCTAllUserResult.ORDER_STANDARD_VALUE) ;
    }
     ...
     * {0} は、カラム名に置き換えられます。
     */
    public void setOrderStandardValueCollect(String sqlfunc)
    {
        setCollect(PCTAllUserResult.ORDER_STANDARD_VALUE, sqlfunc, null) ;
    }
     ...
     * 数値の検索値をセット行作業基準値(<code>LINE_STANDARD_VALUE</code>)します。
     */
    ...
    /**
     * 行作業基準値(<code>LINE_STANDARD_VALUE</code>)のソート順をセットします。
     * 
     * @param ascorder 昇順(true)又は降順(false)を指定します。
     */
    public void setLineStandardValueOrder(boolean ascorder)
    {
        setOrder(PCTAllUserResult.LINE_STANDARD_VALUE, ascorder) ;
    }
     ...
     */
    @Deprecated
    public void setLineStandardValueOrder(int prio, boolean ascorder)
    {
        setOrder(PCTAllUserResult.LINE_STANDARD_VALUE, ascorder) ;
    }

    /**
     * 行作業基準値(<code>LINE_STANDARD_VALUE</code>)のグループ順をセットします。
     */
    public void setLineStandardValueGroup()
    {
        setGroup(PCTAllUserResult.LINE_STANDARD_VALUE) ;
    }
     ...
     */
    @Deprecated
    public void setLineStandardValueGroup(int prio)
    {
        setGroup(PCTAllUserResult.LINE_STANDARD_VALUE) ;
    }

    /**
     * 行作業基準値(<code>LINE_STANDARD_VALUE</code>)の情報取得を設定します。
     */
    public void setLineStandardValueCollect()
    {
        setCollect(PCTAllUserResult.LINE_STANDARD_VALUE) ;
    }
     ...
     * {0} は、カラム名に置き換えられます。
     */
    public void setLineStandardValueCollect(String sqlfunc)
    {
        setCollect(PCTAllUserResult.LINE_STANDARD_VALUE, sqlfunc, null) ;
    }
    ...
    {
        setOrder(PCTAllUserResult.REGIST_DATE, ascorder) ;
    }
    ...
    {
        setGroup(PCTAllUserResult.REGIST_DATE) ;
    }
    ...
    {
        setCollect(PCTAllUserResult.REGIST_DATE) ;
    }
    ...
    {
        setCollect(PCTAllUserResult.REGIST_DATE, sqlfunc, null) ;
    }
    ...
    {
        setOrder(PCTAllUserResult.REGIST_PNAME, ascorder) ;
    }
    ...
    {
        setGroup(PCTAllUserResult.REGIST_PNAME) ;
    }
    ...
    {
        setCollect(PCTAllUserResult.REGIST_PNAME) ;
    }
    ...
    {
        setCollect(PCTAllUserResult.REGIST_PNAME, sqlfunc, null) ;
    }
    ...
    {
        setOrder(PCTAllUserResult.LAST_UPDATE_DATE, ascorder) ;
    }
    ...
    {
        setGroup(PCTAllUserResult.LAST_UPDATE_DATE) ;
    }
    ...
    {
        setCollect(PCTAllUserResult.LAST_UPDATE_DATE) ;
    }
    ...
    {
        setCollect(PCTAllUserResult.LAST_UPDATE_DATE, sqlfunc, null) ;
    }
    ...
    {
        setOrder(PCTAllUserResult.LAST_UPDATE_PNAME, ascorder) ;
    }
    ...
    {
        setGroup(PCTAllUserResult.LAST_UPDATE_PNAME) ;
    }
    ...
    {
        setCollect(PCTAllUserResult.LAST_UPDATE_PNAME) ;
    }
    ...
    {
        setCollect(PCTAllUserResult.LAST_UPDATE_PNAME, sqlfunc, null) ;
    }
    ...
    {
        return "$Id: PCTAllUserResultSearchKey.java 3213 2009-03-02 06:59:20Z arai $" ;
    }
}
