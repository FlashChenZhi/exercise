// $Id: PalletFinder.java 4122 2009-04-10 10:58:38Z ota $
...
/**
 * データベースからPallet表を検索してResultSetからEntity配列を
 * 取得するためのクラスです。<br>
        ...
        extends AbstractDBFinder
{
     ...
     */
    public PalletFinder(Connection conn)
    {
