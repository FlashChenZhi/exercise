// $Id: LstLocateParams.java 3208 2009-03-02 05:42:52Z arai $
        ...
        extends Params
{
     ...
     * @throws IOException
     */
    public LstLocateParams(StringParameters param) throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public LstLocateParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
