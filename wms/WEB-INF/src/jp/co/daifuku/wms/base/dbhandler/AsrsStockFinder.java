// $Id: AsrsStockFinder.java 87 2008-10-04 03:07:38Z admin $
// Handler v3.8
...
/**
 * データベースからAsrsStock表を検索してResultSetからEntity配列を
 * 取得するためのクラスです。<br>
        ...
        extends AbstractDBFinder
{
     ...
     */
    public AsrsStockFinder(Connection conn)
    {
