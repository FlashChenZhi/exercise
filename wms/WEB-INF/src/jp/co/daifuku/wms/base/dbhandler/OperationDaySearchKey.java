// $Id: OperationDaySearchKey.java 87 2008-10-04 03:07:38Z admin $
// Handler v3.8
...
public class OperationDaySearchKey
        extends DefaultSQLSearchKey
{
     ...
     * 文字列の検索値をセット営業日(<code>OPERATION_DAY</code>)します。
     */
    ...
    /**
     * 営業日(<code>OPERATION_DAY</code>)のソート順をセットします。
     * 
     * @param ascorder 昇順(true)又は降順(false)を指定します。
     */
    public void setOperationDayOrder(boolean ascorder)
    {
        setOrder(OperationDay.OPERATION_DAY, ascorder) ;
    }
     ...
     */
    @Deprecated
    public void setOperationDayOrder(int prio, boolean ascorder)
    {
        setOrder(OperationDay.OPERATION_DAY, ascorder) ;
    }

    /**
     * 営業日(<code>OPERATION_DAY</code>)のグループ順をセットします。
     */
    public void setOperationDayGroup()
    {
        setGroup(OperationDay.OPERATION_DAY) ;
    }
     ...
     */
    @Deprecated
    public void setOperationDayGroup(int prio)
    {
        setGroup(OperationDay.OPERATION_DAY) ;
    }

    /**
     * 営業日(<code>OPERATION_DAY</code>)の情報取得を設定します。
     */
    public void setOperationDayCollect()
    {
        setCollect(OperationDay.OPERATION_DAY) ;
    }
     ...
     * {0} は、カラム名に置き換えられます。
     */
    public void setOperationDayCollect(String sqlfunc)
    {
        setCollect(OperationDay.OPERATION_DAY, sqlfunc, null) ;
    }
    ...
    {
        setOrder(OperationDay.REGIST_DATE, ascorder) ;
    }
    ...
    {
        setGroup(OperationDay.REGIST_DATE) ;
    }
    ...
    {
        setCollect(OperationDay.REGIST_DATE) ;
    }
    ...
    {
        setCollect(OperationDay.REGIST_DATE, sqlfunc, null) ;
    }
    ...
    {
        return "$Id: OperationDaySearchKey.java 87 2008-10-04 03:07:38Z admin $" ;
    }
}
