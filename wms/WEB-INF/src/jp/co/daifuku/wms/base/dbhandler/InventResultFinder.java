// $Id: InventResultFinder.java 5127 2009-10-13 12:20:06Z ota $
...
/**
 * データベースからInventResult表を検索してResultSetからEntity配列を
 * 取得するためのクラスです。<br>
 ...
 */
public class InventResultFinder
        extends AbstractDBFinder
{
     ...
     */
    public InventResultFinder(Connection conn)
    {
        super(conn, InventResult.$storeMetaData) ;
    }
