// $Id: WorkingUnit.java 5127 2009-10-13 12:20:06Z ota $
        ...
        implements SystemDefine
{
    ...
    //------------------------------------------------------------
    /** テーブル名定義 */
    public static final String STORE_NAME = "DMWORKINGUNIT" ;

    /*
     * テーブル名: DMWORKINGUNIT
     * 荷主コード :                    CONSIGNOR_CODE      varchar2(16)
     * 商品コード :                    ITEM_CODE           varchar2(40)
     * 作業単位数 :                    WORK_UNIT_QTY       number
     * 最終使用日 :                    LAST_USE_WORK_DAY   varchar2(8)
    ...
    /** フィールド定義 (作業単位数(<code>WORK_UNIT_QTY</code>)) */
    public static final FieldName WORK_UNIT_QTY = new FieldName(STORE_NAME, "WORK_UNIT_QTY") ;

    /** フィールド定義 (最終使用日(<code>LAST_USE_WORK_DAY</code>)) */
    public static final FieldName LAST_USE_WORK_DAY = new FieldName(STORE_NAME, "LAST_USE_WORK_DAY") ;
    ...
    /**
     * 作業単位数(<code>WORK_UNIT_QTY</code>) に値をセットします。
     * @param value セットする値WORK_UNIT_QTY
     */
    public void setWorkUnitQty(int value)  // @@GEN_V3@@
    {
        setValue(WORK_UNIT_QTY, HandlerUtil.toObject(value));
    }

    /**
     * 作業単位数(<code>WORK_UNIT_QTY</code>) から値を取得します。
     * @return WORK_UNIT_QTY
     */
    public int getWorkUnitQty()  // @@GEN_V3@@
    {
        return getBigDecimal(WORK_UNIT_QTY, BigDecimal.ZERO).intValue() ;
    }

    /**
     * 最終使用日(<code>LAST_USE_WORK_DAY</code>) に値をセットします。
     * @param value セットする値LAST_USE_WORK_DAY
     */
    public void setLastUseWorkDay(String value)  // @@GEN_V3@@
    {
        setValue(LAST_USE_WORK_DAY, value);
    }

    /**
     * 最終使用日(<code>LAST_USE_WORK_DAY</code>) から値を取得します。
     * @return LAST_USE_WORK_DAY
     */
    public String getLastUseWorkDay()  // @@GEN_V3@@
    {
        return String.valueOf(getValue(LAST_USE_WORK_DAY, "")) ;
    }
    ...
    {
        return "$Id: WorkingUnit.java 5127 2009-10-13 12:20:06Z ota $" ;
    }
}
