// $Id: ReportSorting.java 87 2008-10-04 03:07:38Z admin $
// Handler v3.8
        ...
        extends AbstractEntity
{
    ...
    //------------------------------------------------------------
    /** Name of File */
    public static final String STORE_NAME = "REPORTSORTING";
    ...
    /**
     * 仕分実績数(<code>RESULT_QTY</code>)に値を設定します。
     * @param value 仕分実績数
     */
    ...
    /**
     * 仕分実績数(<code>RESULT_QTY</code>)を取得します。
     * @return    仕分実績数
     */
    ...
    /**
     * 仕分実績日(<code>WORK_DAY</code>)に値を設定します。
     * @param value 仕分実績日
     */
    ...
    /**
     * 仕分実績日(<code>WORK_DAY</code>)を取得します。
     * @return    仕分実績日
     */
    ...
    {
        return "$Id: ReportSorting.java 87 2008-10-04 03:07:38Z admin $";
    }
}
