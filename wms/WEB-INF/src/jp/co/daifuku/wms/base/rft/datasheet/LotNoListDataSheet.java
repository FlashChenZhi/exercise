// $Id: LotNoListDataSheet.java 8041 2012-05-17 09:39:40Z nagao $
 ...
 */
public class LotNoListDataSheet
        extends BasicDSModel
{
    ...
    //------------------------------------------------------------
    /** DATASHEET_NAME */
    private static final String DATASHEET_NAME = "LotNoListDataSheet";
     ...
     * @param locale Locale
     */
    public LotNoListDataSheet(DataSheetFactory dsf, Locale locale)
    {
    ...
    {
        return "$Id: LotNoListDataSheet.java 8041 2012-05-17 09:39:40Z nagao $";
    }
}
//end of class
