// $Id: PCTCustomerSearchKey.java 3213 2009-03-02 06:59:20Z arai $
...
public class PCTCustomerSearchKey
        extends DefaultSQLSearchKey
{
    ...
    {
        setOrder(PCTCustomer.CONSIGNOR_CODE, ascorder) ;
    }
    ...
    {
        setGroup(PCTCustomer.CONSIGNOR_CODE) ;
    }
    ...
    {
        setCollect(PCTCustomer.CONSIGNOR_CODE) ;
    }
    ...
    {
        setCollect(PCTCustomer.CONSIGNOR_CODE, sqlfunc, null) ;
    }
    ...
    {
        setOrder(PCTCustomer.CONSIGNOR_NAME, ascorder) ;
    }
    ...
    {
        setGroup(PCTCustomer.CONSIGNOR_NAME) ;
    }
    ...
    {
        setCollect(PCTCustomer.CONSIGNOR_NAME) ;
    }
    ...
    {
        setCollect(PCTCustomer.CONSIGNOR_NAME, sqlfunc, null) ;
    }
    ...
    {
        setOrder(PCTCustomer.REGULAR_CUSTOMER_CODE, ascorder) ;
    }
    ...
    {
        setGroup(PCTCustomer.REGULAR_CUSTOMER_CODE) ;
    }
    ...
    {
        setCollect(PCTCustomer.REGULAR_CUSTOMER_CODE) ;
    }
    ...
    {
        setCollect(PCTCustomer.REGULAR_CUSTOMER_CODE, sqlfunc, null) ;
    }
    ...
    {
        setOrder(PCTCustomer.REGULAR_CUSTOMER_NAME, ascorder) ;
    }
    ...
    {
        setGroup(PCTCustomer.REGULAR_CUSTOMER_NAME) ;
    }
    ...
    {
        setCollect(PCTCustomer.REGULAR_CUSTOMER_NAME) ;
    }
    ...
    {
        setCollect(PCTCustomer.REGULAR_CUSTOMER_NAME, sqlfunc, null) ;
    }
    ...
    {
        setOrder(PCTCustomer.CUSTOMER_CODE, ascorder) ;
    }
    ...
    {
        setGroup(PCTCustomer.CUSTOMER_CODE) ;
    }
    ...
    {
        setCollect(PCTCustomer.CUSTOMER_CODE) ;
    }
    ...
    {
        setCollect(PCTCustomer.CUSTOMER_CODE, sqlfunc, null) ;
    }
    ...
    {
        setOrder(PCTCustomer.CUSTOMER_NAME, ascorder) ;
    }
    ...
    {
        setGroup(PCTCustomer.CUSTOMER_NAME) ;
    }
    ...
    {
        setCollect(PCTCustomer.CUSTOMER_NAME) ;
    }
    ...
    {
        setCollect(PCTCustomer.CUSTOMER_NAME, sqlfunc, null) ;
    }
    ...
    {
        setOrder(PCTCustomer.CUSTOMER_CATEGORY, ascorder) ;
    }
    ...
    {
        setGroup(PCTCustomer.CUSTOMER_CATEGORY) ;
    }
    ...
    {
        setCollect(PCTCustomer.CUSTOMER_CATEGORY) ;
    }
    ...
    {
        setCollect(PCTCustomer.CUSTOMER_CATEGORY, sqlfunc, null) ;
    }
     ...
     * 文字列の検索値をセットSeqNo.(<code>SEQ_NO</code>)します。
     */
    ...
    /**
     * SeqNo.(<code>SEQ_NO</code>)のソート順をセットします。
     * 
     * @param ascorder 昇順(true)又は降順(false)を指定します。
     */
    public void setSeqNoOrder(boolean ascorder)
    {
        setOrder(PCTCustomer.SEQ_NO, ascorder) ;
    }
     ...
     */
    @Deprecated
    public void setSeqNoOrder(int prio, boolean ascorder)
    {
        setOrder(PCTCustomer.SEQ_NO, ascorder) ;
    }

    /**
     * SeqNo.(<code>SEQ_NO</code>)のグループ順をセットします。
     */
    public void setSeqNoGroup()
    {
        setGroup(PCTCustomer.SEQ_NO) ;
    }
     ...
     */
    @Deprecated
    public void setSeqNoGroup(int prio)
    {
        setGroup(PCTCustomer.SEQ_NO) ;
    }

    /**
     * SeqNo.(<code>SEQ_NO</code>)の情報取得を設定します。
     */
    public void setSeqNoCollect()
    {
        setCollect(PCTCustomer.SEQ_NO) ;
    }
     ...
     * {0} は、カラム名に置き換えられます。
     */
    public void setSeqNoCollect(String sqlfunc)
    {
        setCollect(PCTCustomer.SEQ_NO, sqlfunc, null) ;
    }
     ...
     * 数値の検索値をセット作業優先度(<code>JOB_PRIORITY</code>)します。
     */
    ...
    /**
     * 作業優先度(<code>JOB_PRIORITY</code>)のソート順をセットします。
     * 
     * @param ascorder 昇順(true)又は降順(false)を指定します。
     */
    public void setJobPriorityOrder(boolean ascorder)
    {
        setOrder(PCTCustomer.JOB_PRIORITY, ascorder) ;
    }
     ...
     */
    @Deprecated
    public void setJobPriorityOrder(int prio, boolean ascorder)
    {
        setOrder(PCTCustomer.JOB_PRIORITY, ascorder) ;
    }

    /**
     * 作業優先度(<code>JOB_PRIORITY</code>)のグループ順をセットします。
     */
    public void setJobPriorityGroup()
    {
        setGroup(PCTCustomer.JOB_PRIORITY) ;
    }
     ...
     */
    @Deprecated
    public void setJobPriorityGroup(int prio)
    {
        setGroup(PCTCustomer.JOB_PRIORITY) ;
    }

    /**
     * 作業優先度(<code>JOB_PRIORITY</code>)の情報取得を設定します。
     */
    public void setJobPriorityCollect()
    {
        setCollect(PCTCustomer.JOB_PRIORITY) ;
    }
     ...
     * {0} は、カラム名に置き換えられます。
     */
    public void setJobPriorityCollect(String sqlfunc)
    {
        setCollect(PCTCustomer.JOB_PRIORITY, sqlfunc, null) ;
    }
    ...
    {
        setOrder(PCTCustomer.LAST_USED_DATE, ascorder) ;
    }
    ...
    {
        setGroup(PCTCustomer.LAST_USED_DATE) ;
    }
    ...
    {
        setCollect(PCTCustomer.LAST_USED_DATE) ;
    }
    ...
    {
        setCollect(PCTCustomer.LAST_USED_DATE, sqlfunc, null) ;
    }
    ...
    {
        setOrder(PCTCustomer.REGIST_DATE, ascorder) ;
    }
    ...
    {
        setGroup(PCTCustomer.REGIST_DATE) ;
    }
    ...
    {
        setCollect(PCTCustomer.REGIST_DATE) ;
    }
    ...
    {
        setCollect(PCTCustomer.REGIST_DATE, sqlfunc, null) ;
    }
    ...
    {
        setOrder(PCTCustomer.REGIST_PNAME, ascorder) ;
    }
    ...
    {
        setGroup(PCTCustomer.REGIST_PNAME) ;
    }
    ...
    {
        setCollect(PCTCustomer.REGIST_PNAME) ;
    }
    ...
    {
        setCollect(PCTCustomer.REGIST_PNAME, sqlfunc, null) ;
    }
    ...
    {
        setOrder(PCTCustomer.LAST_UPDATE_DATE, ascorder) ;
    }
    ...
    {
        setGroup(PCTCustomer.LAST_UPDATE_DATE) ;
    }
    ...
    {
        setCollect(PCTCustomer.LAST_UPDATE_DATE) ;
    }
    ...
    {
        setCollect(PCTCustomer.LAST_UPDATE_DATE, sqlfunc, null) ;
    }
    ...
    {
        setOrder(PCTCustomer.LAST_UPDATE_PNAME, ascorder) ;
    }
    ...
    {
        setGroup(PCTCustomer.LAST_UPDATE_PNAME) ;
    }
    ...
    {
        setCollect(PCTCustomer.LAST_UPDATE_PNAME) ;
    }
    ...
    {
        setCollect(PCTCustomer.LAST_UPDATE_PNAME, sqlfunc, null) ;
    }
    ...
    {
        return "$Id: PCTCustomerSearchKey.java 3213 2009-03-02 06:59:20Z arai $" ;
    }
}
