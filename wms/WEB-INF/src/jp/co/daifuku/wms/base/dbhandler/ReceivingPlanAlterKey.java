// $Id: ReceivingPlanAlterKey.java 5127 2009-10-13 12:20:06Z ota $
...
public class ReceivingPlanAlterKey
        extends DefaultSQLAlterKey
{
    ...
    public static final StoreMetaData $storeMetaData = ReceivingPlan.$storeMetaData;
     ...
     * インスタンスを生成します。
     */
    public ReceivingPlanAlterKey()
    {
        super(ReceivingPlan.STORE_NAME) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_UKEY, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_UKEY, values, true) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_UKEY, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_UKEY, values, and_or_toNext) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_UKEY, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_UKEY, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_UKEY, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setAdhocUpdateValue(ReceivingPlan.PLAN_UKEY, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.LOAD_UNIT_KEY, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.LOAD_UNIT_KEY, values, true) ;
    }
    ...
    {
        setKey(ReceivingPlan.LOAD_UNIT_KEY, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.LOAD_UNIT_KEY, values, and_or_toNext) ;
    }
    ...
    {
        setKey(ReceivingPlan.LOAD_UNIT_KEY, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(ReceivingPlan.LOAD_UNIT_KEY, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.LOAD_UNIT_KEY, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setAdhocUpdateValue(ReceivingPlan.LOAD_UNIT_KEY, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.FILE_LINE_NO, HandlerUtil.toObject(value)) ;
    }
    ...
    {
        setKey(ReceivingPlan.FILE_LINE_NO, ArrayUtil.toObjectArray(values), true) ;
    }
    ...
    {
        setKey(ReceivingPlan.FILE_LINE_NO, ArrayUtil.toObjectArray(values), !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.FILE_LINE_NO, ArrayUtil.toObjectArray(values), and_or_toNext) ;
    }
    ...
    {
        setKey(ReceivingPlan.FILE_LINE_NO, HandlerUtil.toObject(value), compcode, "", "", true) ;
    }
    ...
    {
        setKey(ReceivingPlan.FILE_LINE_NO, HandlerUtil.toObject(value), compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.FILE_LINE_NO, HandlerUtil.toObject(value), compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setAdhocUpdateValue(ReceivingPlan.FILE_LINE_NO, HandlerUtil.toObject(value)) ;
    }
    ...
    {
        setKey(ReceivingPlan.STATUS_FLAG, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.STATUS_FLAG, values, true) ;
    }
    ...
    {
        setKey(ReceivingPlan.STATUS_FLAG, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.STATUS_FLAG, values, and_or_toNext) ;
    }
    ...
    {
        setKey(ReceivingPlan.STATUS_FLAG, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(ReceivingPlan.STATUS_FLAG, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.STATUS_FLAG, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setAdhocUpdateValue(ReceivingPlan.STATUS_FLAG, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.CANCEL_FLAG, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.CANCEL_FLAG, values, true) ;
    }
    ...
    {
        setKey(ReceivingPlan.CANCEL_FLAG, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.CANCEL_FLAG, values, and_or_toNext) ;
    }
    ...
    {
        setKey(ReceivingPlan.CANCEL_FLAG, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(ReceivingPlan.CANCEL_FLAG, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.CANCEL_FLAG, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setAdhocUpdateValue(ReceivingPlan.CANCEL_FLAG, value) ;
    }

    /**
     * TC/DCフラグ(<code>TCDC_FLAG</code>)の検索値をセットします。
     * 
     * @param value TC/DCフラグ(<code>TCDC_FLAG</code>)<br>
     * 文字列の検索値をTC/DCフラグ(<code>TCDC_FLAG</code>)にセットします。
     */
    public void setTcdcFlag(String value)
    {
        setKey(ReceivingPlan.TCDC_FLAG, value) ;
    }

    /**
     * TC/DCフラグ(<code>TCDC_FLAG</code>)の検索値をセットします。<br>
     * 検索条件として、この次に指定されるものとは"AND"で結ばれます。
     * 
     * @param values 文字列の検索配列をセットします。
     * 
    ...
    {
        setKey(ReceivingPlan.TCDC_FLAG, values, true) ;
    }
    ...
    {
        setKey(ReceivingPlan.TCDC_FLAG, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.TCDC_FLAG, values, and_or_toNext) ;
    }
    ...
    {
        setKey(ReceivingPlan.TCDC_FLAG, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(ReceivingPlan.TCDC_FLAG, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.TCDC_FLAG, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }


    /**
     * TC/DCフラグ(<code>TCDC_FLAG</code>)の更新値をセットします。
     * @param value TC/DCフラグ(<code>TCDC_FLAG</code>)更新値
     */
    public void updateTcdcFlag(String value)
    {
        setAdhocUpdateValue(ReceivingPlan.TCDC_FLAG, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_DAY, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_DAY, values, true) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_DAY, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_DAY, values, and_or_toNext) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_DAY, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_DAY, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_DAY, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setAdhocUpdateValue(ReceivingPlan.PLAN_DAY, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.CONSIGNOR_CODE, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.CONSIGNOR_CODE, values, true) ;
    }
    ...
    {
        setKey(ReceivingPlan.CONSIGNOR_CODE, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.CONSIGNOR_CODE, values, and_or_toNext) ;
    }
    ...
    {
        setKey(ReceivingPlan.CONSIGNOR_CODE, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(ReceivingPlan.CONSIGNOR_CODE, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.CONSIGNOR_CODE, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setAdhocUpdateValue(ReceivingPlan.CONSIGNOR_CODE, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.SUPPLIER_CODE, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.SUPPLIER_CODE, values, true) ;
    }
    ...
    {
        setKey(ReceivingPlan.SUPPLIER_CODE, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.SUPPLIER_CODE, values, and_or_toNext) ;
    }
    ...
    {
        setKey(ReceivingPlan.SUPPLIER_CODE, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(ReceivingPlan.SUPPLIER_CODE, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.SUPPLIER_CODE, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setAdhocUpdateValue(ReceivingPlan.SUPPLIER_CODE, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.RECEIVE_TICKET_NO, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.RECEIVE_TICKET_NO, values, true) ;
    }
    ...
    {
        setKey(ReceivingPlan.RECEIVE_TICKET_NO, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.RECEIVE_TICKET_NO, values, and_or_toNext) ;
    }
    ...
    {
        setKey(ReceivingPlan.RECEIVE_TICKET_NO, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(ReceivingPlan.RECEIVE_TICKET_NO, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.RECEIVE_TICKET_NO, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setAdhocUpdateValue(ReceivingPlan.RECEIVE_TICKET_NO, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.RECEIVE_LINE_NO, HandlerUtil.toObject(value)) ;
    }
    ...
    {
        setKey(ReceivingPlan.RECEIVE_LINE_NO, ArrayUtil.toObjectArray(values), true) ;
    }
    ...
    {
        setKey(ReceivingPlan.RECEIVE_LINE_NO, ArrayUtil.toObjectArray(values), !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.RECEIVE_LINE_NO, ArrayUtil.toObjectArray(values), and_or_toNext) ;
    }
    ...
    {
        setKey(ReceivingPlan.RECEIVE_LINE_NO, HandlerUtil.toObject(value), compcode, "", "", true) ;
    }
    ...
    {
        setKey(ReceivingPlan.RECEIVE_LINE_NO, HandlerUtil.toObject(value), compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.RECEIVE_LINE_NO, HandlerUtil.toObject(value), compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setAdhocUpdateValue(ReceivingPlan.RECEIVE_LINE_NO, HandlerUtil.toObject(value)) ;
    }
    ...
    {
        setKey(ReceivingPlan.ITEM_CODE, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.ITEM_CODE, values, true) ;
    }
    ...
    {
        setKey(ReceivingPlan.ITEM_CODE, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.ITEM_CODE, values, and_or_toNext) ;
    }
    ...
    {
        setKey(ReceivingPlan.ITEM_CODE, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(ReceivingPlan.ITEM_CODE, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.ITEM_CODE, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setAdhocUpdateValue(ReceivingPlan.ITEM_CODE, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_LOT_NO, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_LOT_NO, values, true) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_LOT_NO, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_LOT_NO, values, and_or_toNext) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_LOT_NO, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_LOT_NO, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_LOT_NO, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setAdhocUpdateValue(ReceivingPlan.PLAN_LOT_NO, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_QTY, HandlerUtil.toObject(value)) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_QTY, ArrayUtil.toObjectArray(values), true) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_QTY, ArrayUtil.toObjectArray(values), !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_QTY, ArrayUtil.toObjectArray(values), and_or_toNext) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_QTY, HandlerUtil.toObject(value), compcode, "", "", true) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_QTY, HandlerUtil.toObject(value), compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.PLAN_QTY, HandlerUtil.toObject(value), compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setAdhocUpdateValue(ReceivingPlan.PLAN_QTY, HandlerUtil.toObject(value)) ;
    }
    ...
    {
        setKey(ReceivingPlan.RESULT_QTY, HandlerUtil.toObject(value)) ;
    }
    ...
    {
        setKey(ReceivingPlan.RESULT_QTY, ArrayUtil.toObjectArray(values), true) ;
    }
    ...
    {
        setKey(ReceivingPlan.RESULT_QTY, ArrayUtil.toObjectArray(values), !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.RESULT_QTY, ArrayUtil.toObjectArray(values), and_or_toNext) ;
    }
    ...
    {
        setKey(ReceivingPlan.RESULT_QTY, HandlerUtil.toObject(value), compcode, "", "", true) ;
    }
    ...
    {
        setKey(ReceivingPlan.RESULT_QTY, HandlerUtil.toObject(value), compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.RESULT_QTY, HandlerUtil.toObject(value), compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setAdhocUpdateValue(ReceivingPlan.RESULT_QTY, HandlerUtil.toObject(value)) ;
    }
    ...
    {
        setKey(ReceivingPlan.SHORTAGE_QTY, HandlerUtil.toObject(value)) ;
    }
    ...
    {
        setKey(ReceivingPlan.SHORTAGE_QTY, ArrayUtil.toObjectArray(values), true) ;
    }
    ...
    {
        setKey(ReceivingPlan.SHORTAGE_QTY, ArrayUtil.toObjectArray(values), !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.SHORTAGE_QTY, ArrayUtil.toObjectArray(values), and_or_toNext) ;
    }
    ...
    {
        setKey(ReceivingPlan.SHORTAGE_QTY, HandlerUtil.toObject(value), compcode, "", "", true) ;
    }
    ...
    {
        setKey(ReceivingPlan.SHORTAGE_QTY, HandlerUtil.toObject(value), compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.SHORTAGE_QTY, HandlerUtil.toObject(value), compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setAdhocUpdateValue(ReceivingPlan.SHORTAGE_QTY, HandlerUtil.toObject(value)) ;
    }
    ...
    {
        setKey(ReceivingPlan.REPORT_FLAG, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.REPORT_FLAG, values, true) ;
    }
    ...
    {
        setKey(ReceivingPlan.REPORT_FLAG, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.REPORT_FLAG, values, and_or_toNext) ;
    }
    ...
    {
        setKey(ReceivingPlan.REPORT_FLAG, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(ReceivingPlan.REPORT_FLAG, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.REPORT_FLAG, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setAdhocUpdateValue(ReceivingPlan.REPORT_FLAG, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.WORK_DAY, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.WORK_DAY, values, true) ;
    }
    ...
    {
        setKey(ReceivingPlan.WORK_DAY, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.WORK_DAY, values, and_or_toNext) ;
    }
    ...
    {
        setKey(ReceivingPlan.WORK_DAY, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(ReceivingPlan.WORK_DAY, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.WORK_DAY, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setAdhocUpdateValue(ReceivingPlan.WORK_DAY, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.REGIST_KIND, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.REGIST_KIND, values, true) ;
    }
    ...
    {
        setKey(ReceivingPlan.REGIST_KIND, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.REGIST_KIND, values, and_or_toNext) ;
    }
    ...
    {
        setKey(ReceivingPlan.REGIST_KIND, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(ReceivingPlan.REGIST_KIND, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.REGIST_KIND, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setAdhocUpdateValue(ReceivingPlan.REGIST_KIND, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.REGIST_DATE, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.REGIST_DATE, values, true) ;
    }
    ...
    {
        setKey(ReceivingPlan.REGIST_DATE, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.REGIST_DATE, values, and_or_toNext) ;
    }
    ...
    {
        setKey(ReceivingPlan.REGIST_DATE, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(ReceivingPlan.REGIST_DATE, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.REGIST_DATE, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setAdhocUpdateValue(ReceivingPlan.REGIST_DATE, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.REGIST_PNAME, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.REGIST_PNAME, values, true) ;
    }
    ...
    {
        setKey(ReceivingPlan.REGIST_PNAME, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.REGIST_PNAME, values, and_or_toNext) ;
    }
    ...
    {
        setKey(ReceivingPlan.REGIST_PNAME, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(ReceivingPlan.REGIST_PNAME, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.REGIST_PNAME, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setAdhocUpdateValue(ReceivingPlan.REGIST_PNAME, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.LAST_UPDATE_DATE, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.LAST_UPDATE_DATE, values, true) ;
    }
    ...
    {
        setKey(ReceivingPlan.LAST_UPDATE_DATE, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.LAST_UPDATE_DATE, values, and_or_toNext) ;
    }
    ...
    {
        setKey(ReceivingPlan.LAST_UPDATE_DATE, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(ReceivingPlan.LAST_UPDATE_DATE, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.LAST_UPDATE_DATE, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setAdhocUpdateValue(ReceivingPlan.LAST_UPDATE_DATE, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.LAST_UPDATE_PNAME, value) ;
    }
    ...
    {
        setKey(ReceivingPlan.LAST_UPDATE_PNAME, values, true) ;
    }
    ...
    {
        setKey(ReceivingPlan.LAST_UPDATE_PNAME, values, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.LAST_UPDATE_PNAME, values, and_or_toNext) ;
    }
    ...
    {
        setKey(ReceivingPlan.LAST_UPDATE_PNAME, value, compcode, "", "", true) ;
    }
    ...
    {
        setKey(ReceivingPlan.LAST_UPDATE_PNAME, value, compcode, left_paren, right_paren, !"OR".equals(and_or_toNext)) ;
    }
    ...
    {
        setKey(ReceivingPlan.LAST_UPDATE_PNAME, value, compcode, left_paren, right_paren, and_or_toNext) ;
    }
    ...
    {
        setAdhocUpdateValue(ReceivingPlan.LAST_UPDATE_PNAME, value) ;
    }
    ...
    {
        setUpdateWithColumn(ReceivingPlan.FILE_LINE_NO, source, addvalue);
    }
    ...
    {
        setUpdateWithColumn(ReceivingPlan.RECEIVE_LINE_NO, source, addvalue);
    }
    ...
    {
        setUpdateWithColumn(ReceivingPlan.PLAN_QTY, source, addvalue);
    }
    ...
    {
        setUpdateWithColumn(ReceivingPlan.RESULT_QTY, source, addvalue);
    }
    ...
    {
        setUpdateWithColumn(ReceivingPlan.SHORTAGE_QTY, source, addvalue);
    }
    ...
    {
        return "$Id: ReceivingPlanAlterKey.java 5127 2009-10-13 12:20:06Z ota $" ;
    }
}
