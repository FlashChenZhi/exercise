// $Id: StoragePlanFinder.java 5127 2009-10-13 12:20:06Z ota $
...
/**
 * データベースからStoragePlan表を検索してResultSetからEntity配列を
 * 取得するためのクラスです。<br>
 ...
 */
public class StoragePlanFinder
        extends AbstractDBFinder
{
    ...
    {
        super(conn, StoragePlan.$storeMetaData) ;
    }
