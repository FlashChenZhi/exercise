// $Id: ReceivingPlan.java 5127 2009-10-13 12:20:06Z ota $
        ...
        implements SystemDefine
{
    ...
    //------------------------------------------------------------
    /** テーブル名定義 */
    public static final String STORE_NAME = "DNRECEIVINGPLAN" ;

    /*
     * テーブル名: DNRECEIVINGPLAN
    ...
    /** フィールド定義 (TC/DCフラグ(<code>TCDC_FLAG</code>)) */
    ...
    /**
     * TC/DCフラグ(<code>TCDC_FLAG</code>) に値をセットします。
    ...
    /**
     * TC/DCフラグ(<code>TCDC_FLAG</code>) から値を取得します。
     * @return TCDC_FLAG
     */
    ...
    {
        return "$Id: ReceivingPlan.java 5127 2009-10-13 12:20:06Z ota $" ;
    }
}
