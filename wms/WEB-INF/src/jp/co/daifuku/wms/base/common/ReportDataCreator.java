// $Id: ReportDataCreator.java 6297 2009-12-02 05:46:37Z kumano $
 ...
 * Maker :  T.Nakai<BR>
 * <BR>
 * <CODE>ReportDataCreator</CODE>インターフェースは、報告データ処理の操作を規定します。<BR>
...
public interface ReportDataCreator
{
     ...
     */
    public int existTempFilesCount() throws ReadWriteException;
     ...
     */
    public boolean sendReportFile()throws IOException, ReadWriteException;
    
    /**
     * 統計情報取得処理を行います。統計情報処理の実装はこのインタフェースを実装するクラスによって異なります。<BR>
     * @throws CommonException 例外が発生した場合に通知されます。
     */
    public void statics() throws CommonException;
}
