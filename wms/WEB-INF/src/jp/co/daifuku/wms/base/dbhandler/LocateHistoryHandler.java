// $Id: LocateHistoryHandler.java 5551 2009-11-09 09:46:21Z fukuwa $
...
public class LocateHistoryHandler
        extends AbstractDBHandler
{
     ...
     */
    public LocateHistoryHandler(Connection conn)
    {
        // super(conn, LocateHistory.STORE_NAME) ;
        super(conn, LocateHistory.$storeMetaData) ;
    }
    ...
    {
        return "$Id: LocateHistoryHandler.java 5551 2009-11-09 09:46:21Z fukuwa $" ;
    }
}
