// $Id: BatchListDataSheet.java 8041 2012-05-17 09:39:40Z nagao $
 ...
 */
public class BatchListDataSheet
        extends BasicDSModel
{
    ...
    //------------------------------------------------------------
    /** DATASHEET_NAME */
    private static final String DATASHEET_NAME = "BatchListDataSheet";

    /** BATCH_NO */
    public static final DSKey BATCH_NO = new DSKey("BATCH_NO", new DSStringField(), true, 0);
     ...
     * @param locale Locale
     */
    public BatchListDataSheet(DataSheetFactory dsf, Locale locale)
    {
    ...
    {
        return "$Id: BatchListDataSheet.java 8041 2012-05-17 09:39:40Z nagao $";
    }
}
//end of class
