// $Id: InventWorkInfoFinder.java 5127 2009-10-13 12:20:06Z ota $
...
/**
 * データベースからInventWorkInfo表を検索してResultSetからEntity配列を
 * 取得するためのクラスです。<br>
 ...
 */
public class InventWorkInfoFinder
        extends AbstractDBFinder
{
     ...
     */
    public InventWorkInfoFinder(Connection conn)
    {
        super(conn, InventWorkInfo.$storeMetaData) ;
    }
