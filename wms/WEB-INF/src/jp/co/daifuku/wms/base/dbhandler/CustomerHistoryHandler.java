// $Id: CustomerHistoryHandler.java 1841 2008-12-09 10:12:59Z okayama $
...
public class CustomerHistoryHandler
        extends AbstractDBHandler
{
     ...
     */
    public CustomerHistoryHandler(Connection conn)
    {
        // super(conn, CustomerHistory.STORE_NAME) ;
        super(conn, CustomerHistory.$storeMetaData) ;
    }
    ...
    {
        return "$Id: CustomerHistoryHandler.java 1841 2008-12-09 10:12:59Z okayama $" ;
    }
}
