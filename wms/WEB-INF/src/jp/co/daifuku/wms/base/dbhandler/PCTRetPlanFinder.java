// $Id: PCTRetPlanFinder.java 3213 2009-03-02 06:59:20Z arai $
...
/**
 * データベースからPCTRetPlan表を検索してResultSetからEntity配列を
 * 取得するためのクラスです。<br>
        ...
        extends AbstractDBFinder
{
     ...
     */
    public PCTRetPlanFinder(Connection conn)
    {
        super(conn, PCTRetPlan.$storeMetaData) ;
    }
