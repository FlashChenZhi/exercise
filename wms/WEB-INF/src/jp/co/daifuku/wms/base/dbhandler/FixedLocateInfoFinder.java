// $Id: FixedLocateInfoFinder.java 5127 2009-10-13 12:20:06Z ota $
...
/**
 * データベースからFixedLocateInfo表を検索してResultSetからEntity配列を
 * 取得するためのクラスです。<br>
 ...
 */
public class FixedLocateInfoFinder
        extends AbstractDBFinder
{
     ...
     */
    public FixedLocateInfoFinder(Connection conn)
    {
        super(conn, FixedLocateInfo.$storeMetaData) ;
    }
