// $Id: WidthHandler.java 4122 2009-04-10 10:58:38Z ota $
        ...
        extends AbstractDBHandler
{
     ...
     */
    public WidthHandler(Connection conn)
    {
        // super(conn, Width.STORE_NAME) ;
        super(conn, Width.$storeMetaData) ;
    }
    ...
    {
        return "$Id: WidthHandler.java 4122 2009-04-10 10:58:38Z ota $" ;
    }
}
