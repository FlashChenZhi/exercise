// $Id: OperationDisplayHandler.java 87 2008-10-04 03:07:38Z admin $
// Handler v3.8
...
/**
 * OPERATIONDISPLAY用のデータベースハンドラです。
 * 
        ...
        extends AbstractDBHandler
{
    ...
    {
        // super(conn, OperationDisplay.STORE_NAME) ;
        super(conn, OperationDisplay.$storeMetaData) ;
    }
    ...
    {
        return "$Id: OperationDisplayHandler.java 87 2008-10-04 03:07:38Z admin $" ;
    }
}
