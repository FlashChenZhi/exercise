// $Id: ArrivalHandler.java 5127 2009-10-13 12:20:06Z ota $
        ...
        extends AbstractDBHandler
{
     ...
     */
    public ArrivalHandler(Connection conn)
    {
        // super(conn, Arrival.STORE_NAME) ;
        super(conn, Arrival.$storeMetaData) ;
    }
    ...
    {
        return "$Id: ArrivalHandler.java 5127 2009-10-13 12:20:06Z ota $" ;
    }
}
