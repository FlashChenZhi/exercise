 ...
 */
public class CustomerListDataSheet
        extends BasicDSModel
{
    ...
    //------------------------------------------------------------
    /** DATASHEET_NAME */
    private static final String DATASHEET_NAME = "CustomerListDataSheet";
     ...
     * @param locale Locale
     */
    public CustomerListDataSheet(DataSheetFactory dsf, Locale locale)
    {
