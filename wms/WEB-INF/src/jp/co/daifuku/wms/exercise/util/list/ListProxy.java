...
{
    private ScrollListCell listcell = null;
    ...
    public ListProxy(ScrollListCell listcell)
    {
    ...
    public void setCellEnabled(String columnName, boolean isEnabled)
    {
        if (!colunmInfoMap.containsKey(columnName))
        {
            return;
            ...
            try
            {
                ...
                if (fields[i].getType() == PulldownParams.class) {
                    ...
                    if (!pulItems.isEmpty()) {
                        ...
                        for (String value : availablePulItems.keySet()) {
                            sb.append("\r\n");
                            sb.append(availablePulItems.get(value));
                        }
                        for(String value : pulItems.keySet()){
