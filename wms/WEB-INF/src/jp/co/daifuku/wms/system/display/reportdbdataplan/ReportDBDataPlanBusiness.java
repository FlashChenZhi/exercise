// $Id: ReportDBDataPlanBusiness.java 7996 2011-07-06 00:52:24Z kitamaki $
package jp.co.daifuku.wms.system.display.reportdbdataplan;
...
import jp.co.daifuku.wms.system.display.reportdbdataplan.ReportDBDataPlan;
import jp.co.daifuku.wms.system.schedule.ReportDBDataPlanSCH;
import jp.co.daifuku.wms.system.schedule.ReportDBDataPlanSCHParams;
...
public class ReportDBDataPlanBusiness
        extends ReportDBDataPlan
{
     ...
     * Default constructor
     */
    public ReportDBDataPlanBusiness()
    {
        super();
    }
            ...
            throws Exception
    {
        ...
        ReportDBDataPlanSCH sch = null;
        try
        {
            // open connection.
            conn = ConnectionManager.getRequestConnection(this);
            customerConn = WmsParam.getCustomerConnection(); 
            sch = new ReportDBDataPlanSCH(conn, customerConn, this.getClass(), locale, ui);

            // set input parameters.
            ReportDBDataPlanSCHParams inparam = new ReportDBDataPlanSCHParams();
            ...
            for (Params outparam : outparams)
            {
                ...
                line.setValue(KEY_HIDDEN_DATA_TYPE, outparam.get(ReportDBDataPlanSCHParams.DATA_TYPE));
                line.setValue(KEY_LST_REPORT_DATA_TYPE, outparam.get(ReportDBDataPlanSCHParams.REPORT_DATA_TYPE));
                line.setValue(KEY_LST_MESSAGE, outparam.get(ReportDBDataPlanSCHParams.MESSAGE));
                line.setValue(KEY_HIDDEN_LOG_FLAG, outparam.get(ReportDBDataPlanSCHParams.LOG_FLAG));
                line.setValue(KEY_HIDDEN_CLASS_NAME, outparam.get(ReportDBDataPlanSCHParams.CLASS_NAME));
            ...
            throws Exception
    {
        ...
        for (int i = 1; i < lst_ReportData.getMaxRows(); i++)
        {
            lst_ReportData.setCurrentRow(i);
            if (lst_ReportData.getChecked(1))
            {
                checkflg = true;
                break;
            }
...
//                }
                ...
                ReportDBDataPlanSCHParams lineparam = new ReportDBDataPlanSCHParams();
                lineparam.setProcessFlag(ProcessFlag.REGIST);
                lineparam.setRowIndex(i);
                lineparam.set(ReportDBDataPlanSCHParams.DATA_TYPE, line.getValue(KEY_HIDDEN_DATA_TYPE));
                lineparam.set(ReportDBDataPlanSCHParams.SELECT, line.getValue(KEY_LST_SELECT));
                lineparam.set(ReportDBDataPlanSCHParams.CLASS_NAME, line.getValue(KEY_HIDDEN_CLASS_NAME));
                lineparam.set(ReportDBDataPlanSCHParams.REPORT_DATA_TYPE, line.getValue(KEY_LST_REPORT_DATA_TYPE));
            ...
            for (int i = 1; i <= _lcm_lst_ReportData.size(); i++)
            {
                ...
                // DFKLOOK start
                // 取り込みを行えていない行は対象外
                if (!outparams.get(i - 1).getBoolean(ReportDBDataPlanSCHParams.LOG_FLAG))
                {
                	continue;
                }
                // DFKLOOK end
            ...
            for (Params outparam : outparams)
            {
                ...
                line.setValue(KEY_HIDDEN_DATA_TYPE, outparam.get(ReportDBDataPlanSCHParams.DATA_TYPE));
                line.setValue(KEY_HIDDEN_LOG_FLAG, outparam.get(ReportDBDataPlanSCHParams.LOG_FLAG));
                line.setValue(KEY_LST_SELECT, outparam.get(ReportDBDataPlanSCHParams.SELECT));
                line.setValue(KEY_LST_REPORT_DATA_TYPE, outparam.get(ReportDBDataPlanSCHParams.REPORT_DATA_TYPE));
                line.setValue(KEY_LST_MESSAGE, outparam.get(ReportDBDataPlanSCHParams.MESSAGE));
                line.setValue(KEY_HIDDEN_CLASS_NAME, outparam.get(ReportDBDataPlanSCHParams.CLASS_NAME));
                lst_ReportData_SetLineToolTip(line);
