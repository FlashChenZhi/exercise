// $Id: StockHistoryResultInquiryDASCHParams.java 7414 2010-03-06 05:36:39Z okayama $
 ...
 */
public class StockHistoryResultInquiryDASCHParams
        extends WmsDASCHParams
{
    ...
    /** INC_DEC_QTY */
    public static final ParamKey INC_DEC_QTY = new ParamKey("INC_DEC_QTY");
    ...
    /** SEARCH_DAY_FROM */
    public static final ParamKey SEARCH_DAY_FROM = new ParamKey("SEARCH_DAY_FROM");

    /** SEARCH_DAY_TO */
    public static final ParamKey SEARCH_DAY_TO = new ParamKey("SEARCH_DAY_TO");
     ...
     * Default constructor
     */
    public StockHistoryResultInquiryDASCHParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public StockHistoryResultInquiryDASCHParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public StockHistoryResultInquiryDASCHParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
