...
import static jp.co.daifuku.wms.system.schedule.DataLoadEnvironmentSCHParams.*;
        ...
        extends AbstractSCH
{
            ...
            throws CommonException
    {
        for (int i = 0; i < ps.length; i++)
        {
            ...
            if (filepath.getBytes().length + fileName.getBytes().length + 18 > SystemInParameter.FILE_PATH_MAXLENGTH)
            {
                ...
                setMessage(WmsMessageFormatter.format(6023142, ps[i].getString(DATA_NAME),
            ...
            throws CommonException
    {
        ...
        for (Params p : ps)
        {
            ...
            {
                // プレフィックス指定のみ更新を行う
                exEnvAKey.setIsPrefix(ExchangeEnvironment.IS_PREFIX_TRUE);
            }
