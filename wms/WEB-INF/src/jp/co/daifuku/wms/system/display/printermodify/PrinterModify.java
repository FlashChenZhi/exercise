 ...
 * @author  $Author: admin $
 */
public class PrinterModify extends Page
{
	...
	/**
	 * ControlID	lst_PrinterModify
	 * TemplateKey	W_PrinterModify
	 * ControlType	ScrollListCell
	 */
	public jp.co.daifuku.bluedog.ui.control.ScrollListCell lst_PrinterModify = jp.co.daifuku.bluedog.ui.control.ScrollListCellFactory.getInstance("lst_PrinterModify" , "W_PrinterModify");
