// $Id: ReportDataPlanBusiness.java 7996 2011-07-06 00:52:24Z kitamaki $
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            for (int i = 1; i <= _lcm_lst_ReportData.size(); i++)
            {
                ...
                if (!lst_ReportData.getChecked(_lcm_lst_ReportData.getColumnIndex(KEY_LST_SELECT)))
                {
                    continue;
                }
                // 取り込みを行えていない場合も対象外とする
                if (!outparams.get(i - 1).getBoolean(ReportDataPlanSCHParams.LOG_FLAG))
                {
                	continue;
                }
                //DFKLOOK:ここまで修正
