// $Id: ReportDataStockSCH.java 7506 2010-03-12 06:44:21Z shibamoto $
 ...
 */
import static jp.co.daifuku.wms.system.schedule.ReportDataStockSCHParams.*;
        ...
        extends AbstractSCH
{
     ...
     */
    public ReportDataStockSCH(Connection conn, Class parent, Locale locale, DfkUserInfo ui)
            ...
            throws CommonException
    {
        ...
        try
        {
            ...
            StockReportDataCreator creater = new StockReportDataCreator(this.getConnection(), StockReportDataCreator.class);
