// $Id: WMS0801Params.java 3208 2009-03-02 05:42:52Z arai $
 ...
 */
public class DataLoadCheckListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * Default constructor
     */
    public DataLoadCheckListParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public DataLoadCheckListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public DataLoadCheckListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
