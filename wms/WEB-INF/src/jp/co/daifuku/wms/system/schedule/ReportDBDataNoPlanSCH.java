// $Id: ReportDBDataNoPlanSCH.java 7735 2010-03-26 06:22:49Z okayama $
        ...
        extends AbstractSCH
{
     ...
     */
    public ReportDBDataNoPlanSCH(Connection conn, Connection customerConn, Class parent, Locale locale, DfkUserInfo ui) throws CommonException
    {
            ...
            throws CommonException
    {
        ...
        skey.setJobType(Parameter.DATA_TYPE_MOVEMENT, "=", "(", "", false);
        skey.setJobType(Parameter.DATA_TYPE_INVENTORY, "=", "", "", false);
        skey.setJobType(Parameter.DATA_TYPE_NOPLAN_STORAGE, "=", "", "", false);
        skey.setJobType(Parameter.DATA_TYPE_NOPLAN_RETRIEVAL, "=", "", ")", true);
            ...
            throws CommonException
    {
        ...
        try
        {
            ...
            for (Params p : ps)
            {
                ...
                {
                    // 報告クラスを生成
                    ReportDBDataCreator reportCreator = getReportClass(p.getString(CLASS_NAME));
                    ...
                    try
                    {
                        ...
                        if (reportCreator.report())
                        {
                            ...
                            if (reportCreator.isReport())
                            {
                                ...
                                flag = true;
                                createExchangeHistory(ExchangeHistory.STATUS_NORMAL, p, reportCreator);
                            }
                            else
                            {
                                flag = false;
     ...
     * @throws CommonException
     */
    protected ReportDBDataCreator getReportClass(String className)
            throws CommonException
    {
        // コンストラクタクラス
        ...
        try
        {
            ...
            // コンストラクタを取得
            constructor = loaderClass.getConstructor(Connection.class, Connection.class);
            // インスタンス生成
            Object obj = constructor.newInstance(getConnection(), getCustomerConnection());
            // getFileCount()呼び出し
     ...
     */
    protected void createExchangeHistory(String status, Params p, ReportDBDataCreator creator)
            throws DataExistsException,
                ReadWriteException
    {
        ...
        ex.setDataType(ExchangeEnvironment.DATA_DB);
