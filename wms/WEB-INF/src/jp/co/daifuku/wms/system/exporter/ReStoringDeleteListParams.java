// $Id: ReStoringDeleteListParams.java 7352 2010-03-04 04:18:56Z kishimoto $
 ...
 *
 * @version $Revision: 7352 $, $Date:: 2010-03-04 13:18:56 +0900#$
 * @author  BusiTune 1.0 Generator.
 * @author  Last commit: $Author: kishimoto $
 */
public class ReStoringDeleteListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * Default constructor
     */
    public ReStoringDeleteListParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public ReStoringDeleteListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public ReStoringDeleteListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
