//$Id: HostDBDataLoadBusiness.java 7996 2011-07-06 00:52:24Z kitamaki $
...
extends HostDBDataLoad
{
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            // A second connection, this time to the customer's host
            customerConn = WmsParam.getCustomerConnection();  

            sch = new HostDBDataLoadSCH(conn, customerConn, this.getClass(), locale, ui);
