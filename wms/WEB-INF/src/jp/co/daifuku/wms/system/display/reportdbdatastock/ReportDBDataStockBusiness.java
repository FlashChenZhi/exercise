// $Id: ReportDBDataStockBusiness.java 7851 2010-04-21 08:49:56Z shibamoto $
...
import jp.co.daifuku.wms.system.schedule.ReportDBDataStockSCH;
import jp.co.daifuku.wms.system.schedule.ReportDBDataStockSCHParams;
...
public class ReportDBDataStockBusiness
        extends ReportDBDataStock
{
     ...
     * Default constructor
     */
    public ReportDBDataStockBusiness()
    {
        super();
    }
            ...
            throws Exception
    {
        ...
        ReportDBDataStockSCH sch = null;
        try
        {
            // open connection.
            conn = ConnectionManager.getRequestConnection(this);
            customerConn = WmsParam.getCustomerConnection(); 
            sch = new ReportDBDataStockSCH(conn, customerConn, this.getClass(), locale, ui);

            // set input parameters.
            ReportDBDataStockSCHParams inparam = new ReportDBDataStockSCHParams();
            inparam.setProcessFlag(ProcessFlag.REGIST);
            inparam.set(ReportDBDataStockSCHParams.AREA_NO, _pdm_pul_Area.getSelectedValue());
            inparam.set(ReportDBDataStockSCHParams.CONSIGNOR_CODE, WmsParam.DEFAULT_CONSIGNOR_CODE);
