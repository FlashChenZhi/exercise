// $Id: ReportDataPlanSCH.java 7241 2010-02-26 05:32:14Z okayama $
 ...
 */
import static jp.co.daifuku.wms.system.schedule.ReportDataPlanSCHParams.*;
        ...
        extends AbstractSCH
{
     ...
     */
    public ReportDataPlanSCH(Connection conn, Class parent, Locale locale, DfkUserInfo ui) throws CommonException
    {
            ...
            throws CommonException
    {
        ...
        try
        {
            ...
            for (Params p : ps)
            {
                ...
                {
                    // 報告クラスを生成
                    ReportDataCreator reportCreator = getReportClass(p.getString(CLASS_NAME), p.getString(DATA_TYPE));
     ...
     */
    protected void createExchangeHistory(String status, String jobType, ReportDataCreator creator)
            throws DataExistsException,
                ReadWriteException
    {
     ...
     * @throws CommonException
     */
    protected ReportDataCreator getReportClass(String className, String exchangeJob)
            throws CommonException
    {
        // システム定義コントローラ
        ...
        try
        {
            ...
            // Pカートパッケージが導入されている場合
            if (sysCtrl.hasPCTRetrievalPack())
            {
                // コンストラクタを取得
                constructor = loaderClass.getConstructor(Connection.class, String.class, Class.class);
                // インスタンス生成
                obj = constructor.newInstance(getConnection(), exchangeJob, this.getParent());
            }
            else
            {
                // コンストラクタを取得
                constructor = loaderClass.getConstructor(Connection.class, Class.class);
                // インスタンス生成
                obj = constructor.newInstance(getConnection(), this.getParent());
            }
            // getFileCount()呼び出し
