// $Id: DataReportEnvironmentSCH.java 7277 2010-02-26 07:43:50Z okayama $
 ...
 */
import static jp.co.daifuku.wms.system.schedule.DataReportEnvironmentSCHParams.*;
        ...
        extends AbstractSCH
{
     ...
     */
    public DataReportEnvironmentSCH(Connection conn, Class parent, Locale locale, DfkUserInfo ui) throws CommonException
    {
            ...
            throws CommonException
    {
        ...
        skey.setDataType(ExchangeEnvironment.DATA_PLAN, "=", "(", "", false);
        skey.setDataType(ExchangeEnvironment.DATA_NO_PLAN, "=", "", ")", true);

        // 並び順
        skey.setDataTypeOrder(true);
        ...
        for (ExchangeEnvironment exEnv : exEnvs)
        {
            ...
            param.set(DATA_NAME, exEnv.getDataName());
            param.set(DESTINATION_FOLDER, exEnv.getFolderName());
            param.set(PREFIX_NAME, exEnv.getDataId());
            param.set(REPORT_UNIT, DisplayResource.getDataReport(exEnv.getReportType()));
            ...
            throws CommonException
    {
        ...
        for (Params p : ps)
        {
            ...
            exEnvAKey.setDataType(ExchangeEnvironment.DATA_PLAN, "=", "(", "", false);
            exEnvAKey.setDataType(ExchangeEnvironment.DATA_NO_PLAN, "=", "", ")", true);
