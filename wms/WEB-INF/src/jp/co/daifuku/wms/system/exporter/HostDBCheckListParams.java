 ...
 */
public class HostDBCheckListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * @throws IOException
     */
    public HostDBCheckListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public HostDBCheckListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
