 ...
 */
public class StdItemInputBusiness
        extends AbstractHSBusiness
{
    ...
    //------------------------------------------------------------
    /** SCREEN_NAME */
    private static final String SCREEN_NAME = "StdItemInput";
    ...
    public HSResult ent_Click(DataSheetFactory dsf, Locale locale)
    {
        ...
        // input validation.
        if (StringUtil.isBlank(itemDataSheet.getText(ItemDataSheet.ITEM_CODE)))
        {
     ...
     * @return executed result
     */
    public HSResult select_Click(DataSheetFactory dsf, Locale locale)
    {
        // set result code.
        return new HSResult(ResultConst.NORMAL);
    }
