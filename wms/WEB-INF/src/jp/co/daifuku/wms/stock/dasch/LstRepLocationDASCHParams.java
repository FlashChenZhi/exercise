 ...
 */
public class LstRepLocationDASCHParams
        extends WmsDASCHParams
{
     ...
     * Default constructor
     */
    public LstRepLocationDASCHParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public LstRepLocationDASCHParams(StringParameters param) throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public LstRepLocationDASCHParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
