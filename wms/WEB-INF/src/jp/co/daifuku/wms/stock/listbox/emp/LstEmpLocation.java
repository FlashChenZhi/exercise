 ...
 * @author  $Author: admin $
 */
public class LstEmpLocation extends Page
{
	...
	/**
	 * ControlID	lst_EmpLocationList
	 * TemplateKey	W_LocationList
	 * ControlType	ScrollListCell
	 */
	public jp.co.daifuku.bluedog.ui.control.ScrollListCell lst_EmpLocationList = jp.co.daifuku.bluedog.ui.control.ScrollListCellFactory.getInstance("lst_EmpLocationList" , "W_LocationList");
