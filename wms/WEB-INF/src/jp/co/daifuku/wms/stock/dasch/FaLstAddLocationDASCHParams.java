 ...
 */
public class FaLstAddLocationDASCHParams
        extends WmsDASCHParams
{
     ...
     * Default constructor
     */
    public FaLstAddLocationDASCHParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public FaLstAddLocationDASCHParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public FaLstAddLocationDASCHParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
