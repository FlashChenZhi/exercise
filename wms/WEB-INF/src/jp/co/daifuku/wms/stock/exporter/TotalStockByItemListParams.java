 ...
 */
public class TotalStockByItemListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * Default constructor
     */
    public TotalStockByItemListParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public TotalStockByItemListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public TotalStockByItemListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
