// $Id: DirectShipping.java 2267 2008-12-17 17:14:25Z kevin $
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 2267 $, $Date: 2008-12-18 02:14:25 +0900 (木, 18 12 2008) $
 * @author  $Author: kevin $
 */
public class DirectShipping extends Page
{
	 ...
	 * TemplateKey	W_ShippingArea
	 * ControlType	Label
	 */
	public jp.co.daifuku.bluedog.ui.control.Label lbl_StorageArea = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_StorageArea" , "W_ShippingArea");
	 ...
	 * TemplateKey	W_ShippingCaseQty
	 * ControlType	Label
	 */
	public jp.co.daifuku.bluedog.ui.control.Label lbl_StorageCaseQty = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_StorageCaseQty" , "W_ShippingCaseQty");

	/**
	 * ControlID	txt_ShippingCaseQty
	 * TemplateKey	W_WorkCaseQty
	 * ControlType	NumberTextBox
	 */
	public jp.co.daifuku.bluedog.ui.control.NumberTextBox txt_ShippingCaseQty = jp.co.daifuku.bluedog.ui.control.NumberTextBoxFactory.getInstance("txt_ShippingCaseQty" , "W_WorkCaseQty");

	/**
	 * ControlID	lbl_StoragePieceQty
	 * TemplateKey	W_ShippingPieceQty
	 * ControlType	Label
	 */
	public jp.co.daifuku.bluedog.ui.control.Label lbl_StoragePieceQty = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_StoragePieceQty" , "W_ShippingPieceQty");

	/**
	 * ControlID	txt_ShippingPieceQty
	 * TemplateKey	W_WorkPieceQty
	 * ControlType	NumberTextBox
	 */
	public jp.co.daifuku.bluedog.ui.control.NumberTextBox txt_ShippingPieceQty = jp.co.daifuku.bluedog.ui.control.NumberTextBoxFactory.getInstance("txt_ShippingPieceQty" , "W_WorkPieceQty");
	 ...
	 * ControlType	SubmitButton
	 */
	public jp.co.daifuku.bluedog.ui.control.SubmitButton btn_ShippingStart = jp.co.daifuku.bluedog.ui.control.SubmitButtonFactory.getInstance("btn_ShippingStart" , "W_Start");
	...
	/**
	 * ControlID	lst_NoPlanShipping
	 * TemplateKey	W_NoPlanShipping
	 * ControlType	ListCell
	 */
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_NoPlanShipping = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_NoPlanShipping" , "W_NoPlanShipping");
