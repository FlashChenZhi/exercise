 ...
 */
public class TotalStockByItemAndLotListParams
        extends Params
{
    //------------------------------------------------------------
    ...
    /** WAREHOUSE */
    public static final ParamKey WAREHOUSE = new ParamKey("WAREHOUSE");
     ...
     * Default constructor
     */
    public TotalStockByItemAndLotListParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public TotalStockByItemAndLotListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public TotalStockByItemAndLotListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
