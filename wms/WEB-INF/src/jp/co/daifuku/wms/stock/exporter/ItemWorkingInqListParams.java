// $Id: ItemWorkingInqListParams.java 4660 2009-07-14 09:23:02Z kumano $
 ...
 *
 * @version $Revision: 4660 $, $Date:: 2009-07-14 18:23:02 +0900#$
 * @author  BusiTune 1.0 Generator.
 * @author  Last commit: $Author: kumano $
 */
public class ItemWorkingInqListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * Default constructor
     */
    public ItemWorkingInqListParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public ItemWorkingInqListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public ItemWorkingInqListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
