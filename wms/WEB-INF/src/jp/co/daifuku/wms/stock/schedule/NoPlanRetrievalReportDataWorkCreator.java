// $Id: NoPlanRetrievalReportDataWorkCreator.java 7506 2010-03-12 06:44:21Z shibamoto $
 ...
 */
public class NoPlanRetrievalReportDataWorkCreator
        extends NoPlanRetrievalReportDataCreator
{
    //------------------------------------------------------------
     ...
     */
    public NoPlanRetrievalReportDataWorkCreator(Connection conn)
    {
        super(conn);
    }
     ...
     */
    public NoPlanRetrievalReportDataWorkCreator(Connection conn, Class caller)
    {
        super(conn, caller);
    }
     ...
     * 
     * @return boolean 予定外出庫報告データの作成に成功した場合は、True、失敗した場合は、Falseを返します。
     */
     ...
     * 環境情報を取得し、データ報告実績ファイルの作成を行ないます。<BR>
    ...
    {
        return "$Id: NoPlanRetrievalReportDataWorkCreator.java 7506 2010-03-12 06:44:21Z shibamoto $";
    }
}
