        ...
        extends RetrievalPlanInquiry
{
    ...
    private static final ListCellKey KEY_LST_START_STATUS = 
            new ListCellKey("LST_START_STATUS", new StringCellColumn(), false, false);
    ...
    private static final ListCellKey KEY_LST_TICKET =
            new ListCellKey("LST_TICKET", new StringCellColumn(), true, false);
    ...
    private static final ListCellKey KEY_LST_RESULT_CASE_QTY =
            new ListCellKey("LST_RESULT_CASE_QTY", new NumberCellColumn(0), true, false);

    /** lst_RetrievalPlanList(LST_RESULT_PIECE_QTY) */
    private static final ListCellKey KEY_LST_RESULT_PIECE_QTY =
            new ListCellKey("LST_RESULT_PIECE_QTY", new NumberCellColumn(0), true, false);
    ...
    private static final ListCellKey KEY_LST_PICKING_AREA =
            new ListCellKey("LST_PICKING_AREA", new AreaCellColumn(), true, false);

    /** lst_RetrievalPlanList(LST_PICKING_LOCATION) */
    private static final ListCellKey KEY_LST_PICKING_LOCATION =
            new ListCellKey("LST_PICKING_LOCATION", new LocationCellColumn(), true, false);
    ...
    private static final ListCellKey KEY_LST_WORK_STATUS =
            new ListCellKey("LST_WORK_STATUS", new StringCellColumn(), true, false);

    /** lst_RetrievalPlanList kyes */
            ...
            throws Exception
    {
        ...
        line.addToolTip("LBL-W0240", KEY_LST_START_STATUS);
    ...
    {
        // DFKLOOK
        // 表示ボタン時、入力チェックをBusiTuneで指定できないため
        // input validation.
        ...
        try
        {
            ...
            for (Params outparam : outparams)
            {
                ...
                line.setValue(KEY_LST_SHORTAGE_CASE_QTY,
                        outparam.get(RetrievalPlanInquiryDASCHParams.SHORTAGE_CASE_QTY));
                line.setValue(KEY_LST_SHORTAGE_PIECE_QTY,
                        outparam.get(RetrievalPlanInquiryDASCHParams.SHORTAGE_PIECE_QTY));
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            while (dasch.next())
            {
                ...
                expparam.set(RetrievalPlanInqListParams.RESULT_CASE_QTY,
                        outparam.get(RetrievalPlanInquiryDASCHParams.RESULT_CASE_QTY));
                expparam.set(RetrievalPlanInqListParams.RESULT_PIECE_QTY,
                        outparam.get(RetrievalPlanInquiryDASCHParams.RESULT_PIECE_QTY));
                expparam.set(RetrievalPlanInqListParams.SHORTAGE_CASE_QTY,
                        outparam.get(RetrievalPlanInquiryDASCHParams.SHORTAGE_CASE_QTY));
                expparam.set(RetrievalPlanInqListParams.SHORTAGE_PIECE_QTY,
                        outparam.get(RetrievalPlanInquiryDASCHParams.SHORTAGE_PIECE_QTY));
                expparam.set(RetrievalPlanInqListParams.AREA_NO, outparam.get(RetrievalPlanInquiryDASCHParams.PICKING_AREA));
                expparam.set(RetrievalPlanInqListParams.PLAN_LOCATION_NO,
                        outparam.get(RetrievalPlanInquiryDASCHParams.PICKING_LOCATION));
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            while (dasch.next())
            {
                ...
                RetrievalPlanInqListParams expparam = new RetrievalPlanInqListParams();
                expparam.set(RetrievalPlanInqListParams.PLAN_DAY, outparam.get(RetrievalPlanInquiryDASCHParams.PLAN_DATE));
                expparam.set(RetrievalPlanInqListParams.RECEIVE_TICKET_NO,
                        outparam.get(RetrievalPlanInquiryDASCHParams.TICKET));
                expparam.set(RetrievalPlanInqListParams.RECEIVE_LINE_NO,
                        outparam.get(RetrievalPlanInquiryDASCHParams.LINE));
                expparam.set(RetrievalPlanInqListParams.BRANCH_NO, outparam.get(RetrievalPlanInquiryDASCHParams.SERIAL));
                expparam.set(RetrievalPlanInqListParams.BATCH_NO, outparam.get(RetrievalPlanInquiryDASCHParams.BATCH));
                expparam.set(RetrievalPlanInqListParams.ORDER_NO, outparam.get(RetrievalPlanInquiryDASCHParams.ORDER));
                expparam.set(RetrievalPlanInqListParams.CUSTOMER_CODE,
                        outparam.get(RetrievalPlanInquiryDASCHParams.CUSTOMER_CODE));
                expparam.set(RetrievalPlanInqListParams.CUSTOMER_NAME,
                        outparam.get(RetrievalPlanInquiryDASCHParams.CUSTOMER_NAME));
                expparam.set(RetrievalPlanInqListParams.ITEM_CODE, outparam.get(RetrievalPlanInquiryDASCHParams.ITEM_CODE));
                expparam.set(RetrievalPlanInqListParams.ITEM_NAME, outparam.get(RetrievalPlanInquiryDASCHParams.ITEM_NAME));
                expparam.set(RetrievalPlanInqListParams.ENTERING_QTY,
                        outparam.get(RetrievalPlanInquiryDASCHParams.CASE_PACK));
                expparam.set(RetrievalPlanInqListParams.PLAN_CASE_QTY,
                        outparam.get(RetrievalPlanInquiryDASCHParams.PLAN_CASE_QTY));
                expparam.set(RetrievalPlanInqListParams.PLAN_PIECE_QTY,
                        outparam.get(RetrievalPlanInquiryDASCHParams.PLAN_PIECE_QTY));
                expparam.set(RetrievalPlanInqListParams.RESULT_CASE_QTY,
                        outparam.get(RetrievalPlanInquiryDASCHParams.RESULT_CASE_QTY));
                expparam.set(RetrievalPlanInqListParams.RESULT_PIECE_QTY,
                        outparam.get(RetrievalPlanInquiryDASCHParams.RESULT_PIECE_QTY));
                ...
                expparam.set(RetrievalPlanInqListParams.SHORTAGE_PIECE_QTY,
                        outparam.get(RetrievalPlanInquiryDASCHParams.SHORTAGE_PIECE_QTY));
                expparam.set(RetrievalPlanInqListParams.AREA_NO,
                        outparam.get(RetrievalPlanInquiryDASCHParams.PICKING_AREA));
                expparam.set(RetrievalPlanInqListParams.PLAN_LOCATION_NO,
                        outparam.get(RetrievalPlanInquiryDASCHParams.PICKING_LOCATION));
                expparam.set(RetrievalPlanInqListParams.PLAN_LOT_NO, outparam.get(RetrievalPlanInquiryDASCHParams.LOT));
                ...
                expparam.set(RetrievalPlanInqListParams.STATUS_FLAG,
                        outparam.get(RetrievalPlanInquiryDASCHParams.WORK_STATUS));
                if (!exporter.write(expparam))
                {
                    //DFKLOOK start
                    // XLS最大件数出力メッセージ対応
