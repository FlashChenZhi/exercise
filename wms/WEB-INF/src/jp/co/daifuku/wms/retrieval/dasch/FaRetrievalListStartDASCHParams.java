 ...
 */
public class FaRetrievalListStartDASCHParams
        extends WmsDASCHParams
{
    ...
    /** LOCATION_NO */
    public static final ParamKey LOCATION_NO = new ParamKey("PLAN_LOCATION_NO");
     ...
     * Default constructor
     */
    public FaRetrievalListStartDASCHParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public FaRetrievalListStartDASCHParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public FaRetrievalListStartDASCHParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
