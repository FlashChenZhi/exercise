// $Id: RetrievalStartListParams.java 4669 2009-07-14 10:46:07Z kumano $
 ...
 *
 * @version $Revision: 4669 $, $Date:: 2009-07-14 19:46:07 +0900#$
 * @author  BusiTune 1.0 Generator.
 * @author  Last commit: $Author: kumano $
 */
public class RetrievalStartListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * Default constructor
     */
    public RetrievalStartListParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public RetrievalStartListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public RetrievalStartListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
