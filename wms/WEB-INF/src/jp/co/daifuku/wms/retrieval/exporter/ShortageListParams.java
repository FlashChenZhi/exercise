 ...
 */
public class ShortageListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * @throws IOException
     */
    public ShortageListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public ShortageListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
