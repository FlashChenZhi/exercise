// $Id: RetrievalReportDataDetailCreator.java 7241 2010-02-26 05:32:14Z okayama $
 ...
 */
public class RetrievalReportDataDetailCreator
        extends RetrievalReportDataCreator
{
     ...
     */
    public RetrievalReportDataDetailCreator(Connection conn) throws ReadWriteException,
            ScheduleException
    {
        super(conn);
        _WNSysCtrl = new WarenaviSystemController(conn, getClass());
    }
     ...
     * @throws ScheduleException 
     */
    public RetrievalReportDataDetailCreator(Connection conn, Class caller) throws ReadWriteException,
            ScheduleException
    {
        super(conn, caller);
        _WNSysCtrl = new WarenaviSystemController(conn, getClass());
    ...
    {
        return "$Id: RetrievalReportDataDetailCreator.java 7241 2010-02-26 05:32:14Z okayama $";
    }
}
