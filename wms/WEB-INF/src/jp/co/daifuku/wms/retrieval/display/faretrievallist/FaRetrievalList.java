 ...
 * @author  $Author: admin $
 */
public class FaRetrievalList extends Page
{
	...
	/**
	 * ControlID	pul_FFaRetrievalWorkKind
	 * TemplateKey	W_F_FaRetrievalWorkKind
	 * ControlType	PullDown
	 */
	public jp.co.daifuku.bluedog.ui.control.PullDown pul_FFaRetrievalWorkKind = jp.co.daifuku.bluedog.ui.control.PullDownFactory.getInstance("pul_FFaRetrievalWorkKind" , "W_F_FaRetrievalWorkKind");
	...
	/**
	 * ControlID	lst_FaRetrievalWorkList
	 * TemplateKey	W_FaRetrievalWorkList
	 * ControlType	ScrollListCell
	 */
	public jp.co.daifuku.bluedog.ui.control.ScrollListCell lst_FaRetrievalWorkList = jp.co.daifuku.bluedog.ui.control.ScrollListCellFactory.getInstance("lst_FaRetrievalWorkList" , "W_FaRetrievalWorkList");
