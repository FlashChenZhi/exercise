// $Id: AsRetrievalWorkListParams.java 6791 2010-01-22 08:58:22Z okayama $
 ...
 *
 * @version $Revision: 6791 $, $Date:: 2010-01-22 17:58:22 +0900#$
 * @author  BusiTune 1.0 Generator.
 * @author  Last commit: $Author: okayama $
 */
public class AsRetrievalWorkListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * Default constructor
     */
    public AsRetrievalWorkListParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public AsRetrievalWorkListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public AsRetrievalWorkListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
