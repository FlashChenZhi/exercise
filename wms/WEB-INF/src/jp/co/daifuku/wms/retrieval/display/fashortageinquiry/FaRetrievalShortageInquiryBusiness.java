...
import jp.co.daifuku.wms.retrieval.schedule.FaRetrievalShortageInquirySCH;
import jp.co.daifuku.wms.retrieval.schedule.FaRetrievalShortageInquirySCHParams;
        ...
        extends FaRetrievalShortageInquiry
{
    ...
    private ListCellModel _lcm_lst_FaShortageInquiry;
            ...
            throws Exception
    {
        ...
        // DFKLOOK start
        lbl_JavaSet.setValue(DisplayText.getText("LBL-W1365"));
        // DFKLOOK end
        //DFKLOOK:ここまで修正
    }
            ...
            throws Exception
    {
        ...
        _lcm_lst_FaShortageInquiry = new ListCellModel(lst_FaShortageInquiry, LST_FASHORTAGEINQUIRY_KEYS, locale);
            ...
            throws Exception
    {
        ...
        FaRetrievalShortageInquirySCH sch = null;
        try
        {
            // open connection.
            conn = ConnectionManager.getRequestConnection(this);
            sch = new FaRetrievalShortageInquirySCH(conn, this.getClass(), locale, ui);

            // set input parameters.
            FaRetrievalShortageInquirySCHParams inparam = new FaRetrievalShortageInquirySCHParams();
            inparam.set(FaRetrievalShortageInquirySCHParams.CONSIGNOR_CODE, WmsParam.DEFAULT_CONSIGNOR_CODE);
            ...
            for (Params outparam : outparams)
            {
               ...
               // System.out.println(outparam.get(FaRetrievalShortageInquirySCHParams.));
                
                txt_SearchDate.setDate(outparam.getDate(FaRetrievalShortageInquirySCHParams.SET_DAY));
                txt_SearchTime.setTime(outparam.getDate(FaRetrievalShortageInquirySCHParams.SET_TIME));
            }
        }
        catch (Exception ex)
        {
            ...
            throws Exception
    {
        ...
        //DFKLOOK:ここから修正
    	FaLstRetrievalSettingDateParams inparam = new FaLstRetrievalSettingDateParams();
        inparam.set(FaLstRetrievalSettingDateParams.CONSIGNOR_CODE, WmsParam.DEFAULT_CONSIGNOR_CODE);
        inparam.set(FaLstRetrievalSettingDateParams.START_DATE, txt_SearchDate.getDate());
        inparam.set(FaLstRetrievalSettingDateParams.START_TIME, txt_SearchTime.getTime());
        //DFKLOOK:ここまで修正
        ...
        //DFKLOOK:ここから修正
        redirect("/retrieval/listbox/fasettingdate/FaLstRetrievalSettingDate.do", forwardParam, "/Progress.do");
        //DFKLOOK:ここまで修正
    }
            ...
            throws Exception
    {
        // output display.
        //DFKLOOK:ここから修正
    	FaLstRetrievalSettingDateParams outparam = new FaLstRetrievalSettingDateParams(dialogParams);
        txt_SearchDate.setDate(outparam.getDate(FaLstRetrievalSettingDateParams.START_DATETIME));
        txt_SearchTime.setTime(outparam.getDate(FaLstRetrievalSettingDateParams.START_DATETIME));
        //DFKLOOK:ここまで修正
    ...
    {
        // DFKLOOK start
    	txt_SearchDate.validate(true);
    	txt_SearchTime.validate(true);
        // DFKLOOK end
