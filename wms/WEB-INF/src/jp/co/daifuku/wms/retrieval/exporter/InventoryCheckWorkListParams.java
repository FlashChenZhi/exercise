 ...
 */
public class InventoryCheckWorkListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * Default constructor
     */
    public InventoryCheckWorkListParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public InventoryCheckWorkListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public InventoryCheckWorkListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
