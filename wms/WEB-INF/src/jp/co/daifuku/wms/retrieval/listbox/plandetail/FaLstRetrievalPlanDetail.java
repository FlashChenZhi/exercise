 ...
 * @author  $Author: admin $
 */
public class FaLstRetrievalPlanDetail extends Page
{
	...
	/**
	 * ControlID	lst_RetPlanInquiry
	 * TemplateKey	W_RetPlanInquiryList
	 * ControlType	ScrollListCell
	 */
	public jp.co.daifuku.bluedog.ui.control.ScrollListCell lst_RetPlanInquiry = jp.co.daifuku.bluedog.ui.control.ScrollListCellFactory.getInstance("lst_RetPlanInquiry" , "W_RetPlanInquiryList");
