 ...
 */
public class RetInspectionBusiness
        extends AbstractHSBusiness
{
    ...
    //------------------------------------------------------------
    /** SCREEN_NAME */
    private static final String SCREEN_NAME = "RetInspection";
    ...
    public HSResult back_Click(DataSheetFactory dsf, Locale locale)
    {
        ...
        retrievalOutDataSheet.setValue(RetrievalOutDataSheet.RESULT_QTY, 0);
        retrievalOutDataSheet.setValue(RetrievalOutDataSheet.RESULT_CASE_QTY, 0);
        retrievalOutDataSheet.setValue(RetrievalOutDataSheet.RESULT_PIECE_QTY, 0);
        retrievalOutDataSheet.setValue(RetrievalOutDataSheet.RESULT_LOT_NO, retrievalOutDataSheet.getValue(RetrievalOutDataSheet.PLAN_LOT_NO));
