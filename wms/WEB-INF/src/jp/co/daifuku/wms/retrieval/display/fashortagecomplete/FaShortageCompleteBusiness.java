// $Id: FaShortageCompleteBusiness.java 7996 2011-07-06 00:52:24Z kitamaki $
        ...
        extends FaShortageComplete
{
    ...
    private ListCellModel _lcm_lst_FaShortageComplete;
     ...
     * @throws Exception
     */
    public void lst_FaShortageComplete_Click(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_FaShortageComplete_ColumClick(ActionEvent e)
            throws Exception
    {
    }
            ...
            throws Exception
    {
        ...
        _lcm_lst_FaShortageComplete = new ListCellModel(lst_FaShortageComplete, LST_FASHORTAGECOMPLETE_KEYS, locale);
            ...
            throws Exception
    {
        ...
        // DFKLOOK start
        //line.addToolTip("LBL-W0224", KEY_HIDDEN_BATCH_NO);
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            for (Params outparam : outparams)
            {
                ...
                // DFKLOOK start
                line.setValue(KEY_LST_BATCH_NO, outparam.get(FaShortageCompleteSCHParams.BATCH_NO));
                // DFKLOOK end
