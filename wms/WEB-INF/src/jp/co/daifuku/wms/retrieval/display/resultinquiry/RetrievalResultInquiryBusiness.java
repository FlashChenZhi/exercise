// $Id: RetrievalResultInquiryBusiness.java 7521 2010-03-13 05:53:55Z shibamoto $
        ...
        extends RetrievalResultInquiry
{
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            {
                inparam.set(RetrievalResultInquiryDASCHParams.GROUP_CONDITION, Parameter.COLLECT_CONDITION_DETAIL);
            }
            else if (rdo_GroupCondition_PlannedUnit.getChecked())
            {
                inparam.set(RetrievalResultInquiryDASCHParams.GROUP_CONDITION, Parameter.COLLECT_CONDITION_PLAN);
            }
