 ...
 */
public class RetOrderConfirmBusiness
        extends AbstractHSBusiness
{
    ...
    //------------------------------------------------------------
    /** SCREEN_NAME */
    private static final String SCREEN_NAME = "RetOrderConfirm";
     ...
     * Default constructor
     */
    public RetOrderConfirmBusiness()
    {
        super();
    }
    ...
    public HSResult ent_Click(DataSheetFactory dsf, Locale locale)
    {
        ...
        try
        {
            ...
            inparam.set(RetCompleteSCHParams.USER_ID, commonDataSheet.getValue(CommonDataSheet.USER_ID));
            inparam.set(RetCompleteSCHParams.CONSIGNOR_CODE, retrievalOutDataSheet.getValue(RetrievalOutDataSheet.CONSIGNOR_CODE));
            inparam.set(RetCompleteSCHParams.AREA_NO, retrievalOutDataSheet.getValue(RetrievalOutDataSheet.AREA_NO));
            inparam.set(RetCompleteSCHParams.START_DATE_TIME, commonDataSheet.getValue(CommonDataSheet.START_DATE_TIME));
            inparam.set(RetCompleteSCHParams.MISS_SCAN_COUNT, commonDataSheet.getValue(CommonDataSheet.MISS_SCAN_COUNT));
