        ...
        extends FaLstRetrievalPlanDetail
{
    ...
    private ListCellModel _lcm_lst_RetPlanInquiry;
     ...
     * @throws Exception
     */
    public void lst_RetPlanInquiry_Click(ActionEvent e)
            throws Exception
    {
    }
            ...
            throws Exception
    {
        ...
        _lcm_lst_RetPlanInquiry = new ListCellModel(lst_RetPlanInquiry, LST_RETPLANINQUIRY_KEYS, locale);
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            // バッチNo.
            lst_SearchCondition.setValue(1, DispResources.getText("LBL-W0224"));
            lst_SearchCondition.setValue(2, inparam.getString(FaLstRetrievalPlanDetailDASCHParams.BATCH_NO));
            // DFKLOOK end
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            {
                ListCellLine line = _lcm_lst_RetPlanInquiry.getNewLine();
                line.setValue(KEY_LST_NO, outparam.get(FaLstRetrievalPlanDetailDASCHParams.SELECT));
                line.setValue(KEY_LST_TICKET, outparam.get(FaLstRetrievalPlanDetailDASCHParams.SHIP_TICKET_NO));
                line.setValue(KEY_LST_LINE, outparam.get(FaLstRetrievalPlanDetailDASCHParams.SHIP_TICKET_LINE));
                line.setValue(KEY_LST_ITEM_CODE, outparam.get(FaLstRetrievalPlanDetailDASCHParams.ITEM_CODE));
                line.setValue(KEY_LST_LOT, outparam.get(FaLstRetrievalPlanDetailDASCHParams.LOT_NO));
                line.setValue(KEY_LST_PICKING_PLAN_QTY, outparam.get(FaLstRetrievalPlanDetailDASCHParams.PLAN_QTY));
                // DFKLOOK ここから
                line.setValue(KEY_LST_PLAN_DATE, WmsFormatter.toDate(outparam.get(FaLstRetrievalPlanDetailDASCHParams.PLAN_DATE).toString()));
                line.setValue(KEY_LST_WORK_STATUS, DisplayResource.getWorkingStatus(outparam.get(FaLstRetrievalPlanDetailDASCHParams.STATUS_FLAG).toString()));
                line.setValue(KEY_HIDDEN_ITEM_NAME, outparam.get(FaLstRetrievalPlanDetailDASCHParams.ITEM_NAME));
                // DFKLOOK ここまで
                lst_RetPlanInquiry_SetLineToolTip(line);
                _lcm_lst_RetPlanInquiry.add(line);
            }
