// $Id: LstItemHistoryParams.java,v 1.1.1.1 2009/02/10 08:55:42 arai Exp $
 ...
 */
public class LstItemHistoryParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * @throws IOException
     */
    public LstItemHistoryParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public LstItemHistoryParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
