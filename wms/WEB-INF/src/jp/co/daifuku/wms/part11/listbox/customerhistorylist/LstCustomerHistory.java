// $Id: LstCustomerHistory.java 7707 2010-03-20 07:23:11Z okayama $
 ...
 */
public class LstCustomerHistory extends Page
{
	...
	/**
	 * ControlID	lst_CustomerHistoryList
	 * TemplateKey	W_CustomerHistoryList
	 * ControlType	ListCell
	 */
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_CustomerHistoryList = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_CustomerHistoryList" , "W_CustomerHistoryList");
