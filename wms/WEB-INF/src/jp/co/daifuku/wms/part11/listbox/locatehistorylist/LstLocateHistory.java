// $Id: LstLocateHistory.java 7707 2010-03-20 07:23:11Z okayama $
 ...
 */
public class LstLocateHistory extends Page
{
	...
	/**
	 * ControlID	lst_LocateHistoryList
	 * TemplateKey	W_LocateHistoryList
	 * ControlType	ListCell
	 */
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_LocateHistoryList = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_LocateHistoryList" , "W_LocateHistoryList");
