// $Id: LstLocateHistoryBusiness.java 7747 2010-03-29 08:08:07Z kishimoto $
        ...
        extends LstLocateHistory
{
     ...
     * @throws Exception
     */
    public void lst_LocateHistoryList_Click(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_LocateHistoryList_EnterKey(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_LocateHistoryList_TabKey(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_LocateHistoryList_InputComplete(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_LocateHistoryList_ColumClick(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_LocateHistoryList_Server(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_LocateHistoryList_Change(ActionEvent e)
            throws Exception
    {
    }
    ...
    protected boolean checkDate(Params p) throws ScheduleException
    {
        ...
        if (!chk.checkDate(WmsFormatter.toDate(p.getString(LstLocateHistoryDASCHParams.DISPFROMDAY_KEY)),
                WmsFormatter.toDate(p.getString(LstLocateHistoryDASCHParams.DISPFROMTIME_KEY))))
        {
            message.setMsgResourceKey(chk.getMessage());
            return false;
        }

        if (!chk.checkDate(WmsFormatter.toDate(p.getString(LstLocateHistoryDASCHParams.DISPTODAY_KEY)),
                WmsFormatter.toDate(p.getString(LstLocateHistoryDASCHParams.DISPTOTIME_KEY))))
        {
            message.setMsgResourceKey(chk.getMessage());
            return false;
        }
     ...
     * @param param 検索条件
     */
    protected boolean lst_SearchCondition_Make(LstLocateHistoryDASCHParams param, Locale locale) throws ScheduleException
    {
        // 検索日時の補完処理
        Date[] tmp =
                WmsFormatter.getFromTo(WmsFormatter.toDate(param.getString(LstLocateHistoryDASCHParams.DISPFROMDAY_KEY)),
                        WmsFormatter.toTime(param.getString(LstLocateHistoryDASCHParams.DISPFROMTIME_KEY)),
                        WmsFormatter.toDate(param.getString(LstLocateHistoryDASCHParams.DISPTODAY_KEY)),
                        WmsFormatter.toTime(param.getString(LstLocateHistoryDASCHParams.DISPTOTIME_KEY)));
        Date from = tmp[0];
        Date to = tmp[1];
        ...
        lst_SearchCondition.setValue(2, param.getString(LstLocateHistoryDASCHParams.USERID_KEY));
        ...
        lst_SearchCondition.setValue(2, param.getString(LstLocateHistoryDASCHParams.DSNUMBER_KEY));

        // 画面名称
        lst_SearchCondition.setValue(3, DisplayText.getText("LBL-W8007"));
        if (!StringUtil.isBlank(param.getString(LstLocateHistoryDASCHParams.PAGENAMERESOURCEKEY)))
        {
            lst_SearchCondition.setValue(4, DisplayText.getText(param.getString(LstLocateHistoryDASCHParams.PAGENAMERESOURCEKEY)));
        }
