// $Id: LstLocateHistoryParams.java,v 1.1.1.1 2009/02/10 08:55:42 arai Exp $
 ...
 */
public class LstLocateHistoryParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * @throws IOException
     */
    public LstLocateHistoryParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public LstLocateHistoryParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
