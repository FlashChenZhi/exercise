// $Id: LstStockHistory.java 7707 2010-03-20 07:23:11Z okayama $
 ...
 */
public class LstStockHistory extends Page
{
	...
	/**
	 * ControlID	lst_StockHistoryList
	 * TemplateKey	W_StockHistoryList
	 * ControlType	ListCell
	 */
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_StockHistoryList = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_StockHistoryList" , "W_StockHistoryList");
