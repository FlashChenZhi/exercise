// $Id: LstStockHistoryBusiness.java 7747 2010-03-29 08:08:07Z kishimoto $
        ...
        extends LstStockHistory
{
     ...
     * @throws Exception
     */
    public void lst_StockHistoryList_Click(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_StockHistoryList_EnterKey(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_StockHistoryList_TabKey(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_StockHistoryList_InputComplete(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_StockHistoryList_ColumClick(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_StockHistoryList_Server(ActionEvent e)
            throws Exception
    {
    }
     ...
     * @throws Exception
     */
    public void lst_StockHistoryList_Change(ActionEvent e)
            throws Exception
    {
    }
    ...
    protected boolean checkDate(Params p) throws ScheduleException
    {
        ...
        if (!chk.checkDate(WmsFormatter.toDate(p.getString(LstStockHistoryDASCHParams.DISPFROMDAY_KEY)), WmsFormatter.toDate(p.getString(LstStockHistoryDASCHParams.DISPFROMTIME_KEY))))
        {
            message.setMsgResourceKey(chk.getMessage());
            return false;
        }
        
        if (!chk.checkDate(WmsFormatter.toDate(p.getString(LstStockHistoryDASCHParams.DISPTODAY_KEY)), WmsFormatter.toDate(p.getString(LstStockHistoryDASCHParams.DISPTOTIME_KEY))))
        {
            message.setMsgResourceKey(chk.getMessage());
            return false;
        }
     ...
     * @param param 検索条件
     */
    protected boolean lst_SearchCondition_Make(LstStockHistoryDASCHParams param, Locale locale) throws ScheduleException
    {
        // 検索日時の補完処理
        Date[] tmp =
                WmsFormatter.getFromTo(
                        WmsFormatter.toDate(param.getString(LstStockHistoryDASCHParams.DISPFROMDAY_KEY)),
                        WmsFormatter.toTime(param.getString(LstStockHistoryDASCHParams.DISPFROMTIME_KEY)),
                        WmsFormatter.toDate(param.getString(LstStockHistoryDASCHParams.DISPTODAY_KEY)),
                        WmsFormatter.toTime(param.getString(LstStockHistoryDASCHParams.DISPTOTIME_KEY)));
        Date from = tmp[0];
        Date to = tmp[1];
        ...
        lst_SearchCondition.setValue(2, param.getString(LstStockHistoryDASCHParams.USERID_KEY));

        // DS番号
        lst_SearchCondition.setValue(3, DisplayText.getText("LBL-W8003"));
        lst_SearchCondition.setValue(4, param.getString(LstStockHistoryDASCHParams.DSNUMBER_KEY));
        ...
        lst_SearchCondition.setValue(2, param.getString(LstStockHistoryDASCHParams.AREA_NO));

        // 棚No
        lst_SearchCondition.setValue(3, DisplayText.getText("LBL-W0138"));
        lst_SearchCondition.setValue(4, WmsFormatter.toDispLocation(param.getString(LstStockHistoryDASCHParams.LOCATION_NO), param.getString(LstStockHistoryDASCHParams.STYLE_KEY)));
        ...
        lst_SearchCondition.setValue(2, param.getString(LstStockHistoryDASCHParams.ITEM_CODE));

        // ロットNo
        lst_SearchCondition.setValue(3, DisplayText.getText("LBL-W0196"));
        lst_SearchCondition.setValue(4, param.getString(LstStockHistoryDASCHParams.LOT_NO));
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            for (Params outparam : outparams)
            {
                ...
                // DFKLOOK start
                line.setValue(KEY_LST_STOCK_QTY, getFormatNum(outparam.getString(LstStockHistoryDASCHParams.STOCK_QTY)));
                line.setValue(KEY_LST_UPDATE_STOCK_QTY, getFormatNum(outparam.getString(LstStockHistoryDASCHParams.UPDATE_STOCK_QTY)));
                // DFKLOOK end
