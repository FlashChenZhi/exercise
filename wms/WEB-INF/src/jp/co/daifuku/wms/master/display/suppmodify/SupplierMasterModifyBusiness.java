// $Id: SupplierMasterModifyBusiness.java 3208 2009-03-02 05:42:52Z arai $
...
/**
 * 仕入先マスタ修正・削除（基本情報設定）の画面処理を行います。
 *
 * @version $Revision: 3208 $, $Date: 2009-03-02 14:42:52 +0900 (月, 02 3 2009) $
 * @author  BusiTune 1.0 Generator.
 * @author  Last commit: $Author: arai $
 */
public class SupplierMasterModifyBusiness
        extends SupplierMasterModify
{
     ...
     * Default constructor
     */
    public SupplierMasterModifyBusiness()
    {
        super();
    }
            ...
            throws Exception
    {
        ...
        {
            txt_SupplierCode.setValue(viewState.getString(ViewStateKeys.SUPPLIER_CODE));
        }
        // DFKLOOK:ここまで修正
    }
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            inparam.set(SupplierMasterModifySCHParams.SUPPLIER_CODE, txt_SupplierCode.getValue());
            inparam.set(SupplierMasterModifySCHParams.CONSIGNOR_CODE, WmsParam.DEFAULT_CONSIGNOR_CODE);
            ...
            viewState.setObject(ViewStateKeys.SETTING_NAME, lbl_SettingName.getValue());

            // forward.
            forward("/master/suppmodify/SupplierMasterModify2.do");
        }
        catch (Exception ex)
        {
            ex.printStackTrace();
