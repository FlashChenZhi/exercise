// $Id: AreaModifyBusiness.java 6931 2010-01-28 05:53:32Z okayama $
...
/**
 * エリアマスタ修正・削除（基本情報設定）の画面処理を行います。
 *
 * @version $Revision: 6931 $, $Date: 2010-01-28 14:53:32 +0900 (木, 28 1 2010) $
        ...
        extends AreaModify
{
            ...
            throws Exception
    {
        // DFKLOOK:ここから修正
        // 初期値設定
        if (StringUtil.isBlank(viewState.getString(ViewStateKeys.AREA_NO)))
        {
            _pdm_pul_Area.setSelectedValue(null);
        }
        else
        {
            _pdm_pul_Area.setSelectedValue(viewState.getString(ViewStateKeys.AREA_NO));
        }
        // DFKLOOK:ここまで修正
    }
