// $Id: FaItemInquiryBusiness.java 7996 2011-07-06 00:52:24Z kitamaki $
        ...
        extends FaItemInquiry
{
    ...
    private ListCellModel _lcm_lst_FaItemInquiry;
     ...
     * @throws Exception
     */
    public void txt_FromItemCode_EnterKey(ActionEvent e)
            throws Exception
    {
        // DFKLOOK start
        if (StringUtil.isBlank(txt_FromItemCode.getValue()))
        {
        ...
        try
        {
            ...
            Item item = ItemController.getItemInfo(txt_FromItemCode.getText(), WmsParam.DEFAULT_CONSIGNOR_CODE, conn);
     ...
     * @throws Exception
     */
    public void txt_ToItemCode_EnterKey(ActionEvent e)
            throws Exception
    {
        // DFKLOOK start
        if (StringUtil.isBlank(txt_ToItemCode.getValue()))
        {
        ...
        try
        {
            ...
            Item item = ItemController.getItemInfo(txt_ToItemCode.getText(), WmsParam.DEFAULT_CONSIGNOR_CODE, conn);
            ...
            // set focus.
            setFocus(rdo_StockExistence_All);
        }
        catch (Exception ex)
        {
            ex.printStackTrace();
            ...
            throws Exception
    {
        ...
        _lcm_lst_FaItemInquiry = new ListCellModel(lst_FaItemInquiry, LST_FAITEMINQUIRY_KEYS, locale);
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            part11List.add(MasterInParameter.STOCK_EXISTENCE_EXISTENCE, "", rdo_StockExistence_existence.getChecked());
            part11List.add(MasterInParameter.STOCK_EXISTENCE_NOEXISTENCE, "", rdo_StockExistence_Noexistence.getChecked());
            part11List.add(MasterInParameter.STOCK_EXISTENCE_ALL, "", rdo_StockExistence_All.getChecked());
