// $Id: FaItemInquiryDASCHParams.java 5228 2009-10-22 06:21:49Z kumano $
 ...
 *
 * @version $Revision: 5228 $, $Date:: 2009-10-22 15:21:49 +0900#$
 * @author  BusiTune 1.0 Generator.
 * @author  Last commit: $Author: kumano $
 */
public class FaItemInquiryDASCHParams
        extends WmsDASCHParams
{
    ...
    /** STOCK_EXISTENCE */
    public static final ParamKey STOCK_EXISTENCE = new ParamKey("STOCK_EXISTENCE");
     ...
     * Default constructor
     */
    public FaItemInquiryDASCHParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public FaItemInquiryDASCHParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public FaItemInquiryDASCHParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
