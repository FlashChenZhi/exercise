// $Id: MasterLoadEnvironmentSCH.java 7277 2010-02-26 07:43:50Z okayama $
 ...
 */
import static jp.co.daifuku.wms.master.schedule.MasterLoadEnvironmentSCHParams.*;
 ...
 */
public class MasterLoadEnvironmentSCH
        extends AbstractSCH
{
    //------------------------------------------------------------
     ...
     */
    public MasterLoadEnvironmentSCH(Connection conn, Class parent, Locale locale, DfkUserInfo ui) throws CommonException
    {
            ...
            throws CommonException
    {
        ...
        for (Params p : ps)
        {
            ...
            exEnvAKey.setDataType(ExchangeEnvironment.DATA_MASTER);
