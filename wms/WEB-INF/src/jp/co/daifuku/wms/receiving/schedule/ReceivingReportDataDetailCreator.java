// $Id: ReceivingReportDataDetailCreator.java 7241 2010-02-26 05:32:14Z okayama $
 ...
 */
public class ReceivingReportDataDetailCreator
        extends ReceivingReportDataCreator
{
     ...
     */
    public ReceivingReportDataDetailCreator(Connection conn)
    {
        super(conn);
    }
     ...
     */
    public ReceivingReportDataDetailCreator(Connection conn, Class caller)
    {
        super(conn, caller);
    }
     ...
     * @return boolean True when a creation of receiving report data is successful.  Otherwise fasle.<BR>
     */
     ...
     * Actural creating process is done by a method, <CODE>createResultReportFile()</CODE>, in <CODE>AbstractReportDataCreator</CODE> class.<BR>
    ...
    {
        return "$Id: ReceivingReportDataDetailCreator.java 7241 2010-02-26 05:32:14Z okayama $";
    }
}
