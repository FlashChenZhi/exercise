// $Id: ReceivingReportDataCollectionCreator.java 7241 2010-02-26 05:32:14Z okayama $
 ...
 */
public class ReceivingReportDataCollectionCreator
        extends ReceivingReportDataCreator
{
    //------------------------------------------------------------
     ...
     */
    public ReceivingReportDataCollectionCreator(Connection conn)
    {
        super(conn);
    }
     ...
     */
    public ReceivingReportDataCollectionCreator(Connection conn, Class caller)
    {
        super(conn, caller);
    }
    ...
    public boolean report()
    {
        ...
        try
        {
            ...
            //System.out.println("count " + sFinder.search(planSKey));
            ...
            while (sFinder.hasNext())
            {
                ...
                ReceivingPlan[] receivingPlan = (ReceivingPlan[])sFinder.getEntities(RESULT_READ_QTY);
     ...
     * Actural creating process is done by a method, <CODE>createResultReportFile()</CODE>, in <CODE>AbstractReportDataCreator</CODE> class.
    ...
    {
        return "$Id: ReceivingReportDataCollectionCreator.java 7241 2010-02-26 05:32:14Z okayama $";
    }
}
