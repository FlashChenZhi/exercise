// $Id: ReceivingAreaDataSheet.java 8041 2012-05-17 09:39:40Z nagao $
 ...
 */
public class ReceivingAreaDataSheet
        extends BasicDSModel
{
    ...
    //------------------------------------------------------------
    /** DATASHEET_NAME */
    private static final String DATASHEET_NAME = "ReceivingAreaDataSheet";

    /** AREA_NAME */
    public static final DSKey AREA_NAME = new DSKey("AREA_NAME", new DSStringField(), false, 2);

    /** AREA_NO */
    public static final DSKey AREA_NO = new DSKey("AREA_NO", new DSStringField(), false, 0);

    /** TEMP_AREA_NAME */
    public static final DSKey TEMP_AREA_NAME = new DSKey("TEMP_AREA_NAME", new DSStringField(), false, 2);
     ...
     * @param locale Locale
     */
    public ReceivingAreaDataSheet(DataSheetFactory dsf, Locale locale)
    {
    ...
    {
        return "$Id: ReceivingAreaDataSheet.java 8041 2012-05-17 09:39:40Z nagao $";
    }
}
//end of class
