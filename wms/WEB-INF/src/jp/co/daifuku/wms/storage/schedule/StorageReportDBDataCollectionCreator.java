// $Id: StorageReportDBDataCollectionCreator.java 7735 2010-03-26 06:22:49Z okayama $
 ...
 */
public class StorageReportDBDataCollectionCreator
        extends StorageReportDBDataCreator
{
     ...
     */
    public StorageReportDBDataCollectionCreator(Connection conn, Connection customerConn)
    {
     ...
     */
    public StorageReportDBDataCollectionCreator(Connection conn, Connection customerConn, Class caller)
    {
    ...
    public boolean report()
    {
        ...
        try
        {
            ...
            while (sFinder.hasNext())
            {
                ...
                StoragePlan[] storagePlan = (StoragePlan[])sFinder.getEntities(100);
    ...
    {
        return "$Id: StorageReportDBDataCollectionCreator.java 7735 2010-03-26 06:22:49Z okayama $";
    }
}
