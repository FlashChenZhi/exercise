// $Id: AsStorageWorkListParams.java 5219 2009-10-22 05:53:42Z kishimoto $
package jp.co.daifuku.wms.storage.exporter;
 ...
 *
 * @version $Revision: 5219 $, $Date:: 2009-10-22 14:53:42 +0900#$
 * @author  BusiTune 1.0 Generator.
 * @author  Last commit: $Author: kishimoto $
 */
public class AsStorageWorkListParams
        extends Params
{
    //------------------------------------------------------------
     ...
     * Default constructor
     */
    public AsStorageWorkListParams()
    {
        super();
    }
     ...
     * @throws IOException
     */
    public AsStorageWorkListParams(StringParameters param)
            throws IOException
    {
        super(param);
    }
     ...
     * @param initMap Map
     */
    public AsStorageWorkListParams(Map<Key, Object> initMap)
    {
        super(initMap);
    }
